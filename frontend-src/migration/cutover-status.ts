...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "idle-qfr", complete: false, note: "Idle now has source-owned compute-field interaction, generator shop, alignment/retrain/GPU-exchange controls, active-skill presentation, generator milestone upgrades, base economy/tick/persistence runtime, world-fact initialization and SourceApp production binding alongside QFR Dock. Remaining parity work is faction/generic upgrades, heritage/gem/memento progression, advanced click/skill/effect formulas, the full boot cinematic and final shipped-behavior comparison." },
