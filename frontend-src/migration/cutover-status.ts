...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "games", complete: false, note: "Codenames presentation is source-owned. Cake Duel recovery has started with its shipped palette, card/hand geometry, responsive layout model, hand-order reconciliation and measured layout context now source-owned. Cake Duel, Chess and Pictionary still need migration before Games can complete; Cake Duel specifically still needs card interaction/rendering, HUD, piles, action panel, banners, help and full GameScreen composition." },
