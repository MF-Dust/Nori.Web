...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "messenger", complete: false, note: "Messenger service-message Markdown presentation and shipped external-link keyboard behavior are source-owned; broader Messenger/chat-media presentation outside the recovered Signal Messenger boundary still needs migration." },
