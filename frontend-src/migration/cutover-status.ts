...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "idle-qfr", complete: false, note: "Idle now has source-owned compute-field interaction, generator shop, alignment/retrain/GPU-exchange controls, active-skill presentation, generator milestones, three-tier faction progression, permanent Heritage/Gem Power state, Liu Xing memento sequencing, base economy/tick/persistence runtime, world-fact initialization and SourceApp production binding alongside QFR Dock. Remaining parity work is generic/secret upgrades, the remaining advanced faction production/effect curves and lifetime/per-era counters, exact Manifold reveal/reset/completion wiring, the full boot cinematic and final shipped-behavior comparison." },
