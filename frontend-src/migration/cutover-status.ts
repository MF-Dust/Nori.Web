...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "messenger", complete: false, note: "Messenger service-message Markdown and external-link keyboard behavior are source-owned. Source conversation, PCM/encoded TTS playback, mode switching, audio acknowledgements, bounds, cancellation and world/reconnect integration are implemented and browser-tested. Original Messenger visual/reveal/interrupt choreography and shared audio routing remain open; see docs/FRONTEND_MEDIA_RECOVERY.md." },
