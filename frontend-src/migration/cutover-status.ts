...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "games", complete: false, note: "Codenames presentation is source-owned, including header/clue flow, 5x5 board and reveals, turn footer, interactive key card, chat/clue composer, timed board overlays, help sheet and flying-card transition behavior; Cake Duel, Chess and Pictionary still need migration before Games can complete. Cake Duel now source-owns its palette and responsive geometry, card/hand rendering and pointer reordering, HUD, attack/block piles, deck, cake rail, claim/pick/pass/challenge action panel, claim/challenge/bout banners, Wolfy taunt and action-error overlays, plus loading/empty/game screen composition. Remaining Cake Duel work is the long-hover card preview/help content, exact spring-animation parity and production controller/runtime/results/start-flow binding." },
