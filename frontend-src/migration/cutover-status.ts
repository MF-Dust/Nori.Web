...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "games", complete: false, note: "Codenames presentation is source-owned; Cake Duel, Chess and Pictionary presentation still need migration before the Games boundary can complete." },
