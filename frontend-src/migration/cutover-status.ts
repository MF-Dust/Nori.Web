...
export const FRONTEND_CUTOVER_BOUNDARIES: readonly FrontendCutoverBoundary[] = [
  ...
  { id: "messenger", complete: false, note: "Messenger now owns IME-safe composition, duplicate-send fencing, failed-send draft preservation, scroll retention, image failure/preview focus restoration and short-window bubbles. Shipped bubble/thread interaction styling plus the translucent thread-search, service-composer and sealed-composer surface palette are source-owned and parity-gated. Six source story producers are registered alongside cult, with scene-owned clocks/audio and acknowledgement fencing. Original-session visual comparison and original-agent reveal/interrupt/media choreography remain unverified; see docs/FRONTEND_COVERAGE_MATRIX.md." },
