...
const SOURCE_CUES = [
  ["3b7rzf", 4.64, 0.4, "default"],
  ["jkd6mr", 2.4, 0.7, "default"],
  ["aghhjs", 6.96, 0.7, "smile"],
  ["vwkwr6", 4.24, 1.2, "smile"],
  ["3w9mnq", 4, 0.4, "default"],
  ["6mawbk", 6.8, 0.9, "sad"],
  ["k9h86j", 5.04, 0.5, "default"],
  ["s28jhs", 6.64, 0.5, "sad"],
  ["92rpd2", 2.72, 1, "smile"],
  ["xr7hbn", 1.68, 0.5, "smile"],
  ["8gttrk", 6.8, 1, "smile"],
  ["8td8g5", 7.36, 0.9, "smile"],
  ["mpjffb", 4.16, 0.5, "default"],
  ["n8bswz", 6.88, 0.6, "default"],
  ["theucs", 4.88, 0.8, "default"],
  ["6v979j", 3.6, 1.2, "sad-smile"],
  ["99nfna", 2.4, 0.8, "sad"],
  ["pzt84w", 4.64, 0.4, "smile"],
  ["bb9hps", 3.2, 1, "sad-smile"],
  ["p72jpq", 1.2, 1.4, "eyes-closed-smile"],
