...
const candidateDir = resolve(root, ".artifacts/build/app/cutover-candidate");
const output = resolve(process.env.NORI_VISUAL_GAMES_OUTPUT ?? ".artifacts/visual-reference/games");
