import { verifySceneTools } from "../probes/frontend_scene_tools_probe.mjs";
import { verifyChessTutorial } from "../probes/frontend_chess_tutorial_probe.mjs";
import { verifyVoiceCorruption } from "../probes/frontend_voice_corruption_probe.mjs";
import { verifyNoriScene } from "../probes/frontend_nori_scene_probe.mjs";
import { verifyPreview, verifyChip } from "../probes/frontend_preview_chip_probe.mjs";
import { verifyMessenger } from "../probes/frontend_messenger_probe.mjs";
...
import {
  installAudioProbe,
  verifyPodcastMixer,
} from "../probes/frontend_audio_probe.mjs";

const output = resolve(".artifacts/app-smoke");
