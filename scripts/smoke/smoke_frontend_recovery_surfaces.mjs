...
const groups = {
  "debug-labs": ["../probes/frontend_debug_probe.mjs", "verifyDebugLabs"],
  "boot-corruption": [
  ...
  "cold-open": ["../probes/frontend_nori_scene_probe.mjs", "verifyNoriScene"],
  messenger: ["../probes/frontend_messenger_probe.mjs", "verifyMessenger"],
  "datasea-games": ["../probes/frontend_datasea_games_probe.mjs", "verifyDataseaGames"],
  "memory-datasea": [
    "../probes/frontend_memory_datasea_probe.mjs",
    "verifyMemoryDatasea",
  ],
  "datasea-device": [
    "../probes/frontend_datasea_device_matrix_probe.mjs",
    "verifyDataseaDeviceMatrix",
  ],
  "farewell-ending": [
    "../probes/frontend_farewell_ending_probe.mjs",
    "verifyFarewellEnding",
  ],
  cult: ["../probes/frontend_cult_probe.mjs", "verifyCultFlash"],
  "idle-ribbon": ["../probes/frontend_idle_ribbon_probe.mjs", "verifyIdleRibbon"],
};
const selected = process.argv[2];
if (!Object.hasOwn(groups, selected))
  throw new Error(`Unknown recovery surface: ${selected}`);
const output = resolve(".artifacts/surfaces-smoke", selected);
