import {
  ...
  v as re,
  a as U,
} from "./index-B-Up_0PN.js";
import { N as L } from "./NormalApp-Cn6agT0F.js";
var oe = Object.defineProperty,
  ae = (i, e, t) =>
    e in i ? oe(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  W = (i, e, t) => ae(i, typeof e != "symbol" ? e + "" : e, t);
const ue = "color:rgb(0, 145, 255)";
function Z(i) {
  switch (i) {
    case "query":
      return "Q";
...
class ee {
  ...
  addLogLineListener(e) {
    ...
    for (let s = 0; s < 10 && this._onLogLineFuncs[t] !== void 0; s++)
...
function V(i, e, t, s, n) {
  const r = Z(t);
  if (
    (typeof n == "object" && (n = `ConvexError ${JSON.stringify(n.errorData, null, 2)}`),
    e === "info")
  ) {
    const o = n.match(/^\[.*?\] /);
    if (o === null) {
      i.error(`[CONVEX ${r}(${s})] Could not parse console.log`);
      return;
    }
    const a = n.slice(1, o[0].length - 2),
      u = n.slice(o[0].length);
    i.log(`%c[CONVEX ${r}(${s})] [${a}]`, ue, u);
  } else i.error(`[CONVEX ${r}(${s})] ${n}`);
}
function le(i, e) {
  const t = `[CONVEX FATAL ERROR] ${e}`;
  return (i.error(t), new Error(t));
}
function C(i, e, t) {
  return `[CONVEX ${Z(i)}(${e})] ${t.errorMessage}
  Called by client`;
}
function B(i, e) {
  return ((e.data = i.errorData), e);
}
function R(i) {
  const e = i.split(":");
  let t, s;
  return (
    e.length === 1
      ? ((t = e[0]), (s = "default"))
      : ((t = e.slice(0, e.length - 1).join(":")), (s = e[e.length - 1])),
    t.endsWith(".js") && (t = t.slice(0, -3)),
    `${t}:${s}`
  );
}
function v(i, e) {
  return JSON.stringify({ udfPath: R(i), args: T(e) });
}
function K(i, e, t) {
  const { initialNumItems: s, id: n } = t;
  return JSON.stringify({
    type: "paginated",
    udfPath: R(i),
    args: T(e),
    options: T({ initialNumItems: s, id: n }),
  });
}
function tt(i) {
  return JSON.parse(i).type === "paginated";
}
var de = Object.defineProperty,
  fe = (i, e, t) =>
    e in i ? de(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  S = (i, e, t) => fe(i, typeof e != "symbol" ? e + "" : e, t);
class ge {
  constructor() {
    (S(this, "nextQueryId"),
      S(this, "querySetVersion"),
      S(this, "querySet"),
      S(this, "queryIdToToken"),
      S(this, "identityVersion"),
      S(this, "auth"),
      S(this, "outstandingQueriesOlderThanRestart"),
      S(this, "outstandingAuthOlderThanRestart"),
      S(this, "paused"),
      S(this, "pendingQuerySetModifications"),
      (this.nextQueryId = 0),
  ...
  subscribe(e, t, s, n) {
      ...
      );
    {
      ...
      (this.querySet.set(o, l), this.queryIdToToken.set(u, o));
      const g = this.querySetVersion,
        y = this.querySetVersion + 1,
        w = { type: "Add", queryId: u, udfPath: r, args: [T(t)], journal: s, componentPath: n };
      return (
        this.paused ? this.pendingQuerySetModifications.set(u, w) : (this.querySetVersion = y),
        {
          queryToken: o,
          modification: {
            type: "ModifyQuerySet",
    ...
    for (const t of e.modifications)
      switch (t.type) {
        ...
        case "QueryFailed": {
          ...
          const s = t.journal;
          if (s !== void 0) {
            const n = this.queryIdToToken.get(t.queryId);
            n !== void 0 && (this.querySet.get(n).journal = s);
          }
          break;
        }
        case "QueryRemoved": {
  ...
  setAdminAuth(e, t) {
    const s = { tokenType: "Admin", value: e, impersonating: t };
    this.auth = s;
    const n = this.identityVersion;
    return (
      this.paused || (this.identityVersion = n + 1),
      { type: "Authenticate", baseVersion: n, ...s }
    );
  }
  clearAuth() {
  ...
  restart() {
    ...
    const e = [];
    for (const n of this.querySet.values()) {
      const r = {
        type: "Add",
        queryId: n.id,
      ...
      (e.push(r), this.outstandingQueriesOlderThanRestart.add(n.id));
    }
    ...
    return ((this.identityVersion = 1), [t, s]);
  }
  pause() {
    this.paused = !0;
  }
  ...
  removeSubscriber(e) {
    ...
    if (t.numSubscribers > 1) return ((t.numSubscribers -= 1), null);
    {
      ...
      const s = this.querySetVersion,
        n = this.querySetVersion + 1,
        r = { type: "Remove", queryId: t.id };
      return (
        this.paused
          ? this.pendingQuerySetModifications.has(t.id)
            ? this.pendingQuerySetModifications.delete(t.id)
            : this.pendingQuerySetModifications.set(t.id, r)
          : (this.querySetVersion = n),
        { type: "ModifyQuerySet", baseVersion: s, newVersion: n, modifications: [r] }
      );
    }
  }
}
var ye = Object.defineProperty,
  pe = (i, e, t) =>
    e in i ? ye(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  O = (i, e, t) => pe(i, typeof e != "symbol" ? e + "" : e, t);
class me {
  constructor(e, t) {
    ((this.logger = e),
      (this.markConnectionStateDirty = t),
      O(this, "inflightRequests"),
      O(this, "requestsOlderThanRestart"),
      O(this, "inflightMutationsCount", 0),
      O(this, "inflightActionsCount", 0),
      (this.inflightRequests = new Map()),
      (this.requestsOlderThanRestart = new Set()));
  }
  request(e, t) {
    const s = new Promise((n) => {
      const r = t ? "Requested" : "NotSent";
    ...
    return (this.markConnectionStateDirty(), s);
  }
  onResponse(e) {
    const t = this.inflightRequests.get(e.requestId);
    if (t === void 0 || t.status.status === "Completed") return null;
    const s = t.message.type === "Mutation" ? "mutation" : "action",
      n = t.message.udfPath;
    for (const u of e.logLines) V(this.logger, "info", s, n, u);
    const r = t.status;
    let o, a;
    if (e.success)
      ((o = { success: !0, logLines: e.logLines, value: Q(e.result) }), (a = () => r.onResult(o)));
    else {
      const u = e.result,
        { errorData: l } = e;
      (V(this.logger, "error", s, n, u),
        (o = {
          success: !1,
          errorMessage: u,
          errorData: l !== void 0 ? Q(l) : void 0,
          logLines: e.logLines,
        }),
        (a = () => r.onResult(o)));
    }
    return e.type === "ActionResponse" || !e.success
      ...
      : ((t.status = { status: "Completed", result: o, ts: e.ts, onResolve: a }), null);
  }
  removeCompleted(e) {
    const t = new Map();
    for (const [s, n] of this.inflightRequests.entries()) {
      const r = n.status;
      r.status === "Completed" &&
        r.ts.lessThanOrEqual(e) &&
        (r.onResolve(),
        t.set(s, r.result),
        n.message.type === "Mutation"
          ? this.inflightMutationsCount--
          : n.message.type === "Action" && this.inflightActionsCount--,
  ...
  restart() {
    ...
    const e = [];
    for (const [t, s] of this.inflightRequests) {
      if (s.status.status === "NotSent") {
        ((s.status.status = "Requested"), e.push(s.message));
        continue;
      }
      if (s.message.type === "Mutation") e.push(s.message);
      else if (s.message.type === "Action") {
        if (
...
var Se = Object.defineProperty,
  ke = (i, e, t) =>
    e in i ? Se(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  $ = (i, e, t) => ke(i, typeof e != "symbol" ? e + "" : e, t);
class _ {
  constructor(e) {
    ($(this, "queryResults"),
  ...
  getQuery(e, ...t) {
    const s = b(t[0]),
      n = L(e),
      r = this.queryResults.get(v(n, s));
    if (r !== void 0) return _.queryValue(r.result);
  }
  getAllQueries(e) {
    const t = [],
      s = L(e);
    for (const n of this.queryResults.values())
      n.udfPath === R(s) && t.push({ args: n.args, value: _.queryValue(n.result) });
    return t;
  }
  setQuery(e, t, s) {
    const n = b(t),
      ...
      o = v(r, n);
    let a;
    s === void 0 ? (a = void 0) : (a = { success: !0, value: s, logLines: [] });
    const u = { udfPath: r, args: n, result: a };
    (this.queryResults.set(o, u), this.modifiedQueries.push(o));
  }
  static queryValue(e) {
    if (e !== void 0) return e.success ? e.value : void 0;
  }
}
class be {
  constructor() {
  ...
  ingestQueryResultsFromServer(e, t) {
    ...
    const s = this.queryResults;
    this.queryResults = new Map(e);
    const n = new _(this.queryResults);
    for (const o of this.optimisticUpdates) o.update(n);
    const r = [];
    for (const [o, a] of this.queryResults) {
      const u = s.get(o);
      (u === void 0 || u.result !== a.result) && r.push(o);
    }
    return r;
  }
  applyOptimisticUpdate(e, t) {
    this.optimisticUpdates.push({ update: e, mutationId: t });
    const s = new _(this.queryResults);
    return (e(s), s.modifiedQueries);
  }
  rawQueryResult(e) {
  ...
  queryResult(e) {
    ...
    if (s !== void 0) {
      ...
      throw s.errorData !== void 0
        ? B(s, new D(C("query", t.udfPath, s)))
        : new Error(C("query", t.udfPath, s));
    }
  }
  hasQueryResult(e) {
...
var we = Object.defineProperty,
  ve = (i, e, t) =>
    e in i ? we(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  E = (i, e, t) => ve(i, typeof e != "symbol" ? e + "" : e, t);
class p {
  constructor(e, t) {
    (E(this, "low"),
      E(this, "high"),
      E(this, "__isUnsignedLong__"),
      (this.low = e | 0),
      (this.high = t | 0),
  ...
  static fromNumber(e) {
    return isNaN(e) || e < 0 ? z : e >= Te ? Re : new p((e % M) | 0, (e / M) | 0);
  }
  toString() {
    return (BigInt(this.high) * BigInt(M) + BigInt(this.low)).toString();
  }
  equals(e) {
    return (
      p.isLong(e) || (e = p.fromValue(e)),
      this.high >>> 31 === 1 && e.high >>> 31 === 1
        ? !1
  ...
  static fromValue(e) {
    return typeof e == "number" ? p.fromNumber(e) : new p(e.low, e.high);
  }
}
const z = new p(0, 0),
  J = 65536,
...
var qe = Object.defineProperty,
  Ce = (i, e, t) =>
    e in i ? qe(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  P = (i, e, t) => Ce(i, typeof e != "symbol" ? e + "" : e, t);
class j {
  constructor(e, t) {
    (P(this, "version"),
      P(this, "remoteQuerySet"),
      P(this, "queryPath"),
      P(this, "logger"),
      (this.version = { querySet: 0, ts: p.fromNumber(0), identity: 0 }),
  ...
  transition(e) {
    ...
    for (const s of e.modifications)
      switch (s.type) {
        case "QueryUpdated": {
          const n = this.queryPath(s.queryId);
          if (n) for (const o of s.logLines) V(this.logger, "info", "query", n, o);
          const r = Q(s.value ?? null);
          this.remoteQuerySet.set(s.queryId, { success: !0, value: r, logLines: s.logLines });
          break;
        }
        case "QueryFailed": {
          const n = this.queryPath(s.queryId);
          if (n) for (const o of s.logLines) V(this.logger, "info", "query", n, o);
          const { errorData: r } = s;
          this.remoteQuerySet.set(s.queryId, {
            success: !1,
            errorMessage: s.errorMessage,
            errorData: r !== void 0 ? Q(r) : void 0,
            logLines: s.logLines,
          });
          break;
        }
        case "QueryRemoved": {
          this.remoteQuerySet.delete(s.queryId);
          break;
        }
        default:
...
function N(i) {
  const e = ne(i);
  return p.fromBytesLE(Array.from(e));
}
function Ae(i) {
  const e = new Uint8Array(i.toBytesLE());
  return ie(e);
}
function H(i) {
  switch (i.type) {
    ...
    case "MutationResponse":
      return i.success ? { ...i, ts: N(i.ts) } : { ...i };
    case "Transition":
      return {
        ...i,
        startVersion: { ...i.startVersion, ts: N(i.startVersion.ts) },
        endVersion: { ...i.endVersion, ts: N(i.endVersion.ts) },
      };
  }
}
function Me(i) {
  switch (i.type) {
    ...
    case "Connect":
      return i.maxObservedTimestamp !== void 0
        ? { ...i, maxObservedTimestamp: Ae(i.maxObservedTimestamp) }
        : { ...i, maxObservedTimestamp: void 0 };
  }
}
var _e = Object.defineProperty,
  Oe = (i, e, t) =>
    e in i ? _e(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  d = (i, e, t) => Oe(i, typeof e != "symbol" ? e + "" : e, t);
const Pe = 1e3,
  Ie = 1001,
  Qe = 1005,
  Ve = 4040;
...
function q() {
  return (
    I === void 0 && (I = Date.now()),
    typeof performance > "u" || !performance.now ? Date.now() : Math.round(I + performance.now())
  );
}
function G() {
  return `t=${Math.round((q() - I) / 100) / 10}s`;
}
const te = {
...
function $e(i) {
  ...
  for (const e of Object.keys(te)) if (i.startsWith(e)) return e;
  return "Unknown";
}
class xe {
  constructor(e, t, s, n, r, o) {
    ((this.markConnectionStateDirty = r),
      (this.debug = o),
      d(this, "socket"),
      d(this, "connectionCount"),
      d(this, "_hasEverConnected", !1),
      d(this, "lastCloseReason"),
      d(this, "transitionChunkBuffer", null),
      d(this, "defaultInitialBackoff"),
      d(this, "maxBackoff"),
      d(this, "retries"),
      d(this, "serverInactivityThreshold"),
      d(this, "reconnectDueToServerInactivityTimeout"),
      d(this, "scheduledReconnect", null),
      d(this, "networkOnlineHandler", null),
      d(this, "pendingNetworkRecoveryInfo", null),
      d(this, "uri"),
      d(this, "onOpen"),
      d(this, "onResume"),
      d(this, "onMessage"),
      d(this, "webSocketConstructor"),
      d(this, "logger"),
      d(this, "onServerDisconnectError"),
      (this.webSocketConstructor = s),
  ...
  assembleTransition(e) {
    ...
    if (
      ...
      this.transitionChunkBuffer = null;
      const s = H(JSON.parse(t));
      if (s.type !== "Transition")
        throw new Error(`Expected Transition, got ${s.type} after assembling chunks`);
      return s;
    }
    return null;
  }
  connect() {
    ...
    (this._logVerbose("constructed WebSocket"),
        ...
        if (
          ...
          this.lastCloseReason !== "InitialConnect" &&
            (this.lastCloseReason
              ...
              : this.logger.log("WebSocket reconnected at", G())),
      ...
      (e.onerror = (t) => {
        this.transitionChunkBuffer = null;
        const s = t.message;
        s && this.logger.log(`WebSocket error message: ${s}`);
      }),
      (e.onmessage = (t) => {
        this.resetServerInactivityTimeout();
        const s = t.data.length;
        let n = H(JSON.parse(t.data));
        if ((this._logVerbose(`received ws message with type ${n.type}`), n.type === "Ping"))
          return;
        if (n.type === "TransitionChunk") {
          const o = this.assembleTransition(n);
          if (!o) return;
          ((n = o), this._logVerbose(`assembled full ws message of type ${n.type}`));
        }
        (this.transitionChunkBuffer !== null &&
          ((this.transitionChunkBuffer = null),
          this.logger.log(`Received unexpected ${n.type} while buffering TransitionChunks`)),
          n.type === "Transition" &&
            this.reportLargeTransition({ messageLength: s, transition: n }),
      ...
      (e.onclose = (t) => {
        if (
          ...
          (this.transitionChunkBuffer = null),
          this.lastCloseReason === null &&
            (this.lastCloseReason = t.reason || `closed with code ${t.code}`),
          t.code !== Pe && t.code !== Ie && t.code !== Qe && t.code !== Ve)
        ) {
          let n = `WebSocket closed with code ${t.code}`;
          (t.reason && (n += `: ${t.reason}`),
            this.logger.log(n),
            this.onServerDisconnectError && t.reason && this.onServerDisconnectError(n));
        }
        const s = $e(t.reason);
  ...
  sendMessage(e) {
    ...
    if (this.socket.state === "ready" && this.socket.paused === "no") {
      ...
      return (
        this._logVerbose(
          `${r ? "sent" : "failed to send"} message with type ${e.type}: ${JSON.stringify(t)}`,
        ),
        !0
      );
    }
  ...
  scheduleReconnect(e) {
    ...
    const s = q(),
      n = setTimeout(() => {
        this.scheduledReconnect?.timeout === n &&
          ((this.scheduledReconnect = null), this.connect());
      }, t);
    this.scheduledReconnect = { timeout: n, scheduledAt: s, backoffMs: t };
  }
  closeAndReconnect(e) {
  ...
  tryReconnectImmediately() {
    ...
    if (this.scheduledReconnect) {
      const t = q() - this.scheduledReconnect.scheduledAt;
  ...
  nextBackoff(e) {
    const s =
      (e === "client" ? 100 : e === "Unknown" ? this.defaultInitialBackoff : te[e].timeout) *
      Math.pow(2, this.retries);
    this.retries += 1;
    const n = Math.min(s, this.maxBackoff),
      r = n * (Math.random() - 0.5);
    return n + r;
  }
  reportLargeTransition({ transition: e, messageLength: t }) {
    if (e.clientClockSkew === void 0 || e.serverTs === void 0) return;
    const s = q() - e.clientClockSkew - e.serverTs / 1e6,
      n = `${Math.round(s)}ms`,
      r = `${Math.round(t / 1e4) / 100}MB`,
      o = t / (s / 1e3),
      a = `${Math.round(o / 1e4) / 100}MB per second`;
    (this._logVerbose(`received ${r} transition in ${n} at ${a}`),
      t > 2e7
        ? this.logger.log(
            `received query results totaling more that 20MB (${r}) which will take a long time to download on slower connections`,
          )
        : s > 2e4 &&
          this.logger.log(
            `received query results totaling ${r} which took more than 20s to arrive (${n})`,
          ),
      this.debug &&
        this.sendMessage({
          type: "Event",
          eventType: "ClientReceivedTransition",
          event: { transitionTransitTime: s, messageLength: t },
        }));
  }
}
function Le() {
...
function se(i, e) {
  if (typeof i != "string") throw new A("Invalid token specified: must be a string");
  e || (e = {});
  const t = e.header === !0 ? 0 : 1,
    s = i.split(".")[t];
  if (typeof s != "string") throw new A(`Invalid token specified: missing part #${t + 1}`);
  let n;
  try {
    n = Fe(s);
  } catch (r) {
    throw new A(`Invalid token specified: invalid base64 for part #${t + 1} (${r.message})`);
  }
  try {
    return JSON.parse(n);
  } catch (r) {
    throw new A(`Invalid token specified: invalid json for part #${t + 1} (${r.message})`);
  }
}
var De = Object.defineProperty,
  Be = (i, e, t) =>
    e in i ? De(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  m = (i, e, t) => Be(i, typeof e != "symbol" ? e + "" : e, t);
const Ue = 480 * 60 * 60 * 1e3,
  X = 2;
class We {
  constructor(e, t, s) {
    (m(this, "authState", { state: "noAuth" }),
      m(this, "configVersion", 0),
      m(this, "syncState"),
      m(this, "authenticate"),
      m(this, "stopSocket"),
      m(this, "tryRestartSocket"),
      m(this, "pauseSocket"),
      m(this, "resumeSocket"),
      m(this, "clearAuth"),
      m(this, "logger"),
      m(this, "refreshTokenLeewaySeconds"),
      m(this, "tokenConfirmationAttempts", 0),
      (this.syncState = e),
      ...
      (this.refreshTokenLeewaySeconds = s.refreshTokenLeewaySeconds));
  }
  async setConfig(e, t) {
    (this.resetAuthState(),
      this._logVerbose("pausing WS for auth token fetch"),
      this.pauseSocket());
    const s = await this.fetchTokenAndGuardAgainstRace(e, { forceRefreshToken: !1 });
  ...
  async tryToReauthenticate(e) {
    if (
      ...
      this.authState.state === "noAuth" ||
        (this.authState.state === "waitingForServerConfirmationOfFreshToken" &&
          this.tokenConfirmationAttempts >= X))
    ) {
    ...
    (this.authState.state === "waitingForServerConfirmationOfFreshToken" &&
      ...
      this._logVerbose(
        `retrying reauthentication, ${X - this.tokenConfirmationAttempts} attempts remaining`,
      )),
  ...
  async refetchToken() {
    ...
    const e = await this.fetchTokenAndGuardAgainstRace(this.authState.config.fetchToken, {
      forceRefreshToken: !0,
    });
  ...
  scheduleTokenRefetch(e) {
    ...
    let o = Math.min(Ue, (r - this.refreshTokenLeewaySeconds) * 1e3);
    o <= 0 &&
      (this.logger.warn(
        `Refetching auth token immediately, configured leeway ${this.refreshTokenLeewaySeconds}s is larger than the token's lifetime ${r}s`,
      ),
      (o = 0));
    const a = setTimeout(() => {
  ...
  async fetchTokenAndGuardAgainstRace(e, t) {
    const s = ++this.configVersion;
    this._logVerbose(`fetching token with config version ${s}`);
    const n = await e(t);
    return this.configVersion !== s
      ? (this._logVerbose(`stale config version, expected ${s}, got ${this.configVersion}`),
        { isFromOutdatedConfig: !0 })
      : { isFromOutdatedConfig: !1, value: n };
  }
  stop() {
    (this.resetAuthState(),
      this.configVersion++,
...
const Ke = ["convexClientConstructed", "convexWebSocketOpen", "convexFirstMessageReceived"];
function ze(i, e) {
  const t = { sessionId: e };
  typeof performance > "u" || !performance.mark || performance.mark(i, { detail: t });
}
function Je(i) {
  let e = i.name.slice(6);
  return ((e = e.charAt(0).toLowerCase() + e.slice(1)), { name: e, startTime: i.startTime });
}
function je(i) {
  ...
  for (const t of Ke) {
    const s = performance
      .getEntriesByName(t)
      .filter((n) => n.entryType === "mark")
      .filter((n) => n.detail.sessionId === i);
    e.push(...s);
  }
  return e.map(Je);
}
var He = Object.defineProperty,
  Ge = (i, e, t) =>
    e in i ? He(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  f = (i, e, t) => Ge(i, typeof e != "symbol" ? e + "" : e, t);
class st {
  constructor(e, t, s) {
    if (
      (f(this, "address"),
      ...
      f(this, "webSocketManager"),
      f(this, "authenticationManager"),
      f(this, "remoteQuerySet"),
      f(this, "optimisticQueryResults"),
      f(this, "_transitionHandlerCounter", 0),
      f(this, "_nextRequestId"),
      f(this, "_onTransitionFns", new Map()),
      f(this, "_sessionId"),
      f(this, "firstMessageReceived", !1),
      f(this, "debug"),
      f(this, "logger"),
      f(this, "maxObservedTimestamp"),
      f(this, "connectionStateSubscribers", new Map()),
      f(this, "nextConnectionStateSubscriberId", 0),
      f(this, "_lastPublishedConnectionState"),
      f(this, "markConnectionStateDirty", () => {
        Promise.resolve().then(() => {
          const c = this.connectionState();
          if (JSON.stringify(c) !== JSON.stringify(this._lastPublishedConnectionState)) {
            this._lastPublishedConnectionState = c;
            for (const h of this.connectionStateSubscribers.values()) h(c);
          }
        });
      }),
      f(this, "mark", (c) => {
        this.debug && ze(c, this.sessionId);
      }),
      typeof e == "object")
    )
      throw new Error(
    ...
    (s?.skipConvexDeploymentUrlCheck !== !0 && re(e), (s = { ...s }));
    const n = s.authRefreshTokenLeewaySeconds ?? 10;
    let r = s.webSocketConstructor;
    if (!r && typeof WebSocket > "u")
      throw new Error(
        "No WebSocket global variable defined! To use Convex in an environment without WebSocket try the HTTP client: https://docs.convex.dev/api/classes/browser.ConvexHttpClient",
      );
    ((r = r || WebSocket),
      (this.debug = s.reportDebugInfoToConvex ?? !1),
      (this.address = e),
      (this.logger =
        s.logger === !1
          ? he({ verbose: s.verbose ?? !1 })
          : s.logger !== !0 && s.logger
            ? s.logger
            : ce({ verbose: s.verbose ?? !1 })));
    const o = e.search("://");
    if (o === -1) throw new Error("Provided address was not an absolute URL.");
    const a = e.substring(o + 3),
      u = e.substring(0, o);
    let l;
    if (u === "http") l = "ws";
    else if (u === "https") l = "wss";
    else throw new Error(`Unknown parent protocol ${u}`);
    const g = `${l}://${a}/api/${U}/sync`;
    ((this.state = new ge()),
      (this.remoteQuerySet = new j((c) => this.state.queryPath(c), this.logger)),
      (this.requestManager = new me(this.logger, this.markConnectionStateDirty)));
    const y = () => {
      (this.webSocketManager.pause(), this.state.pause());
    };
    ((this.authenticationManager = new We(
      this.state,
      {
        authenticate: (c) => {
      ...
      { logger: this.logger, refreshTokenLeewaySeconds: n },
    )),
      (this.optimisticQueryResults = new be()),
      this.addOnTransitionHandler((c) => {
        t(c.queries.map((h) => h.token));
      }),
      (this._nextRequestId = 0),
      (this._sessionId = Le()));
    const { unsavedChangesWarning: w } = s;
      ...
      w !== !1 &&
        window.addEventListener("beforeunload", (c) => {
          if (this.requestManager.hasIncompleteRequests()) {
            c.preventDefault();
            const h = "Are you sure you want to leave? Your changes may not be saved.";
            return (((c || window.event).returnValue = h), h);
          }
        });
    ((this.webSocketManager = new xe(
      g,
      {
        onOpen: (c) => {
          (this.mark("convexWebSocketOpen"),
            ...
            (this.remoteQuerySet = new j((x) => this.state.queryPath(x), this.logger)));
          const [h, k] = this.state.restart();
          (k && this.webSocketManager.sendMessage(k), this.webSocketManager.sendMessage(h));
          for (const x of this.requestManager.restart()) this.webSocketManager.sendMessage(x);
        },
        onResume: () => {
          const [c, h] = this.state.resume();
          (h && this.webSocketManager.sendMessage(h), c && this.webSocketManager.sendMessage(c));
          for (const k of this.requestManager.resume()) this.webSocketManager.sendMessage(k);
        },
        onMessage: (c) => {
          switch (
            ...
            case "Transition": {
              ...
              const h = this.requestManager.removeCompleted(this.remoteQuerySet.timestamp());
            ...
            case "MutationResponse": {
              ...
              h !== null && this.notifyOnQueryResultChanges(new Map([[h.requestId, h.result]]));
              break;
            }
            case "ActionResponse": {
  ...
  notifyOnQueryResultChanges(e) {
    const t = this.remoteQuerySet.remoteQueryResults(),
      s = new Map();
    for (const [r, o] of t) {
      const a = this.state.queryToken(r);
      if (a !== null) {
        const u = { result: o, udfPath: this.state.queryPath(r), args: this.state.queryArgs(r) };
        s.set(a, u);
      }
    }
    const n = this.optimisticQueryResults.ingestQueryResultsFromServer(s, new Set(e.keys()));
    this.handleTransition({
      queries: n.map((r) => {
        const o = this.optimisticQueryResults.rawQueryResult(r);
        return { token: r, modification: { kind: "Updated", result: o } };
      }),
      reflectedMutations: Array.from(e).map(([r, o]) => ({ requestId: r, result: o })),
  ...
  setAdminAuth(e, t) {
    const s = this.state.setAdminAuth(e, t);
    this.webSocketManager.sendMessage(s);
  }
  clearAuth() {
    ...
    const n = b(t),
      {
        ...
        queryToken: o,
        unsubscribe: a,
      } = this.state.subscribe(e, n, s?.journal, s?.componentPath);
    return (
      r !== null && this.webSocketManager.sendMessage(r),
      {
        queryToken: o,
        unsubscribe: () => {
          const u = a();
  ...
  async mutation(e, t, s) {
    const n = await this.mutationInternal(e, t, s);
    if (!n.success)
      throw n.errorData !== void 0
        ? B(n, new D(C("mutation", e, n)))
        : new Error(C("mutation", e, n));
    return n.value;
  }
  async mutationInternal(e, t, s, n) {
    const { mutationPromise: r } = this.enqueueMutation(e, t, s, n);
    return r;
  }
  enqueueMutation(e, t, s, n) {
    const r = b(t);
    this.tryReportLongDisconnect();
    const o = this.nextRequestId;
    if ((this._nextRequestId++, s !== void 0)) {
      const g = s.optimisticUpdate;
      if (g !== void 0) {
        const y = (h) => {
            g(h, r) instanceof Promise &&
              this.logger.warn(
                "Optimistic update handler returned a Promise. Optimistic updates should be synchronous.",
              );
          },
          c = this.optimisticQueryResults.applyOptimisticUpdate(y, o).map((h) => {
            const k = this.localQueryResultByToken(h);
            return {
              token: h,
              modification: {
                kind: "Updated",
                result: k === void 0 ? void 0 : { success: !0, value: k, logLines: [] },
              },
            };
          });
        this.handleTransition({
    ...
    const a = { type: "Mutation", requestId: o, udfPath: e, componentPath: n, args: [T(r)] },
      u = this.webSocketManager.sendMessage(a),
      l = this.requestManager.request(a, u);
    return { requestId: o, mutationPromise: l };
  }
  async action(e, t) {
    const s = await this.actionInternal(e, t);
    if (!s.success)
      throw s.errorData !== void 0 ? B(s, new D(C("action", e, s))) : new Error(C("action", e, s));
    return s.value;
  }
  async actionInternal(e, t, s) {
    const n = b(t),
      r = this.nextRequestId;
    (this._nextRequestId++, this.tryReportLongDisconnect());
    const o = { type: "Action", requestId: r, udfPath: e, componentPath: s, args: [T(n)] },
  ...
  tryReportLongDisconnect() {
    ...
    fetch(t, {
      method: "POST",
      headers: { "Content-Type": "application/json", "Convex-Client": `npm-${U}` },
      body: JSON.stringify({ event: "LongWebsocketDisconnect" }),
    })
      .then((s) => {
        s.ok || this.logger.warn("Analytics request failed with response:", s.body);
      })
      .catch((s) => {
        this.logger.warn("Analytics response failed with error:", s);
      });
  }
}
function F(i) {
  if (
    typeof i != "object" ||
    i === null ||
    !Array.isArray(i.page) ||
    typeof i.isDone != "boolean" ||
    typeof i.continueCursor != "string"
  )
    throw new Error(`Not a valid paginated query result: ${i?.toString()}`);
  return i;
}
var Xe = Object.defineProperty,
  Ye = (i, e, t) =>
    e in i ? Xe(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  Y = (i, e, t) => Ye(i, typeof e != "symbol" ? e + "" : e, t);
class nt {
  constructor(e, t) {
    ((this.client = e),
      (this.onTransition = t),
      Y(this, "paginatedQuerySet", new Map()),
      Y(this, "lastTransitionTs"),
      (this.lastTransitionTs = p.fromNumber(0)),
      this.client.addOnTransitionHandler((s) => this.onBaseTransition(s)));
  }
  subscribe(e, t, s) {
    const n = R(e),
      r = K(n, t, s),
      o = () => this.removePaginatedQuerySubscriber(r),
      a = this.paginatedQuerySet.get(r);
    return a
      ? ((a.numSubscribers += 1), { paginatedQueryToken: r, unsubscribe: o })
      : (this.paginatedQuerySet.set(r, {
          token: r,
          canonicalizedUdfPath: n,
          args: t,
          numSubscribers: 1,
          options: { initialNumItems: s.initialNumItems },
          nextPageKey: 0,
          pageKeys: [],
        ...
        this.addPageToPaginatedQuery(r, null, s.initialNumItems),
        { paginatedQueryToken: r, unsubscribe: o });
  }
  localQueryResult(e, t, s) {
    const n = R(e),
      r = K(n, t, s);
  ...
  localQueryResultByToken(e) {
    ...
    if (!t) return;
    const s = this.activePageQueryTokens(t);
    if (s.length === 0)
      return {
        results: [],
        status: "LoadingFirstPage",
        loadMore: (u) => this.loadMoreOfPaginatedQuery(e, u),
      };
    let n = [],
      r = !1,
      o = !1;
    for (const u of s) {
      const l = this.client.localQueryResultByToken(u);
      if (l === void 0) {
        ((r = !0), (o = !1));
        continue;
      }
      const g = F(l);
      ((n = n.concat(g.page)), (o = !!g.isDone));
    }
    let a;
    return (
      r
        ? (a = n.length === 0 ? "LoadingFirstPage" : "LoadingMore")
        : o
          ? (a = "Exhausted")
          : (a = "CanLoadMore"),
      { results: n, status: a, loadMore: (u) => this.loadMoreOfPaginatedQuery(e, u) }
    );
  }
  onBaseTransition(e) {
    const t = e.queries.map((o) => o.token),
      s = this.queriesContainingTokens(t);
    let n = [];
    s.length > 0 &&
      (this.processPaginatedQuerySplits(s, (o) => this.client.localQueryResultByToken(o)),
      (n = s.map((o) => ({
        token: o,
        modification: { kind: "Updated", result: this.localQueryResultByToken(o) },
      }))));
    const r = { ...e, paginatedQueries: n };
    this.onTransition(r);
  }
  loadMoreOfPaginatedQuery(e, t) {
    this.mustGetPaginatedQuery(e);
    const s = this.queryTokenForLastPageOfPaginatedQuery(e),
      n = this.client.localQueryResultByToken(s);
    if (!n) return !1;
    const r = F(n);
    if (r.isDone) return !1;
    this.addPageToPaginatedQuery(e, r.continueCursor, t);
    const o = {
      timestamp: this.lastTransitionTs,
      reflectedMutations: [],
      queries: [],
      paginatedQueries: [
        { token: e, modification: { kind: "Updated", result: this.localQueryResultByToken(e) } },
      ],
    };
  ...
  queriesContainingTokens(e) {
    ...
    const t = [],
      s = new Set(e);
    for (const [n, r] of this.paginatedQuerySet)
      for (const o of this.allQueryTokens(r))
        if (s.has(o)) {
          t.push(n);
          break;
        }
  ...
  processPaginatedQuerySplits(e, t) {
    for (const s of e) {
      const n = this.mustGetPaginatedQuery(s),
        { ongoingSplits: r, pageKeyToQuery: o, pageKeys: a } = n;
      for (const [u, [l, g]] of r)
        t(o.get(l).queryToken) !== void 0 &&
          t(o.get(g).queryToken) !== void 0 &&
          this.completePaginatedQuerySplit(n, u, l, g);
      for (const u of a) {
        if (r.has(u)) continue;
        const l = o.get(u).queryToken,
          g = t(l);
        if (!g) continue;
        const y = F(g);
        y.splitCursor &&
          (y.pageStatus === "SplitRecommended" ||
            ...
            y.page.length > n.options.initialNumItems * 2) &&
          this.splitPaginatedQueryPage(n, u, y.splitCursor, y.continueCursor);
      }
    }
  }
  splitPaginatedQueryPage(e, t, s, n) {
    const r = e.nextPageKey++,
      o = e.nextPageKey++,
      a = { cursor: n, numItems: e.options.initialNumItems, id: e.id },
      u = this.client.subscribe(e.canonicalizedUdfPath, {
        ...e.args,
        paginationOpts: { ...a, cursor: null, endCursor: s },
      });
    e.pageKeyToQuery.set(r, u);
    const l = this.client.subscribe(e.canonicalizedUdfPath, {
      ...e.args,
      paginationOpts: { ...a, cursor: s, endCursor: n },
    });
    (e.pageKeyToQuery.set(o, l), e.ongoingSplits.set(t, [r, o]));
  }
  addPageToPaginatedQuery(e, t, s) {
    const n = this.mustGetPaginatedQuery(e),
      r = n.nextPageKey++,
      o = { cursor: t, numItems: s, id: n.id },
      a = { ...n.args, paginationOpts: o },
      u = this.client.subscribe(n.canonicalizedUdfPath, a);
    return (n.pageKeys.push(r), n.pageKeyToQuery.set(r, u), u);
  }
  removePaginatedQuerySubscriber(e) {
    const t = this.paginatedQuerySet.get(e);
    if (t && ((t.numSubscribers -= 1), !(t.numSubscribers > 0))) {
      for (const s of t.pageKeyToQuery.values()) s.unsubscribe();
      this.paginatedQuerySet.delete(e);
    }
  }
  completePaginatedQuerySplit(e, t, s, n) {
    const r = e.pageKeyToQuery.get(t);
    e.pageKeyToQuery.delete(t);
    const o = e.pageKeys.indexOf(t);
    (e.pageKeys.splice(o, 1, s, n), e.ongoingSplits.delete(t), r.unsubscribe());
  }
  ...
  queryTokenForLastPageOfPaginatedQuery(e) {
    const t = this.mustGetPaginatedQuery(e),
      s = t.pageKeys[t.pageKeys.length - 1];
    if (s === void 0) throw new Error(`No pages for paginated query ${e}`);
    return t.pageKeyToQuery.get(s).queryToken;
  }
...
export { st as B, nt as P, ce as a, he as i, V as l, tt as s };
