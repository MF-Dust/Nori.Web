import { i } from "./i18n-DtIC1LRi.js";
import { L as r, M as c } from "./NormalApp-Cn6agT0F.js";
import { D as s } from "./download-BfBW5oEI.js";
const n = {
    "qfr.downloaded": {
      name: "QFR-9000.exe",
...
function d(e, t) {
  r({
    ...
    icon: s,
    accentColor: u,
    title: p(t ? "os.download.already" : "os.download.title"),
    subtitle: e.name,
    onClick: () => {
      c(e.target);
    },
