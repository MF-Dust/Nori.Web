                        ...
                        var u,
                          ...
                          c =
                            p < 3
                              ? t
                              : f === null
                                ? (f = Object.getOwnPropertyDescriptor(t, a))
                                : f;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          c = Reflect.decorate(e, t, a, f);
                        else
                          for (var m = e.length - 1; m >= 0; m--)
                            (u = e[m]) && (c = (p < 3 ? u(c) : p > 3 ? u(t, a, c) : u(t, a)) || c);
                  ...
                  let s = (r.AccessibilityManager = class extends v.Disposable {
                    constructor(e, t, a, f) {
                      ...
                      for (let u = 0; u < this._terminal.rows; u++)
                        ((this._rowElements[u] = this._createAccessibilityTreeNode()),
                          this._rowContainer.appendChild(this._rowElements[u]));
                      if (
                        ((this._topBoundaryFocusListener = (u) => this._handleBoundaryFocus(u, 0)),
                      ...
                      (this._terminal.element.insertAdjacentElement(
                        ...
                        this.register(this._terminal.onResize((u) => this._handleResize(u.rows))),
                        this.register(
                          this._terminal.onRender((u) => this._refreshRows(u.start, u.end)),
                        ),
                        this.register(this._terminal.onScroll(() => this._refreshRows())),
                        this.register(this._terminal.onA11yChar((u) => this._handleChar(u))),
                        this.register(
...
`),
                        ...
                        this.register(this._terminal.onA11yTab((u) => this._handleTab(u))),
                        this.register(this._terminal.onKey((u) => this._handleKey(u.key))),
                        ...
                        this.register(
                          (0, i.addDisposableDomListener)(document, "selectionchange", () =>
...
` &&
                    ...
                    _handleKey(e) {
                      (this._clearLiveRegion(),
                        new RegExp("\\p{Control}", "u").test(e) || this._charsToConsume.push(e));
                    }
                    _refreshRows(e, t) {
                      this._liveRegionDebouncer.refresh(e, t, this._terminal.rows);
                    }
                    _renderRows(e, t) {
                      const a = this._terminal.buffer,
                        f = a.lines.length.toString();
                      for (let u = e; u <= t; u++) {
                        const p = a.lines.get(a.ydisp + u),
                          c = [],
                          m = p?.translateToString(!0, void 0, void 0, c) || "",
                          E = (a.ydisp + u + 1).toString(),
                          k = this._rowElements[u];
                        k &&
                          (m.length === 0
                            ? ((k.innerText = " "), this._rowColumns.set(k, [0, 1]))
                            : ((k.textContent = m), this._rowColumns.set(k, c)),
                          k.setAttribute("aria-posinset", E),
                    ...
                    _handleBoundaryFocus(e, t) {
                      const a = e.target,
                        f = this._rowElements[t === 0 ? 1 : this._rowElements.length - 2];
                      if (
                        a.getAttribute("aria-posinset") ===
                      ...
                      if (
                        (t === 0
                          ? ((u = a),
                            (p = this._rowElements.pop()),
                            this._rowContainer.removeChild(p))
                          : ((u = this._rowElements.shift()),
                            (p = a),
                            this._rowContainer.removeChild(u)),
                        u.removeEventListener("focus", this._topBoundaryFocusListener),
                        p.removeEventListener("focus", this._bottomBoundaryFocusListener),
                        t === 0)
                      ) {
                    ...
                    _handleSelectionChange() {
                      ...
                      let t = { node: e.anchorNode, offset: e.anchorOffset },
                        a = { node: e.focusNode, offset: e.focusOffset };
                      if (
                        ((t.node.compareDocumentPosition(a.node) &
                          Node.DOCUMENT_POSITION_PRECEDING ||
                          (t.node === a.node && t.offset > a.offset)) &&
                          ([t, a] = [a, t]),
                      ...
                      if (
                        (a.node.compareDocumentPosition(f) &
                          (Node.DOCUMENT_POSITION_CONTAINED_BY |
                            Node.DOCUMENT_POSITION_PRECEDING) &&
                          (a = { node: f, offset: f.textContent?.length ?? 0 }),
                        !this._rowContainer.contains(a.node))
                      )
                        return;
                      const u = ({ node: m, offset: E }) => {
                          const k = m instanceof Text ? m.parentNode : m;
                          let D = parseInt(k?.getAttribute("aria-posinset"), 10) - 1;
                          if (isNaN(D))
                            return (console.warn("row is invalid. Race condition?"), null);
                          const b = this._rowColumns.get(k);
                          if (!b) return (console.warn("columns is null. Race condition?"), null);
                          let x = E < b.length ? b[E] : b.slice(-1)[0] + 1;
                          return (
                            x >= this._terminal.cols && (++D, (x = 0)),
                            { row: D, column: x }
                          );
                        },
                        p = u(t),
                        c = u(a);
                      if (p && c) {
                        if (p.row > c.row || (p.row === c.row && p.column >= c.column))
                          throw new Error("invalid range");
                        this._terminal.select(
                          p.column,
                          p.row,
                          (c.row - p.row) * this._terminal.cols - p.column + c.column,
                        );
                      }
                    }
                    _handleResize(e) {
                ...
                3614: (T, r) => {
                  ...
                  function n(d, v, g) {
                    const h = g.getBoundingClientRect(),
                      i = d.clientX - h.left - 10,
                      s = d.clientY - h.top - 10;
                    ((v.style.width = "20px"),
                      (v.style.height = "20px"),
                      (v.style.left = `${i}px`),
                      (v.style.top = `${s}px`),
                  ...
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    (r.rightClickHandler =
                      ...
                      r.prepareTextForTerminal =
                        void 0),
                    (r.prepareTextForTerminal = o),
                    (r.bracketTextForPaste = l),
                    (r.copyHandler = function (d, v) {
                      (d.clipboardData && d.clipboardData.setData("text/plain", v.selectionText),
                        d.preventDefault());
                    }),
                    (r.handlePasteEvent = function (d, v, g, h) {
                      (d.stopPropagation(),
                        d.clipboardData && _(d.clipboardData.getData("text/plain"), v, g, h));
                    }),
                    (r.paste = _),
                    (r.moveTextAreaUnderMouseCursor = n),
                    (r.rightClickHandler = function (d, v, g, h, i) {
                      (n(d, v, g),
                        i && h.rightClickSelect(d),
                        (v.value = h.selectionText),
                        v.select());
                    }));
                },
                7239: (T, r, o) => {
                ...
                3656: (T, r) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.addDisposableDomListener = function (o, l, _, n) {
                          ...
                          p =
                            u < 3
                              ...
                              : a === null
                                ...
                                : a;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          p = Reflect.decorate(s, e, t, a);
                        else
                          for (var c = s.length - 1; c >= 0; c--)
                            (f = s[c]) && (p = (u < 3 ? f(p) : u > 3 ? f(e, t, p) : f(e, t)) || p);
                  ...
                  let i = (r.Linkifier = class extends v.Disposable {
                    ...
                    constructor(s, e, t, a, f) {
                      (super(),
                        ...
                        this.register((0, v.getDisposeArrayDisposable)(this._linkCacheDisposables)),
                        this.register(
                          (0, v.toDisposable)(() => {
                    ...
                    _handleMouseMove(s) {
                      ...
                      (this._lastBufferCell &&
                        ...
                        (this._handleHover(e), (this._lastBufferCell = e));
                    }
                    _handleHover(s) {
                      if (this._activeLine !== s.y || this._wasResized)
                        return (
                          this._clearCurrentLink(),
                          this._askForLink(s, !1),
                          void (this._wasResized = !1)
                        );
                      (this._currentLink && this._linkAtPosition(this._currentLink.link, s)) ||
                        (this._clearCurrentLink(), this._askForLink(s, !0));
                    }
                    _askForLink(s, e) {
                      (this._activeProviderReplies && e) ||
                        (this._activeProviderReplies?.forEach((a) => {
                          a?.forEach((f) => {
                            f.link.dispose && f.link.dispose();
                          });
                        }),
                        (this._activeProviderReplies = new Map()),
                        (this._activeLine = s.y));
                      let t = !1;
                      for (const [a, f] of this._linkProviderService.linkProviders.entries())
                        e
                          ? this._activeProviderReplies?.get(a) &&
                            (t = this._checkLinkProviderResult(a, s, t))
                          : f.provideLinks(s.y, (u) => {
                              if (this._isMouseOut) return;
                              const p = u?.map((c) => ({ link: c }));
                              (this._activeProviderReplies?.set(a, p),
                                (t = this._checkLinkProviderResult(a, s, t)),
                                this._activeProviderReplies?.size ===
                                  this._linkProviderService.linkProviders.length &&
                                  this._removeIntersectingLinks(s.y, this._activeProviderReplies));
                            });
                    }
                      ...
                      for (let a = 0; a < e.size; a++) {
                        ...
                        if (f)
                          for (let u = 0; u < f.length; u++) {
                            const p = f[u],
                              c = p.link.range.start.y < s ? 0 : p.link.range.start.x,
                              m =
                                p.link.range.end.y > s
                    ...
                    _checkLinkProviderResult(s, e, t) {
                      ...
                      let f = !1;
                      for (let u = 0; u < s; u++)
                        (this._activeProviderReplies.has(u) &&
                          !this._activeProviderReplies.get(u)) ||
                          (f = !0);
                      if (!f && a) {
                        const u = a.find((p) => this._linkAtPosition(p.link, e));
                        u && ((t = !0), this._handleNewLink(u));
                      }
                      if (
                        this._activeProviderReplies.size ===
                          this._linkProviderService.linkProviders.length &&
                        ...
                        for (let u = 0; u < this._activeProviderReplies.size; u++) {
                          const p = this._activeProviderReplies
                            .get(u)
                            ?.find((c) => this._linkAtPosition(c.link, e));
                          if (p) {
                            ((t = !0), this._handleNewLink(p));
                            break;
                          }
                        }
                      return t;
                    ...
                    _handleMouseUp(s) {
                      ...
                      e &&
                        ...
                        this._currentLink.link.activate(s, this._currentLink.link.text);
                    }
                    _clearCurrentLink(s, e) {
                      this._currentLink &&
                        ...
                        (!s ||
                          !e ||
                          (this._currentLink.link.range.start.y >= s &&
                    ...
                    _handleNewLink(s) {
                      ...
                      e &&
                        this._linkAtPosition(s.link, e) &&
                        ((this._currentLink = s),
                        (this._currentLink.state = {
                          decorations: {
                            underline:
                              s.link.decorations === void 0 || s.link.decorations.underline,
                            pointerCursor:
                              s.link.decorations === void 0 || s.link.decorations.pointerCursor,
                          },
                          isHovered: !0,
                        }),
                        this._linkHover(this._element, s.link, this._lastMouseEvent),
                        (s.link.decorations = {}),
                        Object.defineProperties(s.link.decorations, {
                          pointerCursor: {
                            get: () => this._currentLink?.state?.decorations.pointerCursor,
                            set: (t) => {
                              this._currentLink?.state &&
                                this._currentLink.state.decorations.pointerCursor !== t &&
                                ((this._currentLink.state.decorations.pointerCursor = t),
                                this._currentLink.state.isHovered &&
                                  this._element.classList.toggle("xterm-cursor-pointer", t));
                            },
                          },
                          underline: {
                            ...
                            set: (t) => {
                              this._currentLink?.state &&
                                ...
                                ((this._currentLink.state.decorations.underline = t),
                                this._currentLink.state.isHovered &&
                                  this._fireUnderlineEvent(s.link, t));
                            },
                          },
                        }),
                        this._linkCacheDisposables.push(
                          this._renderService.onRenderedViewportChange((t) => {
                            if (!this._currentLink) return;
                            const a =
                                t.start === 0 ? 0 : t.start + 1 + this._bufferService.buffer.ydisp,
                              f = this._bufferService.buffer.ydisp + 1 + t.end;
                            if (
                              this._currentLink.link.range.start.y >= a &&
                              this._currentLink.link.range.end.y <= f &&
                              (this._clearCurrentLink(a, f), this._lastMouseEvent)
                            ) {
                    ...
                    _linkHover(s, e, t) {
                      (this._currentLink?.state &&
                        ...
                        this._currentLink.state.decorations.pointerCursor &&
                          s.classList.add("xterm-cursor-pointer")),
                    ...
                    _linkLeave(s, e, t) {
                      (this._currentLink?.state &&
                        ...
                        this._currentLink.state.decorations.pointerCursor &&
                          s.classList.remove("xterm-cursor-pointer")),
                        e.leave && e.leave(t, e.text));
                    }
                    _linkAtPosition(s, e) {
                      const t = s.range.start.y * this._bufferService.cols + s.range.start.x,
                        a = s.range.end.y * this._bufferService.cols + s.range.end.x,
                ...
                3730: function (T, r, o) {
                          ...
                          f =
                            a < 3
                              ...
                              : e === null
                                ...
                                : e;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          f = Reflect.decorate(h, i, s, e);
                        else
                          for (var u = h.length - 1; u >= 0; u--)
                            (t = h[u]) && (f = (a < 3 ? t(f) : a > 3 ? t(i, s, f) : t(i, s)) || f);
                  ...
                  let v = (r.OscLinkProvider = class {
                    ...
                    provideLinks(h, i) {
                      ...
                      const e = [],
                        ...
                        a = new n.CellData(),
                        f = s.getTrimmedLength();
                      let u = -1,
                        p = -1,
                        c = !1;
                      for (let m = 0; m < f; m++)
                        if (p !== -1 || s.hasContent(m)) {
                          if ((s.loadCell(m, a), a.hasExtendedAttrs() && a.extended.urlId)) {
                            if (p === -1) {
                              ((p = m), (u = a.extended.urlId));
                              continue;
                            }
                            c = a.extended.urlId !== u;
                          } else p !== -1 && (c = !0);
                          if (c || (p !== -1 && m === f - 1)) {
                            const E = this._oscLinkService.getLinkData(u)?.uri;
                            if (E) {
                              const k = {
                                start: { x: p + 1, y: h },
                                end: { x: m + (c || m !== f - 1 ? 0 : 1), y: h },
                              };
                              let D = !1;
                              if (!t?.allowNonHttpProtocols)
                                try {
                                  const b = new URL(E);
                              ...
                              D ||
                                e.push({
                                  text: E,
                                  range: k,
                                  activate: (b, x) => (t ? t.activate(b, x, k) : g(0, x)),
                                  hover: (b, x) => t?.hover?.(b, x, k),
                                  leave: (b, x) => t?.leave?.(b, x, k),
                                });
                            }
                            ((c = !1),
                  ...
                  function g(h, i) {
                    if (
                      confirm(`Do you want to navigate to ${i}?
...
WARNING: This link could potentially be dangerous`)
                  ...
                  r.OscLinkProvider = v = l(
                    [_(0, d.IBufferService), _(1, d.IOptionsService), _(2, d.IOscLinkService)],
                    v,
                  );
                },
                6193: (T, r) => {
                    ...
                    (r.RenderDebouncer = class {
                      ...
                      refresh(o, l, _) {
                        ((this._rowCount = _),
                          ...
                          (this._rowStart =
                            this._rowStart !== void 0 ? Math.min(this._rowStart, o) : o),
                  ...
                  class N extends D.CoreTerminal {
                    ...
                    constructor(R = {}) {
                      (super(R),
                        ...
                        (this._accessibilityManager = this.register(new x.MutableDisposable())),
                        ...
                        (this._onSelectionChange = this.register(new b.EventEmitter())),
                        ...
                        (this._onA11yTabEmitter = this.register(new b.EventEmitter())),
                        ...
                        this.register(
                          this._inputHandler.onRequestRefreshRows((C, A) => this.refresh(C, A)),
                        ),
                        this.register(
                        ...
                        this.register(
                          this._inputHandler.onRequestWindowsOptionsReport((C) =>
                            this._reportWindowsOptions(C),
                          ),
                        ),
                        this.register(this._inputHandler.onColor((C) => this._handleColorEvent(C))),
                        this.register(
                          (0, b.forwardEvent)(this._inputHandler.onCursorMove, this._onCursorMove),
                        ),
                        this.register(
                          (0, b.forwardEvent)(
                        ...
                        this.register(
                          (0, b.forwardEvent)(this._inputHandler.onA11yTab, this._onA11yTabEmitter),
                        ),
                        this.register(
                          this._bufferService.onResize((C) => this._afterResize(C.cols, C.rows)),
                        ),
                        this.register(
                          (0, x.toDisposable)(() => {
                    ...
                    _handleColorEvent(R) {
                      if (this._themeService)
                        for (const C of R) {
                          ...
                          switch (C.type) {
                            case 0:
                              const W = k.color.toColorRGB(
                                A === "ansi"
                                  ? this._themeService.colors.ansi[C.index]
                                  : this._themeService.colors[A],
                              );
                              this.coreService.triggerDataEvent(
                                `${U.C0.ESC}]${O};${(0, S.toRgbString)(W)}${U.C1_ESCAPED.ST}`,
                              );
                              break;
                            case 1:
                              if (A === "ansi")
                                this._themeService.modifyColors(
                                  (F) => (F.ansi[C.index] = k.channels.toColor(...C.color)),
                                );
                              else {
                                const F = A;
                                this._themeService.modifyColors(
                                  (z) => (z[F] = k.channels.toColor(...C.color)),
                                );
                              }
                              break;
                            case 2:
                    ...
                    _handleScreenReaderModeOptionChange(R) {
                      R
                        ? !this._accessibilityManager.value &&
                          this._renderService &&
                          (this._accessibilityManager.value =
                            this._instantiationService.createInstance(B.AccessibilityManager, this))
                        : this._accessibilityManager.clear();
                    }
                    _handleTextAreaFocus(R) {
                      (this.coreService.decPrivateModes.sendFocus &&
                        this.coreService.triggerDataEvent(U.C0.ESC + "[I"),
                    ...
                    _handleTextAreaBlur() {
                      ((this.textarea.value = ""),
                        ...
                        this.coreService.decPrivateModes.sendFocus &&
                          this.coreService.triggerDataEvent(U.C0.ESC + "[O"),
                    ...
                    _syncTextArea() {
                      if (
                        ...
                        return;
                      const R = this.buffer.ybase + this.buffer.y,
                        C = this.buffer.lines.get(R);
                      if (!C) return;
                      const A = Math.min(this.buffer.x, this.cols - 1),
                        O = this._renderService.dimensions.css.cell.height,
                        W = C.getWidth(A),
                        F = this._renderService.dimensions.css.cell.width * W,
                        z = this.buffer.y * this._renderService.dimensions.css.cell.height,
                        q = A * this._renderService.dimensions.css.cell.width;
                      ((this.textarea.style.left = q + "px"),
                        (this.textarea.style.top = z + "px"),
                    ...
                    _initGlobal() {
                      (this._bindKeys(),
                        this.register(
                          (0, _.addDisposableDomListener)(this.element, "copy", (C) => {
                      ...
                      (this.register((0, _.addDisposableDomListener)(this.textarea, "paste", R)),
                        this.register((0, _.addDisposableDomListener)(this.element, "paste", R)),
                        M.isFirefox
                          ? this.register(
                              (0, _.addDisposableDomListener)(this.element, "mousedown", (C) => {
                                C.button === 2 &&
                          ...
                          : this.register(
                              (0, _.addDisposableDomListener)(this.element, "contextmenu", (C) => {
                                (0, l.rightClickHandler)(
                                  C,
                                  this.textarea,
                                  this.screenElement,
                        ...
                        M.isLinux &&
                          this.register(
                            (0, _.addDisposableDomListener)(this.element, "auxclick", (C) => {
                              C.button === 1 &&
                    ...
                    _bindKeys() {
                      (this.register(
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(this.textarea, "compositionstart", () =>
                            this._compositionHelper.compositionstart(),
                          ),
                        ),
                        this.register(
                          (0, _.addDisposableDomListener)(this.textarea, "compositionupdate", (R) =>
                            this._compositionHelper.compositionupdate(R),
                          ),
                        ),
                        this.register(
                          (0, _.addDisposableDomListener)(this.textarea, "compositionend", () =>
                    ...
                    open(R) {
                      ...
                      ((this._viewportElement = this._document.createElement("div")),
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(this.screenElement, "mousemove", (A) =>
                            this.updateCursorStyle(A),
                          ),
                        ),
                        ...
                        M.isChromeOS || this.textarea.setAttribute("aria-multiline", "false"),
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(this.textarea, "focus", (A) =>
                            this._handleTextAreaFocus(A),
                          ),
                        ),
                        this.register(
                          (0, _.addDisposableDomListener)(this.textarea, "blur", () =>
                        ...
                        this._instantiationService.setService(m.IThemeService, this._themeService),
                        (this._characterJoinerService = this._instantiationService.createInstance(
                          a.CharacterJoinerService,
                        )),
                        this._instantiationService.setService(
                        ...
                        this.register(
                          this._renderService.onRenderedViewportChange((A) =>
                            this._onRender.fire(A),
                          ),
                        ),
                        this.onResize((A) => this._renderService.resize(A.cols, A.rows)),
                        ...
                        this._instantiationService.setService(m.IMouseService, this._mouseService),
                      ...
                      (this._renderService.hasRenderer() ||
                        ...
                        this.viewport.onRequestScrollLines((A) =>
                          this.scrollLines(A.amount, A.suppressScrollEvent, 1),
                        ),
                        this.register(
                        ...
                        this.register(
                          this._selectionService.onRequestScrollLines((A) =>
                            this.scrollLines(A.amount, A.suppressScrollEvent),
                          ),
                        ),
                        this.register(
                        ...
                        this.register(
                          this._selectionService.onRequestRedraw((A) =>
                        ...
                        this.register(
                          this._selectionService.onLinuxMouseSelection((A) => {
                        ...
                        this.register(
                          this._onScroll.event((A) => {
                            (this.viewport.syncScrollArea(), this._selectionService.refresh());
                          }),
                        ),
                        this.register(
                          (0, _.addDisposableDomListener)(this._viewportElement, "scroll", () =>
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(this.element, "mousedown", (A) =>
                            this._selectionService.handleMouseDown(A),
                          ),
                        ),
                        ...
                        this.register(
                          this.optionsService.onSpecificOptionChange("screenReaderMode", (A) =>
                            this._handleScreenReaderModeOptionChange(A),
                          ),
                        ),
                        this.options.overviewRulerWidth &&
                          (this._overviewRulerRenderer = this.register(
                            this._instantiationService.createInstance(
                              i.OverviewRulerRenderer,
                              this._viewportElement,
                              this.screenElement,
                            ),
                          )),
                        this.optionsService.onSpecificOptionChange("overviewRulerWidth", (A) => {
                    ...
                    bindMouse() {
                      ...
                      function A(F) {
                        ...
                        switch (F.overrideType || F.type) {
                          case "mousemove":
                            ((V = 32),
                              F.buttons === void 0
                                ? ((q = 3),
                                  F.button !== void 0 && (q = F.button < 3 ? F.button : 3))
                                : (q =
                                    1 & F.buttons ? 0 : 4 & F.buttons ? 1 : 2 & F.buttons ? 2 : 3));
                            break;
                          case "mouseup":
                          ...
                          case "wheel":
                            if (
                              (R._customWheelEventHandler &&
                                R._customWheelEventHandler(F) === !1) ||
                              R.viewport.getLinesScrolled(F) === 0
                            )
                              return !1;
                        ...
                        return (
                          !(V === void 0 || q === void 0 || q > 4) &&
                          R.coreMouseService.triggerMouseEvent({
                            col: z.col,
                            row: z.row,
                            x: z.x,
                            y: z.y,
                      ...
                      const O = { mouseup: null, wheel: null, mousedrag: null, mousemove: null },
                        W = {
                          mouseup: (F) => (
                            A(F),
                            F.buttons ||
                              (this._document.removeEventListener("mouseup", O.mouseup),
                              O.mousedrag &&
                                this._document.removeEventListener("mousemove", O.mousedrag)),
                            this.cancel(F)
                          ),
                          wheel: (F) => (A(F), this.cancel(F, !0)),
                          mousedrag: (F) => {
                            F.buttons && A(F);
                          },
                          mousemove: (F) => {
                      ...
                      (this.register(
                        this.coreMouseService.onProtocolChange((F) => {
                          (F
                            ? (this.optionsService.rawOptions.logLevel === "debug" &&
                                this._logService.debug(
                                  "Binding to mouse events:",
                                  this.coreMouseService.explainEvents(F),
                                ),
                              this.element.classList.add("enable-mouse-events"),
                              this._selectionService.disable())
                            ...
                            8 & F
                              ? O.mousemove ||
                                (C.addEventListener("mousemove", W.mousemove),
                                (O.mousemove = W.mousemove))
                              : (C.removeEventListener("mousemove", O.mousemove),
                                (O.mousemove = null)),
                            16 & F
                              ? O.wheel ||
                                (C.addEventListener("wheel", W.wheel, { passive: !1 }),
                                (O.wheel = W.wheel))
                              : (C.removeEventListener("wheel", O.wheel), (O.wheel = null)),
                            2 & F
                              ? O.mouseup || (O.mouseup = W.mouseup)
                              : (this._document.removeEventListener("mouseup", O.mouseup),
                                (O.mouseup = null)),
                            4 & F
                              ? O.mousedrag || (O.mousedrag = W.mousedrag)
                              : (this._document.removeEventListener("mousemove", O.mousedrag),
                                (O.mousedrag = null)));
                        }),
                      ),
                        (this.coreMouseService.activeProtocol =
                          this.coreMouseService.activeProtocol),
                        this.register(
                          (0, _.addDisposableDomListener)(C, "mousedown", (F) => {
                            if (
                              (F.preventDefault(),
                              this.focus(),
                              this.coreMouseService.areMouseEventsActive &&
                                !this._selectionService.shouldForceSelection(F))
                            )
                              return (
                                A(F),
                                O.mouseup && this._document.addEventListener("mouseup", O.mouseup),
                                O.mousedrag &&
                            ...
                            (F) => {
                              if (!O.wheel) {
                                if (
                                  ...
                                  this._customWheelEventHandler(F) === !1
                                )
                                  return !1;
                                if (!this.buffer.hasScrollback) {
                                  ...
                                  return (
                                    this.coreService.triggerDataEvent(V, !0),
                                    this.cancel(F, !0)
                                  );
                                }
                    ...
                    refresh(R, C) {
                      this._renderService?.refreshRows(R, C);
                    }
                    updateCursorStyle(R) {
                      this._selectionService?.shouldColumnSelect(R)
                    ...
                    scrollLines(R, C, A = 0) {
                      A === 1
                        ? (super.scrollLines(R, C, A), this.refresh(0, this.rows - 1))
                        : this.viewport?.scrollLines(R);
                    }
                    paste(R) {
                    ...
                    select(R, C, A) {
                      this._selectionService.setSelection(R, C, A);
                    }
                    getSelection() {
                    ...
                    selectLines(R, C) {
                      this._selectionService?.selectLines(R, C);
                    }
                    _keyDown(R) {
                      if (
                        ((this._keyDownHandled = !1),
                        (this._keyDownSeen = !0),
                        this._customKeyEventHandler && this._customKeyEventHandler(R) === !1)
                      )
                        return !1;
                      const C = this.browser.isMac && this.options.macOptionIsMeta && R.altKey;
                      if (!C && !this._compositionHelper.keydown(R))
                        return (
                      ...
                      C ||
                        (R.key !== "Dead" && R.key !== "AltGraph") ||
                        (this._unprocessedDeadKey = !0);
                      const A = (0, P.evaluateKeyboardEvent)(
                        R,
                        this.coreService.decPrivateModes.applicationCursorKeys,
                        this.browser.isMac,
                        this.options.macOptionIsMeta,
                      );
                      if ((this.updateCursorStyle(R), A.type === 3 || A.type === 2)) {
                        const O = this.rows - 1;
                        return (this.scrollLines(A.type === 2 ? -O : O), this.cancel(R, !0));
                      }
                      return (
                        A.type === 1 && this.selectAll(),
                        !!this._isThirdLevelShift(this.browser, R) ||
                          (A.cancel && this.cancel(R, !0),
                          !A.key ||
                            !!(
                              R.key &&
                              !R.ctrlKey &&
                              ...
                              !R.metaKey &&
                              R.key.length === 1 &&
                              R.key.charCodeAt(0) >= 65 &&
                              R.key.charCodeAt(0) <= 90
                            ) ||
                            (this._unprocessedDeadKey
                              ? ((this._unprocessedDeadKey = !1), !0)
                              : ((A.key !== U.C0.ETX && A.key !== U.C0.CR) ||
                                  (this.textarea.value = ""),
                                this._onKey.fire({ key: A.key, domEvent: R }),
                                this._showCursor(),
                                this.coreService.triggerDataEvent(A.key, !0),
                    ...
                    _isThirdLevelShift(R, C) {
                      const A =
                        (R.isMac &&
                          ...
                          !C.ctrlKey &&
                          !C.metaKey) ||
                        (R.isWindows && C.altKey && C.ctrlKey && !C.metaKey) ||
                        (R.isWindows && C.getModifierState("AltGraph"));
                      return C.type === "keypress" ? A : A && (!C.keyCode || C.keyCode > 47);
                    }
                    _keyUp(R) {
                      ((this._keyDownSeen = !1),
                        (this._customKeyEventHandler && this._customKeyEventHandler(R) === !1) ||
                    ...
                    _keyPress(R) {
                      ...
                      return !(
                        ...
                        this._onKey.fire({ key: C, domEvent: R }),
                        this._showCursor(),
                      ...
                      if (this._renderService)
                        switch (R) {
                          case L.WindowsOptionsReportType.GET_WIN_SIZE_PIXELS:
                            const C = this._renderService.dimensions.css.canvas.width.toFixed(0),
                              A = this._renderService.dimensions.css.canvas.height.toFixed(0);
                            this.coreService.triggerDataEvent(`${U.C0.ESC}[4;${A};${C}t`);
                            break;
                          case L.WindowsOptionsReportType.GET_CELL_SIZE_PIXELS:
                            const O = this._renderService.dimensions.css.cell.width.toFixed(0),
                              W = this._renderService.dimensions.css.cell.height.toFixed(0);
                            this.coreService.triggerDataEvent(`${U.C0.ESC}[6;${W};${O}t`);
                        }
                    }
                    cancel(R, C) {
                ...
                1680: function (T, r, o) {
                  ...
                  let i = (r.Viewport = class extends g.Disposable {
                    constructor(s, e, t, a, f, u, p, c) {
                      (super(),
                        (this._viewportElement = s),
                        (this._scrollArea = e),
                        ...
                        (this._onRequestScrollLines = this.register(new v.EventEmitter())),
                        ...
                        this.register(c.onChangeColors((m) => this._handleThemeChange(m))),
                        this.register(
                    ...
                    _innerRefresh() {
                      ...
                      (this._viewportElement.scrollTop !== s &&
                        ((this._ignoreNextScrollEvent = !0), (this._viewportElement.scrollTop = s)),
                        (this._refreshAnimationFrame = null));
                    }
                    syncScrollArea(s = !1) {
                      if (
                    ...
                    _smoothScroll() {
                      ...
                      ((this._viewportElement.scrollTop =
                        ...
                        Math.round(
                          s * (this._smoothScrollState.target - this._smoothScrollState.origin),
                        )),
                        s < 1
                          ? this._coreBrowserService.window.requestAnimationFrame(() =>
                              this._smoothScroll(),
                    ...
                    _bubbleScroll(s, e) {
                      ...
                      return (
                        !(
                          (e < 0 && this._viewportElement.scrollTop !== 0) ||
                          (e > 0 && t < this._lastRecordedBufferHeight)
                        ) || (s.cancelable && s.preventDefault(), !1)
                      );
                    }
                    handleWheel(s) {
                    ...
                    scrollLines(s) {
                      if (s !== 0)
                        if (this._optionsService.rawOptions.smoothScrollDuration) {
                          ...
                          this._onRequestScrollLines.fire({ amount: s, suppressScrollEvent: !1 });
                    }
                    _getPixelsScrolled(s) {
                      if (s.deltaY === 0 || s.shiftKey) return 0;
                      let e = this._applyScrollModifier(s.deltaY, s);
                      return (
                        s.deltaMode === WheelEvent.DOM_DELTA_LINE
                          ? (e *= this._currentRowHeight)
                          : s.deltaMode === WheelEvent.DOM_DELTA_PAGE &&
                            (e *= this._currentRowHeight * this._bufferService.rows),
                        e
                      );
                    }
                    getBufferElements(s, e) {
                      ...
                      for (let c = s; c < u; c++) {
                        const m = p.get(c);
                        if (!m) continue;
                        const E = p.get(c + 1)?.isWrapped;
                        if (((a += m.translateToString(!E)), !E || c === p.length - 1)) {
                          const k = document.createElement("div");
                          ((k.textContent = a), f.push(k), a.length > 0 && (t = k), (a = ""));
                        }
                      }
                    ...
                    _applyScrollModifier(s, e) {
                      ...
                      return (t === "alt" && e.altKey) ||
                        ...
                        : s * this._optionsService.rawOptions.scrollSensitivity;
                    }
                    handleTouchStart(s) {
                    ...
                    handleTouchMove(s) {
                      ...
                      return (
                        (this._lastTouchY = s.touches[0].pageY),
                        e !== 0 &&
                          ((this._viewportElement.scrollTop += e), this._bubbleScroll(s, e))
                      );
                    }
                  });
                  r.Viewport = i = l(
                ...
                3107: function (T, r, o) {
                  ...
                  let g = (r.BufferDecorationRenderer = class extends d.Disposable {
                    constructor(h, i, s, e, t) {
                      (super(),
                        ...
                        this.register(
                          this._decorationService.onDecorationRemoved((a) =>
                            this._removeDecoration(a),
                          ),
                        ),
                        this.register(
                          (0, d.toDisposable)(() => {
                    ...
                    _createElement(h) {
                      ...
                      (i.classList.add("xterm-decoration"),
                        ...
                        (i.style.width = `${Math.round((h.options.width || 1) * this._renderService.dimensions.css.cell.width)}px`),
                        (i.style.height =
                          (h.options.height || 1) * this._renderService.dimensions.css.cell.height +
                          "px"),
                        (i.style.top =
                          (h.marker.line - this._bufferService.buffers.active.ydisp) *
                            this._renderService.dimensions.css.cell.height +
                          "px"),
                        (i.style.lineHeight = `${this._renderService.dimensions.css.cell.height}px`));
                      const s = h.options.x ?? 0;
                      return (
                        s && s > this._bufferService.cols && (i.style.display = "none"),
                        this._refreshXPosition(h, i),
                        i
                      );
                    }
                    _refreshStyle(h) {
                      ...
                      if (i < 0 || i >= this._bufferService.rows)
                        h.element &&
                          ((h.element.style.display = "none"), h.onRenderEmitter.fire(h.element));
                      else {
                        let s = this._decorationElements.get(h);
                        (s ||
                          ((s = this._createElement(h)),
                          (h.element = s),
                          this._decorationElements.set(h, s),
                          this._container.appendChild(s),
                          h.onDispose(() => {
                            (this._decorationElements.delete(h), s.remove());
                          })),
                          (s.style.top = i * this._renderService.dimensions.css.cell.height + "px"),
                          (s.style.display = this._altBufferIsActive ? "none" : "block"),
                          h.onRenderEmitter.fire(s));
                      }
                    }
                    ...
                    _removeDecoration(h) {
                      (this._decorationElements.get(h)?.remove(),
                  ...
                  r.BufferDecorationRenderer = g = l(
                    [
                      _(1, v.IBufferService),
                      _(2, n.ICoreBrowserService),
                      _(3, v.IDecorationService),
                  ...
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.ColorZoneStore = class {
                      ...
                      _lineAdjacentToZone(o, l, _) {
                        return (
                          l >= o.startBufferLine - this._linePadding[_ || "full"] &&
                          l <= o.endBufferLine + this._linePadding[_ || "full"]
                        );
                      }
                      _addLineToZone(o, l) {
                        ...
                        var p,
                          ...
                          m =
                            c < 3
                              ? a
                              : u === null
                                ? (u = Object.getOwnPropertyDescriptor(a, f))
                                : u;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          m = Reflect.decorate(t, a, f, u);
                        else
                          for (var E = t.length - 1; E >= 0; E--)
                            (p = t[E]) && (m = (c < 3 ? p(m) : c > 3 ? p(a, f, m) : p(a, f)) || m);
                  ...
                  let e = (r.OverviewRulerRenderer = class extends v.Disposable {
                    ...
                    _refreshDrawConstants() {
                      const t = Math.floor(this._canvas.width / 3),
                        a = Math.ceil(this._canvas.width / 3);
                      ((i.full = this._canvas.width),
                        (i.left = t),
                        (i.center = a),
                        (i.right = t),
                    ...
                    _refreshDecorations() {
                      ...
                      for (const a of this._decorationService.decorations)
                        this._colorZoneStore.addDecoration(a);
                    ...
                    _queueRefresh(t, a) {
                      ((this._shouldUpdateDimensions = t || this._shouldUpdateDimensions),
                        (this._shouldUpdateAnchor = a || this._shouldUpdateAnchor),
                        this._animationFrame === void 0 &&
                          (this._animationFrame =
                            this._coreBrowserService.window.requestAnimationFrame(() => {
                        ...
                        ((this._isSendingComposition = !0),
                          setTimeout(() => {
                            if (this._isSendingComposition) {
                              let s;
                              ((this._isSendingComposition = !1),
                                (i.start += this._dataAlreadySent.length),
                                (s = this._isComposing
                                  ? this._textarea.value.substring(i.start, i.end)
                                  : this._textarea.value.substring(i.start)),
                                s.length > 0 && this._coreService.triggerDataEvent(s, !0));
                            }
                          }, 0));
                      } else {
                        this._isSendingComposition = !1;
                      ...
                      setTimeout(() => {
                        if (!this._isComposing) {
                          const i = this._textarea.value,
                            s = i.replace(h, "");
                          ((this._dataAlreadySent = s),
                            i.length > h.length
                              ? this._coreService.triggerDataEvent(s, !0)
                              : i.length < h.length
                                ? this._coreService.triggerDataEvent(`${v.C0.DEL}`, !0)
                                : i.length === h.length &&
                                  i !== h &&
                                  this._coreService.triggerDataEvent(i, !0));
                        }
                        ...
                        if (this._bufferService.buffer.isCursorInViewport) {
                          const i = Math.min(
                            ...
                            e =
                              ...
                              this._renderService.dimensions.css.cell.height,
                            t = i * this._renderService.dimensions.css.cell.width;
                          ((this._compositionView.style.left = t + "px"),
                            (this._compositionView.style.top = e + "px"),
                            (this._compositionView.style.height = s + "px"),
                            (this._compositionView.style.lineHeight = s + "px"),
                          ...
                          ((this._textarea.style.left = t + "px"),
                            ...
                            (this._textarea.style.width = Math.max(a.width, 1) + "px"),
                            (this._textarea.style.height = Math.max(a.height, 1) + "px"),
                            (this._textarea.style.lineHeight = a.height + "px"));
                        }
                ...
                9806: (T, r) => {
                  function o(l, _, n) {
                    const d = n.getBoundingClientRect(),
                      v = l.getComputedStyle(n),
                      g = parseInt(v.getPropertyValue("padding-left")),
                      h = parseInt(v.getPropertyValue("padding-top"));
                    return [_.clientX - d.left - g, _.clientY - d.top - h];
                  }
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    (r.getCoords = r.getCoordsRelativeToElement = void 0),
                    (r.getCoordsRelativeToElement = o),
                    (r.getCoords = function (l, _, n, d, v, g, h, i, s) {
                      if (!g) return;
                      const e = o(l, _, n);
                      return e
                        ? ((e[0] = Math.ceil((e[0] + (s ? h / 2 : 0)) / h)),
                          (e[1] = Math.ceil(e[1] / i)),
                          (e[0] = Math.min(Math.max(e[0], 1), d + (s ? 1 : 0))),
                          (e[1] = Math.min(Math.max(e[1], 1), v)),
                          e)
                        : void 0;
                    }));
                },
                9504: (T, r, o) => {
                    ...
                    const a = i - n(i, e),
                      ...
                      u =
                        ...
                        (function (p, c, m) {
                          ...
                          const k = p - n(p, m),
                            D = c - n(c, m);
                          for (let b = 0; b < Math.abs(k - D); b++) {
                            const x = d(p, c) === "A" ? -1 : 1;
                            m.buffer.lines.get(k + x * b)?.isWrapped && E++;
                          }
                          return E;
                        })(i, s, e);
                    return h(u, g(d(i, s), t));
                  }
                  function n(i, s) {
                    let e = 0,
                      t = s.buffer.lines.get(i),
                      a = t?.isWrapped;
                    for (; a && i >= 0 && i < s.rows;)
                      (e++, (t = s.buffer.lines.get(--i)), (a = t?.isWrapped));
                    return e;
                  }
                  function d(i, s) {
                    return i > s ? "A" : "B";
                  }
                  function v(i, s, e, t, a, f) {
                    let u = i,
                      p = s,
                      c = "";
                    for (; u !== e || p !== t;)
                      ((u += a ? 1 : -1),
                        a && u > f.cols - 1
                          ? ((c += f.buffer.translateBufferLineToString(p, !1, i, u)),
                            (u = 0),
                            (i = 0),
                            p++)
                          : !a &&
                            u < 0 &&
                            ((c += f.buffer.translateBufferLineToString(p, !1, 0, i + 1)),
                            (u = f.cols - 1),
                            (i = u),
                            p--));
                    return c + f.buffer.translateBufferLineToString(p, !1, i, u);
                  }
                  function g(i, s) {
                    const e = s ? "O" : "[";
                    return l.C0.ESC + e + i;
                  ...
                  r.moveToCellSequence = function (i, s, e, t) {
                    ...
                    if (!e.buffer.hasScrollback)
                      return (
                        (function (c, m, E, k, D, b) {
                          return _(m, k, D, b).length === 0
                            ? ""
                            : h(v(c, m, c, m - n(m, D), !1, D).length, g("D", b));
                        })(a, f, 0, s, e, t) +
                        _(f, s, e, t) +
                        (function (c, m, E, k, D, b) {
                          let x;
                          x = _(m, k, D, b).length > 0 ? k - n(k, D) : m;
                          const M = k,
                            I = (function (U, P, S, w, y, L) {
                              let B;
                              return (
                                (B = _(S, w, y, L).length > 0 ? w - n(w, y) : P),
                                (U < S && B <= w) || (U >= S && B < w) ? "C" : "D"
                              );
                            })(c, m, E, k, D, b);
                          return h(v(c, x, E, M, I === "C", D).length, g(I, b));
                        })(a, f, i, s, e, t)
                      );
                    let u;
                    if (f === s) return ((u = a > i ? "D" : "C"), h(Math.abs(a - i), g(u, t)));
                    u = f > s ? "D" : "C";
                    const p = Math.abs(f - s);
                    return h(
                      (function (c, m) {
                        return m.cols - c;
                      })(f > s ? i : a, e) +
                ...
                1296: function (T, r, o) {
                        ...
                        var U,
                          ...
                          S =
                            P < 3
                              ? x
                              : I === null
                                ? (I = Object.getOwnPropertyDescriptor(x, M))
                                : I;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          S = Reflect.decorate(b, x, M, I);
                        else
                          for (var w = b.length - 1; w >= 0; w--)
                            (U = b[w]) && (S = (P < 3 ? U(S) : P > 3 ? U(x, M, S) : U(x, M)) || S);
                        return (P > 3 && S && Object.defineProperty(x, M, S), S);
                      },
                    _ =
                      (this && this.__param) ||
                      function (b, x) {
                  ...
                  const n = o(3787),
                    ...
                    E = "xterm-selection";
                  let k = 1,
                    D = (r.DomRenderer = class extends t.Disposable {
                      constructor(b, x, M, I, U, P, S, w, y, L, B, H, N) {
                        (super(),
                          (this._terminal = b),
                          (this._document = x),
                          (this._element = M),
                          (this._screenElement = I),
                          (this._viewportElement = U),
                          (this._helperContainer = P),
                          (this._linkifier2 = S),
                          (this._charSizeService = y),
                          ...
                          (this._rowElements = []),
                          (this._selectionRenderModel = (0, h.createSelectionRenderModel)()),
                          (this.onRequestRedraw = this.register(new e.EventEmitter()).event),
                          ...
                          this._selectionContainer.classList.add(E),
                          this._selectionContainer.setAttribute("aria-hidden", "true"),
                          (this.dimensions = (0, g.createRenderDimensions)()),
                          this._updateDimensions(),
                          this.register(
                            this._optionsService.onOptionChange(() => this._handleOptionsChanged()),
                          ),
                          this.register(
                            this._themeService.onChangeColors(($) => this._injectCss($)),
                          ),
                          this._injectCss(this._themeService.colors),
                          (this._rowFactory = w.createInstance(n.DomRendererRowFactory, document)),
                          this._element.classList.add(f + this._terminalClass),
                          this._screenElement.appendChild(this._rowContainer),
                          this._screenElement.appendChild(this._selectionContainer),
                          this.register(
                            this._linkifier2.onShowLinkUnderline(($) => this._handleLinkHover($)),
                          ),
                          this.register(
                            this._linkifier2.onHideLinkUnderline(($) => this._handleLinkLeave($)),
                          ),
                          this.register(
                            (0, t.toDisposable)(() => {
                      ...
                      _updateDimensions() {
                        ...
                        ((this.dimensions.device.char.width = this._charSizeService.width * b),
                        ...
                        const x = `${this._terminalSelector} .${u} span { display: inline-block; height: 100%; vertical-align: top;}`;
                        ((this._dimensionsStyleElement.textContent = x),
                      ...
                      _injectCss(b) {
                        ...
                        let x = `${this._terminalSelector} .${u} { color: ${b.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
                        ((x += `${this._terminalSelector} .${u} .xterm-dim { color: ${s.color.multiplyOpacity(b.foreground, 0.5).css};}`),
                          (x += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`));
                        const M = `blink_underline_${this._terminalClass}`,
                          I = `blink_bar_${this._terminalClass}`,
                          U = `blink_block_${this._terminalClass}`;
                        ((x += `@keyframes ${M} { 50% {  border-bottom-style: hidden; }}`),
                          (x += `@keyframes ${I} { 50% {  box-shadow: none; }}`),
                          (x += `@keyframes ${U} { 0% {  background-color: ${b.cursor.css};  color: ${b.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${b.cursor.css}; }}`),
                          (x += `${this._terminalSelector} .${u}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${M} 1s step-end infinite;}${this._terminalSelector} .${u}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${I} 1s step-end infinite;}${this._terminalSelector} .${u}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${U} 1s step-end infinite;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-block { background-color: ${b.cursor.css}; color: ${b.cursorAccent.css};}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${b.cursor.css} !important; color: ${b.cursorAccent.css} !important;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${b.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${b.cursor.css} inset;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${b.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`),
                          (x += `${this._terminalSelector} .${E} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${E} div { position: absolute; background-color: ${b.selectionBackgroundOpaque.css};}${this._terminalSelector} .${E} div { position: absolute; background-color: ${b.selectionInactiveBackgroundOpaque.css};}`));
                        for (const [P, S] of b.ansi.entries())
                          x += `${this._terminalSelector} .${p}${P} { color: ${S.css}; }${this._terminalSelector} .${p}${P}.xterm-dim { color: ${s.color.multiplyOpacity(S, 0.5).css}; }${this._terminalSelector} .${c}${P} { background-color: ${S.css}; }`;
                        ((x += `${this._terminalSelector} .${p}${v.INVERTED_DEFAULT_COLOR} { color: ${s.color.opaque(b.background).css}; }${this._terminalSelector} .${p}${v.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${s.color.multiplyOpacity(s.color.opaque(b.background), 0.5).css}; }${this._terminalSelector} .${c}${v.INVERTED_DEFAULT_COLOR} { background-color: ${b.foreground.css}; }`),
                          (this._themeStyleElement.textContent = x));
                      }
                      _setDefaultSpacing() {
                        const b =
                      ...
                      _refreshRowElements(b, x) {
                        for (let M = this._rowElements.length; M <= x; M++) {
                          const I = this._document.createElement("div");
                          (this._rowContainer.appendChild(I), this._rowElements.push(I));
                        }
                        for (; this._rowElements.length > x;)
                          this._rowContainer.removeChild(this._rowElements.pop());
                      }
                      handleResize(b, x) {
                        (this._refreshRowElements(b, x),
                          this._updateDimensions(),
                      ...
                      handleSelectionChanged(b, x, M) {
                        if (
                          (this._selectionContainer.replaceChildren(),
                          this._rowFactory.handleSelectionChanged(b, x, M),
                          this.renderRows(0, this._bufferService.rows - 1),
                          !b || !x)
                        )
                          return;
                        this._selectionRenderModel.update(this._terminal, b, x, M);
                        const I = this._selectionRenderModel.viewportStartRow,
                          U = this._selectionRenderModel.viewportEndRow,
                          P = this._selectionRenderModel.viewportCappedStartRow,
                          S = this._selectionRenderModel.viewportCappedEndRow;
                        if (P >= this._bufferService.rows || S < 0) return;
                        ...
                        if (M) {
                          ...
                          const y = I === P ? b[0] : 0,
                            L = P === U ? x[0] : this._bufferService.cols;
                          w.appendChild(this._createSelectionElement(P, y, L));
                          const B = S - P - 1;
                          if (
                            (w.appendChild(
                              this._createSelectionElement(P + 1, 0, this._bufferService.cols, B),
                            ),
                            P !== S)
                          ) {
                            const H = U === S ? x[0] : this._bufferService.cols;
                            w.appendChild(this._createSelectionElement(S, 0, H));
                          }
                        }
                        this._selectionContainer.appendChild(w);
                      }
                      _createSelectionElement(b, x, M, I = 1) {
                        const U = this._document.createElement("div"),
                          P = x * this.dimensions.css.cell.width;
                        let S = this.dimensions.css.cell.width * (M - x);
                        return (
                          P + S > this.dimensions.css.canvas.width &&
                            (S = this.dimensions.css.canvas.width - P),
                          (U.style.height = I * this.dimensions.css.cell.height + "px"),
                          (U.style.top = b * this.dimensions.css.cell.height + "px"),
                          (U.style.left = `${P}px`),
                          (U.style.width = `${S}px`),
                          U
                        );
                      ...
                      renderRows(b, x) {
                        const M = this._bufferService.buffer,
                          I = M.ybase + M.y,
                          U = Math.min(M.x, this._bufferService.cols - 1),
                          P = this._optionsService.rawOptions.cursorBlink,
                          S = this._optionsService.rawOptions.cursorStyle,
                          w = this._optionsService.rawOptions.cursorInactiveStyle;
                        for (let y = b; y <= x; y++) {
                          const L = y + M.ydisp,
                            B = this._rowElements[y],
                            H = M.lines.get(L);
                          if (!B || !H) break;
                          B.replaceChildren(
                      ...
                      _setCellUnderline(b, x, M, I, U, P) {
                        (M < 0 && (b = 0), I < 0 && (x = 0));
                        const S = this._bufferService.rows - 1;
                        ((M = Math.max(Math.min(M, S), 0)),
                          (I = Math.max(Math.min(I, S), 0)),
                          (U = Math.min(U, this._bufferService.cols)));
                        const w = this._bufferService.buffer,
                          y = w.ybase + w.y,
                          L = Math.min(w.x, U - 1),
                          B = this._optionsService.rawOptions.cursorBlink,
                          H = this._optionsService.rawOptions.cursorStyle,
                          N = this._optionsService.rawOptions.cursorInactiveStyle;
                        for (let $ = M; $ <= I; ++$) {
                          const R = $ + w.ydisp,
                            C = this._rowElements[$],
                            A = w.lines.get(R);
                  ...
                  r.DomRenderer = D = l(
                    [
                      _(7, a.IInstantiationService),
                      _(8, i.ICharSizeService),
                      _(9, a.IOptionsService),
                      _(10, a.IBufferService),
                      _(11, i.ICoreBrowserService),
                      _(12, i.IThemeService),
                    ],
                    D,
                  );
                },
                3787: function (T, r, o) {
                        ...
                        var E,
                          ...
                          D =
                            k < 3
                              ? p
                              : m === null
                                ? (m = Object.getOwnPropertyDescriptor(p, c))
                                : m;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          D = Reflect.decorate(u, p, c, m);
                        else
                          for (var b = u.length - 1; b >= 0; b--)
                            (E = u[b]) && (D = (k < 3 ? E(D) : k > 3 ? E(p, c, D) : E(p, c)) || D);
                        return (k > 3 && D && Object.defineProperty(p, c, D), D);
                      },
                    _ =
                      (this && this.__param) ||
                      function (u, p) {
                  ...
                  let a = (r.DomRendererRowFactory = class {
                    constructor(u, p, c, m, E, k, D) {
                      ((this._document = u),
                        (this._characterJoinerService = p),
                        (this._optionsService = c),
                        (this._coreBrowserService = m),
                        (this._coreService = E),
                        (this._decorationService = k),
                        (this._themeService = D),
                        (this._workCell = new v.CellData()),
                        (this._columnSelectMode = !1),
                        (this.defaultSpacing = 0));
                    }
                    handleSelectionChanged(u, p, c) {
                      ((this._selectionStart = u),
                        (this._selectionEnd = p),
                        (this._columnSelectMode = c));
                    }
                    createRow(u, p, c, m, E, k, D, b, x, M, I) {
                      const U = [],
                        P = this._characterJoinerService.getJoinedCharacters(p),
                        S = this._themeService.colors;
                      let w,
                        y = u.getNoBgTrimmedLength();
                      c && y < k + 1 && (y = k + 1);
                      let L = 0,
                        B = "",
                        H = 0,
                      ...
                      for (let z = 0; z < y; z++) {
                        ...
                        let V = !1,
                          X = z,
                          j = this._workCell;
                        if (P.length > 0 && z === P[0][0]) {
                          V = !0;
                          const K = P.shift();
                          ((j = new s.JoinedCellData(
                            this._workCell,
                            u.translateToString(!0, K[0], K[1]),
                            K[1] - K[0],
                          )),
                            (X = K[1] - 1),
                            (q = j.getWidth()));
                        }
                        const se = this._isCellInSelection(z, p),
                          le = c && z === k,
                          de = F && z >= M && z <= I;
                        let _e = !1;
                        ...
                        let ae = j.getChars() || d.WHITESPACE_CELL_CHAR;
                        if (
                          (ae === " " && (j.isUnderline() || j.isOverline()) && (ae = " "),
                          (O = q * b - x.get(ae, j.isBold(), j.isItalic())),
                          w)
                        ) {
                          if (
                            L &&
                            ((se && A) || (!se && !A && j.bg === H)) &&
                            ((se && A && S.selectionForeground) || j.fg === N) &&
                            j.extended.ext === $ &&
                            de === R &&
                            O === C &&
                            !le &&
                            ...
                            (j.isInvisible() ? (B += d.WHITESPACE_CELL_CHAR) : (B += ae), L++);
                            continue;
                          }
                          (L && (w.textContent = B),
                            (w = this._document.createElement("span")),
                            (L = 0),
                            (B = ""));
                        ...
                        if (
                          (j.isBold() && W.push("xterm-bold"),
                          j.isItalic() && W.push("xterm-italic"),
                          j.isDim() && W.push("xterm-dim"),
                          (B = j.isInvisible()
                            ? d.WHITESPACE_CELL_CHAR
                            : j.getChars() || d.WHITESPACE_CELL_CHAR),
                          j.isUnderline() &&
                            (W.push(`xterm-underline-${j.extended.underlineStyle}`),
                            B === " " && (B = " "),
                            !j.isUnderlineColorDefault()))
                        )
                          if (j.isUnderlineColorRGB())
                            w.style.textDecorationColor = `rgb(${t.AttributeData.toColorRGB(j.getUnderlineColor()).join(",")})`;
                          else {
                            ...
                            (this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                              ...
                              K < 8 &&
                              (K += 8),
                              (w.style.textDecorationColor = S.ansi[K].css));
                          }
                        (j.isOverline() && (W.push("xterm-overline"), B === " " && (B = " ")),
                          j.isStrikethrough() && W.push("xterm-strikethrough"),
                          de && (w.style.textDecoration = "underline"));
                        let J = j.getFgColor(),
                          re = j.getFgColorMode(),
                          Z = j.getBgColor(),
                          ne = j.getBgColorMode();
                        const ue = !!j.isInverse();
                        if (ue) {
                          const K = J;
                          ((J = Z), (Z = K));
                          const Ce = re;
                        ...
                        switch (
                          (this._decorationService.forEachDecorationAtCell(z, p, void 0, (K) => {
                            (K.options.layer !== "top" && oe) ||
                              (K.backgroundColorRGB &&
                                ((ne = 50331648),
                                (Z = (K.backgroundColorRGB.rgba >> 8) & 16777215),
                                (ee = K.backgroundColorRGB)),
                              K.foregroundColorRGB &&
                                ((re = 50331648),
                                (J = (K.foregroundColorRGB.rgba >> 8) & 16777215),
                                (he = K.foregroundColorRGB)),
                              (oe = K.options.layer === "top"));
                          }),
                          !oe &&
                            se &&
                            ((ee = this._coreBrowserService.isFocused
                              ? S.selectionBackgroundOpaque
                              : S.selectionInactiveBackgroundOpaque),
                            (Z = (ee.rgba >> 8) & 16777215),
                            (ne = 50331648),
                            (oe = !0),
                            S.selectionForeground &&
                              ((re = 50331648),
                              (J = (S.selectionForeground.rgba >> 8) & 16777215),
                              (he = S.selectionForeground))),
                          oe && W.push("xterm-decoration-top"),
                          ne)
                        ) {
                          case 16777216:
                          case 33554432:
                            ((te = S.ansi[Z]), W.push(`xterm-bg-${Z}`));
                            break;
                          case 50331648:
                            ((te = h.channels.toColor(Z >> 16, (Z >> 8) & 255, 255 & Z)),
                              this._addStyle(
                                w,
                                `background-color:#${f((Z >>> 0).toString(16), "0", 6)}`,
                              ));
                            break;
                          default:
                            ue
                              ? ((te = S.foreground),
                                W.push(`xterm-bg-${n.INVERTED_DEFAULT_COLOR}`))
                              : (te = S.background);
                        }
                        switch (
                          (ee || (j.isDim() && (ee = h.color.multiplyOpacity(te, 0.5))), re)
                        ) {
                          case 16777216:
                          case 33554432:
                            (j.isBold() &&
                              ...
                              this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                              (J += 8),
                              this._applyMinimumContrast(w, te, S.ansi[J], j, ee, void 0) ||
                                W.push(`xterm-fg-${J}`));
                            break;
                          case 50331648:
                            const K = h.channels.toColor((J >> 16) & 255, (J >> 8) & 255, 255 & J);
                            this._applyMinimumContrast(w, te, K, j, ee, he) ||
                              this._addStyle(w, `color:#${f(J.toString(16), "0", 6)}`);
                            break;
                          default:
                            this._applyMinimumContrast(w, te, S.foreground, j, ee, he) ||
                              (ue && W.push(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`));
                        }
                        (W.length && ((w.className = W.join(" ")), (W.length = 0)),
                          le || V || _e ? (w.textContent = B) : L++,
                          O !== this.defaultSpacing && (w.style.letterSpacing = `${O}px`),
                          U.push(w),
                          (z = X));
                      }
                      return (w && L && (w.textContent = B), U);
                    }
                    _applyMinimumContrast(u, p, c, m, E, k) {
                      if (
                        this._optionsService.rawOptions.minimumContrastRatio === 1 ||
                        (0, e.treatGlyphAsBackgroundColor)(m.getCode())
                      )
                        return !1;
                      const D = this._getContrastCache(m);
                      let b;
                      if ((E || k || (b = D.getColor(p.rgba, c.rgba)), b === void 0)) {
                        const x =
                          this._optionsService.rawOptions.minimumContrastRatio /
                          (m.isDim() ? 2 : 1);
                        ((b = h.color.ensureContrastRatio(E || p, k || c, x)),
                          D.setColor((E || p).rgba, (k || c).rgba, b ?? null));
                      }
                    ...
                    _isCellInSelection(u, p) {
                      ...
                      return (
                        ...
                        (this._columnSelectMode
                          ? c[0] <= m[0]
                            ? u >= c[0] && p >= c[1] && u < m[0] && p <= m[1]
                            : u < c[0] && p >= c[1] && u >= m[0] && p <= m[1]
                          : (p > c[1] && p < m[1]) ||
                            (c[1] === m[1] && p === c[1] && u >= c[0] && u < m[0]) ||
                            (c[1] < m[1] && p === m[1] && u < m[0]) ||
                            (c[1] < m[1] && p === c[1] && u >= c[0]))
                      );
                    }
                  ...
                  function f(u, p, c) {
                    for (; u.length < c;) u = p + u;
                    return u;
                  }
                  r.DomRendererRowFactory = a = l(
                    [
                      _(1, i.ICharacterJoinerService),
                      _(2, g.IOptionsService),
                      _(3, i.ICoreBrowserService),
                      _(4, g.ICoreService),
                ...
                2550: (T, r) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.WidthCache = class {
                      ...
                      get(o, l, _) {
                        let n = 0;
                        if (!l && !_ && o.length === 1 && (n = o.charCodeAt(0)) < 256) {
                ...
                2223: (T, r, o) => {
                  ...
                  ((r.INVERTED_DEFAULT_COLOR = 257),
                    (r.DIM_OPACITY = 0.5),
                    (r.TEXT_BASELINE = l.isFirefox || l.isLegacyEdge ? "bottom" : "ideographic"));
                },
                6171: (T, r) => {
                  function o(_) {
                  ...
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.computeNextVariantOffset = function (_, n, d = 0) {
                      return (_ - (2 * Math.round(n) - d)) % (2 * Math.round(n));
                    }));
                },
                6052: (T, r) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                              ...
                              ? o % this._bufferService.cols == 0
                                ? [
                                    ...
                                    this.selectionStart[1] +
                                      Math.floor(o / this._bufferService.cols) -
                                      1,
                                  ]
                                : [
                ...
                428: function (T, r, o) {
                  ...
                  class h extends v.Disposable {
                    ...
                    _validateAndSet(t, a) {
                      t !== void 0 &&
                        ...
                        a !== void 0 &&
                        a > 0 &&
                        ((this._result.width = t), (this._result.height = a));
                    }
                  }
                  class i extends h {
                    constructor(t, a, f) {
                  ...
                  class s extends h {
                    constructor(t) {
                      ...
                      if (!(
                        "width" in a &&
                        "fontBoundingBoxAscent" in a &&
                        "fontBoundingBoxDescent" in a
                      ))
                    ...
                    measure() {
                      ...
                      return (
                        this._validateAndSet(
                          t.width,
                          t.fontBoundingBoxAscent + t.fontBoundingBoxDescent,
                        ),
                        this._result
                      );
                    }
                ...
                4269: function (T, r, o) {
                  ...
                  r.JoinedCellData = h;
                  let i = (r.CharacterJoinerService = class me {
                    constructor(e) {
                    ...
                    getJoinedCharacters(e) {
                      ...
                      for (let k = 0; k < t.getTrimmedLength(); k++)
                        if ((t.loadCell(k, this._workCell), this._workCell.getWidth() !== 0)) {
                          if (this._workCell.fg !== m || this._workCell.bg !== E) {
                            if (k - u > 1) {
                              const D = this._getJoinedRanges(f, c, p, t, u);
                              for (let b = 0; b < D.length; b++) a.push(D[b]);
                            }
                            ((u = k), (c = p), (m = this._workCell.fg), (E = this._workCell.bg));
                          }
                          p += this._workCell.getChars().length || d.WHITESPACE_CELL_CHAR.length;
                        }
                      if (this._bufferService.cols - u > 1) {
                        const k = this._getJoinedRanges(f, c, p, t, u);
                        for (let D = 0; D < k.length; D++) a.push(k[D]);
                      }
                      return a;
                    }
                    _getJoinedRanges(e, t, a, f, u) {
                      ...
                      for (let m = 1; m < this._characterJoiners.length; m++)
                        try {
                          const E = this._characterJoiners[m].handler(p);
                          for (let k = 0; k < E.length; k++) me._mergeRanges(c, E[k]);
                        } catch (E) {
                          console.error(E);
                        }
                    ...
                    _stringRangesToCellRanges(e, t, a) {
                      ...
                      if (c) {
                        for (let m = a; m < this._bufferService.cols; m++) {
                          const E = t.getWidth(m),
                            k = t.getString(m).length || d.WHITESPACE_CELL_CHAR.length;
                          if (E !== 0) {
                            if ((!u && c[0] <= p && ((c[0] = m), (u = !0)), c[1] <= p)) {
                    ...
                    static _mergeRanges(e, t) {
                      ...
                      for (let f = 0; f < e.length; f++) {
                        ...
                        if (a) {
                          ...
                          if (t[1] <= u[1])
                            return ((e[f - 1][1] = Math.max(t[1], u[1])), e.splice(f, 1), e);
                          (e.splice(f, 1), f--);
                        } else {
                  ...
                  r.CharacterJoinerService = i = l([_(0, g.IBufferService)], i);
                },
                5114: (T, r, o) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                  ...
                  class d extends l.Disposable {
                    constructor(h, i, s) {
                      (super(),
                        ...
                        (this._onDprChange = this.register(new _.EventEmitter())),
                        (this.onDprChange = this._onDprChange.event),
                        (this._onWindowChange = this.register(new _.EventEmitter())),
                    ...
                    set window(h) {
                      this._window !== h &&
                        ((this._window = h), this._onWindowChange.fire(this._window));
                    }
                    get dpr() {
                ...
                8934: function (T, r, o) {
                        ...
                        var e,
                          ...
                          a =
                            t < 3
                              ? h
                              : s === null
                                ? (s = Object.getOwnPropertyDescriptor(h, i))
                                : s;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          a = Reflect.decorate(g, h, i, s);
                        else
                          for (var f = g.length - 1; f >= 0; f--)
                            (e = g[f]) && (a = (t < 3 ? e(a) : t > 3 ? e(h, i, a) : e(h, i)) || a);
                  ...
                  r.MouseService = v = l([_(0, n.IRenderService), _(1, n.ICharSizeService)], v);
                },
                3230: function (T, r, o) {
                  var l =
                      (this && this.__decorate) ||
                  ...
                  let s = (r.RenderService = class extends g.Disposable {
                    ...
                    constructor(e, t, a, f, u, p, c, m) {
                      (super(),
                        (this._rowCount = e),
                        (this._charSizeService = f),
                        (this._renderer = this.register(new g.MutableDisposable())),
                        (this._pausedResizeTask = new h.DebouncedIdleTask()),
                        ...
                        this.register(u.onDecorationRegistered(() => this._fullRefresh())),
                        this.register(u.onDecorationRemoved(() => this._fullRefresh())),
                        this.register(
                          a.onMultipleOptionChange(
                            [
                              "customGlyphs",
                            ...
                            () => {
                              (this.clear(),
                                this.handleResize(p.cols, p.rows),
                                this._fullRefresh());
                            },
                          ),
                        ),
                        this.register(
                          a.onMultipleOptionChange(["cursorBlink", "cursorStyle"], () =>
                            this.refreshRows(p.buffer.y, p.buffer.y, !0),
                          ),
                        ),
                        this.register(m.onChangeColors(() => this._fullRefresh())),
                        this._registerIntersectionObserver(c.window, t),
                        this.register(
                          c.onWindowChange((E) => this._registerIntersectionObserver(E, t)),
                        ));
                    }
                    _registerIntersectionObserver(e, t) {
                      if ("IntersectionObserver" in e) {
                        const a = new e.IntersectionObserver(
                          (f) => this._handleIntersectionChange(f[f.length - 1]),
                          { threshold: 0 },
                        );
                        (a.observe(t),
                          (this._observerDisposable.value = (0, g.toDisposable)(() =>
                            a.disconnect(),
                          )));
                      }
                    }
                    ...
                    refreshRows(e, t, a = !1) {
                      this._isPaused
                        ...
                        : (a || (this._isNextRenderRedrawOnly = !1),
                    ...
                    handleSelectionChanged(e, t, a) {
                      ((this._selectionState.start = e),
                        ...
                        (this._selectionState.columnSelectMode = a),
                        this._renderer.value?.handleSelectionChanged(e, t, a));
                    }
                    handleCursorMove() {
                  ...
                  r.RenderService = s = l(
                    [
                      _(2, i.IOptionsService),
                      _(3, d.ICharSizeService),
                      _(4, i.IDecorationService),
                      _(5, i.IBufferService),
                      _(6, d.ICoreBrowserService),
                      _(7, d.IThemeService),
                    ],
                    s,
                        ...
                        var D,
                          ...
                          x =
                            b < 3
                              ? m
                              : k === null
                                ? (k = Object.getOwnPropertyDescriptor(m, E))
                                : k;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          x = Reflect.decorate(c, m, E, k);
                        else
                          for (var M = c.length - 1; M >= 0; M--)
                            (D = c[M]) && (x = (b < 3 ? D(x) : b > 3 ? D(m, E, x) : D(m, E)) || x);
                        return (b > 3 && x && Object.defineProperty(m, E, x), x);
                      },
                    _ =
                      (this && this.__param) ||
                      function (c, m) {
                  ...
                  let p = (r.SelectionService = class extends i.Disposable {
                    constructor(c, m, E, k, D, b, x, M, I) {
                      (super(),
                        ...
                        (this.onRequestScrollLines = this._onRequestScrollLines.event),
                        (this._mouseMoveListener = (U) => this._handleMouseMove(U)),
                        (this._mouseUpListener = (U) => this._handleMouseUp(U)),
                        this._coreService.onUserInput(() => {
                          this.hasSelection && this.clearSelection();
                        }),
                        (this._trimListener = this._bufferService.buffer.lines.onTrim((U) =>
                          this._handleTrim(U),
                        )),
                        this.register(
                          this._bufferService.buffers.onBufferActivate((U) =>
                            this._handleBufferActivate(U),
                          ),
                        ),
                        this.enable(),
                    ...
                    get selectionText() {
                      ...
                      if (this._activeSelectionMode === 3) {
                        if (c[0] === m[0]) return "";
                        const D = c[0] < m[0] ? c[0] : m[0],
                          b = c[0] < m[0] ? m[0] : c[0];
                        for (let x = c[1]; x <= m[1]; x++) {
                          const M = E.translateBufferLineToString(x, !0, D, b);
                          k.push(M);
                        }
                      } else {
                        const D = c[1] === m[1] ? m[0] : void 0;
                        k.push(E.translateBufferLineToString(c[1], !0, c[0], D));
                        for (let b = c[1] + 1; b <= m[1] - 1; b++) {
                          const x = E.lines.get(b),
                            M = E.translateBufferLineToString(b, !0);
                          x?.isWrapped ? (k[k.length - 1] += M) : k.push(M);
                        }
                        if (c[1] !== m[1]) {
                          const b = E.lines.get(m[1]),
                            x = E.translateBufferLineToString(m[1], !0, 0, m[0]);
                          b && b.isWrapped ? (k[k.length - 1] += x) : k.push(x);
                        }
                      }
                      return k
                        .map((D) => D.replace(u, " "))
...
`,
                    ...
                    _isClickInSelection(c) {
                      const m = this._getMouseBufferCoords(c),
                        E = this._model.finalSelectionStart,
                        k = this._model.finalSelectionEnd;
                      return !!(E && k && m) && this._areCoordsInSelection(m, E, k);
                    }
                    isCellInSelection(c, m) {
                      const E = this._model.finalSelectionStart,
                        k = this._model.finalSelectionEnd;
                      return !(!E || !k) && this._areCoordsInSelection([c, m], E, k);
                    }
                    _areCoordsInSelection(c, m, E) {
                      return (
                        (c[1] > m[1] && c[1] < E[1]) ||
                        (m[1] === E[1] && c[1] === m[1] && c[0] >= m[0] && c[0] < E[0]) ||
                        (m[1] < E[1] && c[1] === E[1] && c[0] < E[0]) ||
                        (m[1] < E[1] && c[1] === m[1] && c[0] >= m[0])
                      );
                    }
                    _selectWordAtCursor(c, m) {
                      const E = this._linkifier.currentLink?.link?.range;
                      if (E)
                        return (
                          (this._model.selectionStart = [E.start.x - 1, E.start.y - 1]),
                          (this._model.selectionStartLength = (0, e.getRangeLength)(
                            E,
                            this._bufferService.cols,
                          )),
                      ...
                      return (
                        !!k && (this._selectWordAt(k, m), (this._model.selectionEnd = void 0), !0)
                      );
                    }
                    selectAll() {
                    ...
                    selectLines(c, m) {
                      (this._model.clearSelection(),
                        (c = Math.max(c, 0)),
                        (m = Math.min(m, this._bufferService.buffer.lines.length - 1)),
                        (this._model.selectionStart = [0, c]),
                        (this._model.selectionEnd = [this._bufferService.cols, m]),
                        this.refresh(),
                        this._onSelectionChange.fire());
                    }
                    _handleTrim(c) {
                    ...
                    shouldForceSelection(c) {
                      return s.isMac
                        ? c.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection
                        : c.shiftKey;
                    }
                    handleMouseDown(c) {
                      if (
                          ...
                          this._enabled && c.shiftKey
                            ...
                            : c.detail === 1
                              ...
                              : c.detail === 2
                                ...
                                : c.detail === 3 && this._handleTripleClick(c),
                    ...
                    _handleIncrementalClick(c) {
                      this._model.selectionStart &&
                        (this._model.selectionEnd = this._getMouseBufferCoords(c));
                    }
                    ...
                    shouldColumnSelect(c) {
                      return (
                        c.altKey &&
                        !(s.isMac && this._optionsService.rawOptions.macOptionClickForcesSelection)
                      );
                    }
                    _handleMouseMove(c) {
                      ...
                      if (this._model.selectionEnd[1] < E.lines.length) {
                        const k = E.lines.get(this._model.selectionEnd[1]);
                        k &&
                    ...
                    _handleMouseUp(c) {
                      ...
                      if (
                        ...
                        if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
                          const E = this._mouseService.getCoords(
                            c,
                            this._element,
                            this._bufferService.cols,
                            this._bufferService.rows,
                      ...
                      E
                        ? c &&
                          ...
                          ((this._oldSelectionStart &&
                            ...
                            this._fireOnSelectionChange(c, m, E))
                        : this._oldHasSelection && this._fireOnSelectionChange(c, m, E);
                    }
                    _fireOnSelectionChange(c, m, E) {
                      ((this._oldSelectionStart = c),
                        (this._oldSelectionEnd = m),
                        (this._oldHasSelection = E),
                        this._onSelectionChange.fire());
                    }
                    _handleBufferActivate(c) {
                      (this.clearSelection(),
                        this._trimListener.dispose(),
                        (this._trimListener = c.activeBuffer.lines.onTrim((m) =>
                          this._handleTrim(m),
                        )));
                    }
                    _convertViewportColToCharacterIndex(c, m) {
                      let E = m;
                      for (let k = 0; m >= k; k++) {
                        const D = c.loadCell(k, this._workCell).getChars().length;
                        this._workCell.getWidth() === 0 ? E-- : D > 1 && m !== k && (E += D - 1);
                      }
                      return E;
                    }
                    setSelection(c, m, E) {
                    ...
                    rightClickSelect(c) {
                      this._isClickInSelection(c) ||
                        (this._selectWordAtCursor(c, !1) && this.refresh(!0),
                        this._fireEventIfSelectionChanged());
                    }
                    _getWordAt(c, m, E = !0, k = !0) {
                      if (c[0] >= this._bufferService.cols) return;
                      const D = this._bufferService.buffer,
                        b = D.lines.get(c[1]);
                      if (!b) return;
                      const x = D.translateBufferLineToString(c[1], !1);
                      let M = this._convertViewportColToCharacterIndex(b, c[0]),
                        I = M;
                      const U = c[0] - M;
                      let P = 0,
                        S = 0,
                        ...
                        y = 0;
                      if (x.charAt(M) === " ") {
                        for (; M > 0 && x.charAt(M - 1) === " ";) M--;
                        for (; I < x.length && x.charAt(I + 1) === " ";) I++;
                      } else {
                        let H = c[0],
                          N = c[0];
                        (b.getWidth(H) === 0 && (P++, H--), b.getWidth(N) === 2 && (S++, N++));
                        const $ = b.getString(N).length;
                        for (
                          $ > 1 && ((y += $ - 1), (I += $ - 1));
                          H > 0 &&
                          M > 0 &&
                          !this._isCharWordSeparator(b.loadCell(H - 1, this._workCell));
                        ) {
                          b.loadCell(H - 1, this._workCell);
                        ...
                        for (
                          ...
                          N < b.length &&
                          I + 1 < x.length &&
                          !this._isCharWordSeparator(b.loadCell(N + 1, this._workCell));
                        ) {
                      ...
                      I++;
                      let L = M + U - P + w,
                        B = Math.min(this._bufferService.cols, I - M + P + S - w - y);
                      if (m || x.slice(M, I).trim() !== "") {
                        if (E && L === 0 && b.getCodePoint(0) !== 32) {
                          const H = D.lines.get(c[1] - 1);
                          if (
                            H &&
                            b.isWrapped &&
                            H.getCodePoint(this._bufferService.cols - 1) !== 32
                          ) {
                            const N = this._getWordAt(
                        ...
                        if (
                          k &&
                          L + B === this._bufferService.cols &&
                          b.getCodePoint(this._bufferService.cols - 1) !== 32
                        ) {
                          const H = D.lines.get(c[1] + 1);
                          if (H?.isWrapped && H.getCodePoint(0) !== 32) {
                            const N = this._getWordAt([0, c[1] + 1], !1, !1, !0);
                            N && (B += N.length);
                          }
                        }
                        return { start: L, length: B };
                      }
                    }
                    _selectWordAt(c, m) {
                      const E = this._getWordAt(c, m);
                      if (E) {
                        for (; E.start < 0;) ((E.start += this._bufferService.cols), c[1]--);
                        ((this._model.selectionStart = [E.start, c[1]]),
                          (this._model.selectionStartLength = E.length));
                      }
                    }
                    _selectToWordAt(c) {
                      ...
                      if (m) {
                        let E = c[1];
                        for (; m.start < 0;) ((m.start += this._bufferService.cols), E--);
                        if (!this._model.areSelectionValuesReversed())
                          for (; m.start + m.length > this._bufferService.cols;)
                            ((m.length -= this._bufferService.cols), E++);
                        this._model.selectionEnd = [
                          this._model.areSelectionValuesReversed() ? m.start : m.start + m.length,
                          E,
                        ];
                      }
                    }
                    _isCharWordSeparator(c) {
                      return (
                        c.getWidth() !== 0 &&
                        this._optionsService.rawOptions.wordSeparator.indexOf(c.getChars()) >= 0
                      );
                    }
                    _selectLineAt(c) {
                      const m = this._bufferService.buffer.getWrappedRangeForLine(c),
                        E = {
                          start: { x: 0, y: m.first },
                          end: { x: this._bufferService.cols - 1, y: m.last },
                        };
                  ...
                  r.SelectionService = p = l(
                    [
                      _(3, a.IBufferService),
                      _(4, a.ICoreService),
                      _(5, g.IMouseService),
                      _(6, a.IOptionsService),
                  ...
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    (r.ILinkProviderService =
                      ...
                      r.ICharSizeService =
                        void 0));
                  const l = o(8343);
                  ((r.ICharSizeService = (0, l.createDecorator)("CharSizeService")),
                    (r.ICoreBrowserService = (0, l.createDecorator)("CoreBrowserService")),
                    (r.IMouseService = (0, l.createDecorator)("MouseService")),
                    (r.IRenderService = (0, l.createDecorator)("RenderService")),
                    (r.ISelectionService = (0, l.createDecorator)("SelectionService")),
                    (r.ICharacterJoinerService = (0, l.createDecorator)("CharacterJoinerService")),
                    (r.IThemeService = (0, l.createDecorator)("ThemeService")),
                    (r.ILinkProviderService = (0, l.createDecorator)("LinkProviderService")));
                },
                6731: function (T, r, o) {
                  var l =
                      (this && this.__decorate) ||
                        ...
                        var k,
                          ...
                          b =
                            D < 3
                              ? c
                              : E === null
                                ? (E = Object.getOwnPropertyDescriptor(c, m))
                                : E;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          b = Reflect.decorate(p, c, m, E);
                        else
                          for (var x = p.length - 1; x >= 0; x--)
                            (k = p[x]) && (b = (D < 3 ? k(b) : D > 3 ? k(c, m, b) : k(c, m)) || b);
                        return (D > 3 && b && Object.defineProperty(c, m, b), b);
                      },
                    _ =
                      (this && this.__param) ||
                      function (p, c) {
                  ...
                  const n = o(7239),
                    ...
                    g = o(844),
                    h = o(2585),
                    i = d.css.toColor("#ffffff"),
                    s = d.css.toColor("#000000"),
                    e = d.css.toColor("#ffffff"),
                    t = d.css.toColor("#000000"),
                    a = { css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117 };
                    ...
                    (() => {
                      ...
                      for (let m = 0; m < 216; m++) {
                        const E = c[((m / 36) % 6) | 0],
                          ...
                          D = c[m % 6];
                        p.push({
                          css: d.channels.toCss(E, k, D),
                          rgba: d.channels.toRgba(E, k, D),
                        });
                      }
                      for (let m = 0; m < 24; m++) {
                        const E = 8 + 10 * m;
                        p.push({
                          css: d.channels.toCss(E, E, E),
                          rgba: d.channels.toRgba(E, E, E),
                        });
                      }
                      return p;
                    })(),
                  ...
                  let f = (r.ThemeService = class extends g.Disposable {
                    ...
                    constructor(p) {
                      (super(),
                        ...
                        (this._colors = {
                          ...
                          selectionBackgroundTransparent: a,
                          selectionBackgroundOpaque: d.color.blend(s, a),
                          selectionInactiveBackgroundTransparent: a,
                          selectionInactiveBackgroundOpaque: d.color.blend(s, a),
                    ...
                    _setTheme(p = {}) {
                      ...
                      if (
                        ((c.foreground = u(p.foreground, i)),
                        (c.background = u(p.background, s)),
                        (c.cursor = u(p.cursor, e)),
                        (c.cursorAccent = u(p.cursorAccent, t)),
                        (c.selectionBackgroundTransparent = u(p.selectionBackground, a)),
                        (c.selectionBackgroundOpaque = d.color.blend(
                          c.background,
                          c.selectionBackgroundTransparent,
                        )),
                        (c.selectionInactiveBackgroundTransparent = u(
                          p.selectionInactiveBackground,
                          c.selectionBackgroundTransparent,
                        )),
                        (c.selectionInactiveBackgroundOpaque = d.color.blend(
                          c.background,
                          c.selectionInactiveBackgroundTransparent,
                        )),
                        (c.selectionForeground = p.selectionForeground
                          ? u(p.selectionForeground, d.NULL_COLOR)
                          : void 0),
                        c.selectionForeground === d.NULL_COLOR && (c.selectionForeground = void 0),
                        d.color.isOpaque(c.selectionBackgroundTransparent) &&
                          (c.selectionBackgroundTransparent = d.color.opacity(
                            c.selectionBackgroundTransparent,
                            0.3,
                          )),
                        d.color.isOpaque(c.selectionInactiveBackgroundTransparent) &&
                          (c.selectionInactiveBackgroundTransparent = d.color.opacity(
                            c.selectionInactiveBackgroundTransparent,
                            0.3,
                          )),
                        (c.ansi = r.DEFAULT_ANSI_COLORS.slice()),
                        (c.ansi[0] = u(p.black, r.DEFAULT_ANSI_COLORS[0])),
                        (c.ansi[1] = u(p.red, r.DEFAULT_ANSI_COLORS[1])),
                        (c.ansi[2] = u(p.green, r.DEFAULT_ANSI_COLORS[2])),
                        (c.ansi[3] = u(p.yellow, r.DEFAULT_ANSI_COLORS[3])),
                        (c.ansi[4] = u(p.blue, r.DEFAULT_ANSI_COLORS[4])),
                        (c.ansi[5] = u(p.magenta, r.DEFAULT_ANSI_COLORS[5])),
                        (c.ansi[6] = u(p.cyan, r.DEFAULT_ANSI_COLORS[6])),
                        (c.ansi[7] = u(p.white, r.DEFAULT_ANSI_COLORS[7])),
                        (c.ansi[8] = u(p.brightBlack, r.DEFAULT_ANSI_COLORS[8])),
                        (c.ansi[9] = u(p.brightRed, r.DEFAULT_ANSI_COLORS[9])),
                        (c.ansi[10] = u(p.brightGreen, r.DEFAULT_ANSI_COLORS[10])),
                        (c.ansi[11] = u(p.brightYellow, r.DEFAULT_ANSI_COLORS[11])),
                        (c.ansi[12] = u(p.brightBlue, r.DEFAULT_ANSI_COLORS[12])),
                        (c.ansi[13] = u(p.brightMagenta, r.DEFAULT_ANSI_COLORS[13])),
                        (c.ansi[14] = u(p.brightCyan, r.DEFAULT_ANSI_COLORS[14])),
                        (c.ansi[15] = u(p.brightWhite, r.DEFAULT_ANSI_COLORS[15])),
                        p.extendedAnsi)
                      ) {
                        const m = Math.min(c.ansi.length - 16, p.extendedAnsi.length);
                        for (let E = 0; E < m; E++)
                          c.ansi[E + 16] = u(p.extendedAnsi[E], r.DEFAULT_ANSI_COLORS[E + 16]);
                      }
                      (this._contrastCache.clear(),
                ...
                6349: (T, r, o) => {
                  ...
                  class n extends _.Disposable {
                    ...
                    set maxLength(v) {
                      ...
                      const g = new Array(v);
                      for (let h = 0; h < Math.min(v, this.length); h++)
                    ...
                    set length(v) {
                      if (v > this._length)
                        for (let g = this._length; g < v; g++) this._array[g] = void 0;
                      this._length = v;
                    }
                    get(v) {
                    ...
                    splice(v, g, ...h) {
                      if (g) {
                        for (let i = v; i < this._length - g; i++)
                          this._array[this._getCyclicIndex(i)] =
                            this._array[this._getCyclicIndex(i + g)];
                        ((this._length -= g), this.onDeleteEmitter.fire({ index: v, amount: g }));
                      }
                      for (let i = this._length - 1; i >= v; i--)
                        this._array[this._getCyclicIndex(i + h.length)] =
                          this._array[this._getCyclicIndex(i)];
                      for (let i = 0; i < h.length; i++)
                        this._array[this._getCyclicIndex(v + i)] = h[i];
                      if (
                        (h.length && this.onInsertEmitter.fire({ index: v, amount: h.length }),
                        this._length + h.length > this._maxLength)
                      ) {
                        const i = this._length + h.length - this._maxLength;
                        ((this._startIndex += i),
                          (this._length = this._maxLength),
                          this.onTrimEmitter.fire(i));
                ...
                8055: (T, r) => {
                  ...
                  ((r.NULL_COLOR = { css: "#00000000", rgba: 0 }),
                    (function (t) {
                      ((t.toCss = function (a, f, u, p) {
                        return p !== void 0
                          ? `#${s(a)}${s(f)}${s(u)}${s(p)}`
                          : `#${s(a)}${s(f)}${s(u)}`;
                      }),
                        (t.toRgba = function (a, f, u, p = 255) {
                          return ((a << 24) | (f << 16) | (u << 8) | p) >>> 0;
                        }),
                        (t.toColor = function (a, f, u, p) {
                          return { css: t.toCss(a, f, u, p), rgba: t.toRgba(a, f, u, p) };
                        }));
                    })(d || (r.channels = d = {})),
                    (function (t) {
                      function a(f, u) {
                        return (
                          (n = Math.round(255 * u)),
                          ([o, l, _] = i.toChannels(f.rgba)),
                          { css: d.toCss(o, l, _, n), rgba: d.toRgba(o, l, _, n) }
                        );
                      }
                      ((t.blend = function (f, u) {
                        ...
                        const p = (u.rgba >> 24) & 255,
                          ...
                          D = (f.rgba >> 8) & 255;
                        return (
                          (o = E + Math.round((p - E) * n)),
                          (l = k + Math.round((c - k) * n)),
                          (_ = D + Math.round((m - D) * n)),
                          { css: d.toCss(o, l, _), rgba: d.toRgba(o, l, _) }
                        );
                      }),
                        (t.isOpaque = function (f) {
                          return (255 & f.rgba) == 255;
                        }),
                        (t.ensureContrastRatio = function (f, u, p) {
                          const c = i.ensureContrastRatio(f.rgba, u.rgba, p);
                          if (c) return d.toColor((c >> 24) & 255, (c >> 16) & 255, (c >> 8) & 255);
                        }),
                        (t.opaque = function (f) {
                          const u = (255 | f.rgba) >>> 0;
                          return (
                            ([o, l, _] = i.toChannels(u)),
                            { css: d.toCss(o, l, _), rgba: u }
                          );
                        }),
                        (t.opacity = a),
                    ...
                    (function (t) {
                      ...
                      try {
                        ...
                        p &&
                          ...
                          (f = a.createLinearGradient(0, 0, 1, 1)));
                      } catch {}
                      t.toColor = function (u) {
                        if (u.match(/#[\da-f]{3,8}/i))
                          switch (u.length) {
                            case 4:
                              return (
                                (o = parseInt(u.slice(1, 2).repeat(2), 16)),
                                (l = parseInt(u.slice(2, 3).repeat(2), 16)),
                                (_ = parseInt(u.slice(3, 4).repeat(2), 16)),
                                d.toColor(o, l, _)
                              );
                            case 5:
                              return (
                        ...
                        if (p)
                          return (
                            ...
                            (l = parseInt(p[2])),
                            (_ = parseInt(p[3])),
                            (n = Math.round(255 * (p[5] === void 0 ? 1 : parseFloat(p[5])))),
                            d.toColor(o, l, _, n)
                          );
                        if (!a || !f) throw new Error("css.toColor: Unsupported css format");
                        if (((a.fillStyle = f), (a.fillStyle = u), typeof a.fillStyle != "string"))
                          throw new Error("css.toColor: Unsupported css format");
                        if (
                          (a.fillRect(0, 0, 1, 1),
                          ([o, l, _, n] = a.getImageData(0, 0, 1, 1).data),
                          n !== 255)
                        )
                          throw new Error("css.toColor: Unsupported css format");
                        return { rgba: d.toRgba(o, l, _, n), css: u };
                      };
                    })(g || (r.css = g = {})),
                    (function (t) {
                      function a(f, u, p) {
                        const c = f / 255,
                          ...
                          E = p / 255;
                        return (
                          0.2126 * (c <= 0.03928 ? c / 12.92 : Math.pow((c + 0.055) / 1.055, 2.4)) +
                          0.7152 * (m <= 0.03928 ? m / 12.92 : Math.pow((m + 0.055) / 1.055, 2.4)) +
                    ...
                    (function (t) {
                      function a(u, p, c) {
                        ...
                        let D = (p >> 24) & 255,
                          b = (p >> 16) & 255,
                          x = (p >> 8) & 255,
                          M = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k));
                        for (; M < c && (D > 0 || b > 0 || x > 0);)
                          ((D -= Math.max(0, Math.ceil(0.1 * D))),
                            (b -= Math.max(0, Math.ceil(0.1 * b))),
                            (x -= Math.max(0, Math.ceil(0.1 * x))),
                            (M = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k))));
                        return ((D << 24) | (b << 16) | (x << 8) | 255) >>> 0;
                      }
                      function f(u, p, c) {
                        const m = (u >> 24) & 255,
                          E = (u >> 16) & 255,
                        ...
                        let D = (p >> 24) & 255,
                          ...
                          x = (p >> 8) & 255,
                          M = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k));
                        for (; M < c && (D < 255 || b < 255 || x < 255);)
                          ((D = Math.min(255, D + Math.ceil(0.1 * (255 - D)))),
                            (b = Math.min(255, b + Math.ceil(0.1 * (255 - b)))),
                            (x = Math.min(255, x + Math.ceil(0.1 * (255 - x)))),
                            (M = e(h.relativeLuminance2(D, b, x), h.relativeLuminance2(m, E, k))));
                        return ((D << 24) | (b << 16) | (x << 8) | 255) >>> 0;
                      }
                      ((t.blend = function (u, p) {
                        ...
                        const c = (p >> 24) & 255,
                          ...
                          b = (u >> 8) & 255;
                        return (
                          (o = k + Math.round((c - k) * n)),
                          (l = D + Math.round((m - D) * n)),
                          (_ = b + Math.round((E - b) * n)),
                          d.toRgba(o, l, _)
                        );
                      }),
                        (t.ensureContrastRatio = function (u, p, c) {
                          const m = h.relativeLuminance(u >> 8),
                            E = h.relativeLuminance(p >> 8);
                          if (e(m, E) < c) {
                            if (E < m) {
                              const b = a(u, p, c),
                                x = e(m, h.relativeLuminance(b >> 8));
                              if (x < c) {
                                const M = f(u, p, c);
                                return x > e(m, h.relativeLuminance(M >> 8)) ? b : M;
                              }
                              return b;
                            }
                            const k = f(u, p, c),
                              D = e(m, h.relativeLuminance(k >> 8));
                            if (D < c) {
                              const b = a(u, p, c);
                              return D > e(m, h.relativeLuminance(b >> 8)) ? k : b;
                            }
                            return k;
                          }
                        }),
                ...
                8969: (T, r, o) => {
                  ...
                  class m extends l.Disposable {
                    get onScroll() {
                      return (
                        this._onScrollApi ||
                          ((this._onScrollApi = this.register(new i.EventEmitter())),
                          this._onScroll.event((k) => {
                            this._onScrollApi?.fire(k.position);
                          })),
                    ...
                    set options(k) {
                      for (const D in k) this.optionsService.options[D] = k[D];
                    }
                    constructor(k) {
                      (super(),
                        ...
                        (this._onBinary = this.register(new i.EventEmitter())),
                        (this.onBinary = this._onBinary.event),
                        (this._onData = this.register(new i.EventEmitter())),
                        (this.onData = this._onData.event),
                        (this._onLineFeed = this.register(new i.EventEmitter())),
                        (this.onLineFeed = this._onLineFeed.event),
                        (this._onResize = this.register(new i.EventEmitter())),
                        (this.onResize = this._onResize.event),
                        (this._onWriteParsed = this.register(new i.EventEmitter())),
                        (this.onWriteParsed = this._onWriteParsed.event),
                        (this._onScroll = this.register(new i.EventEmitter())),
                        (this._instantiationService = new n.InstantiationService()),
                        (this.optionsService = this.register(new g.OptionsService(k))),
                        this._instantiationService.setService(
                          _.IOptionsService,
                          this.optionsService,
                        ),
                        ...
                        this._instantiationService.setService(_.ILogService, this._logService),
                        (this.coreService = this.register(
                          this._instantiationService.createInstance(h.CoreService),
                        )),
                        this._instantiationService.setService(_.ICoreService, this.coreService),
                        (this.coreMouseService = this.register(
                          this._instantiationService.createInstance(s.CoreMouseService),
                        )),
                        this._instantiationService.setService(
                          _.ICoreMouseService,
                        ...
                        (this.unicodeService = this.register(
                          this._instantiationService.createInstance(e.UnicodeService),
                        )),
                        this._instantiationService.setService(
                          _.IUnicodeService,
                          this.unicodeService,
                        ...
                        this.register(
                          (0, i.forwardEvent)(this._inputHandler.onLineFeed, this._onLineFeed),
                        ),
                        this.register(this._inputHandler),
                        this.register(
                          (0, i.forwardEvent)(this._bufferService.onResize, this._onResize),
                        ),
                        this.register((0, i.forwardEvent)(this.coreService.onData, this._onData)),
                        this.register(
                          (0, i.forwardEvent)(this.coreService.onBinary, this._onBinary),
                        ),
                        this.register(
                        ...
                        this.register(
                          this._bufferService.onScroll((D) => {
                            (this._onScroll.fire({
                        ...
                        (this._writeBuffer = this.register(
                          new u.WriteBuffer((D, b) => this._inputHandler.parse(D, b)),
                        )),
                        this.register(
                          (0, i.forwardEvent)(this._writeBuffer.onWriteParsed, this._onWriteParsed),
                        ));
                    }
                    write(k, D) {
                      this._writeBuffer.write(k, D);
                    }
                    writeSync(k, D) {
                      (this._logService.logLevel <= _.LogLevelEnum.WARN &&
                        ...
                        (c = !0)),
                        this._writeBuffer.writeSync(k, D));
                    }
                    input(k, D = !0) {
                      this.coreService.triggerDataEvent(k, D);
                    }
                    resize(k, D) {
                      isNaN(k) ||
                        isNaN(D) ||
                        ((k = Math.max(k, v.MINIMUM_COLS)),
                        (D = Math.max(D, v.MINIMUM_ROWS)),
                        this._bufferService.resize(k, D));
                    }
                    scroll(k, D = !1) {
                      this._bufferService.scroll(k, D);
                    }
                    scrollLines(k, D, b) {
                      this._bufferService.scrollLines(k, D, b);
                    }
                    scrollPages(k) {
                    ...
                    scrollToLine(k) {
                      const D = k - this._bufferService.buffer.ydisp;
                      D !== 0 && this.scrollLines(D);
                    }
                    registerEscHandler(k, D) {
                      return this._inputHandler.registerEscHandler(k, D);
                    }
                    registerDcsHandler(k, D) {
                      return this._inputHandler.registerDcsHandler(k, D);
                    }
                    registerCsiHandler(k, D) {
                      return this._inputHandler.registerCsiHandler(k, D);
                    }
                    registerOscHandler(k, D) {
                      return this._inputHandler.registerOscHandler(k, D);
                    }
                    _setup() {
                      this._handleWindowsPtyOptionChange();
                    }
                    ...
                    _handleWindowsPtyOptionChange() {
                      ...
                      (D && D.buildNumber !== void 0 && D.buildNumber !== void 0
                        ? (k = D.backend === "conpty" && D.buildNumber < 21376)
                    ...
                    _enableWindowsWrappingHeuristics() {
                      if (!this._windowsWrappingHeuristics.value) {
                        ...
                        (k.push(
                          this.onLineFeed(
                            a.updateWindowsModeWrappedState.bind(null, this._bufferService),
                          ),
                        ),
                          k.push(
                            this.registerCsiHandler(
                              { final: "H" },
                              () => ((0, a.updateWindowsModeWrappedState)(this._bufferService), !1),
                            ),
                          ),
                          (this._windowsWrappingHeuristics.value = (0, l.toDisposable)(() => {
                            for (const D of k) D.dispose();
                          })));
                      }
                    }
                  }
                ...
                8460: (T, r) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    (r.runAndSubscribe = r.forwardEvent = r.EventEmitter = void 0),
                    ...
                    (r.forwardEvent = function (o, l) {
                      return o((_) => l.fire(_));
                    }),
                    (r.runAndSubscribe = function (o, l) {
                      return (l(void 0), o((_) => l(_)));
                    }));
                },
                5435: function (T, r, o) {
                  var l =
                        ...
                        var L,
                          ...
                          H =
                            B < 3
                              ? S
                              : y === null
                                ? (y = Object.getOwnPropertyDescriptor(S, w))
                                : y;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          H = Reflect.decorate(P, S, w, y);
                        else
                          for (var N = P.length - 1; N >= 0; N--)
                            (L = P[N]) && (H = (B < 3 ? L(H) : B > 3 ? L(S, w, H) : L(S, w)) || H);
                        return (B > 3 && H && Object.defineProperty(S, w, H), H);
                      },
                    _ =
                      (this && this.__param) ||
                      function (P, S) {
                  ...
                  const n = o(2584),
                    ...
                    k = 131072;
                  function D(P, S) {
                    if (P > 24) return S.setWinLines || !1;
                    switch (P) {
                      case 1:
                        return !!S.restoreWin;
                      case 2:
                  ...
                  var b;
                  (function (P) {
                    ((P[(P.GET_WIN_SIZE_PIXELS = 0)] = "GET_WIN_SIZE_PIXELS"),
                      (P[(P.GET_CELL_SIZE_PIXELS = 1)] = "GET_CELL_SIZE_PIXELS"));
                  ...
                  class M extends g.Disposable {
                    ...
                    constructor(S, w, y, L, B, H, N, $, R = new v.EscapeSequenceParser()) {
                      (super(),
                        (this._bufferService = S),
                        (this._charsetService = w),
                        (this._coreService = y),
                        (this._logService = L),
                        (this._optionsService = B),
                        (this._oscLinkService = H),
                        (this._coreMouseService = N),
                        ...
                        (this._iconNameStack = []),
                        (this._curAttrData = i.DEFAULT_ATTR_DATA.clone()),
                        (this._eraseAttrDataInternal = i.DEFAULT_ATTR_DATA.clone()),
                        (this._onRequestBell = this.register(new s.EventEmitter())),
                        (this.onRequestBell = this._onRequestBell.event),
                        (this._onRequestRefreshRows = this.register(new s.EventEmitter())),
                        (this.onRequestRefreshRows = this._onRequestRefreshRows.event),
                        (this._onRequestReset = this.register(new s.EventEmitter())),
                        (this.onRequestReset = this._onRequestReset.event),
                        (this._onRequestSendFocus = this.register(new s.EventEmitter())),
                        (this.onRequestSendFocus = this._onRequestSendFocus.event),
                        (this._onRequestSyncScrollBar = this.register(new s.EventEmitter())),
                        (this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event),
                        (this._onRequestWindowsOptionsReport = this.register(new s.EventEmitter())),
                        (this.onRequestWindowsOptionsReport =
                          this._onRequestWindowsOptionsReport.event),
                        (this._onA11yChar = this.register(new s.EventEmitter())),
                        (this.onA11yChar = this._onA11yChar.event),
                        (this._onA11yTab = this.register(new s.EventEmitter())),
                        (this.onA11yTab = this._onA11yTab.event),
                        (this._onCursorMove = this.register(new s.EventEmitter())),
                        (this.onCursorMove = this._onCursorMove.event),
                        (this._onLineFeed = this.register(new s.EventEmitter())),
                        (this.onLineFeed = this._onLineFeed.event),
                        (this._onScroll = this.register(new s.EventEmitter())),
                        (this.onScroll = this._onScroll.event),
                        (this._onTitleChange = this.register(new s.EventEmitter())),
                        (this.onTitleChange = this._onTitleChange.event),
                        (this._onColor = this.register(new s.EventEmitter())),
                        ...
                        this._parser.setCsiHandlerFallback((C, A) => {
                        ...
                        this._parser.setOscHandlerFallback((C, A, O) => {
                        ...
                        this._parser.setDcsHandlerFallback((C, A, O) => {
                          (A === "HOOK" && (O = O.toArray()),
                        ...
                        this._parser.setPrintHandler((C, A, O) => this.print(C, A, O)),
                        this._parser.registerCsiHandler({ final: "@" }, (C) => this.insertChars(C)),
                        this._parser.registerCsiHandler({ intermediates: " ", final: "@" }, (C) =>
                          this.scrollLeft(C),
                        ),
                        this._parser.registerCsiHandler({ final: "A" }, (C) => this.cursorUp(C)),
                        this._parser.registerCsiHandler({ intermediates: " ", final: "A" }, (C) =>
                          this.scrollRight(C),
                        ),
                        this._parser.registerCsiHandler({ final: "B" }, (C) => this.cursorDown(C)),
                        this._parser.registerCsiHandler({ final: "C" }, (C) =>
                          this.cursorForward(C),
                        ),
                        this._parser.registerCsiHandler({ final: "D" }, (C) =>
                          this.cursorBackward(C),
                        ),
                        this._parser.registerCsiHandler({ final: "E" }, (C) =>
                          this.cursorNextLine(C),
                        ),
                        this._parser.registerCsiHandler({ final: "F" }, (C) =>
                          this.cursorPrecedingLine(C),
                        ),
                        this._parser.registerCsiHandler({ final: "G" }, (C) =>
                          this.cursorCharAbsolute(C),
                        ),
                        this._parser.registerCsiHandler({ final: "H" }, (C) =>
                          this.cursorPosition(C),
                        ),
                        this._parser.registerCsiHandler({ final: "I" }, (C) =>
                          this.cursorForwardTab(C),
                        ),
                        this._parser.registerCsiHandler({ final: "J" }, (C) =>
                          this.eraseInDisplay(C, !1),
                        ),
                        this._parser.registerCsiHandler({ prefix: "?", final: "J" }, (C) =>
                          this.eraseInDisplay(C, !0),
                        ),
                        this._parser.registerCsiHandler({ final: "K" }, (C) =>
                          this.eraseInLine(C, !1),
                        ),
                        this._parser.registerCsiHandler({ prefix: "?", final: "K" }, (C) =>
                          this.eraseInLine(C, !0),
                        ),
                        this._parser.registerCsiHandler({ final: "L" }, (C) => this.insertLines(C)),
                        this._parser.registerCsiHandler({ final: "M" }, (C) => this.deleteLines(C)),
                        this._parser.registerCsiHandler({ final: "P" }, (C) => this.deleteChars(C)),
                        this._parser.registerCsiHandler({ final: "S" }, (C) => this.scrollUp(C)),
                        this._parser.registerCsiHandler({ final: "T" }, (C) => this.scrollDown(C)),
                        this._parser.registerCsiHandler({ final: "X" }, (C) => this.eraseChars(C)),
                        this._parser.registerCsiHandler({ final: "Z" }, (C) =>
                          this.cursorBackwardTab(C),
                        ),
                        this._parser.registerCsiHandler({ final: "`" }, (C) =>
                          this.charPosAbsolute(C),
                        ),
                        this._parser.registerCsiHandler({ final: "a" }, (C) =>
                          this.hPositionRelative(C),
                        ),
                        this._parser.registerCsiHandler({ final: "b" }, (C) =>
                          this.repeatPrecedingCharacter(C),
                        ),
                        this._parser.registerCsiHandler({ final: "c" }, (C) =>
                          this.sendDeviceAttributesPrimary(C),
                        ),
                        this._parser.registerCsiHandler({ prefix: ">", final: "c" }, (C) =>
                          this.sendDeviceAttributesSecondary(C),
                        ),
                        this._parser.registerCsiHandler({ final: "d" }, (C) =>
                          this.linePosAbsolute(C),
                        ),
                        this._parser.registerCsiHandler({ final: "e" }, (C) =>
                          this.vPositionRelative(C),
                        ),
                        this._parser.registerCsiHandler({ final: "f" }, (C) => this.hVPosition(C)),
                        this._parser.registerCsiHandler({ final: "g" }, (C) => this.tabClear(C)),
                        this._parser.registerCsiHandler({ final: "h" }, (C) => this.setMode(C)),
                        this._parser.registerCsiHandler({ prefix: "?", final: "h" }, (C) =>
                          this.setModePrivate(C),
                        ),
                        this._parser.registerCsiHandler({ final: "l" }, (C) => this.resetMode(C)),
                        this._parser.registerCsiHandler({ prefix: "?", final: "l" }, (C) =>
                          this.resetModePrivate(C),
                        ),
                        this._parser.registerCsiHandler({ final: "m" }, (C) =>
                          this.charAttributes(C),
                        ),
                        this._parser.registerCsiHandler({ final: "n" }, (C) =>
                          this.deviceStatus(C),
                        ),
                        this._parser.registerCsiHandler({ prefix: "?", final: "n" }, (C) =>
                          this.deviceStatusPrivate(C),
                        ),
                        this._parser.registerCsiHandler({ intermediates: "!", final: "p" }, (C) =>
                          this.softReset(C),
                        ),
                        this._parser.registerCsiHandler({ intermediates: " ", final: "q" }, (C) =>
                          this.setCursorStyle(C),
                        ),
                        this._parser.registerCsiHandler({ final: "r" }, (C) =>
                          this.setScrollRegion(C),
                        ),
                        this._parser.registerCsiHandler({ final: "s" }, (C) => this.saveCursor(C)),
                        this._parser.registerCsiHandler({ final: "t" }, (C) =>
                          this.windowOptions(C),
                        ),
                        this._parser.registerCsiHandler({ final: "u" }, (C) =>
                          this.restoreCursor(C),
                        ),
                        this._parser.registerCsiHandler({ intermediates: "'", final: "}" }, (C) =>
                          this.insertColumns(C),
                        ),
                        this._parser.registerCsiHandler({ intermediates: "'", final: "~" }, (C) =>
                          this.deleteColumns(C),
                        ),
                        this._parser.registerCsiHandler({ intermediates: '"', final: "q" }, (C) =>
                          this.selectProtected(C),
                        ),
                        this._parser.registerCsiHandler({ intermediates: "$", final: "p" }, (C) =>
                          this.requestMode(C, !0),
                        ),
                        ...
                        this._parser.registerOscHandler(
                          0,
                          new p.OscHandler((C) => (this.setTitle(C), this.setIconName(C), !0)),
                        ),
                        this._parser.registerOscHandler(
                          1,
                          new p.OscHandler((C) => this.setIconName(C)),
                        ),
                        this._parser.registerOscHandler(
                          2,
                          new p.OscHandler((C) => this.setTitle(C)),
                        ),
                        this._parser.registerOscHandler(
                          4,
                          new p.OscHandler((C) => this.setOrReportIndexedColor(C)),
                        ),
                        this._parser.registerOscHandler(
                          8,
                          new p.OscHandler((C) => this.setHyperlink(C)),
                        ),
                        this._parser.registerOscHandler(
                          10,
                          new p.OscHandler((C) => this.setOrReportFgColor(C)),
                        ),
                        this._parser.registerOscHandler(
                          11,
                          new p.OscHandler((C) => this.setOrReportBgColor(C)),
                        ),
                        this._parser.registerOscHandler(
                          12,
                          new p.OscHandler((C) => this.setOrReportCursorColor(C)),
                        ),
                        this._parser.registerOscHandler(
                          104,
                          new p.OscHandler((C) => this.restoreIndexedColor(C)),
                        ),
                        this._parser.registerOscHandler(
                          110,
                          new p.OscHandler((C) => this.restoreFgColor(C)),
                        ),
                        this._parser.registerOscHandler(
                          111,
                          new p.OscHandler((C) => this.restoreBgColor(C)),
                        ),
                        this._parser.registerOscHandler(
                          112,
                          new p.OscHandler((C) => this.restoreCursorColor(C)),
                        ),
                      ...
                      for (const C in d.CHARSETS)
                        (this._parser.registerEscHandler({ intermediates: "(", final: C }, () =>
                      ...
                      (this._parser.registerEscHandler({ intermediates: "#", final: "8" }, () =>
                        ...
                        this._parser.setErrorHandler(
                          (C) => (this._logService.error("Parsing error: ", C), C),
                        ),
                        this._parser.registerDcsHandler(
                          { intermediates: "$", final: "q" },
                          new c.DcsHandler((C, A) => this.requestStatusString(C, A)),
                        ));
                    }
                    _preserveStack(S, w, y, L) {
                      ((this._parseStack.paused = !0),
                        (this._parseStack.cursorStartX = S),
                        (this._parseStack.cursorStartY = w),
                        (this._parseStack.decodedLength = y),
                        (this._parseStack.position = L));
                    }
                    _logSlowResolvingAsync(S) {
                      this._logService.logLevel <= f.LogLevelEnum.WARN &&
                        Promise.race([
                          S,
                          new Promise((w, y) => setTimeout(() => y("#SLOW_TIMEOUT"), 5e3)),
                        ]).catch((w) => {
                    ...
                    parse(S, w) {
                      let y,
                        L = this._activeBuffer.x,
                        B = this._activeBuffer.y,
                        H = 0;
                      ...
                      if (N) {
                        ...
                        ((L = this._parseStack.cursorStartX),
                          (B = this._parseStack.cursorStartY),
                          (this._parseStack.paused = !1),
                          S.length > k && (H = this._parseStack.position + k));
                      }
                      if (
                        (this._logService.logLevel <= f.LogLevelEnum.DEBUG &&
                          this._logService.debug(
                            ...
                            typeof S == "string" ? S.split("").map((C) => C.charCodeAt(0)) : S,
                          ),
                        this._parseBuffer.length < S.length &&
                          this._parseBuffer.length < k &&
                          (this._parseBuffer = new Uint32Array(Math.min(S.length, k))),
                        N || this._dirtyRowTracker.clearRange(),
                        S.length > k)
                      )
                        for (let C = H; C < S.length; C += k) {
                          const A = C + k < S.length ? C + k : S.length,
                            O =
                              typeof S == "string"
                                ? this._stringDecoder.decode(S.substring(C, A), this._parseBuffer)
                                : this._utf8Decoder.decode(S.subarray(C, A), this._parseBuffer);
                          if ((y = this._parser.parse(this._parseBuffer, O)))
                            return (
                              this._preserveStack(L, B, O, C),
                        ...
                        if ((y = this._parser.parse(this._parseBuffer, C)))
                          return (
                            this._preserveStack(L, B, C, 0),
                            this._logSlowResolvingAsync(y),
                            y
                          );
                      }
                      (this._activeBuffer.x === L && this._activeBuffer.y === B) ||
                      ...
                      const $ =
                        ...
                        R =
                          ...
                          (this._bufferService.buffer.ybase - this._bufferService.buffer.ydisp);
                      R < this._bufferService.rows &&
                        this._onRequestRefreshRows.fire(
                          Math.min(R, this._bufferService.rows - 1),
                          Math.min($, this._bufferService.rows - 1),
                        );
                    }
                    print(S, w, y) {
                      let L, B;
                      const H = this._charsetService.charset,
                        N = this._optionsService.rawOptions.screenReaderMode,
                        $ = this._bufferService.cols,
                        R = this._coreService.decPrivateModes.wraparound,
                        C = this._coreService.modes.insertMode,
                        A = this._curAttrData;
                      let O = this._activeBuffer.lines.get(
                        this._activeBuffer.ybase + this._activeBuffer.y,
                      );
                      (this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                        this._activeBuffer.x &&
                          y - w > 0 &&
                          O.getWidth(this._activeBuffer.x - 1) === 2 &&
                          O.setCellFromCodepoint(this._activeBuffer.x - 1, 0, 1, A));
                      let W = this._parser.precedingJoinState;
                      for (let F = w; F < y; ++F) {
                        if (((L = S[F]), L < 127 && H)) {
                          const X = H[String.fromCharCode(L)];
                          X && (L = X.charCodeAt(0));
                        }
                        const z = this._unicodeService.charProperties(L, W);
                        B = u.UnicodeService.extractWidth(z);
                        const q = u.UnicodeService.extractShouldJoin(z),
                          V = q ? u.UnicodeService.extractWidth(W) : 0;
                        if (
                          ((W = z),
                          N && this._onA11yChar.fire((0, h.stringFromCodePoint)(L)),
                          this._getCurrentLinkId() &&
                            this._oscLinkService.addLineToLink(
                              this._getCurrentLinkId(),
                              this._activeBuffer.ybase + this._activeBuffer.y,
                            ),
                          this._activeBuffer.x + B - V > $)
                        ) {
                          if (R) {
                            const X = O;
                            ...
                            for (
                              this._activeBuffer.x = V,
                                ...
                                O = this._activeBuffer.lines.get(
                                  this._activeBuffer.ybase + this._activeBuffer.y,
                                ),
                                V > 0 &&
                                  O instanceof i.BufferLine &&
                                  O.copyCellsFrom(X, j, 0, V, !1);
                              j < $;
                            )
                              X.setCellFromCodepoint(j++, 0, 1, A);
                          } else if (((this._activeBuffer.x = $ - 1), B === 2)) continue;
                        }
                        if (q && this._activeBuffer.x) {
                          const X = O.getWidth(this._activeBuffer.x - 1) ? 1 : 2;
                          O.addCodepointToCell(this._activeBuffer.x - X, L, B);
                          for (let j = B - V; --j >= 0;)
                            O.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, A);
                        } else if (
                          (C &&
                            (O.insertCells(
                              this._activeBuffer.x,
                              B - V,
                              this._activeBuffer.getNullCell(A),
                            ),
                            O.getWidth($ - 1) === 2 &&
                              O.setCellFromCodepoint(
                                $ - 1,
                                e.NULL_CELL_CODE,
                                e.NULL_CELL_WIDTH,
                                A,
                              )),
                          O.setCellFromCodepoint(this._activeBuffer.x++, L, B, A),
                          B > 0)
                        )
                          for (; --B;) O.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, A);
                      }
                      ((this._parser.precedingJoinState = W),
                        this._activeBuffer.x < $ &&
                          y - w > 0 &&
                          O.getWidth(this._activeBuffer.x) === 0 &&
                          !O.hasContent(this._activeBuffer.x) &&
                          O.setCellFromCodepoint(this._activeBuffer.x, 0, 1, A),
                        this._dirtyRowTracker.markDirty(this._activeBuffer.y));
                    }
                    registerCsiHandler(S, w) {
                      return S.final !== "t" || S.prefix || S.intermediates
                        ? this._parser.registerCsiHandler(S, w)
                        : this._parser.registerCsiHandler(
                            S,
                            (y) =>
                              !D(y.params[0], this._optionsService.rawOptions.windowOptions) ||
                              w(y),
                          );
                    }
                    registerDcsHandler(S, w) {
                      return this._parser.registerDcsHandler(S, new c.DcsHandler(w));
                    }
                    ...
                    backspace() {
                      ...
                      if (
                        (this._restrictCursor(this._bufferService.cols), this._activeBuffer.x > 0)
                      )
                        this._activeBuffer.x--;
                      else if (
                        ...
                        const S = this._activeBuffer.lines.get(
                          this._activeBuffer.ybase + this._activeBuffer.y,
                        );
                        S.hasWidth(this._activeBuffer.x) &&
                          !S.hasContent(this._activeBuffer.x) &&
                          this._activeBuffer.x--;
                      }
                    ...
                    _restrictCursor(S = this._bufferService.cols - 1) {
                      ((this._activeBuffer.x = Math.min(S, Math.max(0, this._activeBuffer.x))),
                      ...
                      (this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                        this._coreService.decPrivateModes.origin
                          ? ((this._activeBuffer.x = S),
                            (this._activeBuffer.y = this._activeBuffer.scrollTop + w))
                          : ((this._activeBuffer.x = S), (this._activeBuffer.y = w)),
                        this._restrictCursor(),
                        this._dirtyRowTracker.markDirty(this._activeBuffer.y));
                    }
                    _moveCursor(S, w) {
                      (this._restrictCursor(),
                        this._setCursor(this._activeBuffer.x + S, this._activeBuffer.y + w));
                    }
                    cursorUp(S) {
                      const w = this._activeBuffer.y - this._activeBuffer.scrollTop;
                      return (
                        w >= 0
                          ? this._moveCursor(0, -Math.min(w, S.params[0] || 1))
                    ...
                    selectProtected(S) {
                      const w = S.params[0];
                      return (
                        w === 1 && (this._curAttrData.bg |= 536870912),
                        (w !== 2 && w !== 0) || (this._curAttrData.bg &= -536870913),
                        !0
                      );
                    }
                    _eraseInBufferLine(S, w, y, L = !1, B = !1) {
                    ...
                    _resetBufferLine(S, w = !1) {
                      const y = this._activeBuffer.lines.get(this._activeBuffer.ybase + S);
                      y &&
                        (y.fill(this._activeBuffer.getNullCell(this._eraseAttrData()), w),
                        this._bufferService.buffer.clearMarkers(this._activeBuffer.ybase + S),
                        (y.isWrapped = !1));
                    }
                      ...
                      switch ((this._restrictCursor(this._bufferService.cols), S.params[0])) {
                        ...
                        case 1:
                          for (
                            y = this._activeBuffer.y,
                              this._dirtyRowTracker.markDirty(y),
                              this._eraseInBufferLine(y, 0, this._activeBuffer.x + 1, !0, w),
                        ...
                        case 2:
                          for (
                            y = this._bufferService.rows, this._dirtyRowTracker.markDirty(y - 1);
                            y--;
                          )
                            this._resetBufferLine(y, w);
                          this._dirtyRowTracker.markDirty(0);
                        ...
                        case 3:
                          ...
                          L > 0 &&
                            (this._activeBuffer.lines.trimStart(L),
                            (this._activeBuffer.ybase = Math.max(this._activeBuffer.ybase - L, 0)),
                            (this._activeBuffer.ydisp = Math.max(this._activeBuffer.ydisp - L, 0)),
                    ...
                    insertLines(S) {
                      ...
                      const y = this._activeBuffer.ybase + this._activeBuffer.y,
                        L = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom,
                        B = this._bufferService.rows - 1 + this._activeBuffer.ybase - L + 1;
                      for (; w--;)
                    ...
                    deleteLines(S) {
                      ...
                      for (
                        L = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom,
                          L = this._bufferService.rows - 1 + this._activeBuffer.ybase - L;
                        w--;
                      )
                    ...
                    insertChars(S) {
                      this._restrictCursor();
                      const w = this._activeBuffer.lines.get(
                        this._activeBuffer.ybase + this._activeBuffer.y,
                      );
                      return (
                        w &&
                      ...
                      for (; w--;)
                        (this._activeBuffer.lines.splice(
                          ...
                          this._activeBuffer.lines.splice(
                            this._activeBuffer.ybase + this._activeBuffer.scrollTop,
                            0,
                            this._activeBuffer.getBlankLine(i.DEFAULT_ATTR_DATA),
                          ));
                      return (
                        this._dirtyRowTracker.markRangeDirty(
                          this._activeBuffer.scrollTop,
                    ...
                    scrollLeft(S) {
                      ...
                      for (
                        ...
                        const L = this._activeBuffer.lines.get(this._activeBuffer.ybase + y);
                        (L.deleteCells(0, w, this._activeBuffer.getNullCell(this._eraseAttrData())),
                          (L.isWrapped = !1));
                      }
                      return (
                        this._dirtyRowTracker.markRangeDirty(
                    ...
                    scrollRight(S) {
                      ...
                      for (
                        ...
                        const L = this._activeBuffer.lines.get(this._activeBuffer.ybase + y);
                        (L.insertCells(0, w, this._activeBuffer.getNullCell(this._eraseAttrData())),
                          (L.isWrapped = !1));
                      }
                      return (
                        this._dirtyRowTracker.markRangeDirty(
                    ...
                    repeatPrecedingCharacter(S) {
                      ...
                      const y = S.params[0] || 1,
                        L = u.UnicodeService.extractWidth(w),
                        B = this._activeBuffer.x - L,
                        H = this._activeBuffer.lines
                          .get(this._activeBuffer.ybase + this._activeBuffer.y)
                          .getString(B),
                        N = new Uint32Array(H.length * y);
                      let $ = 0;
                      for (let C = 0; C < H.length;) {
                        const A = H.codePointAt(C) || 0;
                        ((N[$++] = A), (C += A > 65535 ? 2 : 1));
                      }
                      let R = $;
                      for (let C = 1; C < y; ++C) (N.copyWithin(R, 0, $), (R += $));
                      return (this.print(N, 0, R), !0);
                    }
                        ...
                        S.params[0] > 0 ||
                          (this._is("xterm")
                            ...
                            : this._is("rxvt-unicode")
                              ...
                              : this._is("linux")
                                ? this._coreService.triggerDataEvent(S.params[0] + "c")
                                : this._is("screen") &&
                        ...
                        switch (S.params[w]) {
                          ...
                          case 1047:
                            (this._bufferService.buffers.activateNormalBuffer(),
                              S.params[w] === 1049 && this.restoreCursor(),
                              (this._coreService.isCursorInitialized = !0),
                              this._onRequestRefreshRows.fire(0, this._bufferService.rows - 1),
                              this._onRequestSyncScrollBar.fire());
                            break;
                    ...
                    requestMode(S, w) {
                      const y = this._coreService.decPrivateModes,
                        { activeProtocol: L, activeEncoding: B } = this._coreMouseService,
                        H = this._coreService,
                        { buffers: N, cols: $ } = this._bufferService,
                        { active: R, alt: C } = N,
                            ...
                            : W === 4
                              ...
                              : W === 12
                                ...
                                : W === 20
                                  ...
                                  : 0
                          : W === 1
                            ? O(y.applicationCursorKeys)
                            : W === 3
                              ? A.windowOptions.setWinLines
                                ? $ === 80
                                  ? 2
                                  : $ === 132
                                    ? 1
                                    ...
                                    : W === 9
                                      ...
                                      : W === 12
                                        ...
                                        : W === 25
                                          ? O(!H.isCursorHidden)
                                          : W === 45
                                            ? O(y.reverseWraparound)
                                            : W === 66
                                              ? O(y.applicationKeypad)
                                              : W === 67
                                                ? 4
                                                : W === 1e3
                                                  ? O(L === "VT200")
                                                              ...
                                                              : W === 1016
                                                                ...
                                                                : W === 1048
                                                                  ...
                                                                  : W === 47 ||
                                                                    ...
                                                                    ? O(R === C)
                                                                    : W === 2004
                                                                      ? O(y.bracketedPasteMode)
                                                                      : 0),
                        H.triggerDataEvent(`${n.C0.ESC}[${w ? "" : "?"}${F};${z}$y`),
                        !0
                      );
                      var F, z;
                    }
                    _updateAttrColor(S, w, y, L, B) {
                      return (
                        w === 2
                          ? ((S |= 50331648),
                            (S &= -16777216),
                            (S |= a.AttributeData.fromColorRGB([y, L, B])))
                          : w === 5 && ((S &= -50331904), (S |= 33554432 | (255 & y))),
                        S
                      );
                    }
                    _extractColor(S, w, y) {
                      ...
                      let B = 0,
                        H = 0;
                      do {
                        if (((L[H + B] = S.params[w + H]), S.hasSubParams(w + H))) {
                          const N = S.getSubParams(w + H);
                          let $ = 0;
                          do (L[1] === 5 && (B = 1), (L[H + $ + 1 + B] = N[$]));
                          while (++$ < N.length && $ + H + 1 + B < L.length);
                          break;
                        }
                        if ((L[1] === 5 && H + B >= 2) || (L[1] === 2 && H + B >= 5)) break;
                        L[1] && (B = 1);
                      } while (++H + w < S.length && H + B < L.length);
                      for (let N = 2; N < L.length; ++N) L[N] === -1 && (L[N] = 0);
                      switch (L[0]) {
                        case 38:
                          y.fg = this._updateAttrColor(y.fg, L[1], L[3], L[4], L[5]);
                          break;
                        case 48:
                          y.bg = this._updateAttrColor(y.bg, L[1], L[3], L[4], L[5]);
                          break;
                        case 58:
                    ...
                    _processUnderline(S, w) {
                      ((w.extended = w.extended.clone()),
                        (!~S || S > 5) && (S = 1),
                        (w.extended.underlineStyle = S),
                        (w.fg |= 268435456),
                        S === 0 && (w.fg &= -268435457),
                        w.updateExtended());
                    }
                    _processSGR0(S) {
                      ((S.fg = i.DEFAULT_ATTR_DATA.fg),
                        (S.bg = i.DEFAULT_ATTR_DATA.bg),
                    ...
                    charAttributes(S) {
                      ...
                      for (let B = 0; B < w; B++)
                        ((y = S.params[B]),
                          y >= 30 && y <= 37
                            ? ((L.fg &= -50331904), (L.fg |= 16777216 | (y - 30)))
                            : y >= 40 && y <= 47
                              ? ((L.bg &= -50331904), (L.bg |= 16777216 | (y - 40)))
                              : y >= 90 && y <= 97
                                ? ((L.fg &= -50331904), (L.fg |= 16777224 | (y - 90)))
                                : y >= 100 && y <= 107
                                  ? ((L.bg &= -50331904), (L.bg |= 16777224 | (y - 100)))
                                  : y === 0
                                    ? this._processSGR0(L)
                                    : y === 1
                                      ? (L.fg |= 134217728)
                                        ...
                                        : y === 4
                                          ? ((L.fg |= 268435456),
                                            this._processUnderline(
                                              S.hasSubParams(B) ? S.getSubParams(B)[0] : 1,
                                              L,
                                            ))
                                          : y === 5
                                            ? (L.fg |= 536870912)
                                                                  ...
                                                                  : y === 29
                                                                    ...
                                                                    : y === 39
                                                                      ? ((L.fg &= -67108864),
                                                                        (L.fg |=
                                                                          16777215 &
                                                                          i.DEFAULT_ATTR_DATA.fg))
                                                                      : y === 49
                                                                        ? ((L.bg &= -67108864),
                                                                          (L.bg |=
                                                                            16777215 &
                                                                            i.DEFAULT_ATTR_DATA.bg))
                                                                        : y === 38 ||
                                                                            y === 48 ||
                                                                            y === 58
                                                                          ? (B +=
                    ...
                    deviceStatus(S) {
                      switch (S.params[0]) {
                        case 5:
                          ...
                          break;
                        case 6:
                          const w = this._activeBuffer.y + 1,
                            y = this._activeBuffer.x + 1;
                          this._coreService.triggerDataEvent(`${n.C0.ESC}[${w};${y}R`);
                      }
                      return !0;
                    }
                    ...
                    setScrollRegion(S) {
                      ...
                      let y;
                      return (
                        (S.length < 2 || (y = S.params[1]) > this._bufferService.rows || y === 0) &&
                          (y = this._bufferService.rows),
                        y > w &&
                          ((this._activeBuffer.scrollTop = w - 1),
                    ...
                    windowOptions(S) {
                      if (!D(S.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
                      const w = S.length > 1 ? S.params[1] : 0;
                      switch (S.params[0]) {
                        case 14:
                          w !== 2 &&
                            this._onRequestWindowsOptionsReport.fire(b.GET_WIN_SIZE_PIXELS);
                          break;
                        case 16:
                    ...
                    setOrReportIndexedColor(S) {
                      ...
                      for (; y.length > 1;) {
                        ...
                        if (/^\d+$/.exec(L)) {
                          const H = parseInt(L);
                          if (U(H))
                            if (B === "?") w.push({ type: 0, index: H });
                            else {
                              const N = (0, m.parseColor)(B);
                    ...
                    setHyperlink(S) {
                      ...
                      return (
                        !(w.length < 2) &&
                        (w[1]
                          ? this._createHyperlink(w[0], w[1])
                          : !w[0] && this._finishHyperlink())
                      );
                    }
                    _createHyperlink(S, w) {
                      ...
                      const y = S.split(":");
                      let L;
                      const B = y.findIndex((H) => H.startsWith("id="));
                      return (
                        B !== -1 && (L = y[B].slice(3) || void 0),
                    ...
                    _setOrReportSpecialColor(S, w) {
                      const y = S.split(";");
                      for (let L = 0; L < y.length && !(w >= this._specialColors.length); ++L, ++w)
                        if (y[L] === "?")
                          this._onColor.fire([{ type: 0, index: this._specialColors[w] }]);
                        else {
                          const B = (0, m.parseColor)(y[L]);
                          B &&
                            this._onColor.fire([
                              { type: 1, index: this._specialColors[w], color: B },
                            ]);
                        }
                      return !0;
                    }
                    ...
                    restoreIndexedColor(S) {
                      ...
                      for (let L = 0; L < y.length; ++L)
                        if (/^\d+$/.exec(y[L])) {
                          const B = parseInt(y[L]);
                          U(B) && w.push({ type: 2, index: B });
                        }
                      return (w.length && this._onColor.fire(w), !0);
                    }
                    restoreFgColor(S) {
                    ...
                    screenAlignmentPattern() {
                      ...
                      for (let w = 0; w < this._bufferService.rows; ++w) {
                        const y = this._activeBuffer.ybase + this._activeBuffer.y + w,
                          L = this._activeBuffer.lines.get(y);
                    ...
                    requestStatusString(S, w) {
                      const y = this._bufferService.buffer,
                        L = this._optionsService.rawOptions;
                      return ((B) => (
                        this._coreService.triggerDataEvent(`${n.C0.ESC}${B}${n.C0.ESC}\\`),
                        !0
                      ))(
                        S === '"q'
                          ...
                          : S === '"p'
                            ...
                            : S === "r"
                              ...
                              : S === "m"
                                ? "P1$r0m"
                                : S === " q"
                                  ? `P1$r${{ block: 2, underline: 4, bar: 6 }[L.cursorStyle] - (L.cursorBlink ? 1 : 0)} q`
                                  : "P0$r",
                      );
                    }
                    markRangeDirty(S, w) {
                ...
                1505: (T, r) => {
                  ...
                  ((r.TwoKeyMap = o),
                    (r.FourKeyMap = class {
                      ...
                      set(l, _, n, d, v) {
                        (this._data.get(l, _) || this._data.set(l, _, new o()),
                          this._data.get(l, _).set(n, d, v));
                      }
                      get(l, _, n, d) {
                        return this._data.get(l, _)?.get(n, d);
                      }
                      clear() {
                        this._data.clear();
                      }
                ...
                6114: (T, r) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    (r.isChromeOS =
                      ...
                      r.isNode =
                        void 0),
                    (r.isNode = typeof process < "u" && "title" in process));
                  const o = r.isNode ? "node" : navigator.userAgent,
                    l = r.isNode ? "node" : navigator.platform;
                  ((r.isFirefox = o.includes("Firefox")),
                    (r.isLegacyEdge = o.includes("Edge")),
                    (r.isSafari = /^((?!chrome|android).)*safari/i.test(o)),
                    (r.getSafariVersion = function () {
                      if (!r.isSafari) return 0;
                      const _ = o.match(/Version\/(\d+)/);
                      return _ === null || _.length < 2 ? 0 : parseInt(_[1]);
                    }),
                    (r.isMac = ["Macintosh", "MacIntel", "MacPPC", "Mac68K"].includes(l)),
                    (r.isIpad = l === "iPad"),
                    (r.isIphone = l === "iPhone"),
                    (r.isWindows = ["Windows", "Win16", "Win32", "WinCE"].includes(l)),
                    (r.isLinux = l.indexOf("Linux") >= 0),
                    (r.isChromeOS = /\bCrOS\b/.test(o)));
                },
                6106: (T, r) => {
                  ...
                  r.SortedList = class {
                    ...
                    delete(l) {
                      ...
                      if (
                        _ === void 0 ||
                        ((o = this._search(_)), o === -1) ||
                        this._getKey(this._array[o]) !== _
                      )
                        return !1;
                      ...
                      for (; this._i < this._tasks.length;) {
                        if (
                          ...
                          return (
                            i - g < -20 &&
                              console.warn(
                                `task queue exceeded allotted deadline by ${Math.abs(Math.round(i - g))}ms`,
                              ),
                            void this._start()
                          );
                        i = s;
                ...
                9282: (T, r, o) => {
                  ...
                  r.updateWindowsModeWrappedState = function (_) {
                    const n = _.buffer.lines.get(_.buffer.ybase + _.buffer.y - 1),
                      d = n?.get(_.cols - 1),
                      v = _.buffer.lines.get(_.buffer.ybase + _.buffer.y);
                    v &&
                      d &&
                      (v.isWrapped =
                        d[l.CHAR_DATA_CODE_INDEX] !== l.NULL_CELL_CODE &&
                        d[l.CHAR_DATA_CODE_INDEX] !== l.WHITESPACE_CELL_CODE);
                  };
                },
                3734: (T, r) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.Buffer = class {
                      constructor(e, t, a) {
                        ((this._hasScrollback = e),
                          ...
                          (this._isClearing = !1),
                          (this._memoryCleanupQueue = new _.IdleTaskQueue()),
                      ...
                      resize(e, t) {
                        ...
                        if (
                          (u > this.lines.maxLength && (this.lines.maxLength = u),
                          this.lines.length > 0)
                        ) {
                          if (this._cols < e)
                            for (let c = 0; c < this.lines.length; c++)
                              f += +this.lines.get(c).resize(e, a);
                          let p = 0;
                          if (this._rows < t)
                            for (let c = this._rows; c < t; c++)
                              this.lines.length < t + this.ybase &&
                                ...
                                this._optionsService.rawOptions.windowsPty.buildNumber !== void 0
                                  ? this.lines.push(new d.BufferLine(e, a))
                                  : this.ybase > 0 &&
                                      this.lines.length <= this.ybase + this.y + p + 1
                                    ? (this.ybase--, p++, this.ydisp > 0 && this.ydisp--)
                                    : this.lines.push(new d.BufferLine(e, a)));
                          else
                            for (let c = this._rows; c > t; c--)
                              this.lines.length > t + this.ybase &&
                      ...
                      _reflowLarger(e, t) {
                        const a = (0, v.reflowLargerGetLinesToRemove)(
                          this.lines,
                          this._cols,
                          e,
                          this.ybase + this.y,
                        ...
                        if (a.length > 0) {
                          const f = (0, v.reflowLargerCreateNewLayout)(this.lines, a);
                          ((0, v.reflowLargerApplyNewLayout)(this.lines, f.layout),
                            this._reflowLargerAdjustViewport(e, t, f.countRemoved));
                        }
                      }
                      _reflowLargerAdjustViewport(e, t, a) {
                        ...
                        for (; u-- > 0;)
                          this.ybase === 0
                            ? (this.y > 0 && this.y--,
                              this.lines.length < t && this.lines.push(new d.BufferLine(e, f)))
                      ...
                      _reflowSmaller(e, t) {
                        ...
                        for (let p = this.lines.length - 1; p >= 0; p--) {
                          ...
                          if (E >= p && E < p + m.length) continue;
                          const k = m[m.length - 1].getTrimmedLength(),
                            D = (0, v.reflowSmallerGetNewLineLengths)(m, this._cols, e),
                            b = D.length - m.length;
                          let x;
                          x =
                          ...
                          const M = [];
                          for (let y = 0; y < b; y++) {
                            const L = this.getBlankLine(d.DEFAULT_ATTR_DATA, !0);
                            M.push(L);
                          }
                          (M.length > 0 &&
                            (f.push({ start: p + m.length + u, newLines: M }), (u += M.length)),
                            m.push(...M));
                          let I = D.length - 1,
                            U = D[I];
                          U === 0 && (I--, (U = D[I]));
                          let P = m.length - b - 1,
                            S = k;
                          for (; P >= 0;) {
                            const y = Math.min(S, U);
                            if (m[I] === void 0) break;
                            if (
                              (m[I].copyCellsFrom(m[P], S - y, U - y, y, !0),
                              (U -= y),
                              U === 0 && (I--, (U = D[I])),
                              (S -= y),
                              S === 0)
                              ...
                              P--;
                              const L = Math.max(P, 0);
                              S = (0, v.getWrappedLineTrimmedLength)(m, L, this._cols);
                            }
                          }
                          for (let y = 0; y < m.length; y++) D[y] < e && m[y].setCell(D[y], a);
                          let w = b - x;
                          for (; w-- > 0;)
                            this.ybase === 0
                              ? this.y < t - 1
                                ...
                                : (this.ybase++, this.ydisp++)
                              : this.ybase <
                                  Math.min(this.lines.maxLength, this.lines.length + u) - t &&
                        ...
                        if (f.length > 0) {
                          const p = [],
                            c = [];
                          for (let I = 0; I < this.lines.length; I++) c.push(this.lines.get(I));
                          ...
                          let b = 0;
                          for (let I = Math.min(this.lines.maxLength - 1, m + u - 1); I >= 0; I--)
                            if (D && D.start > E + b) {
                              for (let U = D.newLines.length - 1; U >= 0; U--)
                                this.lines.set(I--, D.newLines[U]);
                              (I++,
                                p.push({ index: E + 1, amount: D.newLines.length }),
                                (b += D.newLines.length),
                                (D = f[++k]));
                            } else this.lines.set(I, c[E--]);
                          let x = 0;
                          for (let I = p.length - 1; I >= 0; I--)
                            ((p[I].index += x),
                              this.lines.onInsertEmitter.fire(p[I]),
                              (x += p[I].amount));
                      ...
                      addMarker(e) {
                        ...
                        return (
                          ...
                          t.register(
                            this.lines.onInsert((a) => {
                              t.line >= a.index && (t.line += a.amount);
                            }),
                          ),
                          t.register(
                            this.lines.onDelete((a) => {
                              (t.line >= a.index && t.line < a.index + a.amount && t.dispose(),
                                t.line > a.index && (t.line -= a.amount));
                            }),
                          ),
                  ...
                  class g {
                    constructor(i, s, e = !1) {
                      ((this.isWrapped = e),
                        (this._combined = {}),
                        (this._extendedAttrs = {}),
                        (this._data = new Uint32Array(3 * i)));
                      const t =
                        s ||
                    ...
                    get(i) {
                      ...
                      return [
                        this._data[3 * i + 1],
                        2097152 & s ? this._combined[i] : e ? (0, d.stringFromCodePoint)(e) : "",
                        s >> 22,
                        2097152 & s
                          ? this._combined[i].charCodeAt(this._combined[i].length - 1)
                          : e,
                      ];
                    }
                    set(i, s) {
                      ((this._data[3 * i + 1] = s[n.CHAR_DATA_ATTR_INDEX]),
                        s[n.CHAR_DATA_CHAR_INDEX].length > 1
                          ? ((this._combined[i] = s[1]),
                            (this._data[3 * i + 0] =
                              2097152 | i | (s[n.CHAR_DATA_WIDTH_INDEX] << 22)))
                          : (this._data[3 * i + 0] =
                              s[n.CHAR_DATA_CHAR_INDEX].charCodeAt(0) |
                              (s[n.CHAR_DATA_WIDTH_INDEX] << 22)));
                    }
                    getWidth(i) {
                    ...
                    getString(i) {
                      ...
                      return 2097152 & s
                        ? this._combined[i]
                        : 2097151 & s
                          ? (0, d.stringFromCodePoint)(2097151 & s)
                          : "";
                    }
                    isProtected(i) {
                    ...
                    loadCell(i, s) {
                      return (
                        (v = 3 * i),
                        (s.content = this._data[v + 0]),
                        (s.fg = this._data[v + 1]),
                        (s.bg = this._data[v + 2]),
                        2097152 & s.content && (s.combinedData = this._combined[i]),
                        268435456 & s.bg && (s.extended = this._extendedAttrs[i]),
                        s
                      );
                    }
                    setCell(i, s) {
                      (2097152 & s.content && (this._combined[i] = s.combinedData),
                        268435456 & s.bg && (this._extendedAttrs[i] = s.extended),
                        (this._data[3 * i + 0] = s.content),
                        (this._data[3 * i + 1] = s.fg),
                        (this._data[3 * i + 2] = s.bg));
                    }
                    setCellFromCodepoint(i, s, e, t) {
                      (268435456 & t.bg && (this._extendedAttrs[i] = t.extended),
                        (this._data[3 * i + 0] = s | (e << 22)),
                        (this._data[3 * i + 1] = t.fg),
                        (this._data[3 * i + 2] = t.bg));
                    }
                    addCodepointToCell(i, s, e) {
                      let t = this._data[3 * i + 0];
                      (2097152 & t
                        ? (this._combined[i] += (0, d.stringFromCodePoint)(s))
                        : 2097151 & t
                          ? ((this._combined[i] =
                    ...
                    insertCells(i, s, e) {
                      if (
                        ((i %= this.length) &&
                          this.getWidth(i - 1) === 2 &&
                          this.setCellFromCodepoint(i - 1, 0, 1, e),
                        s < this.length - i)
                      ) {
                        const t = new _.CellData();
                        for (let a = this.length - i - s - 1; a >= 0; --a)
                          this.setCell(i + s + a, this.loadCell(i + a, t));
                        for (let a = 0; a < s; ++a) this.setCell(i + a, e);
                      } else for (let t = i; t < this.length; ++t) this.setCell(t, e);
                      this.getWidth(this.length - 1) === 2 &&
                        this.setCellFromCodepoint(this.length - 1, 0, 1, e);
                    }
                    deleteCells(i, s, e) {
                      if (((i %= this.length), s < this.length - i)) {
                        const t = new _.CellData();
                        for (let a = 0; a < this.length - i - s; ++a)
                          this.setCell(i + a, this.loadCell(i + s + a, t));
                        for (let a = this.length - s; a < this.length; ++a) this.setCell(a, e);
                      } else for (let t = i; t < this.length; ++t) this.setCell(t, e);
                      (i && this.getWidth(i - 1) === 2 && this.setCellFromCodepoint(i - 1, 0, 1, e),
                        this.getWidth(i) !== 0 ||
                          this.hasContent(i) ||
                    ...
                    replaceCells(i, s, e, t = !1) {
                      if (t)
                        for (
                          ...
                          (this.isProtected(i) || this.setCell(i, e), i++);
                      else
                        for (
                          i &&
                            this.getWidth(i - 1) === 2 &&
                    ...
                    copyFrom(i) {
                      (this.length !== i.length
                        ? (this._data = new Uint32Array(i._data))
                        : this._data.set(i._data),
                        (this.length = i.length),
                        (this._combined = {}));
                      for (const s in i._combined) this._combined[s] = i._combined[s];
                      this._extendedAttrs = {};
                      for (const s in i._extendedAttrs)
                        this._extendedAttrs[s] = i._extendedAttrs[s];
                    ...
                    clone() {
                      ...
                      for (const s in this._extendedAttrs)
                        i._extendedAttrs[s] = this._extendedAttrs[s];
                      return ((i.isWrapped = this.isWrapped), i);
                    }
                    getTrimmedLength() {
                      for (let i = this.length - 1; i >= 0; --i)
                        if (4194303 & this._data[3 * i + 0])
                          return i + (this._data[3 * i + 0] >> 22);
                      return 0;
                    }
                    getNoBgTrimmedLength() {
                      for (let i = this.length - 1; i >= 0; --i)
                        if (4194303 & this._data[3 * i + 0] || 50331648 & this._data[3 * i + 2])
                          return i + (this._data[3 * i + 0] >> 22);
                      return 0;
                    }
                    copyCellsFrom(i, s, e, t, a) {
                      ...
                      if (a)
                        for (let p = t - 1; p >= 0; p--) {
                          for (let c = 0; c < 3; c++)
                            this._data[3 * (e + p) + c] = f[3 * (s + p) + c];
                          268435456 & f[3 * (s + p) + 2] &&
                            (this._extendedAttrs[e + p] = i._extendedAttrs[s + p]);
                        }
                      else
                        for (let p = 0; p < t; p++) {
                          for (let c = 0; c < 3; c++)
                    ...
                    translateToString(i, s, e, t) {
                      ((s = s ?? 0),
                        (e = e ?? this.length),
                        i && (e = Math.min(e, this.getTrimmedLength())),
                        t && (t.length = 0));
                      let a = "";
                      for (; s < e;) {
                        const f = this._data[3 * s + 0],
                          u = 2097151 & f,
                          p =
                            2097152 & f
                              ? this._combined[s]
                        ...
                        if (((a += p), t)) for (let c = 0; c < p.length; ++c) t.push(s);
                        s += f >> 22 || 1;
                      }
                      return (t && t.push(s), a);
                    }
                ...
                4634: (T, r) => {
                  function o(l, _, n) {
                    ...
                    const d = !l[_].hasContent(n - 1) && l[_].getWidth(n - 1) === 1,
                      v = l[_ + 1].getWidth(0) === 2;
                    return d && v ? n - 1 : n;
                  }
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    (r.getWrappedLineTrimmedLength =
                      ...
                      r.reflowLargerGetLinesToRemove =
                        void 0),
                    (r.reflowLargerGetLinesToRemove = function (l, _, n, d, v) {
                      const g = [];
                        ...
                        for (; f < e.length;) {
                          ...
                          (e[t].copyCellsFrom(e[f], u, a, k, !1),
                            ...
                            a === 0 &&
                              ...
                              (e[t].copyCellsFrom(e[t - 1], n - 1, a++, 1, !1),
                              e[t - 1].setCell(n - 1, v)));
                        }
                        e[t].replaceCells(a, n, v);
                        let p = 0;
                        for (
                          let c = e.length - 1;
                          c > 0 && (c > t || e[c].getTrimmedLength() === 0);
                          c--
                        )
                          p++;
                    ...
                    (r.reflowLargerCreateNewLayout = function (l, _) {
                      ...
                      for (let h = 0; h < l.length; h++)
                        if (v === h) {
                          const i = _[++d];
                          (l.onDeleteEmitter.fire({ index: h - g, amount: i }),
                            (h += i - 1),
                            (g += i),
                            (v = _[++d]));
                        } else n.push(h);
                    ...
                    (r.reflowSmallerGetNewLineLengths = function (l, _, n) {
                      const d = [],
                        v = l.map((s, e) => o(l, e, _)).reduce((s, e) => s + e);
                      let g = 0,
                        h = 0,
                        i = 0;
                      for (; i < v;) {
                  ...
                  class d extends n.AttributeData {
                    ...
                    setFromCharData(g) {
                      ...
                      if (g[_.CHAR_DATA_CHAR_INDEX].length > 2) h = !0;
                        ...
                        const i = g[_.CHAR_DATA_CHAR_INDEX].charCodeAt(0);
                        if (55296 <= i && i <= 56319) {
                          const s = g[_.CHAR_DATA_CHAR_INDEX].charCodeAt(1);
                          56320 <= s && s <= 57343
                            ? (this.content =
                      ...
                      h &&
                        ...
                        (this.content = 2097152 | (g[_.CHAR_DATA_WIDTH_INDEX] << 22)));
                    }
                    getAsCharData() {
                      return [this.fg, this.getChars(), this.getWidth(), this.getCode()];
                    }
...
`),
                    ...
                    switch (n.keyCode) {
                      case 0:
                        n.key === "UIKeyInputUpArrow"
                          ? (h.key = d ? l.C0.ESC + "OA" : l.C0.ESC + "[A")
                          : n.key === "UIKeyInputLeftArrow"
                            ? (h.key = d ? l.C0.ESC + "OD" : l.C0.ESC + "[D")
                            : n.key === "UIKeyInputRightArrow"
                              ? (h.key = d ? l.C0.ESC + "OC" : l.C0.ESC + "[C")
                              : n.key === "UIKeyInputDownArrow" &&
                                (h.key = d ? l.C0.ESC + "OB" : l.C0.ESC + "[B");
                        break;
                      case 8:
                      ...
                      case 37:
                        if (n.metaKey) break;
                        i
                          ? ((h.key = l.C0.ESC + "[1;" + (i + 1) + "D"),
                            h.key === l.C0.ESC + "[1;3D" &&
                              (h.key = l.C0.ESC + (v ? "b" : "[1;5D")))
                          : (h.key = d ? l.C0.ESC + "OD" : l.C0.ESC + "[D");
                        break;
                      case 39:
                        if (n.metaKey) break;
                        i
                          ? ((h.key = l.C0.ESC + "[1;" + (i + 1) + "C"),
                            h.key === l.C0.ESC + "[1;3C" &&
                              (h.key = l.C0.ESC + (v ? "f" : "[1;5C")))
                          : (h.key = d ? l.C0.ESC + "OC" : l.C0.ESC + "[C");
                        break;
                      case 38:
                        if (n.metaKey) break;
                        i
                          ? ((h.key = l.C0.ESC + "[1;" + (i + 1) + "A"),
                            v || h.key !== l.C0.ESC + "[1;3A" || (h.key = l.C0.ESC + "[1;5A"))
                          : (h.key = d ? l.C0.ESC + "OA" : l.C0.ESC + "[A");
                        break;
                      case 40:
                        if (n.metaKey) break;
                        i
                          ? ((h.key = l.C0.ESC + "[1;" + (i + 1) + "B"),
                            v || h.key !== l.C0.ESC + "[1;3B" || (h.key = l.C0.ESC + "[1;5B"))
                          : (h.key = d ? l.C0.ESC + "OB" : l.C0.ESC + "[B");
                        break;
                      case 45:
                      ...
                      default:
                        if (!n.ctrlKey || n.shiftKey || n.altKey || n.metaKey)
                          if ((v && !g) || !n.altKey || n.metaKey)
                            !v || n.altKey || n.ctrlKey || n.shiftKey || !n.metaKey
                              ? n.key &&
                                !n.ctrlKey &&
                                !n.altKey &&
                                !n.metaKey &&
                            ...
                            if (e) h.key = l.C0.ESC + e;
                              ...
                              h.key = l.C0.ESC + (n.ctrlKey ? l.C0.NUL : " ");
                          ...
                          n.keyCode >= 65 && n.keyCode <= 90
                            ? (h.key = String.fromCharCode(n.keyCode - 64))
                            : n.keyCode === 32
                              ? (h.key = l.C0.NUL)
                              : n.keyCode >= 51 && n.keyCode <= 55
                                ? (h.key = String.fromCharCode(n.keyCode - 51 + 27))
                                : n.keyCode === 56
                                  ? (h.key = l.C0.DEL)
                                  : n.keyCode === 219
                                    ? (h.key = l.C0.ESC)
                  ...
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    (r.Utf8ToUtf32 =
                      ...
                      r.stringFromCodePoint =
                        void 0),
                    (r.stringFromCodePoint = function (o) {
                      return o > 65535
                        ? ((o -= 65536),
                    ...
                    (r.utf32ToString = function (o, l = 0, _ = o.length) {
                      let n = "";
                      for (let d = l; d < _; ++d) {
                        let v = o[d];
                        v > 65535
                    ...
                    (r.StringToUtf32 = class {
                      ...
                      decode(o, l) {
                        ...
                        let n = 0,
                          d = 0;
                        if (this._interim) {
                          const v = o.charCodeAt(d++);
                          (56320 <= v && v <= 57343
                            ? (l[n++] = 1024 * (this._interim - 55296) + v - 56320 + 65536)
                            : ((l[n++] = this._interim), (l[n++] = v)),
                            (this._interim = 0));
                        }
                        for (let v = d; v < _; ++v) {
                          const g = o.charCodeAt(v);
                          if (55296 <= g && g <= 56319) {
                            if (++v >= _) return ((this._interim = g), n);
                            const h = o.charCodeAt(v);
                            56320 <= h && h <= 57343
                              ? (l[n++] = 1024 * (g - 55296) + h - 56320 + 65536)
                              : ((l[n++] = g), (l[n++] = h));
                          } else g !== 65279 && (l[n++] = g);
                        }
                        return n;
                    ...
                    (r.Utf8ToUtf32 = class {
                      ...
                      decode(o, l) {
                        ...
                        if (this.interim[0]) {
                          ...
                          let u,
                            p = 0;
                          for (; (u = 63 & this.interim[++p]) && p < 4;) ((f <<= 6), (f |= u));
                          const c =
                        ...
                        for (; t < _;) {
                          ...
                          if (((n = o[t++]), n < 128)) l[h++] = n;
                            ...
                            if (t >= _) return ((this.interim[0] = n), (this.interim[1] = d), h);
                            if (((v = o[t++]), (192 & v) != 128)) {
                              t--;
                              continue;
                            }
                            if (
                              ((i = ((15 & n) << 12) | ((63 & d) << 6) | (63 & v)),
                              i < 2048 || (i >= 55296 && i <= 57343) || i === 65279)
                            )
                              continue;
                            l[h++] = i;
                          } else if ((248 & n) == 240) {
                  ...
                  r.UnicodeV6 = class {
                    constructor() {
                      if (((this.version = "6"), !d)) {
                        ...
                        for (let v = 0; v < _.length; ++v) d.fill(0, _[v][0], _[v][1] + 1);
                      }
                    }
                    wcwidth(v) {
                      return v < 32
                        ...
                        : v < 127
                          ...
                          : v < 65536
                            ...
                            : (function (g, h) {
                              ...
                              ? 0
                              : (v >= 131072 && v <= 196605) || (v >= 196608 && v <= 262141)
                                ? 2
                                : 1;
                    }
                    charProperties(v, g) {
                      let h = this.wcwidth(v),
                        i = h === 0 && g !== 0;
                      if (i) {
                  ...
                  class n extends _.Disposable {
                    ...
                    _innerWrite(v = 0, g = !0) {
                      ...
                      for (; this._writeBuffer.length > this._bufferOffset;) {
                        const i = this._writeBuffer[this._bufferOffset],
                          s = this._action(i, g);
                        if (s) {
                          const t = (a) =>
                            Date.now() - h >= 12
                              ? setTimeout(() => this._innerWrite(0, a))
                              : this._innerWrite(h, a);
                          return void s
                            .catch(
                              (a) => (
                                queueMicrotask(() => {
                  ...
                  ((r.parseColor = function (n) {
                    ...
                    if (d.indexOf("rgb:") === 0) {
                      ...
                      if (v) {
                        ...
                        return [
                          Math.round((parseInt(v[1] || v[4] || v[7] || v[10], 16) / g) * 255),
                          Math.round((parseInt(v[2] || v[5] || v[8] || v[11], 16) / g) * 255),
                          Math.round((parseInt(v[3] || v[6] || v[9] || v[12], 16) / g) * 255),
                        ];
                      }
                    } else if (
                      d.indexOf("#") === 0 &&
                      ((d = d.slice(1)), l.exec(d) && [3, 6, 9, 12].includes(d.length))
                    ) {
                      const v = d.length / 3,
                        g = [0, 0, 0];
                      for (let h = 0; h < 3; ++h) {
                ...
                6351: (T, r, o) => {
                  ...
                  r.DcsParser = class {
                    ...
                    hook(g, h) {
                      if (
                        ...
                        for (let i = this._active.length - 1; i >= 0; i--) this._active[i].hook(h);
                      else this._handlerFb(this._ident, "HOOK", h);
                    }
                    put(g, h, i) {
                      if (this._active.length)
                        for (let s = this._active.length - 1; s >= 0; s--)
                          this._active[s].put(g, h, i);
                    ...
                    unhook(g, h = !0) {
                      if (this._active.length) {
                        ...
                        if (
                          ...
                          for (; s >= 0 && ((i = this._active[s].unhook(g)), i !== !0); s--)
                  ...
                  (v.addParam(0),
                    (r.DcsHandler = class {
                      ...
                      hook(g) {
                        ((this._params = g.length > 1 || g.params[0] ? g.clone() : v),
                          (this._data = ""),
                          (this._hitLimit = !1));
                      }
                      put(g, h, i) {
                        this._hitLimit ||
                          ((this._data += (0, l.utf32ToString)(g, h, i)),
                      ...
                      unhook(g) {
                        ...
                        if (this._hitLimit) h = !1;
                          ...
                          g &&
                          ((h = this._handler(this._data, this._params)), h instanceof Promise)
                        )
                          return h.then(
                            (i) => (
                              (this._params = v),
                        ...
                        return ((this._params = v), (this._data = ""), (this._hitLimit = !1), h);
                      }
                    }));
                },
                2015: (T, r, o) => {
                  ...
                  r.VT500_TRANSITION_TABLE = (function () {
                    const i = new v(4095),
                      s = Array.apply(null, Array(256)).map((p, c) => c),
                      e = (p, c) => s.slice(p, c),
                      t = e(32, 127),
                      a = e(0, 24);
                    ...
                    const f = e(0, 14);
                    let u;
                    for (u in (i.setDefault(1, 0), i.addMany(t, 0, 2, 0), f))
                      (i.addMany([24, 26, 153, 154], u, 3, 0),
                        i.addMany(e(128, 144), u, 3, 0),
                        i.addMany(e(144, 152), u, 3, 0),
                        i.add(156, u, 0, 0),
                        i.add(27, u, 11, 1),
                        i.add(157, u, 4, 8),
                        i.addMany([152, 158, 159], u, 0, 7),
                        i.add(155, u, 11, 3),
                        i.add(144, u, 11, 9));
                    return (
                      i.addMany(a, 0, 3, 0),
                      ...
                      i.addMany(t, 8, 5, 8),
                      i.add(127, 8, 5, 8),
                      i.addMany([156, 27, 24, 26, 7], 8, 6, 0),
                      i.addMany(e(28, 32), 8, 0, 8),
                      i.addMany([88, 94, 95], 1, 0, 7),
                      i.addMany(t, 7, 0, 7),
                      i.addMany(a, 7, 0, 7),
                      i.add(156, 7, 0, 0),
                      i.add(127, 7, 0, 7),
                      i.add(91, 1, 11, 3),
                      i.addMany(e(64, 127), 3, 7, 0),
                      i.addMany(e(48, 60), 3, 8, 4),
                      i.addMany([60, 61, 62, 63], 3, 9, 4),
                      i.addMany(e(48, 60), 4, 8, 4),
                      i.addMany(e(64, 127), 4, 7, 0),
                      i.addMany([60, 61, 62, 63], 4, 0, 6),
                      i.addMany(e(32, 64), 6, 0, 6),
                      i.add(127, 6, 0, 6),
                      i.addMany(e(64, 127), 6, 0, 0),
                      i.addMany(e(32, 48), 3, 9, 5),
                      i.addMany(e(32, 48), 5, 9, 5),
                      i.addMany(e(48, 64), 5, 0, 6),
                      i.addMany(e(64, 127), 5, 7, 0),
                      i.addMany(e(32, 48), 4, 9, 5),
                      i.addMany(e(32, 48), 1, 9, 2),
                      i.addMany(e(32, 48), 2, 9, 2),
                      i.addMany(e(48, 127), 2, 10, 0),
                      i.addMany(e(48, 80), 1, 10, 0),
                      i.addMany(e(81, 88), 1, 10, 0),
                      i.addMany([89, 90, 92], 1, 10, 0),
                      i.addMany(e(96, 127), 1, 10, 0),
                      i.add(80, 1, 11, 9),
                      i.addMany(a, 9, 0, 9),
                      i.add(127, 9, 0, 9),
                      i.addMany(e(28, 32), 9, 0, 9),
                      i.addMany(e(32, 48), 9, 9, 12),
                      i.addMany(e(48, 60), 9, 8, 10),
                      i.addMany([60, 61, 62, 63], 9, 9, 10),
                      i.addMany(a, 11, 0, 11),
                      i.addMany(e(32, 128), 11, 0, 11),
                      i.addMany(e(28, 32), 11, 0, 11),
                      i.addMany(a, 10, 0, 10),
                      i.add(127, 10, 0, 10),
                      i.addMany(e(28, 32), 10, 0, 10),
                      i.addMany(e(48, 60), 10, 8, 10),
                      i.addMany([60, 61, 62, 63], 10, 0, 11),
                      i.addMany(e(32, 48), 10, 9, 12),
                      i.addMany(a, 12, 0, 12),
                      i.add(127, 12, 0, 12),
                      i.addMany(e(28, 32), 12, 0, 12),
                      i.addMany(e(32, 48), 12, 9, 12),
                      i.addMany(e(48, 64), 12, 0, 11),
                      i.addMany(e(64, 127), 12, 12, 13),
                      i.addMany(e(64, 127), 10, 12, 13),
                      i.addMany(e(64, 127), 9, 12, 13),
                      i.addMany(a, 13, 13, 13),
                      i.addMany(t, 13, 13, 13),
                      i.add(127, 13, 0, 13),
                      i.addMany([27, 156, 24, 26], 13, 14, 0),
                      i.add(g, 0, 2, 0),
                      i.add(g, 8, 5, 8),
                      i.add(g, 6, 0, 6),
                      i.add(g, 11, 0, 11),
                  ...
                  class h extends l.Disposable {
                    ...
                    _identifier(s, e = [64, 126]) {
                      ...
                      if (s.prefix) {
                        ...
                        if (((t = s.prefix.charCodeAt(0)), (t && 60 > t) || t > 63))
                          throw new Error("prefix must be in range 0x3c .. 0x3f");
                      }
                      if (s.intermediates) {
                        if (s.intermediates.length > 2)
                    ...
                    clearEscHandler(s) {
                      this._escHandlers[this._identifier(s, [48, 126])] &&
                        delete this._escHandlers[this._identifier(s, [48, 126])];
                    }
                    ...
                    clearExecuteHandler(s) {
                      this._executeHandlers[s.charCodeAt(0)] &&
                        delete this._executeHandlers[s.charCodeAt(0)];
                    }
                    ...
                    clearCsiHandler(s) {
                      this._csiHandlers[this._identifier(s)] &&
                        delete this._csiHandlers[this._identifier(s)];
                    }
                    ...
                    parse(s, e, t) {
                      ...
                      if (this._parseStack.state)
                        if (this._parseStack.state === 2)
                          ...
                          switch (this._parseStack.state) {
                            case 3:
                              if (t === !1 && m > -1) {
                                for (; m >= 0 && ((a = c[m](this._params)), a !== !0); m--)
                                  if (a instanceof Promise)
                                    return ((this._parseStack.handlerPos = m), a);
                              }
                            ...
                            case 6:
                              if (
                                ((f = s[this._parseStack.chunkPos]),
                                (a = this._dcsParser.unhook(f !== 24 && f !== 26, t)),
                                a)
                              )
                                return a;
                            ...
                            case 5:
                              if (
                                ((f = s[this._parseStack.chunkPos]),
                                (a = this._oscParser.end(f !== 24 && f !== 26, t)),
                                a)
                              )
                                return a;
                              (f === 27 && (this._parseStack.transition |= 1),
                      ...
                      for (let c = p; c < e; ++c) {
                        switch (
                          ((f = s[c]),
                          (u =
                            this._transitions.table[(this.currentState << 8) | (f < 160 ? f : g)]),
                          u >> 4)
                        ) {
                          case 2:
                            for (let b = c + 1; ; ++b) {
                              if (b >= e || (f = s[b]) < 32 || (f > 126 && f < g)) {
                                (this._printHandler(s, c, b), (c = b - 1));
                                break;
                              }
                              if (++b >= e || (f = s[b]) < 32 || (f > 126 && f < g)) {
                                (this._printHandler(s, c, b), (c = b - 1));
                          ...
                          case 7:
                            ...
                            for (; E >= 0 && ((a = m[E](this._params)), a !== !0); E--)
                              if (a instanceof Promise)
                                return (this._preserveStack(3, m, E, u, c), a);
                            (E < 0 && this._csiHandlerFb((this._collect << 8) | f, this._params),
                              (this.precedingJoinState = 0));
                            break;
                          case 8:
                            do
                          ...
                          case 10:
                            ...
                            let D = k ? k.length - 1 : -1;
                            for (; D >= 0 && ((a = k[D]()), a !== !0); D--)
                              if (a instanceof Promise)
                                return (this._preserveStack(4, k, D, u, c), a);
                            (D < 0 && this._escHandlerFb((this._collect << 8) | f),
                              (this.precedingJoinState = 0));
                            break;
                          case 11:
                          ...
                          case 13:
                            for (let b = c + 1; ; ++b)
                              if (
                                ...
                                (this._dcsParser.put(s, c, b), (c = b - 1));
                                break;
                              }
                            break;
                          case 14:
                            if (((a = this._dcsParser.unhook(f !== 24 && f !== 26)), a))
                              return (this._preserveStack(6, [], 0, u, c), a);
                            (f === 27 && (u |= 1),
                              this._params.reset(),
                              this._params.addParam(0),
                              (this._collect = 0),
                          ...
                          case 5:
                            for (let b = c + 1; ; b++)
                              if (b >= e || (f = s[b]) < 32 || (f > 127 && f < g)) {
                                (this._oscParser.put(s, c, b), (c = b - 1));
                                break;
                              }
                            break;
                          case 6:
                            if (((a = this._oscParser.end(f !== 24 && f !== 26)), a))
                              return (this._preserveStack(5, [], 0, u, c), a);
                            (f === 27 && (u |= 1),
                              this._params.reset(),
                              this._params.addParam(0),
                              (this._collect = 0),
                  ...
                  ((r.OscParser = class {
                    ...
                    _start() {
                      if (((this._active = this._handlers[this._id] || n), this._active.length))
                        for (let d = this._active.length - 1; d >= 0; d--) this._active[d].start();
                      else this._handlerFb(this._id, "START");
                    }
                    _put(d, v, g) {
                      if (this._active.length)
                        for (let h = this._active.length - 1; h >= 0; h--)
                          this._active[h].put(d, v, g);
                      else this._handlerFb(this._id, "PUT", (0, _.utf32ToString)(d, v, g));
                    }
                    start() {
                        ...
                        if (this._state !== 3)
                          if ((this._state === 1 && this._start(), this._active.length)) {
                            ...
                            if (
                              ...
                              for (; h >= 0 && ((g = this._active[h].end(d)), g !== !0); h--)
                            ...
                            for (; h >= 0; h--)
                              if (((g = this._active[h].end(!1)), g instanceof Promise))
                                return (
                                  (this._stack.paused = !0),
                                  (this._stack.loopPosition = h),
                                  (this._stack.fallThrough = !0),
                    ...
                    (r.OscHandler = class {
                      ...
                      put(d, v, g) {
                        this._hitLimit ||
                          ((this._data += (0, _.utf32ToString)(d, v, g)),
                  ...
                  class l {
                    static fromArray(n) {
                      ...
                      for (let v = Array.isArray(n[0]) ? 1 : 0; v < n.length; ++v) {
                        const g = n[v];
                        if (Array.isArray(g))
                          for (let h = 0; h < g.length; ++h) d.addSubParam(g[h]);
                        else d.addParam(g);
                      }
                      return d;
                    }
                    constructor(n = 32, d = 32) {
                      if (((this.maxLength = n), (this.maxSubParamsLength = d), d > 256))
                    ...
                    addParam(n) {
                      if (((this._digitIsSub = !1), this.length >= this.maxLength))
                        ...
                        ((this._subParamsIdx[this.length] =
                          ...
                          (this.params[this.length++] = n > o ? o : n));
                      }
                    }
                    addSubParam(n) {
                      if (((this._digitIsSub = !0), this.length))
                        if (this._rejectDigits || this._subParamsLength >= this.maxSubParamsLength)
                          ...
                          if (n < -1) throw new Error("values lesser than -1 are not allowed");
                          ((this._subParams[this._subParamsLength++] = n > o ? o : n),
                    ...
                    addDigit(n) {
                      ...
                      if (
                        this._rejectDigits ||
                        !(d = this._digitIsSub ? this._subParamsLength : this.length) ||
                        (this._digitIsSub && this._rejectSubDigits)
                      )
                        return;
                      const v = this._digitIsSub ? this._subParams : this.params,
                        g = v[d - 1];
                      v[d - 1] = ~g ? Math.min(10 * g + n, o) : n;
                    }
                  }
                  r.Params = l;
                },
                  ...
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                    ...
                    (r.AddonManager = class {
                      ...
                      loadAddon(o, l) {
                        ...
                        (this._addons.push(_),
                          (l.dispose = () => this._wrappedAddonDispose(_)),
                          l.activate(o));
                      }
                ...
                8285: (T, r, o) => {
                  ...
                  class d extends n.Disposable {
                    constructor(g) {
                      (super(),
                        (this._core = g),
                        (this._onBufferChange = this.register(new _.EventEmitter())),
                          ...
                          u =
                            f < 3
                              ...
                              : t === null
                                ...
                                : t;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          u = Reflect.decorate(i, s, e, t);
                        else
                          for (var p = i.length - 1; p >= 0; p--)
                            (a = i[p]) && (u = (f < 3 ? a(u) : f > 3 ? a(s, e, u) : a(s, e)) || u);
                  ...
                  let h = (r.BufferService = class extends d.Disposable {
                    ...
                    constructor(i) {
                      (super(),
                        ...
                        (this.onScroll = this._onScroll.event),
                        (this.cols = Math.max(i.rawOptions.cols || 0, r.MINIMUM_COLS)),
                        (this.rows = Math.max(i.rawOptions.rows || 0, r.MINIMUM_ROWS)),
                        (this.buffers = this.register(new v.BufferSet(i, this))));
                    }
                    resize(i, s) {
                      ((this.cols = i),
                        (this.rows = s),
                        this.buffers.resize(i, s),
                        this._onResize.fire({ cols: i, rows: s }));
                    }
                    reset() {
                    ...
                    scroll(i, s = !1) {
                      ...
                      ((t = this._cachedBlankLine),
                        (t &&
                          ...
                          t.getFg(0) === i.fg &&
                          t.getBg(0) === i.bg) ||
                          ((t = e.getBlankLine(i, s)), (this._cachedBlankLine = t)),
                        (t.isWrapped = s));
                      const a = e.ybase + e.scrollTop,
                    ...
                    scrollLines(i, s, e) {
                      ...
                      const a = t.ydisp;
                      ((t.ydisp = Math.max(Math.min(t.ydisp + i, t.ybase), 0)),
                        a !== t.ydisp && (s || this._onScroll.fire(t.ydisp)));
                    }
                  });
                ...
                1753: function (T, r, o) {
                    ...
                    g = {
                      ...
                      X10: {
                        ...
                        restrict: (t) =>
                          t.button !== 4 &&
                          t.action === 1 &&
                          ((t.ctrl = !1), (t.alt = !1), (t.shift = !1), !0),
                      },
                      VT200: { events: 19, restrict: (t) => t.action !== 32 },
                      DRAG: { events: 23, restrict: (t) => t.action !== 32 || t.button !== 3 },
                    ...
                    return (
                      t.button === 4
                        ...
                        : ((f |= 3 & t.button),
                          4 & t.button && (f |= 64),
                          8 & t.button && (f |= 128),
                          t.action === 32 ? (f |= 32) : t.action !== 0 || a || (f |= 3)),
                      f
                    );
                  }
                  ...
                  let e = (r.CoreMouseService = class extends v.Disposable {
                    ...
                    set activeProtocol(t) {
                      ...
                      ((this._activeProtocol = t),
                        this._onProtocolChange.fire(this._protocols[t].events));
                    }
                    get activeEncoding() {
                    ...
                    triggerMouseEvent(t) {
                      if (
                        ...
                        (t.button !== 4 && (t.action === 2 || t.action === 3)) ||
                        (t.col++,
                        t.row++,
                        t.action === 32 &&
                          this._lastEvent &&
                      ...
                      return (
                        a &&
                          (this._activeEncoding === "DEFAULT"
                            ? this._coreService.triggerBinaryEvent(a)
                  ...
                  r.CoreMouseService = e = l([_(0, n.IBufferService), _(1, n.ICoreService)], e);
                },
                6975: function (T, r, o) {
                  var l =
                      (this && this.__decorate) ||
                  ...
                  let s = (r.CoreService = class extends v.Disposable {
                    constructor(e, t, a) {
                      (super(),
                        ...
                        (this.decPrivateModes = (0, n.clone)(i)));
                    }
                    reset() {
                  ...
                  r.CoreService = s = l(
                    [_(0, g.IBufferService), _(1, g.ILogService), _(2, g.IOptionsService)],
                    s,
                  );
                },
                9074: (T, r, o) => {
                  ...
                  class h extends n.Disposable {
                    ...
                    constructor() {
                      (super(),
                        (this._decorations = new d.SortedList((e) => e?.marker.line)),
                        (this._onDecorationRegistered = this.register(new _.EventEmitter())),
                        (this.onDecorationRegistered = this._onDecorationRegistered.event),
                        (this._onDecorationRemoved = this.register(new _.EventEmitter())),
                    ...
                    *getDecorationsAtCell(e, t, a) {
                      let f = 0,
                        u = 0;
                      for (const p of this._decorations.getKeyIterator(t))
                        ((f = p.options.x ?? 0),
                          (u = f + (p.options.width ?? 1)),
                          e >= f &&
                            e < u &&
                            (!a || (p.options.layer ?? "bottom") === a) &&
                            (yield p));
                    }
                    forEachDecorationAtCell(e, t, a, f) {
                      this._decorations.forEachByKey(t, (u) => {
                        ((v = u.options.x ?? 0),
                          (g = v + (u.options.width ?? 1)),
                          e >= v && e < g && (!a || (u.options.layer ?? "bottom") === a) && f(u));
                      });
                    }
                  }
                  ...
                  class i extends n.Disposable {
                    ...
                    constructor(e) {
                      (super(),
                        (this.options = e),
                        (this.onRenderEmitter = this.register(new _.EventEmitter())),
                        (this.onRender = this.onRenderEmitter.event),
                        (this._onDispose = this.register(new _.EventEmitter())),
                        (this.onDispose = this._onDispose.event),
                        (this._cachedBg = null),
                        (this._cachedFg = null),
                    ...
                    (r.InstantiationService = class {
                      constructor() {
                        ((this._services = new n()),
                          this._services.set(l.IInstantiationService, this));
                      }
                      setService(d, v) {
                      ...
                      createInstance(d, ...v) {
                        ...
                        for (const s of g) {
                          ...
                          if (!e)
                            throw new Error(
                              `[createInstance] ${d.name} depends on UNKNOWN service ${s.id}.`,
                            );
                          h.push(e);
                        }
                        ...
                        if (v.length !== i)
                          throw new Error(
                            `[createInstance] First service dependency of ${d.name} at position ${i + 1} conflicts with ${v.length} static arguments`,
                          );
                        return new d(...v, ...h);
                      }
                    }));
                    ...
                    h = (r.LogService = class extends n.Disposable {
                      ...
                      _evalLazyOptionalParams(i) {
                        for (let s = 0; s < i.length; s++)
                          typeof i[s] == "function" && (i[s] = i[s]());
                      }
                      _log(i, s, e) {
                        (this._evalLazyOptionalParams(e),
                          i.call(
                            console,
                            (this._optionsService.options.logger ? "" : "xterm.js: ") + s,
                            ...e,
                          ));
                      }
                      trace(i, ...s) {
                  ...
                  ((r.LogService = h = l([_(0, d.IOptionsService)], h)),
                    ...
                    (r.traceCall = function (i, s, e) {
                      ...
                      e.value = function (...a) {
                        ...
                        g.trace(
                          `GlyphRenderer#${t.name}(${a.map((u) => JSON.stringify(u)).join(", ")})`,
                        );
                ...
                7302: (T, r, o) => {
                  ...
                  class v extends _.Disposable {
                    ...
                    _setupOptions() {
                      const h = (s) => {
                          if (!(s in r.DEFAULT_OPTIONS))
                            throw new Error(`No option with key "${s}"`);
                          return this.rawOptions[s];
                        },
                        i = (s, e) => {
                          if (!(s in r.DEFAULT_OPTIONS))
                            throw new Error(`No option with key "${s}"`);
                          ((e = this._sanitizeAndValidateOption(s, e)),
                            this.rawOptions[s] !== e &&
                              ((this.rawOptions[s] = e), this._onOptionChange.fire(s)));
                        };
                      ...
                      switch (h) {
                        case "cursorStyle":
                          if (
                            ...
                            throw new Error(`"${i}" is not a valid value for ${h}`);
                          break;
                        case "wordSeparator":
                          i || (i = r.DEFAULT_OPTIONS[h]);
                          break;
                        ...
                        case "scrollback":
                          if ((i = Math.min(i, 4294967295)) < 0)
                            throw new Error(`${h} cannot be less than 0, value: ${i}`);
                          break;
                        case "fastScrollSensitivity":
                        case "scrollSensitivity":
                          if (i <= 0)
                            throw new Error(`${h} cannot be less than or equal to 0, value: ${i}`);
                          break;
                        case "rows":
                        case "cols":
                ...
                2660: function (T, r, o) {
                        ...
                        var s,
                          ...
                          t =
                            e < 3
                              ? g
                              : i === null
                                ? (i = Object.getOwnPropertyDescriptor(g, h))
                                : i;
                        if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
                          t = Reflect.decorate(v, g, h, i);
                        else
                          for (var a = v.length - 1; a >= 0; a--)
                            (s = v[a]) && (t = (e < 3 ? s(t) : e > 3 ? s(g, h, t) : s(g, h)) || t);
                  ...
                  let d = (r.OscLinkService = class {
                    ...
                    registerLink(v) {
                      ...
                      if (v.id === void 0) {
                        const a = g.addMarker(g.ybase + g.y),
                          f = { data: v, id: this._nextId++, lines: [a] };
                        return (
                          a.onDispose(() => this._removeMarkerFromLink(f, a)),
                          this._dataByLinkId.set(f.id, f),
                          f.id
                        );
                      }
                      const h = v,
                        i = this._getEntryIdKey(h),
                      ...
                      return (
                        e.onDispose(() => this._removeMarkerFromLink(t, e)),
                    ...
                    getLinkData(v) {
                      return this._dataByLinkId.get(v)?.data;
                    }
                    _getEntryIdKey(v) {
                      return `${v.id};;${v.uri}`;
                    }
                  ...
                  ((r.serviceRegistry = new Map()),
                    ...
                    (r.createDecorator = function (_) {
                      ...
                      const n = function (d, v, g) {
                        ...
                        (function (h, i, s) {
                          i[o] === i
                            ? i[l].push({ id: h, index: s })
                            : ((i[l] = [{ id: h, index: s }]), (i[o] = i));
                        })(n, d, g);
                      };
                ...
                2585: (T, r, o) => {
                  ...
                  const l = o(8343);
                  var _;
                  ((r.IBufferService = (0, l.createDecorator)("BufferService")),
                    (r.ICoreMouseService = (0, l.createDecorator)("CoreMouseService")),
                    (r.ICoreService = (0, l.createDecorator)("CoreService")),
                    (r.ICharsetService = (0, l.createDecorator)("CharsetService")),
                    (r.IInstantiationService = (0, l.createDecorator)("InstantiationService")),
                    (function (n) {
                      ((n[(n.TRACE = 0)] = "TRACE"),
                        (n[(n.DEBUG = 1)] = "DEBUG"),
                        (n[(n.INFO = 2)] = "INFO"),
                    ...
                    (r.ILogService = (0, l.createDecorator)("LogService")),
                    (r.IOptionsService = (0, l.createDecorator)("OptionsService")),
                    (r.IOscLinkService = (0, l.createDecorator)("OscLinkService")),
                    (r.IUnicodeService = (0, l.createDecorator)("UnicodeService")),
                    (r.IDecorationService = (0, l.createDecorator)("DecorationService")));
                },
                1480: (T, r, o) => {
                  (Object.defineProperty(r, "__esModule", { value: !0 }),
                  ...
                  class n {
                    ...
                    static createPropertyValue(v, g, h = !1) {
            ...
            function G(T) {
              ...
              var o = (Y[T] = { exports: {} });
              return (ie[T].call(o.exports, o, o.exports, G), o.exports);
            }
            var Q = {};
            return (
              (() => {
                ...
                class h extends l.Disposable {
                  constructor(s) {
                    (super(),
                      (this._core = this.register(new o.Terminal(s))),
                      (this._addonManager = this.register(new _.AddonManager())),
                      (this._publicOptions = { ...this._core.options }));
                    const e = (a) => this._core.options[a],
                      t = (a, f) => {
                  ...
                  _checkReadonlyOptions(s) {
                    if (g.includes(s))
                      throw new Error(`Option "${s}" can only be set in the constructor`);
                  }
                  _checkProposedApi() {
                  ...
                  get buffer() {
                    return (
                      this._buffer ||
                        (this._buffer = this.register(new n.BufferNamespaceApi(this._core))),
                      this._buffer
                    );
                  }
                  get markers() {
                  ...
                  registerDecoration(s) {
                    return (
                      ...
                      this._verifyPositiveIntegers(s.x ?? 0, s.width ?? 0, s.height ?? 0),
                      this._core.registerDecoration(s)
                    );
                  }
                  hasSelection() {
                ...
                (Object.defineProperty(Y, "__esModule", { value: !0 }),
                  ...
                  (Y.FitAddon = class {
                    ...
                    fit() {
                      ...
                      if (!G || !this._terminal || isNaN(G.cols) || isNaN(G.rows)) return;
                      const Q = this._terminal._core;
                      (this._terminal.rows === G.rows && this._terminal.cols === G.cols) ||
                        (Q._renderService.clear(), this._terminal.resize(G.cols, G.rows));
                    }
                    proposeDimensions() {
                      if (
                        !this._terminal ||
                      ...
                      const G = this._terminal._core,
                        Q = G._renderService.dimensions;
                      if (Q.css.cell.width === 0 || Q.css.cell.height === 0) return;
                      const T =
                          this._terminal.options.scrollback === 0 ? 0 : G.viewport.scrollBarWidth,
                        r = window.getComputedStyle(this._terminal.element.parentElement),
                        o = parseInt(r.getPropertyValue("height")),
                        l = Math.max(0, parseInt(r.getPropertyValue("width"))),
                        _ = window.getComputedStyle(this._terminal.element),
                        n =
                          o -
                          (parseInt(_.getPropertyValue("padding-top")) +
                            parseInt(_.getPropertyValue("padding-bottom"))),
                        d =
                          l -
                          (parseInt(_.getPropertyValue("padding-right")) +
                            parseInt(_.getPropertyValue("padding-left"))) -
                          T;
                      return {
                        cols: Math.max(2, Math.floor(d / Q.css.cell.width)),
                        rows: Math.max(1, Math.floor(n / Q.css.cell.height)),
                      };
                    }
                  }));
              })(),
