import { j as D } from "./index-CyHAbkO5.js";
import { o as Re } from "./openUrlInBrowser-VWrl1VvA.js";
import {
  f as Ie,
  p as De,
  a as Pe,
  ...
  M as Gt,
  r as Wt,
} from "./index-6t0U9yuc.js";
import "./i18n-DtIC1LRi.js";
import "./browserIntent-DuTqin6R.js";
import "./NormalApp-Cn6agT0F.js";
const tt = String.raw`<r\s+(h|f)=(\d+)\s*/>`,
  qt = "░▒▓█▄▀■□▪▫●○◌◍◎★☆✦✧◆◇◈⬢⬡⎔⌘⌥⌦⌫⏏⏎⏍⎇⌬⌭⍟⍜⍝⍣⍤⎈⎊⎋⎌⎍⎎⎏",
  Xt = "░▒▓█▄▀■□▪▫㊀㊁㊂㊃㊄㊅㊆㊇㊈㊉㊊㊋㊌㊍㊎㊏㊐㊑㊒㊓㊔㊕㊖㊗㊘㊙㊚㊛㊜㊝㊞㊟",
  Kt = "rgba(0, 255, 120, 0.8)",
  Vt = "-1px 0 rgba(255, 0, 60, 0.45), 1px 0 rgba(0, 100, 255, 0.45)";
function zt(e, t, a) {
  const s = e === "half" ? qt : Xt;
  let c = (a * 9301 + 49297) % 233280,
    d = "";
  for (let l = 0; l < t; l++) ((c = (c * 9301 + 49297) % 233280), (d += s[c % s.length]));
  return d;
}
function jt(e) {
  return `font-family:monospace;letter-spacing:${e === "half" ? "0.05em" : "0"};color:${Kt};text-shadow:${Vt}`;
}
...
function ut(e, t) {
  ...
  function s(c, ...d) {
    ...
    if (c && Be.call(c, e)) {
      const f = String(c[e]);
      l = Be.call(m, f) ? m[f] : s.unknown;
    }
    if (l) return l.call(this, c, ...d);
  }
  return ((s.handlers = a.handlers || {}), (s.invalid = a.invalid), (s.unknown = a.unknown), s);
}
const ke = /[#.]/g;
function Jt(e, t) {
  const a = e || "",
  ...
  for (; c < a.length;) {
    ke.lastIndex = c;
    const m = ke.exec(a),
      f = a.slice(c, m ? m.index : a.length);
    (f &&
      (d
        ? d === "#"
          ? (s.id = f)
  ...
  return { type: "element", tagName: l || t || "div", properties: s, children: [] };
}
function at(e, t, a) {
  const s = a ? tu(a) : void 0;
  function c(d, l, ...m) {
    let f;
    if (d == null) {
      ...
      f = Jt(d, t);
      const b = f.tagName.toLowerCase(),
        S = s ? s.get(b) : void 0;
      if (((f.tagName = S || b), $t(l))) m.unshift(l);
      else for (const [y, wt] of Object.entries(l)) Zt(e, f.properties, y, wt);
    }
    for (const b of m) me(f.children, b);
    return (
      f.type === "element" &&
        f.tagName === "template" &&
...
function $t(e) {
  ...
  for (const s of a) {
    ...
    if (c && typeof c == "object") {
      ...
      const d = c;
      for (const l of d) if (typeof l != "number" && typeof l != "string") return !0;
    }
  }
    ...
    if (typeof s == "number") {
      ...
      typeof s == "boolean"
        ...
        : typeof s == "string"
          ...
          : Array.isArray(s)
            ? (d = [...s])
            : (d = c.property === "style" ? eu(s) : String(s));
    if (Array.isArray(d)) {
      const l = [];
      for (const m of d) l.push(He(c, c.property, m));
      d = l;
    }
...
function me(e, t) {
  if (t != null)
    ...
    else if (Array.isArray(t)) for (const a of t) me(e, a);
    else if (typeof t == "object" && "type" in t) t.type === "root" ? me(e, t.children) : e.push(t);
    else throw new Error("Expected node, nodes, or string, got `" + t + "`");
}
function He(e, t, a) {
  if (typeof a == "string") {
    if (e.number && a && !Number.isNaN(Number(a))) return Number(a);
    if ((e.boolean || e.overloadedBoolean) && (a === "" || Me(a) === Me(t))) return !0;
  }
  return a;
}
function eu(e) {
  const t = [];
  for (const [a, s] of Object.entries(e)) t.push([a, s].join(": "));
  return t.join("; ");
}
function tu(e) {
  const t = new Map();
  for (const a of e) t.set(a.toLowerCase(), a);
  return t;
}
const uu = [
    "altGlyph",
  ...
  function s(d) {
    if (typeof d == "number" && d > -1 && d <= t.length) {
      ...
      for (;;) {
        ...
        if (m > d) return { line: l + 1, column: d - (l > 0 ? a[l - 1] : 0) + 1, offset: d };
        l++;
      }
    }
  }
...
function pe(e, t) {
  ...
  switch (t.nodeName) {
    case "#comment": {
      const s = t;
      return ((a = { type: "comment", value: s.data }), ae(e, s, a), a);
    }
    case "#document":
    case "#document-fragment": {
      ...
      if (
        ((a = { type: "root", children: rt(e, t.childNodes), data: { quirksMode: c } }),
        e.file && e.location)
      ) {
        const d = String(e.file),
          l = ru(d),
          m = l.toPoint(0),
          f = l.toPoint(d.length);
    ...
    case "#documentType": {
      const s = t;
      return ((a = { type: "doctype" }), ae(e, s, a), a);
    }
    case "#text": {
      const s = t;
      return ((a = { type: "text", value: s.value }), ae(e, s, a), a);
    }
    default:
      return ((a = cu(e, t)), a);
  }
...
function cu(e, t) {
  const a = e.schema;
  e.schema = t.namespaceURI === k.svg ? Z : ce;
  let s = -1;
  const c = {};
  for (; ++s < t.attrs.length;) {
    const m = t.attrs[s],
      f = (m.prefix ? m.prefix + ":" : "") + m.name;
    st.call(nu, f) || (c[f] = m.value);
  }
  const l = (e.schema.space === "svg" ? su : au)(t.tagName, c, rt(e, t.childNodes));
  if ((ae(e, t, l), l.tagName === "template")) {
    const m = t,
      f = m.sourceCodeLocation,
      b = f && f.startTag && w(f.startTag),
      S = f && f.endTag && w(f.endTag),
      y = pe(e, m.content);
    (b && S && e.file && (y.position = { start: b.end, end: S.start }), (l.content = y));
  }
  return ((e.schema = a), l);
}
function ae(e, t, a) {
  if ("sourceCodeLocation" in t && t.sourceCodeLocation && e.file) {
    const s = ou(e, a, t.sourceCodeLocation);
...
function ou(e, t, a) {
  ...
  if (t.type === "element") {
    ...
    if (
      ...
      let l;
      if (a.attrs)
        for (l in a.attrs) st.call(a.attrs, l) && (d[Ie(e.schema, l).property] = w(a.attrs[l]));
      fe(a.startTag);
      const m = w(a.startTag),
        f = a.endTag ? w(a.endTag) : void 0,
        b = { opening: m };
...
function w(e) {
  const t = Fe({ line: e.startLine, column: e.startCol, offset: e.startOffset }),
    a = Fe({ line: e.endLine, column: e.endCol, offset: e.endOffset });
...
const du = {},
  Eu = {}.hasOwnProperty,
  nt = ut("type", { handlers: { root: Tu, element: bu, text: mu, comment: _u, doctype: fu } });
function lu(e, t) {
  const s = (t || du).space;
  return nt(e, s === "svg" ? Z : ce);
}
function Tu(e, t) {
  const a = {
    nodeName: "#document",
  ...
  return ((a.childNodes = Ce(e.children, a, t)), v(e, a), a);
}
function hu(e, t) {
...
function bu(e, t) {
  ...
  if (e.properties) {
    for (d in e.properties)
      if (d !== "children" && Eu.call(e.properties, d)) {
        const f = Au(s, d, e.properties[d]);
        f && c.push(f);
      }
  }
  const l = s.space,
  ...
  return (
    (m.childNodes = Ce(e.children, m, s)),
    v(e, m),
    e.tagName === "template" && e.content && (m.content = hu(e.content, s)),
    m
  );
}
function Au(e, t, a) {
...
function v(e, t) {
  ...
  a &&
    a.start &&
    a.end &&
    (fe(typeof a.start.offset == "number"),
    fe(typeof a.end.offset == "number"),
...
function ot(e) {
  return (e >= 64976 && e <= 65007) || Iu.has(e);
}
var E;
(function (e) {
...
class Su {
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (pu(a)) return (this.pos++, this._addGap(), Cu(t, a));
  ...
  advance() {
    ...
    return t === r.CARRIAGE_RETURN
      ...
      : t === r.LINE_FEED && ((this.isEol = !0), this.skipNextNewLine)
        ...
        : ((this.skipNextNewLine = !1),
          it(t) && (t = this._processSurrogate(t)),
  ...
  _checkForProblematicCharacters(t) {
    ct(t)
      ...
      : ot(t) && this._err(E.noncharacterInInputStream);
  }
  retreat(t) {
...
function Mu(e) {
  return (e >= p.UPPER_A && e <= p.UPPER_Z) || (e >= p.LOWER_A && e <= p.LOWER_Z) || _e(e);
}
function xu(e) {
  return e === p.EQUALS || Mu(e);
}
var I;
(function (e) {
...
class Bu {
  ...
  write(t, a) {
    switch (this.state) {
      case I.EntityStart:
        return t.charCodeAt(a) === p.NUM
          ? ((this.state = I.NumericStart), (this.consumed += 1), this.stateNumericStart(t, a + 1))
          : ((this.state = I.NamedEntity), this.stateNamedEntity(t, a));
      case I.NumericStart:
  ...
  stateNumericStart(t, a) {
    return a >= t.length
      ? -1
      : (t.charCodeAt(a) | Du) === p.LOWER_X
        ? ((this.state = I.NumericHex), (this.consumed += 1), this.stateNumericHex(t, a + 1))
        : ((this.state = I.NumericDecimal), this.stateNumericDecimal(t, a));
  }
  addToNumericResult(t, a, s, c) {
    if (a !== s) {
      const d = s - a;
      ((this.result = this.result * Math.pow(c, d) + Number.parseInt(t.substr(a, d), c)),
        (this.consumed += d));
    }
  }
  stateNumericHex(t, a) {
    ...
    for (; a < t.length;) {
      ...
      if (_e(c) || Pu(c)) a += 1;
      else return (this.addToNumericResult(t, s, a, 16), this.emitNumericEntity(c, 3));
    }
  ...
  stateNumericDecimal(t, a) {
    ...
    for (; a < t.length;) {
      const c = t.charCodeAt(a);
      if (_e(c)) a += 1;
      else return (this.addToNumericResult(t, s, a, 10), this.emitNumericEntity(c, 2));
    }
  ...
  emitNumericEntity(t, a) {
    ...
    return (
      this.emitCodePoint(Ru(this.result), this.consumed),
      this.errors &&
        (t !== p.SEMI && this.errors.missingSemicolonAfterCharacterReference(),
  ...
  stateNamedEntity(t, a) {
    ...
    let c = s[this.treeIndex],
      d = (c & B.VALUE_LENGTH) >> 14;
    for (; a < t.length; a++, this.excess++) {
      const l = t.charCodeAt(a);
      if (((this.treeIndex = ku(s, c, this.treeIndex + Math.max(1, d), l)), this.treeIndex < 0))
        return this.result === 0 || (this.decodeMode === P.Attribute && (d === 0 || xu(l)))
          ? 0
  ...
  emitNotTerminatedNamedEntity() {
    var t;
    const { result: a, decodeTree: s } = this,
      c = (s[a] & B.VALUE_LENGTH) >> 14;
    return (
  ...
  emitNamedEntityData(t, a, s) {
    ...
    return (
      this.emitCodePoint(a === 1 ? c[t] & ~B.VALUE_LENGTH : c[t + 1], s),
...
function ku(e, t, a, s) {
  const c = (t & B.BRANCH_LENGTH) >> 7,
    d = t & B.JUMP_TABLE;
  if (c === 0) return d !== 0 && s === d ? a : -1;
  if (d) {
    const f = s - d;
...
function Q(e) {
  var t;
  return (t = Hu.get(e)) !== null && t !== void 0 ? t : u.UNKNOWN;
}
const h = u,
  Uu = {
    [T.HTML]: new Set([
    ...
    [T.MATHML]: new Set([h.MI, h.MO, h.MN, h.MS, h.MTEXT, h.ANNOTATION_XML]),
    [T.SVG]: new Set([h.TITLE, h.FOREIGN_OBJECT, h.DESC]),
    [T.XLINK]: new Set(),
    [T.XML]: new Set(),
    [T.XMLNS]: new Set(),
  },
  be = new Set([h.H1, h.H2, h.H3, h.H4, h.H5, h.H6]);
...
function we(e) {
  return Et(e) || e === r.SOLIDUS || e === r.GREATER_THAN_SIGN;
}
function wu(e) {
  return e === r.NULL
...
class Yu {
  constructor(t, a) {
    ((this.options = t),
      ...
      (this.preprocessor = new Su(a)),
      (this.currentLocation = this.getCurrentLocation(-1)),
      (this.entityDecoder = new Bu(
        gu,
        (s, c) => {
  ...
  _err(t, a = 0) {
    ...
    (c = (s = this.handler).onParseError) === null ||
      c === void 0 ||
      c.call(s, this.preprocessor.getError(t, a));
  }
  ...
  _createCommentToken(t) {
    this.currentToken = { type: _.COMMENT, data: "", location: this.getCurrentLocation(t) };
  }
  ...
  _leaveAttrName() {
    ...
    if (dt(s, this.currentAttr.name) === null) {
  ...
  _emitEOFToken() {
    ...
    (t && ((t.endLine = t.startLine), (t.endCol = t.startCol), (t.endOffset = t.startOffset)),
      ...
      this.handler.onEof({ type: _.EOF, location: t }),
      (this.active = !1));
  }
  ...
  _emitCodePoint(t) {
    const a = Et(t) ? _.WHITESPACE_CHARACTER : t === r.NULL ? _.NULL_CHARACTER : _.CHARACTER;
  ...
  _startCharacterReference() {
    ((this.returnState = this.state),
      ...
      this.entityDecoder.startEntity(
        this._isCharacterReferenceInAttribute() ? P.Attribute : P.Legacy,
      ));
  }
  ...
  _stateTagOpen(t) {
    if (M(t)) (this._createStartTagToken(), (this.state = n.TAG_NAME), this._stateTagName(t));
    else
      switch (t) {
  ...
  _stateEndTagOpen(t) {
    if (M(t)) (this._createEndTagToken(), (this.state = n.TAG_NAME), this._stateTagName(t));
    else
      switch (t) {
  ...
  _stateTagName(t) {
    ...
    switch (t) {
      ...
      default:
        a.tagName += String.fromCodePoint(X(t) ? ue(t) : t);
    }
  }
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(O.SCRIPT, !1) && we(this.preprocessor.peek(O.SCRIPT.length))) {
      this._emitCodePoint(t);
      for (let a = 0; a < O.SCRIPT.length; a++) this._emitCodePoint(this._consume());
  ...
  _stateAttributeName(t) {
    switch (t) {
      ...
      default:
        this.currentAttr.name += String.fromCodePoint(X(t) ? ue(t) : t);
    }
  }
  ...
  _stateMarkupDeclarationOpen(t) {
    this._consumeSequenceIfMatch(O.DASH_DASH, !0)
      ? (this._createCommentToken(O.DASH_DASH.length + 1), (this.state = n.COMMENT_START))
      : this._consumeSequenceIfMatch(O.DOCTYPE, !1)
        ? ((this.currentLocation = this.getCurrentLocation(O.DOCTYPE.length + 1)),
          (this.state = n.DOCTYPE))
        : this._consumeSequenceIfMatch(O.CDATA_START, !0)
          ? this.inForeignNode
            ? (this.state = n.CDATA_SECTION)
            : (this._err(E.cdataInHtmlContent),
              this._createCommentToken(O.CDATA_START.length + 1),
  ...
  _stateBeforeDoctypeName(t) {
    if (X(t)) (this._createDoctypeToken(String.fromCharCode(ue(t))), (this.state = n.DOCTYPE_NAME));
    else
      switch (t) {
        case r.SPACE:
        case r.LINE_FEED:
  ...
  _stateDoctypeName(t) {
    ...
    switch (t) {
      ...
      default:
        a.name += String.fromCodePoint(X(t) ? ue(t) : t);
    }
  }
  _stateAfterDoctypeName(t) {
    ...
    switch (t) {
      ...
      default:
        this._consumeSequenceIfMatch(O.PUBLIC, !1)
          ? (this.state = n.AFTER_DOCTYPE_PUBLIC_KEYWORD)
          : this._consumeSequenceIfMatch(O.SYSTEM, !1)
  ...
  _stateCharacterReference() {
    ...
    t === 0
      ? ((this.preprocessor.pos = this.entityStartPos),
        ...
        (this.state =
          !this._isCharacterReferenceInAttribute() && ye(this.preprocessor.peek(1))
...
const lt = new Set([u.DD, u.DT, u.LI, u.OPTGROUP, u.OPTION, u.P, u.RB, u.RP, u.RT, u.RTC]),
  Ye = new Set([...lt, u.CAPTION, u.COLGROUP, u.TBODY, u.TD, u.TFOOT, u.TH, u.THEAD, u.TR]),
  re = new Set([u.APPLET, u.CAPTION, u.HTML, u.MARQUEE, u.OBJECT, u.TABLE, u.TD, u.TEMPLATE, u.TH]),
  vu = new Set([...re, u.OL, u.UL]),
  Qu = new Set([...re, u.BUTTON]),
  ve = new Set([u.ANNOTATION_XML, u.MI, u.MN, u.MO, u.MS, u.MTEXT]),
  Qe = new Set([u.DESC, u.FOREIGN_OBJECT, u.TITLE]),
  Gu = new Set([u.TR, u.TEMPLATE, u.HTML]),
  Wu = new Set([u.TBODY, u.TFOOT, u.THEAD, u.TEMPLATE, u.HTML]),
  qu = new Set([u.TABLE, u.TEMPLATE, u.HTML]),
  Xu = new Set([u.TD, u.TH]);
class Ku {
  ...
  _isInTemplate() {
    return (
      this.currentTagId === u.TEMPLATE && this.treeAdapter.getNamespaceURI(this.current) === T.HTML
    );
  }
  ...
  popUntilNumberedHeaderPopped() {
    this.popUntilPopped(be, T.HTML);
  }
  popUntilTableCellPopped() {
    this.popUntilPopped(Xu, T.HTML);
  }
  ...
  _indexOfTagNames(t, a) {
    for (let s = this.stackTop; s >= 0; s--)
      if (t.has(this.tagIDs[s]) && this.treeAdapter.getNamespaceURI(this.items[s]) === a) return s;
    return -1;
  }
  clearBackTo(t, a) {
    const s = this._indexOfTagNames(t, a);
  ...
  clearBackToTableContext() {
    this.clearBackTo(qu, T.HTML);
  }
  clearBackToTableBodyContext() {
    this.clearBackTo(Wu, T.HTML);
  }
  ...
  hasInDynamicScope(t, a) {
    for (let s = this.stackTop; s >= 0; s--) {
      ...
      switch (this.treeAdapter.getNamespaceURI(this.items[s])) {
        ...
        case T.SVG: {
          if (Qe.has(c)) return !1;
          break;
        }
        case T.MATHML: {
          if (ve.has(c)) return !1;
          break;
        }
      }
    }
  ...
  hasInScope(t) {
    return this.hasInDynamicScope(t, re);
  }
  hasInListItemScope(t) {
    return this.hasInDynamicScope(t, vu);
  }
  hasInButtonScope(t) {
    return this.hasInDynamicScope(t, Qu);
  }
  hasNumberedHeaderInScope() {
    for (let t = this.stackTop; t >= 0; t--) {
      ...
      switch (this.treeAdapter.getNamespaceURI(this.items[t])) {
        case T.HTML: {
          if (be.has(a)) return !0;
          if (re.has(a)) return !1;
          break;
        }
        case T.SVG: {
          if (Qe.has(a)) return !1;
          break;
        }
        case T.MATHML: {
          if (ve.has(a)) return !1;
          break;
        }
      }
    }
  ...
  generateImpliedEndTags() {
    for (; this.currentTagId !== void 0 && lt.has(this.currentTagId);) this.pop();
  }
  generateImpliedEndTagsThoroughly() {
    for (; this.currentTagId !== void 0 && Ye.has(this.currentTagId);) this.pop();
  }
  generateImpliedEndTagsWithExclusion(t) {
    for (; this.currentTagId !== void 0 && this.currentTagId !== t && Ye.has(this.currentTagId);)
      this.pop();
  }
}
const Te = 3;
...
class Vu {
  ...
  _ensureNoahArkCondition(t) {
    ...
    if (s.length < Te) return;
    const c = new Map(a.map((l) => [l.name, l.value]));
    let d = 0;
    for (let l = 0; l < s.length; l++) {
      const m = s[l];
      m.attrs.every((f) => c.get(f.name) === f.value) &&
        ((d += 1), d >= Te && this.entries.splice(m.idx, 1));
    }
  }
  insertMarker() {
    this.entries.unshift(Ge);
  }
  pushElement(t, a) {
    (this._ensureNoahArkCondition(t),
      this.entries.unshift({ type: R.Element, element: t, token: a }));
  }
  insertElementAfterBookmark(t, a) {
    const s = this.entries.indexOf(this.bookmark);
    this.entries.splice(s, 0, { type: R.Element, element: t, token: a });
  }
  removeEntry(t) {
  ...
  clearToLastMarker() {
    const t = this.entries.indexOf(Ge);
    t === -1 ? (this.entries.length = 0) : this.entries.splice(0, t + 1);
  }
  getElementEntryInScopeWithTagName(t) {
    const a = this.entries.find(
      (s) => s.type === R.Marker || this.treeAdapter.getTagName(s.element) === t,
    );
...
const x = {
    createDocument() {
      return { nodeName: "#document", mode: g.NO_QUIRKS, childNodes: [] };
    },
    ...
    adoptAttributes(e, t) {
      ...
      for (let s = 0; s < t.length; s++) a.has(t[s].name) || e.attrs.push(t[s]);
    },
    getFirstChild(e) {
  ...
  Tt = "html",
  zu = "about:legacy-compat",
  ju = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd",
  ht = [
  ...
  Ju = [...ht, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"],
  $u = new Set([
    "-//w3o//dtd w3 html strict 3.0//en//",
    "-/w3c/dtd html 4.0 transitional/en",
    "html",
  ]),
  ft = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"],
  Zu = [...ft, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"];
function We(e, t) {
  return t.some((a) => e.startsWith(a));
}
function ea(e) {
  return e.name === Tt && e.publicId === null && (e.systemId === null || e.systemId === zu);
}
function ta(e) {
  if (e.name !== Tt) return g.QUIRKS;
  const { systemId: t } = e;
  if (t && t.toLowerCase() === ju) return g.QUIRKS;
  let { publicId: a } = e;
  if (a !== null) {
    if (((a = a.toLowerCase()), $u.has(a))) return g.QUIRKS;
    let s = t === null ? Ju : ht;
    if (We(a, s)) return g.QUIRKS;
    if (((s = t === null ? ft : Zu), We(a, s))) return g.LIMITED_QUIRKS;
  }
  return g.NO_QUIRKS;
}
const qe = { TEXT_HTML: "text/html", APPLICATION_XML: "application/xhtml+xml" },
  ua = "definitionurl",
  aa = "definitionURL",
  sa = new Map(
    [
...
function ca(e) {
  ...
  return (
    (t === u.FONT &&
      e.attrs.some(({ name: s }) => s === H.COLOR || s === H.SIZE || s === H.FACE)) ||
    ia.has(t)
  );
}
function mt(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === ua) {
      e.attrs[t].name = aa;
      break;
    }
}
function _t(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    const a = sa.get(e.attrs[t].name);
    a != null && (e.attrs[t].name = a);
  }
}
function Oe(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    const a = ra.get(e.attrs[t].name);
    a &&
...
function oa(e) {
  const t = na.get(e.tagName);
  t != null && ((e.tagName = t), (e.tagID = Q(e.tagName)));
}
function da(e, t) {
...
function la(e, t, a, s) {
  return ((!s || s === T.HTML) && Ea(e, t, a)) || ((!s || s === T.MATHML) && da(e, t));
}
const Ta = "hidden",
  ha = 8,
  fa = 3;
...
const ma = { startLine: -1, startCol: -1, startOffset: -1, endLine: -1, endCol: -1, endOffset: -1 },
  bt = new Set([u.TABLE, u.TBODY, u.TFOOT, u.THEAD, u.TR]),
  Xe = { scriptingEnabled: !0, sourceCodeLocationInfo: !1, treeAdapter: x, onParseError: null };
class Ke {
  constructor(t, a, s = null, c = null) {
    ((this.fragmentContext = s),
      ...
      (this.tokenizer = new Yu(this.options, this)),
      (this.activeFormattingElements = new Vu(this.treeAdapter)),
      (this.fragmentContextID = s ? Q(this.treeAdapter.getTagName(s)) : u.UNKNOWN),
      this._setContextModes(s ?? this.document, this.fragmentContextID),
      (this.openElements = new Ku(this.document, this.treeAdapter, this)));
  }
  static parse(t, a) {
    const s = new this(a);
  ...
  static getFragmentParser(t, a) {
    ...
    const c = s.treeAdapter.createElement("documentmock", T.HTML, []),
      d = new this(s, c, t);
    return (
      d.fragmentContextID === u.TEMPLATE && d.tmplInsertionModeStack.unshift(i.IN_TEMPLATE),
  ...
  _err(t, a, s) {
    ...
    const d = (c = t.location) !== null && c !== void 0 ? c : ma,
      l = {
        code: a,
  ...
  onItemPop(t, a) {
    ...
    if (
      ...
      (this.openElements.stackTop === 0 && this.fragmentContext
        ? ((d = this.fragmentContext), (l = this.fragmentContextID))
        : ({ current: d, currentTagId: l } = this.openElements),
        this._setContextModes(d, l));
    }
  }
  _setContextModes(t, a) {
    ...
    ((this.currentNotInHTML = !s),
      (this.tokenizer.inForeignNode =
        !s && t !== void 0 && a !== void 0 && !this._isIntegrationPoint(a, t)));
  }
  ...
  _initTokenizerForFragmentParsing() {
    if (!(
      !this.fragmentContext || this.treeAdapter.getNamespaceURI(this.fragmentContext) !== T.HTML
    ))
  ...
  _insertTemplate(t) {
    const a = this.treeAdapter.createElement(t.tagName, T.HTML, t.attrs),
  ...
  _insertCharacters(t) {
    ...
    if (
      (this._shouldFosterParentOnInsertion()
        ? (({ parent: a, beforeElement: s } = this._findFosterParentingLocation()),
          s
            ? this.treeAdapter.insertTextBefore(a, t.chars, s)
      ...
      return;
    const c = this.treeAdapter.getChildNodes(a),
  ...
  shouldProcessStartTagTokenInForeignContent(t) {
    ...
    return (
      this.openElements.stackTop === 0 && this.fragmentContext
        ? ((a = this.fragmentContext), (s = this.fragmentContextID))
        : ({ current: a, currentTagId: s } = this.openElements),
      t.tagID === u.SVG &&
      this.treeAdapter.getTagName(a) === o.ANNOTATION_XML &&
      this.treeAdapter.getNamespaceURI(a) === T.MATHML
        ? !1
        : this.tokenizer.inForeignNode ||
          ((t.tagID === u.MGLYPH || t.tagID === u.MALIGNMARK) &&
            s !== void 0 &&
            !this._isIntegrationPoint(s, a, T.HTML))
    );
  }
  _processToken(t) {
    switch (t.type) {
  ...
  _isIntegrationPoint(t, a, s) {
    const c = this.treeAdapter.getNamespaceURI(a),
  ...
  _reconstructActiveFormattingElements() {
    ...
    if (t) {
      const a = this.activeFormattingElements.entries.findIndex(
          (c) => c.type === R.Marker || this.openElements.contains(c.element),
        ),
        s = a === -1 ? t - 1 : a - 1;
      for (let c = s; c >= 0; c--) {
  ...
  onEndTag(t) {
    ((this.skipNextNewLine = !1),
      (this.currentToken = t),
      this.currentNotInHTML ? Vs(this, t) : this._endTagOutsideForeignContent(t));
  }
...
function Aa(e, t, a) {
  ...
  for (let d = 0, l = c; l !== a; d++, l = c) {
    ...
    const m = e.activeFormattingElements.getElementEntry(l),
      f = m && d >= fa;
    !m || f
      ? (f && e.activeFormattingElements.removeEntry(m), e.openElements.remove(l))
      : ((l = Na(e, m)),
...
function Ia(e, t, a) {
  ...
  if (e._isElementCausesFosterParenting(c)) e._fosterParentElement(a);
    ...
    (c === u.TEMPLATE && d === T.HTML && (t = e.treeAdapter.getTemplateContent(t)),
      e.treeAdapter.appendChild(t, a));
  }
}
function pa(e, t, a) {
  const s = e.treeAdapter.getNamespaceURI(a.element),
    { token: c } = a,
...
function Se(e, t) {
  for (let a = 0; a < ha; a++) {
    ...
    const d = Aa(e, c, s.element),
      l = e.openElements.getCommonAncestor(s.element);
    (e.treeAdapter.detachNode(d), l && Ia(e, l, d), pa(e, c, s));
  }
}
function Ae(e, t) {
    ...
    if (!e.fragmentContext && e.openElements.stackTop >= 0) {
      ...
      if (c && !c.endTag && (e._setEndLocation(s, t), e.openElements.stackTop >= 1)) {
        const d = e.openElements.items[1],
          l = e.treeAdapter.getNodeSourceCodeLocation(d);
...
function Sa(e, t) {
  ...
  const a = t.forceQuirks ? g.QUIRKS : ta(t);
  (ea(t) || e._err(t, E.nonConformingDoctype),
    e.treeAdapter.setDocumentMode(e.document, a),
    (e.insertionMode = i.BEFORE_HTML));
}
function W(e, t) {
  (e._err(t, E.missingDoctype, !0),
    e.treeAdapter.setDocumentMode(e.document, g.QUIRKS),
    (e.insertionMode = i.BEFORE_HTML),
    e._processToken(t));
}
function ga(e, t) {
  t.tagID === u.HTML ? (e._insertElement(t, T.HTML), (e.insertionMode = i.BEFORE_HEAD)) : K(e, t);
}
function La(e, t) {
  const a = t.tagID;
  ...
  switch (t.tagID) {
    ...
    case u.NOSCRIPT: {
      e.options.scriptingEnabled
        ...
        : (e._insertElement(t, T.HTML), (e.insertionMode = i.IN_HEAD_NO_SCRIPT));
      break;
    }
    case u.NOFRAMES:
    case u.STYLE: {
...
function J(e, t) {
  (e._insertFakeElement(o.BODY, u.BODY), (e.insertionMode = i.IN_BODY), oe(e, t));
}
function oe(e, t) {
  switch (t.type) {
    case _.CHARACTER: {
...
function wa(e, t) {
  (e.openElements.hasInButtonScope(u.P) && e._closePElement(),
    e.openElements.currentTagId !== void 0 &&
      be.has(e.openElements.currentTagId) &&
      e.openElements.pop(),
    e._insertElement(t, T.HTML));
}
function Ya(e, t) {
...
function qa(e, t) {
  ...
  (a && (Se(e, t), e.openElements.remove(a.element), e.activeFormattingElements.removeEntry(a)),
    e._reconstructActiveFormattingElements(),
    e._insertElement(t, T.HTML),
...
function Ka(e, t) {
  (e._reconstructActiveFormattingElements(),
    e.openElements.hasInScope(u.NOBR) && (Se(e, t), e._reconstructActiveFormattingElements()),
    e._insertElement(t, T.HTML),
    e.activeFormattingElements.pushElement(e.openElements.current, t));
}
function Va(e, t) {
...
function za(e, t) {
  (e.treeAdapter.getDocumentMode(e.document) !== g.QUIRKS &&
...
function pt(e) {
  const t = dt(e, H.TYPE);
  return t != null && t.toLowerCase() === Ta;
}
function ja(e, t) {
  (e._reconstructActiveFormattingElements(),
    e._appendElement(t, T.HTML),
...
function Za(e, t) {
  ((t.tagName = o.IMG), (t.tagID = u.IMG), It(e, t));
}
function es(e, t) {
  (e._insertElement(t, T.HTML),
    (e.skipNextNewLine = !0),
...
function rs(e, t) {
  (e.openElements.hasInScope(u.RUBY) && e.openElements.generateImpliedEndTags(),
    e._insertElement(t, T.HTML));
}
function ns(e, t) {
  (e.openElements.hasInScope(u.RUBY) && e.openElements.generateImpliedEndTagsWithExclusion(u.RTC),
    e._insertElement(t, T.HTML));
}
function is(e, t) {
  (e._reconstructActiveFormattingElements(),
    mt(t),
    Oe(t),
    t.selfClosing ? e._appendElement(t, T.MATHML) : e._insertElement(t, T.MATHML),
    (t.ackSelfClosing = !0));
}
function cs(e, t) {
  (e._reconstructActiveFormattingElements(),
...
function ds(e, t) {
  e.openElements.hasInScope(u.BODY) && ((e.insertionMode = i.AFTER_BODY), xt(e, t));
}
function Es(e, t) {
  const a = t.tagID;
...
function ls(e) {
  ...
  (t || (e.formElement = null),
    (a || t) &&
      ...
      t ? e.openElements.popUntilTagNamePopped(u.FORM) : a && e.openElements.remove(a)));
}
function Ts(e) {
...
function Ct(e, t) {
  ...
  for (let c = e.openElements.stackTop; c > 0; c--) {
    ...
    if (e._isSpecialElement(d, l)) break;
  }
}
function de(e, t) {
  switch (t.tagID) {
...
function Ot(e, t) {
  e.tmplInsertionModeStack.length > 0 ? Mt(e, t) : ge(e, t);
}
function As(e, t) {
  var a;
  (t.tagID === u.SCRIPT &&
...
function he(e, t) {
  if (e.openElements.currentTagId !== void 0 && bt.has(e.openElements.currentTagId))
    switch (
...
function gs(e, t) {
  e.openElements.hasInTableScope(u.TABLE) &&
    (e.openElements.popUntilTagNamePopped(u.TABLE), e._resetInsertionMode(), e._processStartTag(t));
}
function Ls(e, t) {
  (pt(t) ? e._appendElement(t, T.HTML) : ee(e, t), (t.ackSelfClosing = !0));
}
function Rs(e, t) {
  !e.formElement &&
    e.openElements.tmplCount === 0 &&
    (e._insertElement(t, T.HTML), (e.formElement = e.openElements.current), e.openElements.pop());
}
function Y(e, t) {
  switch (t.tagID) {
    case u.TD:
...
function $(e, t) {
  switch (t.tagID) {
    case u.TABLE: {
      e.openElements.hasInTableScope(u.TABLE) &&
        (e.openElements.popUntilTagNamePopped(u.TABLE), e._resetInsertionMode());
      break;
    }
    case u.TEMPLATE: {
      F(e, t);
...
function q(e, t) {
  ...
  if (e.hasNonWhitespacePendingCharacterToken)
    for (; a < e.pendingCharacterTokens.length; a++) ee(e, e.pendingCharacterTokens[a]);
  else
    for (; a < e.pendingCharacterTokens.length; a++)
      e._insertCharacters(e.pendingCharacterTokens[a]);
  ((e.insertionMode = e.originalInsertionMode), e._processToken(t));
}
const Lt = new Set([u.CAPTION, u.COL, u.COLGROUP, u.TBODY, u.TD, u.TFOOT, u.TH, u.THEAD, u.TR]);
function Ds(e, t) {
  const a = t.tagID;
  Lt.has(a)
...
function Rt(e, t) {
  switch (t.tagID) {
    ...
    case u.TFOOT:
    case u.THEAD: {
      (e.openElements.hasInTableScope(t.tagID) || e.openElements.hasInTableScope(u.TR)) &&
        (e.openElements.clearBackToTableRowContext(),
        e.openElements.pop(),
        (e.insertionMode = i.IN_TABLE_BODY),
        Ne(e, t));
...
function xs(e, t) {
  const a = t.tagID;
  Lt.has(a)
    ? (e.openElements.hasInTableScope(u.TD) || e.openElements.hasInTableScope(u.TH)) &&
      (e._closeTableCell(), le(e, t))
    : C(e, t);
}
function Bs(e, t) {
  const a = t.tagID;
  switch (a) {
    ...
    case u.THEAD:
    case u.TR: {
      e.openElements.hasInTableScope(a) && (e._closeTableCell(), Rt(e, t));
      break;
    }
    case u.BODY:
    case u.CAPTION:
...
function Pt(e, t) {
  switch (t.tagID) {
    ...
    case u.SELECT: {
      e.openElements.hasInSelectScope(u.SELECT) &&
        (e.openElements.popUntilTagNamePopped(u.SELECT), e._resetInsertionMode());
      break;
    }
    case u.TEMPLATE: {
      F(e, t);
...
function Hs(e, t) {
  ...
  a === u.TH
    ? e.openElements.hasInTableScope(a) &&
      (e.openElements.popUntilTagNamePopped(u.SELECT), e._resetInsertionMode(), e.onEndTag(t))
    : Pt(e, t);
}
function Us(e, t) {
  switch (t.tagID) {
    ...
    case u.TFOOT:
    case u.THEAD: {
      ((e.tmplInsertionModeStack[0] = i.IN_TABLE), (e.insertionMode = i.IN_TABLE), Y(e, t));
      break;
    }
    case u.COL: {
    ...
    case u.TD:
    case u.TH: {
      ((e.tmplInsertionModeStack[0] = i.IN_ROW), (e.insertionMode = i.IN_ROW), le(e, t));
      break;
    }
    default:
      ((e.tmplInsertionModeStack[0] = i.IN_BODY), (e.insertionMode = i.IN_BODY), C(e, t));
  }
}
function Fs(e, t) {
...
function xt(e, t) {
  ...
  if (t.tagID === u.HTML) {
    if (
      ...
      s &&
        !(
          !((a = e.treeAdapter.getNodeSourceCodeLocation(s)) === null || a === void 0) && a.endTag
        ) &&
...
function ie(e, t) {
  ((e.insertionMode = i.IN_BODY), oe(e, t));
}
function ws(e, t) {
  switch (t.tagID) {
    case u.HTML: {
...
function Ks(e, t) {
  if (ca(t)) (Bt(e), e._startTagOutsideForeignContent(t));
  else {
    const a = e._getAdjustedCurrentElement(),
      s = e.treeAdapter.getNamespaceURI(a);
    (s === T.MATHML ? mt(t) : s === T.SVG && (oa(t), _t(t)),
      Oe(t),
...
function Vs(e, t) {
  if (t.tagID === u.P || t.tagID === u.BR) {
    (Bt(e), e._endTagOutsideForeignContent(t));
    return;
  }
...
const zs =
  ...
  je = { sourceCodeLocationInfo: !0, scriptingEnabled: !1 };
function kt(e, t) {
  const a = nr(e),
    s = ut("type", {
      handlers: { root: Js, element: $s, text: Zs, comment: Ut, doctype: er, raw: ur },
      unknown: ar,
    }),
    c = {
      parser: a ? new Ke(je) : Ke.getFragmentParser(void 0, je),
      handle(m) {
        s(m, c);
      },
      stitches: !1,
  ...
  (s(e, c), G(c, U()));
  const d = a ? c.parser.document : c.parser.getFragment(),
    l = iu(d, { file: c.options.file });
  return (
    c.stitches &&
      Qt(l, "comment", function (m, f, b) {
        const S = m;
        if (S.value.stitch && b && f !== void 0) {
          const y = b.children;
          return ((y[f] = S.value.stitch), f);
        }
      }),
    l.type === "root" && l.children.length === 1 && l.children[0].type === e.type
      ? l.children[0]
      : l
  );
}
...
function $s(e, t) {
  (sr(e, t), Ht(e.children, t), rr(e, t));
}
function Zs(e, t) {
  t.parser.tokenizer.state > 4 && (t.parser.tokenizer.state = 0);
  const a = { type: _.CHARACTER, chars: e.value, location: te(e) };
  (G(t, U(e)), (t.parser.currentToken = a), t.parser._processToken(t.parser.currentToken));
}
function er(e, t) {
  const a = {
    type: _.DOCTYPE,
...
function tr(e, t) {
  ...
  if ("children" in e && "children" in a) {
    const s = kt({ type: "root", children: e.children }, t.options);
    a.children = s.children;
  }
  Ut({ type: "comment", value: { stitch: a } }, t);
}
function Ut(e, t) {
  const a = e.value,
    s = { type: _.COMMENT, data: a, location: te(e) };
  (G(t, U(e)), (t.parser.currentToken = s), t.parser._processToken(t.parser.currentToken));
}
function ur(e, t) {
  if (
    ...
    Ft(t, U(e)),
    t.parser.tokenizer.write(t.options.tagfilter ? e.value.replace(zs, "&lt;$1$2") : e.value, !1),
...
function ar(e, t) {
  const a = e;
  if (t.options.passThrough && t.options.passThrough.includes(a.type)) tr(a, t);
  else {
    let s = "";
    throw (
      js.has(a.type) &&
      ...
      new Error("Cannot compile `" + a.type + "` node" + s)
    );
  }
}
function G(e, t) {
  ...
  (a &&
    ...
    (e.parser.tokenizer.returnState = N.DATA),
...
function sr(e, t) {
  ...
  let c = "namespaceURI" in s ? s.namespaceURI : k.html;
  c === k.html && a === "svg" && (c = k.svg);
  const d = lu({ ...e, children: [] }, { space: c === k.svg ? "svg" : "html" }),
    l = {
      type: _.START_TAG,
      tagName: a,
      tagID: Q(a),
...
function rr(e, t) {
  const a = e.tagName.toLowerCase();
  if (
    (!t.parser.tokenizer.inForeignNode && Nu.includes(a)) ||
    t.parser.tokenizer.state === N.PLAINTEXT
  )
    return;
  G(t, et(e));
  const s = {
  ...
  ((t.parser.currentToken = s),
    ...
    a === t.parser.tokenizer.lastStartTagName &&
      (t.parser.tokenizer.state === N.RCDATA ||
        t.parser.tokenizer.state === N.RAWTEXT ||
        t.parser.tokenizer.state === N.SCRIPT_DATA) &&
      (t.parser.tokenizer.state = N.DATA));
}
function nr(e) {
...
function te(e) {
  const t = U(e) || { line: void 0, column: void 0, offset: void 0 },
    a = et(e) || { line: void 0, column: void 0, offset: void 0 };
  return {
    startLine: t.line,
    startCol: t.column,
    startOffset: t.offset,
...
function ir(e) {
  return "children" in e ? xe({ ...e, children: [] }) : xe(e);
}
function cr(e) {
  return function (t, a) {
    return kt(t, { ...e, file: a });
  };
}
const Je = new RegExp(tt),
  or = new Set(["code", "inlineCode"]);
function dr(e, t, a) {
  const s = zt(e, t, a);
  return {
    type: "text",
    ...
    data: {
      hName: "span",
      hProperties: { className: "select-none", "aria-label": "Redacted content", style: jt(e) },
...
`);
  for (let s = 0; s < a.length; s++)
    (s > 0 && t.push({ type: "break" }), a[s] && t.push({ type: "text", value: a[s] }));
}
function $e(e, t, a) {
  const s = [],
    c = new RegExp(tt, "g");
  let d = 0,
    l;
  for (; (l = c.exec(e)) !== null;) {
    l.index > d && a(e.slice(d, l.index), s);
    const m = l[1] === "h" ? "half" : "full";
    (s.push(dr(m, Number.parseInt(l[2], 10), t())), (d = l.index + l[0].length));
  }
  return (d < e.length && a(e.slice(d), s), s);
}
function yt(e, t) {
  const a = [];
...
`) || Je.test(c)
    ...
    if (s.type === "html") {
      const { value: c } = s;
      Je.test(c) ? a.push(...$e(c, t, (d, l) => l.push({ type: "html", value: d }))) : a.push(s);
      continue;
    }
    ("children" in s && Array.isArray(s.children) && yt(s, t), a.push(s));
  }
  e.children = a;
}
const lr = () => (e) => {
  ...
  Tr = [Wt, lr],
  hr = [cr],
  Ze = "font-semibold text-primary",
  fr = ["script", "style", "iframe", "object", "embed", "form", "input", "link", "meta", "base"],
  mr = {
    p: ({ children: e }) => D.jsx("p", { className: "mb-4 last:mb-0", children: e }),
    hr: () => D.jsx("hr", { className: "mb-4 border-border/50" }),
    ul: ({ children: e }) =>
      D.jsx("ul", { className: "mb-4 list-disc pl-5 space-y-1 last:mb-0", children: e }),
    ol: ({ children: e }) =>
      D.jsx("ol", { className: "mb-4 list-decimal pl-5 space-y-1 last:mb-0", children: e }),
    strong: ({ children: e }) => D.jsx("strong", { className: Ze, children: e }),
    b: ({ children: e }) => D.jsx("b", { className: Ze, children: e }),
    a: ({ children: e, href: t }) => {
      ...
      return a.startsWith("http://") || a.startsWith("https://")
        ? D.jsx("span", {
            ...
            onClick: () => void Re(a),
            onKeyDown: (c) => {
              (c.key === "Enter" || c.key === " ") && (c.preventDefault(), Re(a));
            },
