import { j as o, l as H } from "./index-CyHAbkO5.js";
import { r as d, o as re, b as $, s as he, _ as ln, a as cn, u as Se } from "./i18n-DtIC1LRi.js";
import {
  a as b,
  F as le,
  c as G,
  ...
  d as Sn,
  P as jn,
} from "./moleskineComponents-DxZW-ZrL.js";
import {
  Graphics as _e,
  Rectangle as ze,
  Application as Rn,
  Container as Cn,
} from "./index-BsHKXFB1.js";
import {
  p as ge,
  ce as Mn,
  aL as Nn,
...
import { T as Wn, a as Yn, b as Hn } from "./tooltip-DSjmCc9t.js";
import { a as $n } from "./ChatPanel-BVBzPw5d.js";
import "./CardPreviewContext-C0SSQTqj.js";
import { P as Un } from "./HelpOverlay-DERW7xRx.js";
import "./scroll-area-CdLZUFfR.js";
import "./zap-BiEriS6T.js";
import "./use-animation-B4di4aFs.js";
function Vn() {
  ge("partygames-pictionary-correct-answer");
}
const Xn = 180;
let Oe = null,
  xe = null;
function Ne() {
  try {
    const n = Mn["partygames-pictionary-pen-scratch"];
    if (!n) return;
    const e = Nn.getInstance();
    if (!e.isInitialized || !e.sfx.isLoaded(n.key)) return;
    ((Oe ??= e.sfx.play(n.key, { volume: n.gain, loop: !0 })),
      xe && clearTimeout(xe),
      (xe = setTimeout(Ae, Xn)));
  } catch {}
}
function Ae() {
  (xe && (clearTimeout(xe), (xe = null)), Oe?.stop(), (Oe = null));
}
function ue(n) {
  if (!n) return 0;
...
const Kn = d.forwardRef(function (
  {
    width: e,
    height: r,
    style: s,
    canvasColor: a = "#ffffff",
    strokeColor: i,
    strokeWidth: t,
    eraserWidth: l,
    onStroke: c,
  ...
  return (
    d.useEffect(() => {
      ((z.current = i), (N.current = t), (Y.current = l));
    }, [i, t, l]),
    d.useEffect(() => {
      ((ie.current = c), (Z.current = w), (ee.current = u), (P.current = m));
    }, [c, w, u, m]),
    d.useEffect(() => {
      let f = !1;
      return (
        (async () => {
          ...
          ((S.current = v), x.current.append(v.canvas));
          const E = v.canvas;
          ((E.style.width = "100%"),
            (E.style.height = "100%"),
          ...
          const A = new _e();
          ((C.current = A), v.stage.addChild(A));
          const k = new Cn();
          ((I.current = k),
            v.stage.addChild(k),
            (v.stage.eventMode = "static"),
            (v.stage.hitArea = new ze(0, 0, v.renderer.width, v.renderer.height)));
          const p = (K, T) => {
              const B = v.stage.toLocal({ x: K, y: T }),
                oe = k.scale.x || 1,
                se = k.scale.y || 1;
              return { x: B.x / oe, y: B.y / se };
            },
            F = (K) => {
              O.current = !0;
              const T = p(K.global.x, K.global.y);
              D.current = T;
              const B = new _e();
              W.current = B;
              const oe = g.current ? ue(V.current) : ue(z.current),
                se = g.current ? Y.current : N.current;
              (B.moveTo(T.x, T.y),
                B.lineTo(T.x, T.y),
                B.stroke({ color: oe, width: se, cap: "round", join: "round" }),
                k.addChild(B));
              const ce = g.current ? V.current : z.current,
                de = g.current ? Y.current : N.current;
              ((J.current = { color: ce, width: de }),
                (M.current = [{ x: T.x, y: T.y }]),
                Ne(),
                Z.current?.());
            },
            X = (K) => {
              ...
              const oe = g.current ? ue(V.current) : ue(z.current),
                se = g.current ? Y.current : N.current;
              (B.stroke({ color: oe, width: se, cap: "round", join: "round" }), (D.current = T));
              const ce = M.current;
              if (ce) {
                const de = ce.at(-1);
                (!de || de.x !== T.x || de.y !== T.y) &&
                  (ce.push({ x: T.x, y: T.y }), Ne(), ee.current?.());
              }
            },
            te = () => {
              ((O.current = !1), (D.current = null), (W.current = null), Ae());
              const K = M.current,
                T = J.current;
              ((M.current = null), (J.current = null), P.current?.());
              const B = ie.current;
              if (B && K && T && K.length >= 2) {
                const oe = R.current,
                  se = Math.max(1, oe?.width ?? v.renderer.width),
                  ce = Math.max(1, oe?.height ?? v.renderer.height),
                  de = K.map((Q) => ({
                    x: Math.min(1, Math.max(0, Q.x / se)),
                    y: Math.min(1, Math.max(0, Q.y / ce)),
                  })),
                  h = Math.max(1, Math.ceil(de.length / 128)),
                  q = de.filter((Q, ne) => ne % h === 0);
                q.length >= 2 && B({ points: q, color: T.color, width: T.width });
              }
            };
          (v.stage.on("pointerdown", F),
            v.stage.on("pointermove", X),
            v.stage.on("pointerup", te),
            v.stage.on("pointerupoutside", te));
          const Re = new ResizeObserver(() => {
            if (!x.current) return;
            const K = x.current.getBoundingClientRect(),
              T = Math.max(1, Math.floor(K.width)),
              B = Math.max(1, Math.floor(K.height));
            if (
              (!R.current && T > 16 && B > 16 && (R.current = { width: T, height: B }),
              v.renderer.resize(T, B),
              A.clear(),
              A.rect(0, 0, T, B).fill({ color: ue(V.current) }),
              (v.stage.hitArea = new ze(0, 0, T, B)),
              R.current)
            ) {
              const oe = T / R.current.width,
                se = B / R.current.height;
              k.scale.set(oe, se);
            }
            v.render();
          });
          return (
            Re.observe(x.current),
            () => {
              Re.disconnect();
            }
          );
        ...
        () => {
          ...
          if (v) {
            ...
            ((S.current = null), (I.current = null), (C.current = null));
          }
        }
      );
    }, []),
    d.useEffect(() => {
      ...
      const f = S.current,
        j = C.current;
      if (f && j) {
        const v = f.renderer.width,
          E = f.renderer.height;
        (j.clear(), j.rect(0, 0, v, E).fill({ color: ue(a) }), f.render());
      }
    }, [a]),
    d.useImperativeHandle(
      ...
      () => ({
        exportImage: async () => {
          const f = S.current;
          return f ? (f.render(), f.canvas.toDataURL("image/png")) : "";
        },
        clearCanvas: () => {
          const f = I.current,
            j = S.current;
          if (f && (f.removeChildren(), j)) {
            const v = j.renderer.width,
              E = j.renderer.height;
            v > 16 && E > 16 && ((R.current = { width: v, height: E }), f.scale.set(1, 1));
          }
        },
        eraseMode: (f) => {
          g.current = !!f;
        ...
        getSize: () => {
          if (R.current) return { width: R.current.width, height: R.current.height };
          const f = S.current;
          return f
            ? { width: f.renderer.width, height: f.renderer.height }
            : { width: 0, height: 0 };
        },
        getClientSize: () => {
          const f = x.current;
          ...
          return { width: Math.floor(j.width), height: Math.floor(j.height) };
        },
        forceResize: () => {
          const f = S.current,
            j = x.current,
          ...
          const A = j.getBoundingClientRect(),
            k = Math.max(1, Math.floor(A.width)),
            p = Math.max(1, Math.floor(A.height));
          if (k !== f.renderer.width || p !== f.renderer.height) {
            if (
              (!R.current && k > 16 && p > 16 && (R.current = { width: k, height: p }),
              f.renderer.resize(k, p),
              v.clear(),
              v.rect(0, 0, k, p).fill({ color: ue(V.current) }),
              (f.stage.hitArea = new ze(0, 0, k, p)),
              R.current)
            ) {
              const F = k / R.current.width,
                X = p / R.current.height;
              E.scale.set(F, X);
            }
            f.render();
          }
        ...
        beginStroke: (f, j, v) => {
          ...
          const A = new _e();
          W.current = A;
          const k = v?.color ?? z.current,
            p = v?.width ?? N.current,
            F = ue(k);
          (A.moveTo(f, j),
            A.lineTo(f, j),
            A.stroke({ color: F, width: p, cap: "round", join: "round" }),
            E.addChild(A),
            (D.current = { x: f, y: j }),
            Ne());
        },
        extendStroke: (f, j, v) => {
          const E = W.current;
          if (!E) return;
          const A = v?.color ?? z.current,
            k = v?.width ?? N.current,
            p = ue(A);
          (E.lineTo(f, j),
            E.stroke({ color: p, width: k, cap: "round", join: "round" }),
            (D.current = { x: f, y: j }),
            Ne());
        },
        endStroke: () => {
          ((W.current = null), (D.current = null), Ae());
        },
      }),
      [],
    ),
    o.jsx("div", {
      ref: x,
      style: {
        width: typeof e == "number" ? `${e}px` : (e ?? "100%"),
        height: typeof r == "number" ? `${r}px` : (r ?? "100%"),
        display: "block",
        ...s,
      },
    })
...
class Qn {
  ...
  beginStroke(e, r, s) {
    this.canvasRef.current?.beginStroke(e, r, s);
  }
  extendStroke(e, r) {
    this.canvasRef.current?.extendStroke(e, r);
  }
  endStroke() {
    this.canvasRef.current?.endStroke();
  }
  clear() {
    this.canvasRef.current?.clearCanvas();
  }
  exportImage(e) {
    return this.canvasRef.current?.exportImage(e) ?? Promise.resolve("");
  }
  getSize() {
    return this.canvasRef.current?.getSize() ?? { width: 0, height: 0 };
  }
  getClientSize() {
    return this.canvasRef.current?.getClientSize() ?? { width: 0, height: 0 };
  }
  forceResize() {
    this.canvasRef.current?.forceResize();
  }
}
const Jn = `aircraft carrier
airplane
alarm clock
ambulance
angel
...
function rr(n) {
  try {
    ...
    return (H.warn("[Drawings] Failed to parse drawings.json", e), null);
  }
}
function or(n) {
...
function sr(n) {
  ...
  for (const s of Object.keys(e)) {
    const a = e[s];
    Array.isArray(a) && (r[String(s).toLowerCase()] = a);
  }
  ...
  return (
    Le ||
      (Le = fetch(nr)
        ...
        .then((n) => ((Ie = sr(n)), Ie))
        .catch((n) => (H.warn("[Drawings] Failed to fetch drawings.json", n), (Ie = {}), Ie))),
    Le
  );
}
function ir() {
  return (
    Ie ||
    (H.warn("[Drawings] Index read before ensureDrawingsLoaded() resolved; returning empty"), {})
  );
}
function De(n) {
...
function mn(n) {
  ...
  const i = Object.keys(e).find((t) => t.includes(r) || r.includes(t));
  return i ? e[i] || [] : (H.warn("[Drawings] No samples for word:", n), []);
}
function tr(n, e = new Set()) {
  const r = mn(n);
  if (!r.length) return null;
  const s = r.map((t, l) => l).filter((t) => !e.has(t));
  if (s.length === 0) {
...
function dr(n, e) {
  return mn(n).indexOf(e);
}
const be = {
    NORI_STROKE_POINT_DELAY_MS: 15,
    NORI_STROKE_GAP_MIN_MS: 300,
    NORI_STROKE_GAP_MAX_MS: 2e3,
    NORI_REDRAW_IDLE_MS: 1e4,
  },
  lr = 0.16,
  Ve = (n, e, r) => (n < e ? e : n > r ? r : n);
function cr(n, e = 2) {
  if (n.length < 3 || e <= 0) return n;
  let r = n;
  for (let s = 0; s < e && !(r.length < 3); s++) {
    const a = [r[0]];
    for (let i = 0; i < r.length - 1; i++) {
      const t = r[i],
        l = r[i + 1],
        c = { x: 0.75 * t.x + 0.25 * l.x, y: 0.75 * t.y + 0.25 * l.y },
        w = { x: 0.25 * t.x + 0.75 * l.x, y: 0.25 * t.y + 0.75 * l.y };
      a.push(c, w);
    }
    (a.push(r.at(-1)), (r = a));
  }
...
class mr {
  ...
  stopFlag = !1;
  isRunning = !1;
  onFinishedOnceCallback;
  constructor(e, r, s) {
    ((this.drawer = e), (this.word = r), (this.onFinishedOnceCallback = s));
  }
  async start() {
    if (this.isRunning) return;
    ((this.isRunning = !0), (this.cancelled = !1), (this.stopFlag = !1), (this.finishedAt = null));
    const e = performance.now();
    if (
      (H.info("[NoriAutoDrawer] Starting for word:", this.word),
      await ar(),
      this.cancelled || this.stopFlag)
    )
      return;
    await this.waitForReady();
    const r = performance.now();
    (H.info("[NoriAutoDrawer] waitForReady took", Math.round(r - e), "ms"),
      !(this.cancelled || this.stopFlag) &&
        (await this.kick(),
        H.info(
          "[NoriAutoDrawer] First stroke started after",
  ...
  stop() {
    ((this.isRunning = !1),
      (this.cancelled = !0),
      (this.stopFlag = !0),
      this.redrawTimer !== null && (clearTimeout(this.redrawTimer), (this.redrawTimer = null)));
  }
  setStopFlag(e) {
    this.stopFlag = e;
  }
  async waitForReady() {
    ...
    let r = !1,
      s = !1;
    for (; !this.cancelled && !this.stopFlag;) {
      if (!this.drawer.isReady()) {
        if (
          (r || (H.info("[NoriAutoDrawer] Waiting for drawer.isReady()..."), (r = !0)),
          performance.now() - e > 5e3)
        ) {
          H.warn(
            "[NoriAutoDrawer] Timeout waiting for drawer; proceeding after",
            Math.round(performance.now() - e),
            "ms",
          );
          break;
        }
        await new Promise((w) => requestAnimationFrame(() => w()));
        continue;
      }
      const a = this.drawer.getSize(),
        i = this.drawer.getClientSize ? this.drawer.getClientSize() : a,
        t = i.width > 8 && i.height > 8,
        l = a.width > 8 && a.height > 8;
      if (t && l && Math.abs(a.width - i.width) <= 2 && Math.abs(a.height - i.height) <= 2) {
        H.info(
          "[NoriAutoDrawer] Drawer ready and aligned after",
          Math.round(performance.now() - e),
          "ms",
          a,
        );
      ...
      if (
        (s ||
          (H.info("[NoriAutoDrawer] Waiting for canvas alignment...", {
            rendererSize: a,
            clientSize: i,
            hostReady: t,
            rendererReady: l,
          ...
          (s = !0)),
        t &&
          this.drawer.forceResize &&
          (Math.abs(a.width - i.width) > 2 || Math.abs(a.height - i.height) > 2))
      ) {
        (this.drawer.forceResize(), await new Promise((u) => requestAnimationFrame(() => u())));
        continue;
      }
      if (performance.now() - e > 5e3) {
        H.warn(
          "[NoriAutoDrawer] Timeout waiting for alignment; proceeding after",
          Math.round(performance.now() - e),
          "ms",
          { rendererSize: a, clientSize: i },
        );
        break;
      }
      await new Promise((w) => requestAnimationFrame(() => w()));
  ...
  ensureSample() {
    this.usedIndices.has(this.word) || this.usedIndices.set(this.word, new Set());
    const e = this.usedIndices.get(this.word),
      r = tr(this.word, e);
    if (((this.currentSample = r), !r))
      H.warn("[NoriAutoDrawer] No sample found for word:", this.word);
    else {
      const s = dr(this.word, r);
      (s >= 0 && e.add(s),
        H.debug("[NoriAutoDrawer] Sample selected. Strokes:", r.length, "Used so far:", e.size));
    }
  }
  async drawStrokes() {
    const e = this.currentSample;
    if (!e || !this.drawer.isReady()) return;
    const r = this.drawer.getSize(),
      s = Math.max(1, r.width),
      a = Math.max(1, r.height);
    (s <= 1 || a <= 1) && H.warn("[NoriAutoDrawer] Canvas size is small; drawing may be invisible");
    const i = yr(s, a);
    for (let t = 0; t < e.length; t++) {
      if (this.cancelled || this.stopFlag) return;
      const l = e[t],
        c = l[0],
        w = l[1];
      if (!c || !w || c.length === 0 || w.length === 0) {
        H.warn("[NoriAutoDrawer] Skipping empty stroke", t);
        continue;
      }
      const u = Math.min(c.length, w.length);
      H.debug(`[NoriAutoDrawer] Stroke ${t + 1}/${e.length} with ${u} points (pre-smooth)`);
      const m = [];
      for (let z = 0; z < u; z++) {
        const N = i(c[z], w[z]);
        m.push(N);
      ...
      for (let z = 1; z < y.length; z++) {
        if (this.cancelled || this.stopFlag) return;
        const N = y[z];
        ((O += Math.hypot(N.x - I, N.y - C)),
          (I = N.x),
          (C = N.y),
          this.drawer.extendStroke(N.x, N.y),
          await new Promise((Y) => setTimeout(Y, be.NORI_STROKE_POINT_DELAY_MS)));
      }
      this.drawer.endStroke();
      const g = Math.max(1, Math.hypot(s, a)),
        D = Math.min(1, O / g),
        R = Math.max(0, be.NORI_STROKE_GAP_MAX_MS - be.NORI_STROKE_GAP_MIN_MS),
        W = be.NORI_STROKE_GAP_MIN_MS + D * R,
        M = R * 0.15 * (Math.random() - 0.5),
        J = Math.max(0, Math.floor(W + M));
      J > 0 && (await new Promise((z) => setTimeout(z, J)));
    }
    ((this.finishedAt = performance.now()),
      H.debug("[NoriAutoDrawer] Finished drawing sample at", this.finishedAt),
      this.onFinishedOnceCallback?.());
  }
  async kick() {
    if (
      (this.drawer.clear(),
      this.ensureSample(),
      await this.drawStrokes(),
      this.cancelled || this.stopFlag)
    )
      return;
    const e = () => {
      if (this.cancelled || this.stopFlag || !this.isRunning) return;
      const r = this.finishedAt;
      (r &&
        performance.now() - r > be.NORI_REDRAW_IDLE_MS &&
        (this.drawer.clear(),
        this.ensureSample(),
        (this.finishedAt = null),
        this.drawStrokes().catch((s) => H.warn("[NoriAutoDrawer] Redraw error", s))),
        (this.redrawTimer = window.setTimeout(e, 1e3)));
    };
    this.redrawTimer = window.setTimeout(e, 1e3);
  }
}
const wr = 256,
  ...
  Xe = qe * 9,
  ke = [
    { id: "graphite", color: "#363636", wood: "#E8DCC8" },
    { id: "indigo", color: "#4A5568", wood: "#E8DCC8" },
    { id: "brick", color: "#9B6B5B", wood: "#E8DCC8" },
    { id: "ochre", color: "#B8956B", wood: "#E8DCC8" },
    { id: "forest", color: "#5B7B6B", wood: "#E8DCC8" },
    { id: "wine", color: "#7B4B5B", wood: "#E8DCC8" },
  ];
async function gr(n, e, r) {
  if (!n) return null;
  const s = new Image(),
    a = new Promise((x, S) => {
      ((s.onload = () => x()), (s.onerror = () => S(new Error("Failed to load snapshot"))));
    });
  ((s.src = n), await a);
  const i = Math.max(s.width, s.height, 1),
    t = e / i,
    l = Math.max(1, Math.round(s.width * t)),
    c = Math.max(1, Math.round(s.height * t)),
    w = document.createElement("canvas");
  ((w.width = l), (w.height = c));
  const u = w.getContext("2d");
  return u
    ? ((u.fillStyle = "#ffffff"),
      u.fillRect(0, 0, l, c),
      u.drawImage(s, 0, 0, l, c),
      { image: w.toDataURL("image/png").split(",")[1] ?? "", width: l, height: c })
    : null;
}
function wn({ label: n, offset: e, children: r }) {
  return o.jsxs(Wn, {
    delayDuration: 120,
    children: [
      o.jsx(Yn, { asChild: !0, children: r }),
      o.jsx(Hn, {
        side: "right",
        sideOffset: e,
        className:
          "border border-black/10 px-2.5 py-1 text-[13px] leading-none shadow-[0_6px_18px_rgba(0,0,0,0.4)]",
        style: {
          "--foreground": b.paper,
          color: b.graphite,
          fontFamily: le.handwriting,
          fontWeight: 700,
...
function Ke({ pencilColor: n, woodColor: e, label: r, active: s, disabled: a, onClick: i }) {
  return o.jsx(wn, {
    label: r,
    offset: 32,
    children: o.jsx(_.button, {
      type: "button",
      onClick: i,
      disabled: a,
      "aria-label": r,
      className: We("relative", a ? "opacity-40 cursor-not-allowed" : "cursor-pointer"),
      initial: !1,
      animate: { x: s ? 8 : 0 },
      whileHover: a ? {} : { x: 4 },
      whileTap: a ? {} : { x: 2 },
      ...
      children: o.jsxs("svg", {
        viewBox: "0 0 100 20",
        className: "w-[120%] h-9 max-xl:h-7",
        style: {
          filter: s
        ...
        children: [
          o.jsx("rect", { x: "0", y: "2", width: "6", height: "16", rx: "2", fill: e }),
          o.jsx("rect", {
            x: "0",
            y: "2",
            width: "6",
          ...
          o.jsx("rect", { x: "6", y: "2", width: "10", height: "16", rx: "1", fill: n }),
          o.jsx("rect", { x: "16", y: "2", width: "60", height: "16", fill: e }),
          o.jsx("rect", { x: "16", y: "2", width: "60", height: "5", fill: "rgba(0,0,0,0.06)" }),
          o.jsx("rect", {
            x: "16",
            y: "13",
            width: "60",
          ...
          o.jsx("path", { d: "M76 2 L100 10 L76 18 Z", fill: e }),
          o.jsx("path", { d: "M76 2 L100 10 L80 10 Z", fill: "rgba(0,0,0,0.06)" }),
          o.jsx("path", { d: "M88 7 L100 10 L88 13 Z", fill: n }),
        ],
      }),
    }),
  });
}
const Pe = '"Plus Jakarta Sans", "Helvetica Neue", Arial, sans-serif';
function Qe({ label: n, active: e, disabled: r, onClick: s }) {
  return o.jsx(wn, {
    label: n,
    offset: 12,
    children: o.jsx(_.button, {
      ...
      disabled: r,
      "aria-label": n,
      className: We("relative", r ? "opacity-40 cursor-not-allowed" : "cursor-pointer"),
      initial: !1,
      animate: { x: e ? 8 : 0 },
      whileHover: r ? {} : { x: 4 },
      whileTap: r ? {} : { x: 2 },
      ...
      children: o.jsxs("svg", {
        viewBox: "0 0 84 33",
        className: "w-[84px] h-[33px] max-xl:w-[68px] max-xl:h-[27px]",
        style: {
          filter: e
        ...
        children: [
          o.jsx("defs", {
            children: o.jsx("clipPath", {
              id: "eraser-body",
              children: o.jsx("rect", { x: "0", y: "0", width: "84", height: "33", rx: "2.5" }),
            }),
          }),
          o.jsxs("g", {
            clipPath: "url(#eraser-body)",
            children: [
              o.jsx("rect", { x: "0", y: "0", width: "84", height: "33", fill: "#F5F2EA" }),
              o.jsx("rect", {
                x: "0",
                y: "0",
                width: "84",
              ...
              o.jsx("rect", {
                ...
                width: "12",
                height: "33",
                fill: "rgba(70,64,60,0.09)",
              }),
              o.jsx("path", {
                d: "M74 27 L80 8 M78 28 L83 14",
                stroke: "rgba(70,64,60,0.13)",
                strokeWidth: "1.1",
                strokeLinecap: "round",
              }),
              o.jsx("rect", { x: "0", y: "0", width: "57", height: "11", fill: "#17479E" }),
              o.jsx("rect", { x: "0", y: "11", width: "57", height: "11", fill: "#FBFAF7" }),
              o.jsx("rect", { x: "0", y: "22", width: "57", height: "11", fill: "#111111" }),
              o.jsx("rect", {
                x: "57",
                y: "0",
                width: "1.6",
              ...
              o.jsx("text", {
                ...
                textAnchor: "middle",
                fill: "#FFFFFF",
                style: { font: `600 5px ${Pe}`, letterSpacing: "0.7px" },
                children: "PLASTIC",
              }),
              o.jsx("text", {
                x: "28.5",
                ...
                textAnchor: "middle",
                fill: "#141414",
                style: { font: `700 9.5px ${Pe}`, letterSpacing: "0.3px" },
                children: "ERASER",
              }),
              o.jsx("text", {
                x: "28.5",
                ...
                style: { font: `500 4.6px ${Pe}`, letterSpacing: "0.9px" },
                children: "NORI PE-02",
              }),
            ],
          }),
...
function fr({ className: n = "w-3 h-3" }) {
  return o.jsx("svg", {
    viewBox: "0 0 20 20",
    className: n,
    fill: "none",
    ...
    children: o.jsx("path", {
      d: "M3 5h14M8 5V3a1 1 0 011-1h2a1 1 0 011 1v2M6 5l1 12a1 1 0 001 1h4a1 1 0 001-1l1-12",
    }),
  });
}
function Je({ className: n = "w-3 h-3" }) {
  return o.jsx("svg", {
    viewBox: "0 0 20 20",
    className: n,
    fill: "none",
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    children: o.jsx("path", { d: "M5 4l8 6-8 6V4zM15 4v12" }),
  });
}
function Ze({ children: n, className: e }) {
  return o.jsxs("div", {
    className: We("rounded-lg relative overflow-visible", e),
    style: {
      background: "linear-gradient(90deg, #5D4D3A 0%, #4A3D2E 100%)",
    ...
    children: [
      o.jsx("div", {
        ...
        style: {
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 50 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='g'%3E%3CfeTurbulence baseFrequency='0.005,0.02' numOctaves='3'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23g)'/%3E%3C/svg%3E")`,
        },
      }),
      o.jsx("div", { className: "relative overflow-visible", children: n }),
    ],
  });
}
function pr({ isScanning: n }) {
  return o.jsx(je, {
    children:
      n &&
      o.jsxs(_.div, {
        ...
        exit: { opacity: 0 },
        transition: { duration: 0.45, times: [0, 0.12, 0.88, 1] },
        children: [
          o.jsx(_.div, {
            ...
            style: {
              width: 56,
              background:
                "linear-gradient(90deg, transparent 0%, rgba(43, 43, 43, 0.018) 36%, rgba(43, 43, 43, 0.032) 50%, rgba(43, 43, 43, 0.018) 64%, transparent 100%)",
              filter: "blur(0.2px)",
          ...
          o.jsx(_.div, {
            ...
            style: {
              width: 28,
              background:
                "linear-gradient(90deg, transparent 0%, rgba(255, 248, 231, 0.55) 45%, transparent 100%)",
          ...
          o.jsx(_.div, {
            ...
            style: {
              background:
                "linear-gradient(180deg, transparent 0%, rgba(43, 43, 43, 0.12) 20%, rgba(43, 43, 43, 0.26) 50%, rgba(43, 43, 43, 0.12) 80%, transparent 100%)",
              boxShadow: "1px 0 0 rgba(255, 248, 231, 0.32)",
              mixBlendMode: "multiply",
            },
            initial: { left: -1 },
            animate: { left: "100%" },
          ...
          o.jsx(_.div, {
            ...
            style: {
              background:
                "radial-gradient(90% 140% at 40% 50%, transparent 0%, rgba(43, 43, 43, 0.022) 58%, transparent 100%)",
              mixBlendMode: "multiply",
            },
...
const hr = d.forwardRef(function (
    {
      active: e,
      word: r,
      drawingId: s,
        ...
        c &&
          (C.current ||
            (C.current = setTimeout(() => {
              ((C.current = null), c({ roundId: i, revision: I.current, atMs: Date.now() }));
            }, ur)));
      }, [c, i]),
      N = d.useCallback(() => {
        ((I.current += 1), z());
    ...
    (d.useImperativeHandle(
      ...
      () => ({
        ...
        strokeColor: D,
        setTool: (p) => {
          (g(p), u.current?.eraseMode(p === "eraser"));
        },
        setStrokeColor: (p) => {
          (R(p), O === "eraser" && (g("pen"), u.current?.eraseMode(!1)));
        },
        clearCanvas: () => {
          (u.current?.clearCanvas(), N());
        },
        getRevision: () => I.current,
        captureSnapshot: async () => {
          if (y.current) return null;
          y.current = !0;
          try {
            const p = await u.current?.exportImage("png");
            if (!p || p.length < 100) return null;
            const F = await gr(p, wr, !1);
            return F ? (S(!0), setTimeout(() => S(!1), 450), { ...F, revision: I.current }) : null;
          } catch (p) {
            return (console.warn("[DrawingView] Snapshot capture error:", p), null);
          } finally {
            y.current = !1;
          }
        },
      ...
      d.useEffect(() => {
        (u.current?.clearCanvas(), m.current && (m.current.stop(), (m.current = null)));
      }, [i, t]),
      d.useEffect(() => {
        if (
          (console.info("[DrawingView] Nori effect check:", {
            active: e,
            drawer: a,
            drawingId: s,
            roundId: i,
        ...
        console.info("[DrawingView] Creating NoriAutoDrawer for:", s);
        const F = new Qn(u),
          X = new mr(F, s);
        return (
          (m.current = X),
          X.start()
            .catch((te) => {
              console.error("[DrawingView] Auto-drawer error:", te);
            })
            .then(() => {
              console.info(
                "[DrawingView] NoriAutoDrawer.start() resolved after",
                Math.round(performance.now() - p),
                "ms",
              );
            }),
          () => {
            (X.stop(), (m.current = null));
          }
        );
      }, [e, a, s, r, i, t]),
      d.useEffect(() => {
        ((I.current = 0), C.current && (clearTimeout(C.current), (C.current = null)));
      }, [i]));
    const Y = d.useCallback(() => {
      ...
      Z = d.useCallback(
        (p) => {
          !e ||
            ...
            !l ||
            p.points.length < 2 ||
            l([{ points: p.points, color: p.color, width: p.width }]);
        },
        [e, a, l],
      ),
      ee = a === "player",
      P = e && ee,
      f = d.useCallback(() => {
        const p = u.current?.getSize(),
          F = u.current?.getClientSize();
        if (!p?.width || !F?.width) return;
        const X = F.width / p.width;
        J((te) => (Math.abs(te - X) < 0.01 ? te : X));
      }, []),
      j = d.useCallback(() => {
        f();
      }, [f]),
      v = d.useCallback((p) => {
        ...
        ((F.style.transform = `translate3d(${p.clientX - X.left}px, ${p.clientY - X.top}px, 0) translate(-50%, -50%)`),
          (F.style.opacity = "1"));
      }, []),
      E = d.useCallback(() => {
        const p = W.current;
      ...
      A = Math.max(4, (O === "eraser" ? Xe : qe) * M),
      k = d.useMemo(() => {
        const p = { background: "var(--surface)", transition: "opacity 180ms ease" };
        return ee
          ? { ...p, pointerEvents: P ? "auto" : "none", opacity: P ? 1 : 0.7 }
          : { ...p, pointerEvents: "none", opacity: 1 };
      }, [P, ee]);
    return o.jsx("div", {
      ...
      children: o.jsxs("div", {
        ...
        style: {
          ...
          cursor: P ? "none" : void 0,
        },
        onPointerEnter: P ? j : void 0,
        onPointerMove: P ? v : void 0,
        onPointerLeave: P ? E : void 0,
        children: [
          o.jsx(Kn, {
            ref: u,
            style: k,
            canvasColor: b.paper,
            strokeColor: a === "agent" ? ke[0].color : O === "eraser" ? b.paper : D,
            strokeWidth: qe,
            eraserWidth: Xe,
            onStroke: Z,
            onDrawStart: Y,
          ...
          o.jsx(pr, { isScanning: x }),
          o.jsx("div", {
            className: "absolute inset-0 pointer-events-none rounded",
            style: {
              backgroundImage: `radial-gradient(${b.dotGrid} 1px, transparent 1px)`,
                ...
                style: {
                  ...
                  ...(O === "eraser"
                    ? {
                        ...
                        border: `1.5px solid ${b.graphiteLight}`,
                        boxShadow: "0 0 0 1px rgba(255,255,255,0.75)",
                      }
                    : {
                        background: D,
                        border: "1px solid rgba(255,255,255,0.9)",
                        boxShadow: `0 0 0 1px ${b.graphiteFaint}`,
                      }),
                },
              })
            : null,
  ...
  vr = "#3D5A8B",
  Ir = Array.from({ length: 8 }, (n, e) => {
    const r = (e / 8) * Math.PI * 2 + 0.35,
      s = 44 + (e % 2) * 4,
      a = 58 + (e % 3) * 3;
    return {
      x1: 65 + Math.cos(r) * s,
...
function xr() {
  return o.jsx("div", {
    ...
    children: o.jsx(_.svg, {
      width: 130,
      height: 130,
      viewBox: "0 0 130 130",
      initial: { scale: 0.3, opacity: 0 },
      animate: { scale: [0.3, 1.1, 1.3], opacity: [0, 0.9, 0] },
...
function br({ bubble: n }) {
  const e = n.correct ? b.inkGreen : n.by === "player" ? vr : b.graphite;
  return o.jsxs(_.div, {
    className: "absolute",
    style: { right: n.anchorRight, bottom: 18 },
    initial: { opacity: 0, y: 26, x: 0, scale: 0.35, rotate: n.tilt + 9 },
    animate: { opacity: 1, y: -n.floatY, x: n.drift, scale: 1, rotate: n.tilt },
    exit: {
      opacity: 0,
      y: -(n.floatY + 34),
      scale: 0.85,
    ...
    transition: {
      y: { duration: n.floatDuration, ease: [0.16, 0.6, 0.45, 1] },
      x: { duration: n.floatDuration, ease: "easeOut" },
    ...
    children: [
      ...
      o.jsxs("div", {
        ...
        style: {
          ...
          boxShadow: "0 4px 12px rgba(0,0,0,0.28), inset 0 1px 0 rgba(255,255,255,0.7)",
          padding: n.correct ? "8px 16px" : "6px 13px",
          maxWidth: 200,
        },
        children: [
          o.jsx("span", {
            style: {
              display: "block",
              fontFamily: le.handwriting,
              fontSize: n.correct ? "17px" : "15px",
              fontWeight: n.correct ? 700 : 600,
              lineHeight: 1.3,
              color: e,
              wordBreak: "break-word",
            },
            children: n.correct ? `✓ ${n.text}` : n.text,
          }),
          o.jsx("svg", {
            width: "18",
            height: "15",
...
function kr({ bubbles: n }) {
  return o.jsx("div", {
    className: "absolute inset-0 z-10 pointer-events-none overflow-hidden",
    children: o.jsx(je, { children: n.map((e) => o.jsx(br, { bubble: e }, e.id)) }),
  });
}
const en = 5,
  Sr = 3400,
  jr = 4600,
  Rr = () => `bubble-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`,
  Ee = (n, e) => n + Math.random() * (e - n);
function Cr() {
  const [n, e] = d.useState([]),
    r = d.useRef(new Map()),
    s = d.useCallback((t) => {
      const l = r.current.get(t);
      (l && (clearTimeout(l), r.current.delete(t)), e((c) => c.filter((w) => w.id !== t)));
    }, []),
    a = d.useCallback(
      (t) => {
        const l = Rr(),
        ...
        (e((u) => {
          const m = [...u, w];
          return m.length > en ? m.slice(m.length - en) : m;
        }),
          r.current.set(
            l,
            setTimeout(() => s(l), c),
    ...
    i = d.useCallback(() => {
      for (const t of r.current.values()) clearTimeout(t);
      (r.current.clear(), e([]));
    }, []);
  return (
    d.useEffect(() => {
      const t = r.current;
      return () => {
        for (const l of t.values()) clearTimeout(l);
        t.clear();
      };
    }, []),
    { bubbles: n, spawnBubble: a, clearBubbles: i }
  );
}
const nn = /[a-z]/i;
function Mr(n) {
  return { locale: "zh-CN", pinyin: n, revealed: new Set() };
}
function Nr(n, e = "en", r) {
  if (e === "zh-CN" && r) return Mr(r);
  const s = n.split(""),
    a = s.map((t) => (nn.test(t) ? "_" : t)),
    i = s.reduce((t, l, c) => (nn.test(l) && t.push(c), t), []);
  return { locale: "en", wordChars: s, displayChars: a, letterIndices: i, revealed: new Set() };
}
function Er(n) {
  return n.pinyin
    ? n.pinyin
        .map((e, r) => {
          const [s, a] = e;
          return n.revealed.has(r) ? (s === null ? a[0] : `${s}_`) : "__";
        })
        .join(" ")
    : "";
}
function Ar(n) {
  if (n.locale === "zh-CN") return Er(n);
  if (!n.displayChars) return "";
  let e = "";
  return (
    n.displayChars.forEach((r, s) => {
      const a = r === "_" ? "_" : r === " " ? " " : r.toUpperCase();
      ((e += a), s < n.displayChars.length - 1 && (e += " "));
    }),
    e.replaceAll(/\s{3,}/g, "  ")
  );
}
const un = new Set(["a", "e", "i", "o", "u"]),
  Tr = new Set(["t", "n", "s", "h", "r", "d", "l", "c", "m"]),
  gn = new Set(["j", "q", "x", "z", "k", "v", "y"]),
  _r = new Set([
    "sh",
    "zh",
    "j",
  ...
  zr = new Set(["z", "c", "r", "p", "k"]),
  ae = {
    MAX_DELAY_EASY: 1e4,
    MAX_DELAY_HARD_DELTA: 3500,
    MIN_DELAY_EASY: 2400,
    MIN_DELAY_HARD_DELTA: 800,
    INITIAL_DELAY_EASY: 6e3,
    INITIAL_DELAY_HARD_DELTA: 2200,
    ABSOLUTE_MIN_DELAY: 1200,
    ABSOLUTE_MAX_DELAY: 1e4,
    INITIAL_MIN_DELAY: 2500,
    INITIAL_MAX_DELAY: 6e3,
  };
function Ge(n) {
  return n * n * n;
}
...
function Lr(n) {
  if (n.locale === "zh-CN") return Dr(n.pinyin || []);
  const { wordChars: e, letterIndices: r } = n;
  if (!e || !r)
    return {
      firstLetterIndex: null,
      lastLetterIndex: null,
      charToIndices: new Map(),
      difficulty: 0,
    };
  const s = r.length ? r[0] : null,
    a = r.length ? r[r.length - 1] : null,
    i = new Map();
  for (const S of r) {
    const I = e[S].toLowerCase(),
      C = i.get(I);
    C ? C.push(S) : i.set(I, [S]);
  }
  const t = r.length;
  if (!t) return { firstLetterIndex: s, lastLetterIndex: a, charToIndices: i, difficulty: 0 };
  let l = 0;
  t >= 10 ? (l += 1.5) : t >= 8 ? (l += 1) : t <= 4 && (l -= 0.5);
  let c = 0;
  for (const S of r) un.has(e[S].toLowerCase()) && c++;
  const w = c / t;
  w < 0.35 ? (l += 1) : w > 0.55 && (l -= 0.5);
  let u = 0;
  for (const S of r) gn.has(e[S].toLowerCase()) && u++;
  (u >= 2 ? (l += 1) : u === 1 && (l += 0.5),
    new Set(r.map((S) => e[S].toLowerCase())).size / t > 0.8 && (l += 0.5));
  const x = we((l + 0.5) / 5, 0, 1);
  return { firstLetterIndex: s, lastLetterIndex: a, charToIndices: i, difficulty: x };
}
function Dr(n) {
  const e = n.length;
  let r = 0;
  (e >= 4 ? (r += 1.5) : e >= 3 ? (r += 1) : e <= 1 && (r -= 0.5),
    n.filter(([i]) => i === null).length >= 2 && (r -= 0.5));
  const a = we((r + 0.5) / 3, 0, 1);
  return { firstLetterIndex: null, lastLetterIndex: null, charToIndices: new Map(), difficulty: a };
}
function Pr(n, e) {
  if (n.locale === "zh-CN" || !n.letterIndices) return [];
  const r = n.letterIndices.filter((i) => !n.revealed.has(i)),
    s = new Map();
  for (const i of r) {
    const t = n.wordChars[i].toLowerCase(),
      l = s.get(t);
    l ? l.push(i) : s.set(t, [i]);
  }
  const a = [];
  for (const [i, t] of s) {
    const l = e.firstLetterIndex !== null && t.includes(e.firstLetterIndex);
    a.push({
      char: i,
      indices: t,
      isFirstLetter: l,
...
function Br(n, e) {
  let r = 0;
  return (
    n.isFirstLetter && (r += fe(-100, 40, e * e)),
    n.isVowel && (r += fe(8, 1.5, e)),
    n.isCommon && (r += fe(4, 3, e)),
    n.isRare && (r += fe(-2, 8, e)),
    (r += (n.freq - 1) * 1.8),
    (r += Math.random() * 0.5),
    r
...
function Fr(n, e, r) {
  if (!n.pinyin) return 0;
  const [s] = n.pinyin[e];
  let a = 0;
  return (
    e === 0 && (a += fe(-100, 40, r * r)),
    s === null && (a += fe(6, 2, r)),
    s && _r.has(s) && (a += fe(5, 2, r)),
    s && zr.has(s) && (a += fe(-1, 6, r)),
    (a += Math.random() * 0.5),
    a
  );
}
function Or(n) {
  const e = we(
      ae.MAX_DELAY_EASY - ae.MAX_DELAY_HARD_DELTA * n,
      ae.MAX_DELAY_HARD_DELTA,
      ae.ABSOLUTE_MAX_DELAY,
    ),
    r = we(
      ae.MIN_DELAY_EASY - ae.MIN_DELAY_HARD_DELTA * n,
      ae.ABSOLUTE_MIN_DELAY,
      ae.MIN_DELAY_EASY,
    ),
    s = we(
      ae.INITIAL_DELAY_EASY - ae.INITIAL_DELAY_HARD_DELTA * n,
      ae.INITIAL_MIN_DELAY,
      ae.INITIAL_MAX_DELAY,
    );
  return { maxDelay: e, minDelay: r, initialDelay: s };
}
function qr(n) {
  const e = Ge(n);
  return we(0.1 + 0.75 * e, 0, 0.85);
}
function Gr(n, e, r, s) {
  if (n.locale === "zh-CN" && n.pinyin) {
    const m = n.pinyin.map((I, C) => C).filter((I) => !n.revealed.has(I));
    if (!m.length) return [];
    const y = [];
    r >= 0.92 && !n.revealed.has(0) && y.push(0);
    const x = m
      .filter((I) => !y.includes(I))
      .map((I) => ({ idx: I, score: Fr(n, I, r) }))
      .sort((I, C) => C.score - I.score);
    let S = y.length;
    for (const { idx: I } of x) {
      if (S >= s) break;
      (y.push(I), S++);
    }
    if (r >= 0.97) {
      const I = m.filter((C) => !y.includes(C)).slice(0, 3);
      y.push(...I);
    }
    return y;
  }
  if (!n.letterIndices) return [];
  if (!n.letterIndices.filter((m) => !n.revealed.has(m)).length) return [];
  const i = [];
  if (r >= 0.92 && e.firstLetterIndex !== null && !n.revealed.has(e.firstLetterIndex)) {
    const m = n.wordChars[e.firstLetterIndex].toLowerCase(),
      y = e.charToIndices.get(m) || [];
    for (const x of y) n.revealed.has(x) || i.push(x);
  }
  const t = new Set([...n.revealed, ...i]),
    l = { ...n, revealed: t },
    w = Pr(l, e)
      .map((m) => ({ s: m, score: Br(m, r) }))
      .sort((m, y) => y.score - m.score);
  let u = i.length;
  for (const { s: m } of w) {
    if (u >= s) break;
    for (const y of m.indices) t.has(y) || (i.push(y), t.add(y), u++);
  }
  if (r >= 0.97) {
    const m = n.letterIndices.filter((y) => !t.has(y)).slice(0, 3);
    i.push(...m);
  }
  return i;
}
function Wr({
  ...
  const I = d.useCallback(() => {
    ...
    C = d.useCallback(
      (g, D) => {
        if ((I(), (w.current = performance.now()), g && e)) {
          const R = Nr(g, D, S.current);
          ((u.current = R),
            (y.current = Lr(R)),
            (x.current = Or(y.current.difficulty)),
            l(R),
            (m.current = R));
        } else
          ((u.current = null), (y.current = null), (x.current = null), l(null), (m.current = null));
      },
      [I, e],
    );
  (d.useEffect(() => {
    ...
    d.useEffect(() => {
      if ((I(), !n || !e || !m.current || !y.current || !x.current)) return;
      const { maxDelay: g, minDelay: D } = x.current,
        R = (M) => {
          c.current = setTimeout(W, M);
        },
        W = () => {
          const M = m.current,
            J = y.current;
          if (!M || !J) return;
          const N = performance.now() - w.current,
            Y = we(N / s, 0, 1),
            V = M.locale === "zh-CN" && M.pinyin ? M.pinyin.length : (M.letterIndices?.length ?? 0);
          if (V === 0) return;
          const ie = M.revealed.size;
          if (ie >= V) return;
          const Z = Y < 0.4 || Y < 0.75 ? 1 : Y < 0.92 ? 2 : 3,
            ee = Math.ceil(qr(Y) * V),
            P = Math.max(0, ee - ie),
            f = we(Math.max(Z, P), 1, 3),
            j = Gr(M, J, Y, Math.min(f, V - ie));
          if (j.length === 0) {
            const A = we(g - (g - D) * Ge(Y), D, g);
            R(A);
            return;
          }
          const v = new Set(M.revealed);
          if (M.locale === "zh-CN") {
            for (const k of j) v.add(k);
            const A = { ...M, revealed: v };
            (l(A), (m.current = A));
          } else {
            const A = [...(M.displayChars || [])];
            for (const p of j) (v.add(p), M.wordChars && (A[p] = M.wordChars[p]));
            const k = { ...M, displayChars: A, revealed: v };
            (l(k), (m.current = k));
          }
          ge("partygames-pictionary-hint-reveal");
          const E = we(g - (g - D) * Ge(Y), D, g);
          R(E);
        };
      return (R(x.current.initialDelay), () => I());
    }, [n, e, s, I, r, a]));
  const O = d.useMemo(() => (!e || !t ? null : Ar(t)), [t, e]);
  return { hint: t, setHint: l, displayText: O };
}
const rn = 48,
  Yr = () => `${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
function Hr() {
  const [n, e] = d.useState([]),
    r = d.useRef(null),
    s = d.useRef(!0),
    ...
    i = d.useCallback((c) => {
      e((w) => {
        const u = { id: c.id ?? Yr(), sender: c.sender, content: c.content, tone: c.tone },
          m = [...w, u];
        return m.length > rn ? m.slice(m.length - rn) : m;
      });
    }, []),
    t = d.useCallback(() => {
      e([]);
    ...
    l = d.useCallback((c = !1) => {
      ...
      w &&
        ((!c && !s.current) ||
          ...
          setTimeout(() => {
            r.current && r.current.scrollTo({ top: r.current.scrollHeight, behavior: "auto" });
          }, 450)));
    }, []);
  return (
    d.useEffect(() => {
    ...
    d.useEffect(() => {
      ...
      return (
        c.addEventListener("scroll", w),
        w(),
        () => {
          c.removeEventListener("scroll", w);
        }
      );
    }, []),
    { messages: n, push: i, clear: t, viewportRef: r }
  );
}
function $r(n) {
  const e = Math.max(0, n),
    ...
    s = Math.floor(r / 60),
    a = r % 60;
  return `${s.toString().padStart(2, "0")}:${a.toString().padStart(2, "0")}`;
}
class Ur {
  constructor() {
    this.map = new Map();
  ...
  convert(e) {
    ...
    for (let t = 0; t < s;) {
      ...
      c > 0
        ? (i !== null && (a.push(e.slice(i, t)), (i = null)), a.push(w), (t = c))
        : (i === null && (i = t), (t += e.codePointAt(t) > 65535 ? 2 : 1));
    }
    return (i !== null && a.push(e.slice(i, s)), a.join(""));
  }
}
function Vr(...n) {
  const e = n.map((s) => {
    const a = new Ur();
    return (a.loadDictGroup(s), a);
  });
  function r(s) {
    return e.reduce((a, i) => i.convert(a), s);
  }
  return r;
}
function Xr(n) {
  return function (r) {
    ...
    return (
      ["from", "to"].forEach((a) => {
        if (typeof r[a] != "string") throw new Error("Please provide the `" + a + "` option");
        r[a] !== "t" && s.push(n[a][r[a]]);
      }),
      Vr.apply(null, s)
    );
  };
...
var Kr =
  ...
  no = [Zr, eo],
  fn =
    "偽 僞|參 蔘|吃 喫|唇 脣|啟 啓|媯 嬀|嫻 嫺|峰 峯|床 牀|抬 擡|汙 污|洩 泄|溈 潙|潀 潨|灶 竈|為 爲|痴 癡|痺 痹|皂 皁|眾 衆|睪 睾|秘 祕|稜 棱|簷 檐|粽 糉|缽 鉢|群 羣|著 着|蒍 蔿|裡 裏|踴 踊|韁 繮|顎 齶|鯰 鮎|麵 麪",
  pn =
  ...
  uo = [wo],
  hn =
    "僞 偽|啓 啟|喫 吃|嫺 嫻|嬀 媯|峯 峰|幺 么|擡 抬|棱 稜|檐 簷|污 汙|泄 洩|潙 溈|潨 潀|爲 為|牀 床|痹 痺|癡 痴|皁 皂|着 著|睾 睪|祕 秘|竈 灶|糉 粽|繮 韁|纔 才|羣 群|脣 唇|蔘 參|蔿 蒍|衆 眾|裏 裡|覈 核|踊 踴|鉢 缽|鍼 針|鮎 鯰|麪 麵|齶 顎",
  go = [hn],
  fo =
  ...
  xo = [Io];
const bo = { cn: Jr, hk: no, tw: ro, twp: so, jp: lo },
  ko = { cn: mo, hk: uo, tw: go, twp: vo, jp: xo };
var So = Object.freeze({ __proto__: null, from: bo, to: ko });
const vn = Xr(So),
  jo = vn({ from: "tw", to: "cn" });
function Ro(n, e = "en") {
  let r = n.trim().replaceAll(/\s+/g, " ");
  return (
    (r = r.replaceAll(/[\uff01-\uff5e]/g, (s) => String.fromCharCode(s.charCodeAt(0) - 65248))),
    e === "zh-CN"
      ? (r = jo(r))
      : (r = r
          .normalize("NFKD")
...
const Co = re({ roundId: he(), revision: $().int().nonnegative(), atMs: $() }),
  Mo = re({
    roundId: he(),
    sinceRevision: $().int().nonnegative(),
    reason: ln(["first_timeout", "revision_changed", "cooldown_drain"]),
  }),
  No = re({
    roundId: he(),
  ...
  Eo = Ye("pictionary.revision", Co),
  Ao = Ye("pictionary.snapshot.request", Mo),
  To = Ye("pictionary.snapshot", No);
function _o(n, e) {
  return n.publishEvent(Eo, e);
}
function zo(n) {
  const { binding: e, captureSnapshot: r, isRoundActive: s, roundId: a, roundRoles: i } = n;
  return e.onEvent(Ao, (t, { requestId: l }) => {
    s &&
      (i?.drawer !== "player" ||
        i.guesser !== "agent" ||
        (t.roundId === a &&
            ...
            .then((c) => {
              c &&
                e
                  ...
                  .catch((w) => {
                    console.warn("[Pictionary] Snapshot send failed:", w);
                  });
            })
            .catch((c) => {
              console.warn("[Pictionary] Snapshot capture failed:", c);
            })));
  });
}
const Lo = JSON.parse(
    '[{"word":"aircraft carrier","synonyms":[],"drawingId":"aircraft carrier","removed":false},{"word":"airplane","synonyms":["plane","aircraft"],"drawingId":"airplane","removed":false},{"word":"alarm clock","synonyms":["alarm","clock"],"drawingId":"alarm clock","removed":false},{"word":"ambulance","synonyms":[],"drawingId":"ambulance","removed":false},{"word":"angel","synonyms":[],"drawingId":"angel","removed":false},{"word":"animal migration","synonyms":["migration"],"drawingId":"animal migration","removed":true},{"word":"ant","synonyms":[],"drawingId":"ant","removed":false},{"word":"anvil","synonyms":[],"drawingId":"anvil","removed":false},{"word":"apple","synonyms":[],"drawingId":"apple","removed":false},{"word":"arm","synonyms":[],"drawingId":"arm","removed":false},{"word":"asparagus","synonyms":[],"drawingId":"asparagus","removed":true},{"word":"axe","synonyms":["ax"],"drawingId":"axe","removed":false},{"word":"backpack","synonyms":["rucksack","pack"],"drawingId":"backpack","removed":false},{"word":"banana","synonyms":[],"drawingId":"banana","removed":false},{"word":"bandage","synonyms":[],"drawingId":"bandage","removed":false},{"word":"barn","synonyms":[],"drawingId":"barn","removed":false},{"word":"baseball","synonyms":[],"drawingId":"baseball","removed":false},{"word":"baseball bat","synonyms":["bat"],"drawingId":"baseball bat","removed":false},{"word":"basket","synonyms":[],"drawingId":"basket","removed":false},{"word":"basketball","synonyms":[],"drawingId":"basketball","removed":false},{"word":"bat","synonyms":[],"drawingId":"bat","removed":false},{"word":"bathtub","synonyms":["tub","bath"],"drawingId":"bathtub","removed":false},{"word":"beach","synonyms":[],"drawingId":"beach","removed":false},{"word":"bear","synonyms":[],"drawingId":"bear","removed":false},{"word":"beard","synonyms":[],"drawingId":"beard","removed":false},{"word":"bed","synonyms":[],"drawingId":"bed","removed":false},{"word":"bee","synonyms":[],"drawingId":"bee","removed":false},{"word":"belt","synonyms":[],"drawingId":"belt","removed":false},{"word":"bench","synonyms":[],"drawingId":"bench","removed":false},{"word":"bicycle","synonyms":["bike","cycle"],"drawingId":"bicycle","removed":false},{"word":"binoculars","synonyms":["binocs"],"drawingId":"binoculars","removed":false},{"word":"bird","synonyms":[],"drawingId":"bird","removed":false},{"word":"birthday cake","synonyms":["cake"],"drawingId":"birthday cake","removed":false},{"word":"blackberry","synonyms":[],"drawingId":"blackberry","removed":false},{"word":"blueberry","synonyms":[],"drawingId":"blueberry","removed":false},{"word":"book","synonyms":[],"drawingId":"book","removed":false},{"word":"boomerang","synonyms":[],"drawingId":"boomerang","removed":false},{"word":"bottlecap","synonyms":["bottle cap"],"drawingId":"bottlecap","removed":false},{"word":"bowtie","synonyms":["bow tie"],"drawingId":"bowtie","removed":false},{"word":"bracelet","synonyms":[],"drawingId":"bracelet","removed":false},{"word":"brain","synonyms":[],"drawingId":"brain","removed":false},{"word":"bread","synonyms":[],"drawingId":"bread","removed":false},{"word":"bridge","synonyms":[],"drawingId":"bridge","removed":false},{"word":"broccoli","synonyms":[],"drawingId":"broccoli","removed":false},{"word":"broom","synonyms":[],"drawingId":"broom","removed":false},{"word":"bucket","synonyms":["pail"],"drawingId":"bucket","removed":false},{"word":"bulldozer","synonyms":[],"drawingId":"bulldozer","removed":false},{"word":"bus","synonyms":[],"drawingId":"bus","removed":false},{"word":"bush","synonyms":["shrub"],"drawingId":"bush","removed":false},{"word":"butterfly","synonyms":[],"drawingId":"butterfly","removed":false},{"word":"cactus","synonyms":[],"drawingId":"cactus","removed":false},{"word":"cake","synonyms":[],"drawingId":"cake","removed":false},{"word":"calculator","synonyms":[],"drawingId":"calculator","removed":false},{"word":"calendar","synonyms":[],"drawingId":"calendar","removed":false},{"word":"camel","synonyms":[],"drawingId":"camel","removed":false},{"word":"camera","synonyms":[],"drawingId":"camera","removed":false},{"word":"camouflage","synonyms":["camo"],"drawingId":"camouflage","removed":true},{"word":"campfire","synonyms":["camp fire","fire"],"drawingId":"campfire","removed":false},{"word":"candle","synonyms":[],"drawingId":"candle","removed":false},{"word":"cannon","synonyms":[],"drawingId":"cannon","removed":false},{"word":"canoe","synonyms":[],"drawingId":"canoe","removed":true},{"word":"car","synonyms":["automobile","vehicle"],"drawingId":"car","removed":false},{"word":"carrot","synonyms":[],"drawingId":"carrot","removed":false},{"word":"castle","synonyms":[],"drawingId":"castle","removed":false},{"word":"cat","synonyms":["kitty","kitten"],"drawingId":"cat","removed":false},{"word":"ceiling fan","synonyms":["fan"],"drawingId":"ceiling fan","removed":false},{"word":"cello","synonyms":["violoncello"],"drawingId":"cello","removed":false},{"word":"cell phone","synonyms":["cellphone","mobile","mobile phone","smartphone","phone"],"drawingId":"cell phone","removed":false},{"word":"chair","synonyms":[],"drawingId":"chair","removed":false},{"word":"chandelier","synonyms":[],"drawingId":"chandelier","removed":true},{"word":"church","synonyms":[],"drawingId":"church","removed":false},{"word":"circle","synonyms":[],"drawingId":"circle","removed":false},{"word":"clarinet","synonyms":[],"drawingId":"clarinet","removed":true},{"word":"clock","synonyms":[],"drawingId":"clock","removed":false},{"word":"cloud","synonyms":[],"drawingId":"cloud","removed":false},{"word":"coffee cup","synonyms":["coffee","cup"],"drawingId":"coffee cup","removed":false},{"word":"compass","synonyms":[],"drawingId":"compass","removed":false},{"word":"computer","synonyms":["pc","desktop"],"drawingId":"computer","removed":false},{"word":"cookie","synonyms":["biscuit"],"drawingId":"cookie","removed":false},{"word":"cooler","synonyms":["ice chest","cooler box"],"drawingId":"cooler","removed":true},{"word":"couch","synonyms":["sofa"],"drawingId":"couch","removed":false},{"word":"cow","synonyms":[],"drawingId":"cow","removed":false},{"word":"crab","synonyms":[],"drawingId":"crab","removed":false},{"word":"crayon","synonyms":[],"drawingId":"crayon","removed":false},{"word":"crocodile","synonyms":["croc"],"drawingId":"crocodile","removed":false},{"word":"crown","synonyms":[],"drawingId":"crown","removed":false},{"word":"cruise ship","synonyms":["cruise","ship"],"drawingId":"cruise ship","removed":false},{"word":"cup","synonyms":[],"drawingId":"cup","removed":false},{"word":"diamond","synonyms":[],"drawingId":"diamond","removed":false},{"word":"dishwasher","synonyms":[],"drawingId":"dishwasher","removed":true},{"word":"diving board","synonyms":["diving platform"],"drawingId":"diving board","removed":true},{"word":"dog","synonyms":["puppy","pup"],"drawingId":"dog","removed":false},{"word":"dolphin","synonyms":[],"drawingId":"dolphin","removed":false},{"word":"donut","synonyms":["doughnut"],"drawingId":"donut","removed":false},{"word":"door","synonyms":[],"drawingId":"door","removed":false},{"word":"dragon","synonyms":[],"drawingId":"dragon","removed":false},{"word":"dresser","synonyms":["chest of drawers","drawers"],"drawingId":"dresser","removed":false},{"word":"drill","synonyms":[],"drawingId":"drill","removed":false},{"word":"drums","synonyms":["drum set","drumkit"],"drawingId":"drums","removed":false},{"word":"duck","synonyms":[],"drawingId":"duck","removed":false},{"word":"dumbbell","synonyms":["weight"],"drawingId":"dumbbell","removed":false},{"word":"ear","synonyms":[],"drawingId":"ear","removed":false},{"word":"elbow","synonyms":[],"drawingId":"elbow","removed":false},{"word":"elephant","synonyms":[],"drawingId":"elephant","removed":false},{"word":"envelope","synonyms":[],"drawingId":"envelope","removed":false},{"word":"eraser","synonyms":["rubber"],"drawingId":"eraser","removed":false},{"word":"eye","synonyms":[],"drawingId":"eye","removed":false},{"word":"eyeglasses","synonyms":["glasses","spectacles"],"drawingId":"eyeglasses","removed":false},{"word":"face","synonyms":[],"drawingId":"face","removed":false},{"word":"fan","synonyms":[],"drawingId":"fan","removed":false},{"word":"feather","synonyms":[],"drawingId":"feather","removed":false},{"word":"fence","synonyms":[],"drawingId":"fence","removed":false},{"word":"finger","synonyms":[],"drawingId":"finger","removed":false},{"word":"fire hydrant","synonyms":["hydrant","fireplug"],"drawingId":"fire hydrant","removed":false},{"word":"fireplace","synonyms":[],"drawingId":"fireplace","removed":false},{"word":"firetruck","synonyms":["fire truck","fire engine"],"drawingId":"firetruck","removed":false},{"word":"fish","synonyms":[],"drawingId":"fish","removed":false},{"word":"flamingo","synonyms":[],"drawingId":"flamingo","removed":false},{"word":"flashlight","synonyms":["torch"],"drawingId":"flashlight","removed":false},{"word":"flip flops","synonyms":["sandals","thongs"],"drawingId":"flip flops","removed":false},{"word":"floor lamp","synonyms":["lamp"],"drawingId":"floor lamp","removed":false},{"word":"flower","synonyms":[],"drawingId":"flower","removed":false},{"word":"flying saucer","synonyms":["ufo","unidentified flying object"],"drawingId":"flying saucer","removed":false},{"word":"foot","synonyms":[],"drawingId":"foot","removed":false},{"word":"fork","synonyms":[],"drawingId":"fork","removed":false},{"word":"frog","synonyms":[],"drawingId":"frog","removed":false},{"word":"frying pan","synonyms":["frypan","skillet"],"drawingId":"frying pan","removed":false},{"word":"garden","synonyms":[],"drawingId":"garden","removed":false},{"word":"garden hose","synonyms":["hose"],"drawingId":"garden hose","removed":true},{"word":"giraffe","synonyms":[],"drawingId":"giraffe","removed":false},{"word":"goatee","synonyms":[],"drawingId":"goatee","removed":false},{"word":"golf club","synonyms":["club"],"drawingId":"golf club","removed":false},{"word":"grapes","synonyms":[],"drawingId":"grapes","removed":false},{"word":"grass","synonyms":[],"drawingId":"grass","removed":false},{"word":"guitar","synonyms":[],"drawingId":"guitar","removed":false},{"word":"hamburger","synonyms":["burger"],"drawingId":"hamburger","removed":false},{"word":"hammer","synonyms":[],"drawingId":"hammer","removed":false},{"word":"hand","synonyms":[],"drawingId":"hand","removed":false},{"word":"harp","synonyms":[],"drawingId":"harp","removed":false},{"word":"hat","synonyms":["cap"],"drawingId":"hat","removed":false},{"word":"headphones","synonyms":["earphones","earbuds"],"drawingId":"headphones","removed":false},{"word":"hedgehog","synonyms":[],"drawingId":"hedgehog","removed":false},{"word":"helicopter","synonyms":["chopper","copter"],"drawingId":"helicopter","removed":false},{"word":"helmet","synonyms":[],"drawingId":"helmet","removed":false},{"word":"hexagon","synonyms":[],"drawingId":"hexagon","removed":false},{"word":"hockey puck","synonyms":["puck"],"drawingId":"hockey puck","removed":true},{"word":"hockey stick","synonyms":["stick"],"drawingId":"hockey stick","removed":true},{"word":"horse","synonyms":[],"drawingId":"horse","removed":false},{"word":"hospital","synonyms":[],"drawingId":"hospital","removed":false},{"word":"hot air balloon","synonyms":["balloon"],"drawingId":"hot air balloon","removed":false},{"word":"hot dog","synonyms":["hotdog"],"drawingId":"hot dog","removed":false},{"word":"hot tub","synonyms":["jacuzzi","spa"],"drawingId":"hot tub","removed":false},{"word":"hourglass","synonyms":["sand timer"],"drawingId":"hourglass","removed":false},{"word":"house","synonyms":["home"],"drawingId":"house","removed":false},{"word":"house plant","synonyms":["houseplant","plant"],"drawingId":"house plant","removed":false},{"word":"hurricane","synonyms":[],"drawingId":"hurricane","removed":false},{"word":"ice cream","synonyms":["icecream"],"drawingId":"ice cream","removed":false},{"word":"jacket","synonyms":["coat"],"drawingId":"jacket","removed":false},{"word":"jail","synonyms":["prison"],"drawingId":"jail","removed":false},{"word":"kangaroo","synonyms":[],"drawingId":"kangaroo","removed":false},{"word":"key","synonyms":[],"drawingId":"key","removed":false},{"word":"keyboard","synonyms":[],"drawingId":"keyboard","removed":false},{"word":"knee","synonyms":[],"drawingId":"knee","removed":false},{"word":"knife","synonyms":[],"drawingId":"knife","removed":false},{"word":"ladder","synonyms":[],"drawingId":"ladder","removed":false},{"word":"lantern","synonyms":[],"drawingId":"lantern","removed":false},{"word":"laptop","synonyms":["notebook"],"drawingId":"laptop","removed":false},{"word":"leaf","synonyms":[],"drawingId":"leaf","removed":false},{"word":"leg","synonyms":[],"drawingId":"leg","removed":false},{"word":"light bulb","synonyms":["bulb","light"],"drawingId":"light bulb","removed":false},{"word":"lighter","synonyms":[],"drawingId":"lighter","removed":false},{"word":"lighthouse","synonyms":[],"drawingId":"lighthouse","removed":false},{"word":"lightning","synonyms":[],"drawingId":"lightning","removed":false},{"word":"line","synonyms":[],"drawingId":"line","removed":false},{"word":"lion","synonyms":[],"drawingId":"lion","removed":false},{"word":"lipstick","synonyms":[],"drawingId":"lipstick","removed":false},{"word":"lobster","synonyms":[],"drawingId":"lobster","removed":false},{"word":"lollipop","synonyms":["lolly","sucker"],"drawingId":"lollipop","removed":false},{"word":"mailbox","synonyms":["post box","letter box"],"drawingId":"mailbox","removed":false},{"word":"map","synonyms":[],"drawingId":"map","removed":false},{"word":"marker","synonyms":[],"drawingId":"marker","removed":true},{"word":"matches","synonyms":["matchsticks"],"drawingId":"matches","removed":false},{"word":"megaphone","synonyms":[],"drawingId":"megaphone","removed":false},{"word":"mermaid","synonyms":[],"drawingId":"mermaid","removed":false},{"word":"microphone","synonyms":["mic","mike"],"drawingId":"microphone","removed":false},{"word":"microwave","synonyms":["microwave oven"],"drawingId":"microwave","removed":false},{"word":"monkey","synonyms":[],"drawingId":"monkey","removed":false},{"word":"moon","synonyms":[],"drawingId":"moon","removed":false},{"word":"mosquito","synonyms":[],"drawingId":"mosquito","removed":false},{"word":"motorbike","synonyms":["motorcycle"],"drawingId":"motorbike","removed":false},{"word":"mountain","synonyms":[],"drawingId":"mountain","removed":false},{"word":"mouse","synonyms":[],"drawingId":"mouse","removed":false},{"word":"moustache","synonyms":["mustache"],"drawingId":"moustache","removed":false},{"word":"mouth","synonyms":[],"drawingId":"mouth","removed":false},{"word":"mug","synonyms":[],"drawingId":"mug","removed":false},{"word":"mushroom","synonyms":[],"drawingId":"mushroom","removed":false},{"word":"nail","synonyms":[],"drawingId":"nail","removed":false},{"word":"necklace","synonyms":[],"drawingId":"necklace","removed":false},{"word":"nose","synonyms":[],"drawingId":"nose","removed":false},{"word":"ocean","synonyms":["sea"],"drawingId":"ocean","removed":false},{"word":"octagon","synonyms":[],"drawingId":"octagon","removed":false},{"word":"octopus","synonyms":[],"drawingId":"octopus","removed":false},{"word":"onion","synonyms":[],"drawingId":"onion","removed":false},{"word":"oven","synonyms":[],"drawingId":"oven","removed":false},{"word":"owl","synonyms":[],"drawingId":"owl","removed":false},{"word":"paintbrush","synonyms":["brush","paint brush"],"drawingId":"paintbrush","removed":false},{"word":"paint can","synonyms":["paint canister","paint tin"],"drawingId":"paint can","removed":false},{"word":"palm tree","synonyms":["palm"],"drawingId":"palm tree","removed":false},{"word":"panda","synonyms":[],"drawingId":"panda","removed":false},{"word":"pants","synonyms":["trousers"],"drawingId":"pants","removed":false},{"word":"paper clip","synonyms":["paperclip"],"drawingId":"paper clip","removed":false},{"word":"parachute","synonyms":[],"drawingId":"parachute","removed":false},{"word":"parrot","synonyms":[],"drawingId":"parrot","removed":false},{"word":"passport","synonyms":[],"drawingId":"passport","removed":false},{"word":"peanut","synonyms":[],"drawingId":"peanut","removed":false},{"word":"pear","synonyms":[],"drawingId":"pear","removed":false},{"word":"peas","synonyms":[],"drawingId":"peas","removed":false},{"word":"pencil","synonyms":[],"drawingId":"pencil","removed":false},{"word":"penguin","synonyms":[],"drawingId":"penguin","removed":false},{"word":"piano","synonyms":[],"drawingId":"piano","removed":false},{"word":"pickup truck","synonyms":["pickup","truck"],"drawingId":"pickup truck","removed":true},{"word":"picture frame","synonyms":["frame"],"drawingId":"picture frame","removed":false},{"word":"pig","synonyms":["hog"],"drawingId":"pig","removed":false},{"word":"pillow","synonyms":[],"drawingId":"pillow","removed":false},{"word":"pineapple","synonyms":[],"drawingId":"pineapple","removed":false},{"word":"pizza","synonyms":[],"drawingId":"pizza","removed":false},{"word":"pliers","synonyms":[],"drawingId":"pliers","removed":false},{"word":"police car","synonyms":["police","cop car"],"drawingId":"police car","removed":false},{"word":"pond","synonyms":[],"drawingId":"pond","removed":false},{"word":"pool","synonyms":["swimming pool"],"drawingId":"pool","removed":false},{"word":"popsicle","synonyms":["ice pop","ice lolly"],"drawingId":"popsicle","removed":false},{"word":"postcard","synonyms":[],"drawingId":"postcard","removed":false},{"word":"potato","synonyms":[],"drawingId":"potato","removed":false},{"word":"power outlet","synonyms":["outlet","socket","power socket"],"drawingId":"power outlet","removed":false},{"word":"purse","synonyms":["handbag"],"drawingId":"purse","removed":false},{"word":"rabbit","synonyms":["bunny"],"drawingId":"rabbit","removed":false},{"word":"raccoon","synonyms":[],"drawingId":"raccoon","removed":false},{"word":"radio","synonyms":[],"drawingId":"radio","removed":false},{"word":"rain","synonyms":[],"drawingId":"rain","removed":false},{"word":"rainbow","synonyms":[],"drawingId":"rainbow","removed":false},{"word":"rake","synonyms":[],"drawingId":"rake","removed":false},{"word":"remote control","synonyms":["remote"],"drawingId":"remote control","removed":false},{"word":"rhinoceros","synonyms":["rhino"],"drawingId":"rhinoceros","removed":false},{"word":"rifle","synonyms":[],"drawingId":"rifle","removed":false},{"word":"river","synonyms":[],"drawingId":"river","removed":false},{"word":"roller coaster","synonyms":["coaster"],"drawingId":"roller coaster","removed":false},{"word":"rollerskates","synonyms":["roller skates","skates"],"drawingId":"rollerskates","removed":false},{"word":"sailboat","synonyms":["sail boat","sailing boat"],"drawingId":"sailboat","removed":false},{"word":"sandwich","synonyms":["sandwich"],"drawingId":"sandwich","removed":false},{"word":"saw","synonyms":[],"drawingId":"saw","removed":false},{"word":"saxophone","synonyms":["sax"],"drawingId":"saxophone","removed":false},{"word":"school bus","synonyms":["bus"],"drawingId":"school bus","removed":true},{"word":"scissors","synonyms":[],"drawingId":"scissors","removed":false},{"word":"scorpion","synonyms":[],"drawingId":"scorpion","removed":false},{"word":"screwdriver","synonyms":[],"drawingId":"screwdriver","removed":false},{"word":"sea turtle","synonyms":["turtle"],"drawingId":"sea turtle","removed":false},{"word":"see saw","synonyms":["seesaw","teeter totter"],"drawingId":"see saw","removed":false},{"word":"shark","synonyms":[],"drawingId":"shark","removed":false},{"word":"sheep","synonyms":[],"drawingId":"sheep","removed":false},{"word":"shoe","synonyms":[],"drawingId":"shoe","removed":false},{"word":"shorts","synonyms":[],"drawingId":"shorts","removed":false},{"word":"shovel","synonyms":[],"drawingId":"shovel","removed":false},{"word":"sink","synonyms":[],"drawingId":"sink","removed":false},{"word":"skateboard","synonyms":["skate board"],"drawingId":"skateboard","removed":false},{"word":"skull","synonyms":[],"drawingId":"skull","removed":false},{"word":"skyscraper","synonyms":[],"drawingId":"skyscraper","removed":false},{"word":"sleeping bag","synonyms":[],"drawingId":"sleeping bag","removed":true},{"word":"smiley face","synonyms":["smiley","smile"],"drawingId":"smiley face","removed":false},{"word":"snail","synonyms":[],"drawingId":"snail","removed":false},{"word":"snake","synonyms":[],"drawingId":"snake","removed":false},{"word":"snorkel","synonyms":[],"drawingId":"snorkel","removed":true},{"word":"snowflake","synonyms":[],"drawingId":"snowflake","removed":false},{"word":"snowman","synonyms":[],"drawingId":"snowman","removed":false},{"word":"soccer ball","synonyms":["football"],"drawingId":"soccer ball","removed":false},{"word":"sock","synonyms":[],"drawingId":"sock","removed":false},{"word":"speedboat","synonyms":["speed boat"],"drawingId":"speedboat","removed":true},{"word":"spider","synonyms":[],"drawingId":"spider","removed":false},{"word":"spoon","synonyms":[],"drawingId":"spoon","removed":false},{"word":"spreadsheet","synonyms":[],"drawingId":"spreadsheet","removed":false},{"word":"square","synonyms":[],"drawingId":"square","removed":false},{"word":"squiggle","synonyms":[],"drawingId":"squiggle","removed":false},{"word":"squirrel","synonyms":[],"drawingId":"squirrel","removed":false},{"word":"stairs","synonyms":["steps","staircase"],"drawingId":"stairs","removed":false},{"word":"star","synonyms":[],"drawingId":"star","removed":false},{"word":"steak","synonyms":[],"drawingId":"steak","removed":false},{"word":"stereo","synonyms":[],"drawingId":"stereo","removed":false},{"word":"stethoscope","synonyms":[],"drawingId":"stethoscope","removed":false},{"word":"stitches","synonyms":[],"drawingId":"stitches","removed":false},{"word":"stop sign","synonyms":["stop"],"drawingId":"stop sign","removed":false},{"word":"stove","synonyms":["cooker"],"drawingId":"stove","removed":false},{"word":"strawberry","synonyms":[],"drawingId":"strawberry","removed":false},{"word":"streetlight","synonyms":["street light","street lamp"],"drawingId":"streetlight","removed":false},{"word":"string bean","synonyms":["green bean"],"drawingId":"string bean","removed":true},{"word":"submarine","synonyms":["sub"],"drawingId":"submarine","removed":false},{"word":"suitcase","synonyms":["luggage"],"drawingId":"suitcase","removed":false},{"word":"sun","synonyms":[],"drawingId":"sun","removed":false},{"word":"swan","synonyms":[],"drawingId":"swan","removed":false},{"word":"sweater","synonyms":["jumper"],"drawingId":"sweater","removed":false},{"word":"swing set","synonyms":["swings","swing"],"drawingId":"swing set","removed":false},{"word":"sword","synonyms":[],"drawingId":"sword","removed":false},{"word":"syringe","synonyms":[],"drawingId":"syringe","removed":false},{"word":"table","synonyms":[],"drawingId":"table","removed":false},{"word":"teapot","synonyms":["tea pot"],"drawingId":"teapot","removed":false},{"word":"teddy-bear","synonyms":["teddy bear","teddy","bear"],"drawingId":"teddy-bear","removed":false},{"word":"telephone","synonyms":["phone"],"drawingId":"telephone","removed":false},{"word":"television","synonyms":["tv","telly"],"drawingId":"television","removed":false},{"word":"tennis racquet","synonyms":["tennis racket","racket"],"drawingId":"tennis racquet","removed":false},{"word":"tent","synonyms":[],"drawingId":"tent","removed":false},{"word":"The Eiffel Tower","synonyms":["eiffel tower"],"drawingId":"The Eiffel Tower","removed":false},{"word":"The Great Wall of China","synonyms":["great wall","great wall of china"],"drawingId":"The Great Wall of China","removed":false},{"word":"The Mona Lisa","synonyms":["mona lisa"],"drawingId":"The Mona Lisa","removed":false},{"word":"tiger","synonyms":[],"drawingId":"tiger","removed":false},{"word":"toaster","synonyms":[],"drawingId":"toaster","removed":false},{"word":"toe","synonyms":[],"drawingId":"toe","removed":false},{"word":"toilet","synonyms":["loo","bathroom"],"drawingId":"toilet","removed":false},{"word":"tooth","synonyms":[],"drawingId":"tooth","removed":false},{"word":"toothbrush","synonyms":[],"drawingId":"toothbrush","removed":false},{"word":"toothpaste","synonyms":[],"drawingId":"toothpaste","removed":false},{"word":"tornado","synonyms":[],"drawingId":"tornado","removed":false},{"word":"tractor","synonyms":[],"drawingId":"tractor","removed":false},{"word":"traffic light","synonyms":["traffic lights","stoplight"],"drawingId":"traffic light","removed":false},{"word":"train","synonyms":[],"drawingId":"train","removed":false},{"word":"tree","synonyms":[],"drawingId":"tree","removed":false},{"word":"triangle","synonyms":[],"drawingId":"triangle","removed":false},{"word":"trombone","synonyms":[],"drawingId":"trombone","removed":false},{"word":"truck","synonyms":[],"drawingId":"truck","removed":false},{"word":"trumpet","synonyms":[],"drawingId":"trumpet","removed":false},{"word":"t-shirt","synonyms":["tee","tshirt","t shirt"],"drawingId":"t-shirt","removed":false},{"word":"umbrella","synonyms":[],"drawingId":"umbrella","removed":false},{"word":"underwear","synonyms":[],"drawingId":"underwear","removed":false},{"word":"van","synonyms":[],"drawingId":"van","removed":false},{"word":"vase","synonyms":[],"drawingId":"vase","removed":false},{"word":"violin","synonyms":["fiddle"],"drawingId":"violin","removed":false},{"word":"washing machine","synonyms":["washer"],"drawingId":"washing machine","removed":false},{"word":"watermelon","synonyms":[],"drawingId":"watermelon","removed":false},{"word":"waterslide","synonyms":["water slide"],"drawingId":"waterslide","removed":false},{"word":"whale","synonyms":[],"drawingId":"whale","removed":false},{"word":"wheel","synonyms":[],"drawingId":"wheel","removed":false},{"word":"windmill","synonyms":[],"drawingId":"windmill","removed":false},{"word":"wine bottle","synonyms":["bottle"],"drawingId":"wine bottle","removed":false},{"word":"wine glass","synonyms":["glass"],"drawingId":"wine glass","removed":false},{"word":"wristwatch","synonyms":["watch"],"drawingId":"wristwatch","removed":false},{"word":"yoga","synonyms":[],"drawingId":"yoga","removed":false},{"word":"zebra","synonyms":[],"drawingId":"zebra","removed":false},{"word":"zigzag","synonyms":[],"drawingId":"zigzag","removed":true}]',
  ),
  Do = JSON.parse(
    '[{"word":"航空母舰","synonyms":["航母"],"drawingId":"aircraft carrier","pinyin":[["h","ang"],["k","ong"],["m","u"],["j","ian"]],"removed":false},{"word":"飞机","synonyms":["飞行器"],"drawingId":"airplane","pinyin":[["f","ei"],["j","i"]],"removed":false},{"word":"闹钟","synonyms":["闹表"],"drawingId":"alarm clock","pinyin":[["n","ao"],["zh","ong"]],"removed":false},{"word":"救护车","synonyms":[],"drawingId":"ambulance","pinyin":[["j","iu"],["h","u"],["ch","e"]],"removed":false},{"word":"天使","synonyms":[],"drawingId":"angel","pinyin":[["t","ian"],["sh","i"]],"removed":false},{"word":"动物迁徙","synonyms":["动物迁移"],"drawingId":"animal migration","pinyin":[["d","ong"],["w","u"],["q","ian"],["x","i"]],"removed":true},{"word":"蚂蚁","synonyms":[],"drawingId":"ant","pinyin":[["m","a"],["y","i"]],"removed":false},{"word":"铁砧","synonyms":["砧子"],"drawingId":"anvil","pinyin":[["t","ie"],["zh","en"]],"removed":false},{"word":"苹果","synonyms":[],"drawingId":"apple","pinyin":[["p","ing"],["g","uo"]],"removed":false},{"word":"手臂","synonyms":["胳膊","臂"],"drawingId":"arm","pinyin":[["sh","ou"],["b","i"]],"removed":false},{"word":"芦笋","synonyms":["龙须菜"],"drawingId":"asparagus","pinyin":[["l","u"],["s","un"]],"removed":true},{"word":"斧头","synonyms":["斧子"],"drawingId":"axe","pinyin":[["f","u"],["t","ou"]],"removed":false},{"word":"背包","synonyms":["双肩包"],"drawingId":"backpack","pinyin":[["b","ei"],["b","ao"]],"removed":false},{"word":"香蕉","synonyms":[],"drawingId":"banana","pinyin":[["x","iang"],["j","iao"]],"removed":false},{"word":"绷带","synonyms":["纱布"],"drawingId":"bandage","pinyin":[["b","eng"],["d","ai"]],"removed":false},{"word":"谷仓","synonyms":["仓库"],"drawingId":"barn","pinyin":[["g","u"],["c","ang"]],"removed":false},{"word":"棒球","synonyms":[],"drawingId":"baseball","pinyin":[["b","ang"],["q","iu"]],"removed":false},{"word":"棒球棒","synonyms":["球棒"],"drawingId":"baseball bat","pinyin":[["b","ang"],["q","iu"],["b","ang"]],"removed":false},{"word":"篮子","synonyms":["筐"],"drawingId":"basket","pinyin":[["l","an"],["z","i"]],"removed":false},{"word":"篮球","synonyms":[],"drawingId":"basketball","pinyin":[["l","an"],["q","iu"]],"removed":false},{"word":"蝙蝠","synonyms":[],"drawingId":"bat","pinyin":[["b","ian"],["f","u"]],"removed":false},{"word":"浴缸","synonyms":["浴盆"],"drawingId":"bathtub","pinyin":[["y","u"],["g","ang"]],"removed":false},{"word":"海滩","synonyms":["沙滩"],"drawingId":"beach","pinyin":[["h","ai"],["t","an"]],"removed":false},{"word":"熊","synonyms":[],"drawingId":"bear","pinyin":[["x","iong"]],"removed":false},{"word":"胡须","synonyms":["胡子"],"drawingId":"beard","pinyin":[["h","u"],["x","u"]],"removed":false},{"word":"床","synonyms":[],"drawingId":"bed","pinyin":[["ch","uang"]],"removed":false},{"word":"蜜蜂","synonyms":[],"drawingId":"bee","pinyin":[["m","i"],["f","eng"]],"removed":false},{"word":"腰带","synonyms":["皮带"],"drawingId":"belt","pinyin":[["y","ao"],["d","ai"]],"removed":false},{"word":"长凳","synonyms":["板凳"],"drawingId":"bench","pinyin":[["ch","ang"],["d","eng"]],"removed":false},{"word":"自行车","synonyms":["单车","脚踏车"],"drawingId":"bicycle","pinyin":[["z","i"],["x","ing"],["ch","e"]],"removed":false},{"word":"望远镜","synonyms":[],"drawingId":"binoculars","pinyin":[["w","ang"],["y","uan"],["j","ing"]],"removed":false},{"word":"鸟","synonyms":[],"drawingId":"bird","pinyin":[["n","iao"]],"removed":false},{"word":"生日蛋糕","synonyms":["生日蛋糕"],"drawingId":"birthday cake","pinyin":[["sh","eng"],["r","i"],["d","an"],["g","ao"]],"removed":false},{"word":"黑莓","synonyms":[],"drawingId":"blackberry","pinyin":[["h","ei"],["m","ei"]],"removed":false},{"word":"蓝莓","synonyms":[],"drawingId":"blueberry","pinyin":[["l","an"],["m","ei"]],"removed":false},{"word":"书","synonyms":["书籍"],"drawingId":"book","pinyin":[["sh","u"]],"removed":false},{"word":"回旋镖","synonyms":["回力镖"],"drawingId":"boomerang","pinyin":[["h","ui"],["x","uan"],["b","iao"]],"removed":false},{"word":"瓶盖","synonyms":[],"drawingId":"bottlecap","pinyin":[["p","ing"],["g","ai"]],"removed":false},{"word":"领结","synonyms":["蝴蝶结"],"drawingId":"bowtie","pinyin":[["l","ing"],["j","ie"]],"removed":false},{"word":"手镯","synonyms":["手环"],"drawingId":"bracelet","pinyin":[["sh","ou"],["zh","uo"]],"removed":false},{"word":"大脑","synonyms":["脑"],"drawingId":"brain","pinyin":[["d","a"],["n","ao"]],"removed":false},{"word":"面包","synonyms":[],"drawingId":"bread","pinyin":[["m","ian"],["b","ao"]],"removed":false},{"word":"桥","synonyms":[],"drawingId":"bridge","pinyin":[["q","iao"]],"removed":false},{"word":"西兰花","synonyms":["花椰菜"],"drawingId":"broccoli","pinyin":[["x","i"],["l","an"],["h","ua"]],"removed":false},{"word":"扫帚","synonyms":["扫把"],"drawingId":"broom","pinyin":[["s","ao"],["zh","ou"]],"removed":false},{"word":"水桶","synonyms":["桶"],"drawingId":"bucket","pinyin":[["sh","ui"],["t","ong"]],"removed":false},{"word":"推土机","synonyms":[],"drawingId":"bulldozer","pinyin":[["t","ui"],["t","u"],["j","i"]],"removed":false},{"word":"公共汽车","synonyms":["公交车","巴士"],"drawingId":"bus","pinyin":[["g","ong"],["g","ong"],["q","i"],["ch","e"]],"removed":false},{"word":"灌木","synonyms":["树丛","草丛"],"drawingId":"bush","pinyin":[["g","uan"],["m","u"]],"removed":false},{"word":"蝴蝶","synonyms":[],"drawingId":"butterfly","pinyin":[["h","u"],["d","ie"]],"removed":false},{"word":"仙人掌","synonyms":[],"drawingId":"cactus","pinyin":[["x","ian"],["r","en"],["zh","ang"]],"removed":false},{"word":"蛋糕","synonyms":["糕点"],"drawingId":"cake","pinyin":[["d","an"],["g","ao"]],"removed":false},{"word":"计算器","synonyms":["计算器"],"drawingId":"calculator","pinyin":[["j","i"],["s","uan"],["q","i"]],"removed":false},{"word":"日历","synonyms":["月历"],"drawingId":"calendar","pinyin":[["r","i"],["l","i"]],"removed":false},{"word":"骆驼","synonyms":[],"drawingId":"camel","pinyin":[["l","uo"],["t","uo"]],"removed":false},{"word":"相机","synonyms":["照相机","摄像机"],"drawingId":"camera","pinyin":[["x","iang"],["j","i"]],"removed":false},{"word":"伪装","synonyms":["迷彩"],"drawingId":"camouflage","pinyin":[["w","ei"],["zh","uang"]],"removed":true},{"word":"篝火","synonyms":["营火"],"drawingId":"campfire","pinyin":[["g","ou"],["h","uo"]],"removed":false},{"word":"蜡烛","synonyms":[],"drawingId":"candle","pinyin":[["l","a"],["zh","u"]],"removed":false},{"word":"大炮","synonyms":["加农炮"],"drawingId":"cannon","pinyin":[["d","a"],["p","ao"]],"removed":false},{"word":"独木舟","synonyms":["小舟"],"drawingId":"canoe","pinyin":[["d","u"],["m","u"],["zh","ou"]],"removed":true},{"word":"汽车","synonyms":["小汽车","轿车"],"drawingId":"car","pinyin":[["q","i"],["ch","e"]],"removed":false},{"word":"胡萝卜","synonyms":[],"drawingId":"carrot","pinyin":[["h","u"],["l","uo"],["b","o"]],"removed":false},{"word":"城堡","synonyms":[],"drawingId":"castle","pinyin":[["ch","eng"],["b","ao"]],"removed":false},{"word":"猫","synonyms":[],"drawingId":"cat","pinyin":[["m","ao"]],"removed":false},{"word":"吊扇","synonyms":["风扇"],"drawingId":"ceiling fan","pinyin":[["d","iao"],["sh","an"]],"removed":false},{"word":"大提琴","synonyms":[],"drawingId":"cello","pinyin":[["d","a"],["t","i"],["q","in"]],"removed":false},{"word":"手机","synonyms":["移动电话","电话"],"drawingId":"cell phone","pinyin":[["sh","ou"],["j","i"]],"removed":false},{"word":"椅子","synonyms":[],"drawingId":"chair","pinyin":[["y","i"],["z","i"]],"removed":false},{"word":"枝形吊灯","synonyms":["吊灯"],"drawingId":"chandelier","pinyin":[["zh","i"],["x","ing"],["d","iao"],["d","eng"]],"removed":true},{"word":"教堂","synonyms":[],"drawingId":"church","pinyin":[["j","iao"],["t","ang"]],"removed":false},{"word":"圆形","synonyms":["圆圈","圈"],"drawingId":"circle","pinyin":[["y","uan"],["x","ing"]],"removed":false},{"word":"单簧管","synonyms":["黑管"],"drawingId":"clarinet","pinyin":[["d","an"],["h","uang"],["g","uan"]],"removed":true},{"word":"时钟","synonyms":["钟表"],"drawingId":"clock","pinyin":[["sh","i"],["zh","ong"]],"removed":false},{"word":"云","synonyms":["云朵"],"drawingId":"cloud","pinyin":[["y","un"]],"removed":false},{"word":"咖啡杯","synonyms":[],"drawingId":"coffee cup","pinyin":[["k","a"],["f","ei"],["b","ei"]],"removed":false},{"word":"指南针","synonyms":["罗盘"],"drawingId":"compass","pinyin":[["zh","i"],["n","an"],["zh","en"]],"removed":false},{"word":"电脑","synonyms":["计算机"],"drawingId":"computer","pinyin":[["d","ian"],["n","ao"]],"removed":false},{"word":"饼干","synonyms":["曲奇"],"drawingId":"cookie","pinyin":[["b","ing"],["g","an"]],"removed":false},{"word":"冷却器","synonyms":["冰桶"],"drawingId":"cooler","pinyin":[["l","eng"],["q","ue"],["q","i"]],"removed":true},{"word":"沙发","synonyms":[],"drawingId":"couch","pinyin":[["sh","a"],["f","a"]],"removed":false},{"word":"牛","synonyms":[],"drawingId":"cow","pinyin":[["n","iu"]],"removed":false},{"word":"螃蟹","synonyms":[],"drawingId":"crab","pinyin":[["p","ang"],["x","ie"]],"removed":false},{"word":"蜡笔","synonyms":["彩色笔"],"drawingId":"crayon","pinyin":[["l","a"],["b","i"]],"removed":false},{"word":"鳄鱼","synonyms":[],"drawingId":"crocodile","pinyin":[[null,"e"],["y","u"]],"removed":false},{"word":"王冠","synonyms":["皇冠"],"drawingId":"crown","pinyin":[["w","ang"],["g","uan"]],"removed":false},{"word":"游轮","synonyms":["邮轮"],"drawingId":"cruise ship","pinyin":[["y","ou"],["l","un"]],"removed":false},{"word":"杯子","synonyms":["茶杯"],"drawingId":"cup","pinyin":[["b","ei"],["z","i"]],"removed":false},{"word":"钻石","synonyms":[],"drawingId":"diamond","pinyin":[["z","uan"],["sh","i"]],"removed":false},{"word":"洗碗机","synonyms":[],"drawingId":"dishwasher","pinyin":[["x","i"],["w","an"],["j","i"]],"removed":true},{"word":"跳板","synonyms":["跳水板"],"drawingId":"diving board","pinyin":[["t","iao"],["b","an"]],"removed":true},{"word":"狗","synonyms":[],"drawingId":"dog","pinyin":[["g","ou"]],"removed":false},{"word":"海豚","synonyms":[],"drawingId":"dolphin","pinyin":[["h","ai"],["t","un"]],"removed":false},{"word":"甜甜圈","synonyms":["多纳圈"],"drawingId":"donut","pinyin":[["t","ian"],["t","ian"],["q","uan"]],"removed":false},{"word":"门","synonyms":[],"drawingId":"door","pinyin":[["m","en"]],"removed":false},{"word":"龙","synonyms":[],"drawingId":"dragon","pinyin":[["l","ong"]],"removed":false},{"word":"梳妆台","synonyms":["衣柜","柜子"],"drawingId":"dresser","pinyin":[["sh","u"],["zh","uang"],["t","ai"]],"removed":false},{"word":"钻头","synonyms":["电钻"],"drawingId":"drill","pinyin":[["z","uan"],["t","ou"]],"removed":false},{"word":"鼓","synonyms":[],"drawingId":"drums","pinyin":[["g","u"]],"removed":false},{"word":"鸭子","synonyms":[],"drawingId":"duck","pinyin":[["y","a"],["z","i"]],"removed":false},{"word":"哑铃","synonyms":[],"drawingId":"dumbbell","pinyin":[["y","a"],["l","ing"]],"removed":false},{"word":"耳朵","synonyms":["耳"],"drawingId":"ear","pinyin":[[null,"er"],["d","uo"]],"removed":false},{"word":"肘部","synonyms":["手肘"],"drawingId":"elbow","pinyin":[["zh","ou"],["b","u"]],"removed":false},{"word":"大象","synonyms":[],"drawingId":"elephant","pinyin":[["d","a"],["x","iang"]],"removed":false},{"word":"信封","synonyms":[],"drawingId":"envelope","pinyin":[["x","in"],["f","eng"]],"removed":false},{"word":"橡皮擦","synonyms":["橡皮"],"drawingId":"eraser","pinyin":[["x","iang"],["p","i"],["c","a"]],"removed":false},{"word":"眼睛","synonyms":["眼"],"drawingId":"eye","pinyin":[["y","an"],["j","ing"]],"removed":false},{"word":"眼镜","synonyms":[],"drawingId":"eyeglasses","pinyin":[["y","an"],["j","ing"]],"removed":false},{"word":"脸","synonyms":["面部"],"drawingId":"face","pinyin":[["l","ian"]],"removed":false},{"word":"风扇","synonyms":["电扇"],"drawingId":"fan","pinyin":[["f","eng"],["sh","an"]],"removed":false},{"word":"羽毛","synonyms":[],"drawingId":"feather","pinyin":[["y","u"],["m","ao"]],"removed":false},{"word":"栅栏","synonyms":["围栏"],"drawingId":"fence","pinyin":[["zh","a"],["l","an"]],"removed":false},{"word":"手指","synonyms":["指头"],"drawingId":"finger","pinyin":[["sh","ou"],["zh","i"]],"removed":false},{"word":"消防栓","synonyms":["消火栓"],"drawingId":"fire hydrant","pinyin":[["x","iao"],["f","ang"],["sh","uan"]],"removed":false},{"word":"壁炉","synonyms":["火炉"],"drawingId":"fireplace","pinyin":[["b","i"],["l","u"]],"removed":false},{"word":"消防车","synonyms":[],"drawingId":"firetruck","pinyin":[["x","iao"],["f","ang"],["ch","e"]],"removed":false},{"word":"鱼","synonyms":[],"drawingId":"fish","pinyin":[["y","u"]],"removed":false},{"word":"火烈鸟","synonyms":["红鹤"],"drawingId":"flamingo","pinyin":[["h","uo"],["l","ie"],["n","iao"]],"removed":false},{"word":"手电筒","synonyms":["电筒"],"drawingId":"flashlight","pinyin":[["sh","ou"],["d","ian"],["t","ong"]],"removed":false},{"word":"人字拖","synonyms":["拖鞋"],"drawingId":"flip flops","pinyin":[["r","en"],["z","i"],["t","uo"]],"removed":false},{"word":"落地灯","synonyms":["台灯"],"drawingId":"floor lamp","pinyin":[["l","uo"],["d","i"],["d","eng"]],"removed":false},{"word":"花","synonyms":["花朵","鲜花"],"drawingId":"flower","pinyin":[["h","ua"]],"removed":false},{"word":"飞碟","synonyms":["UFO"],"drawingId":"flying saucer","pinyin":[["f","ei"],["d","ie"]],"removed":false},{"word":"脚","synonyms":["足"],"drawingId":"foot","pinyin":[["j","iao"]],"removed":false},{"word":"叉子","synonyms":["餐叉"],"drawingId":"fork","pinyin":[["ch","a"],["z","i"]],"removed":false},{"word":"青蛙","synonyms":[],"drawingId":"frog","pinyin":[["q","ing"],["w","a"]],"removed":false},{"word":"平底锅","synonyms":["煎锅"],"drawingId":"frying pan","pinyin":[["p","ing"],["d","i"],["g","uo"]],"removed":false},{"word":"花园","synonyms":["庭院"],"drawingId":"garden","pinyin":[["h","ua"],["y","uan"]],"removed":false},{"word":"花园软管","synonyms":["水管"],"drawingId":"garden hose","pinyin":[["h","ua"],["y","uan"],["r","uan"],["g","uan"]],"removed":true},{"word":"长颈鹿","synonyms":[],"drawingId":"giraffe","pinyin":[["ch","ang"],["j","ing"],["l","u"]],"removed":false},{"word":"山羊胡","synonyms":["小胡子"],"drawingId":"goatee","pinyin":[["sh","an"],["y","ang"],["h","u"]],"removed":false},{"word":"高尔夫球杆","synonyms":["球杆"],"drawingId":"golf club","pinyin":[["g","ao"],[null,"er"],["f","u"],["q","iu"],["g","an"]],"removed":false},{"word":"葡萄","synonyms":[],"drawingId":"grapes","pinyin":[["p","u"],["t","ao"]],"removed":false},{"word":"草","synonyms":["青草"],"drawingId":"grass","pinyin":[["c","ao"]],"removed":false},{"word":"吉他","synonyms":[],"drawingId":"guitar","pinyin":[["j","i"],["t","a"]],"removed":false},{"word":"汉堡包","synonyms":["汉堡"],"drawingId":"hamburger","pinyin":[["h","an"],["b","ao"],["b","ao"]],"removed":false},{"word":"锤子","synonyms":["铁锤"],"drawingId":"hammer","pinyin":[["ch","ui"],["z","i"]],"removed":false},{"word":"手","synonyms":[],"drawingId":"hand","pinyin":[["sh","ou"]],"removed":false},{"word":"竖琴","synonyms":[],"drawingId":"harp","pinyin":[["sh","u"],["q","in"]],"removed":false},{"word":"帽子","synonyms":[],"drawingId":"hat","pinyin":[["m","ao"],["z","i"]],"removed":false},{"word":"耳机","synonyms":["头戴式耳机"],"drawingId":"headphones","pinyin":[[null,"er"],["j","i"]],"removed":false},{"word":"刺猬","synonyms":[],"drawingId":"hedgehog","pinyin":[["c","i"],["w","ei"]],"removed":false},{"word":"直升机","synonyms":["直升飞机"],"drawingId":"helicopter","pinyin":[["zh","i"],["sh","eng"],["j","i"]],"removed":false},{"word":"头盔","synonyms":["安全帽"],"drawingId":"helmet","pinyin":[["t","ou"],["k","ui"]],"removed":false},{"word":"六边形","synonyms":["六角形"],"drawingId":"hexagon","pinyin":[["l","iu"],["b","ian"],["x","ing"]],"removed":false},{"word":"冰球","synonyms":["曲棍球"],"drawingId":"hockey puck","pinyin":[["b","ing"],["q","iu"]],"removed":true},{"word":"曲棍球杆","synonyms":["球杆"],"drawingId":"hockey stick","pinyin":[["q","u"],["g","un"],["q","iu"],["g","an"]],"removed":true},{"word":"马","synonyms":[],"drawingId":"horse","pinyin":[["m","a"]],"removed":false},{"word":"医院","synonyms":[],"drawingId":"hospital","pinyin":[["y","i"],["y","uan"]],"removed":false},{"word":"热气球","synonyms":[],"drawingId":"hot air balloon","pinyin":[["r","e"],["q","i"],["q","iu"]],"removed":false},{"word":"热狗","synonyms":[],"drawingId":"hot dog","pinyin":[["r","e"],["g","ou"]],"removed":false},{"word":"浴缸","synonyms":["按摩浴缸","热水浴缸"],"drawingId":"hot tub","pinyin":[["y","u"],["g","ang"]],"removed":false},{"word":"沙漏","synonyms":[],"drawingId":"hourglass","pinyin":[["sh","a"],["l","ou"]],"removed":false},{"word":"房子","synonyms":["房屋"],"drawingId":"house","pinyin":[["f","ang"],["z","i"]],"removed":false},{"word":"盆栽","synonyms":["室内植物"],"drawingId":"house plant","pinyin":[["p","en"],["z","ai"]],"removed":false},{"word":"飓风","synonyms":["台风"],"drawingId":"hurricane","pinyin":[["j","u"],["f","eng"]],"removed":false},{"word":"冰淇淋","synonyms":["冰激凌"],"drawingId":"ice cream","pinyin":[["b","ing"],["q","i"],["l","in"]],"removed":false},{"word":"夹克","synonyms":["外套"],"drawingId":"jacket","pinyin":[["j","ia"],["k","e"]],"removed":false},{"word":"监狱","synonyms":["牢房"],"drawingId":"jail","pinyin":[["j","ian"],["y","u"]],"removed":false},{"word":"袋鼠","synonyms":[],"drawingId":"kangaroo","pinyin":[["d","ai"],["sh","u"]],"removed":false},{"word":"钥匙","synonyms":[],"drawingId":"key","pinyin":[["y","ao"],["sh","i"]],"removed":false},{"word":"键盘","synonyms":[],"drawingId":"keyboard","pinyin":[["j","ian"],["p","an"]],"removed":false},{"word":"膝盖","synonyms":["膝"],"drawingId":"knee","pinyin":[["x","i"],["g","ai"]],"removed":false},{"word":"刀","synonyms":["刀子"],"drawingId":"knife","pinyin":[["d","ao"]],"removed":false},{"word":"梯子","synonyms":[],"drawingId":"ladder","pinyin":[["t","i"],["z","i"]],"removed":false},{"word":"灯笼","synonyms":[],"drawingId":"lantern","pinyin":[["d","eng"],["l","ong"]],"removed":false},{"word":"笔记本电脑","synonyms":["笔记本"],"drawingId":"laptop","pinyin":[["b","i"],["j","i"],["b","en"],["d","ian"],["n","ao"]],"removed":false},{"word":"叶子","synonyms":["树叶"],"drawingId":"leaf","pinyin":[["y","e"],["z","i"]],"removed":false},{"word":"腿","synonyms":[],"drawingId":"leg","pinyin":[["t","ui"]],"removed":false},{"word":"灯泡","synonyms":["电灯泡"],"drawingId":"light bulb","pinyin":[["d","eng"],["p","ao"]],"removed":false},{"word":"打火机","synonyms":[],"drawingId":"lighter","pinyin":[["d","a"],["h","uo"],["j","i"]],"removed":false},{"word":"灯塔","synonyms":[],"drawingId":"lighthouse","pinyin":[["d","eng"],["t","a"]],"removed":false},{"word":"闪电","synonyms":[],"drawingId":"lightning","pinyin":[["sh","an"],["d","ian"]],"removed":false},{"word":"线","synonyms":["线条"],"drawingId":"line","pinyin":[["x","ian"]],"removed":false},{"word":"狮子","synonyms":[],"drawingId":"lion","pinyin":[["sh","i"],["z","i"]],"removed":false},{"word":"口红","synonyms":["唇膏"],"drawingId":"lipstick","pinyin":[["k","ou"],["h","ong"]],"removed":false},{"word":"龙虾","synonyms":[],"drawingId":"lobster","pinyin":[["l","ong"],["x","ia"]],"removed":false},{"word":"棒棒糖","synonyms":[],"drawingId":"lollipop","pinyin":[["b","ang"],["b","ang"],["t","ang"]],"removed":false},{"word":"邮箱","synonyms":["信箱"],"drawingId":"mailbox","pinyin":[["y","ou"],["x","iang"]],"removed":false},{"word":"地图","synonyms":[],"drawingId":"map","pinyin":[["d","i"],["t","u"]],"removed":false},{"word":"马克笔","synonyms":["记号笔"],"drawingId":"marker","pinyin":[["m","a"],["k","e"],["b","i"]],"removed":true},{"word":"火柴","synonyms":[],"drawingId":"matches","pinyin":[["h","uo"],["ch","ai"]],"removed":false},{"word":"喇叭","synonyms":["扩音器"],"drawingId":"megaphone","pinyin":[["l","a"],["b","a"]],"removed":false},{"word":"美人鱼","synonyms":[],"drawingId":"mermaid","pinyin":[["m","ei"],["r","en"],["y","u"]],"removed":false},{"word":"麦克风","synonyms":["话筒"],"drawingId":"microphone","pinyin":[["m","ai"],["k","e"],["f","eng"]],"removed":false},{"word":"微波炉","synonyms":[],"drawingId":"microwave","pinyin":[["w","ei"],["b","o"],["l","u"]],"removed":false},{"word":"猴子","synonyms":[],"drawingId":"monkey","pinyin":[["h","ou"],["z","i"]],"removed":false},{"word":"月亮","synonyms":["月球"],"drawingId":"moon","pinyin":[["y","ue"],["l","iang"]],"removed":false},{"word":"蚊子","synonyms":[],"drawingId":"mosquito","pinyin":[["w","en"],["z","i"]],"removed":false},{"word":"摩托车","synonyms":["摩托"],"drawingId":"motorbike","pinyin":[["m","o"],["t","uo"],["ch","e"]],"removed":false},{"word":"山","synonyms":["山峰"],"drawingId":"mountain","pinyin":[["sh","an"]],"removed":false},{"word":"老鼠","synonyms":["鼠"],"drawingId":"mouse","pinyin":[["l","ao"],["sh","u"]],"removed":false},{"word":"小胡子","synonyms":["八字胡"],"drawingId":"moustache","pinyin":[["x","iao"],["h","u"],["z","i"]],"removed":false},{"word":"嘴","synonyms":["嘴巴"],"drawingId":"mouth","pinyin":[["z","ui"]],"removed":false},{"word":"马克杯","synonyms":["杯子"],"drawingId":"mug","pinyin":[["m","a"],["k","e"],["b","ei"]],"removed":false},{"word":"蘑菇","synonyms":[],"drawingId":"mushroom","pinyin":[["m","o"],["g","u"]],"removed":false},{"word":"钉子","synonyms":[],"drawingId":"nail","pinyin":[["d","ing"],["z","i"]],"removed":false},{"word":"项链","synonyms":[],"drawingId":"necklace","pinyin":[["x","iang"],["l","ian"]],"removed":false},{"word":"鼻子","synonyms":["鼻"],"drawingId":"nose","pinyin":[["b","i"],["z","i"]],"removed":false},{"word":"海洋","synonyms":["大海"],"drawingId":"ocean","pinyin":[["h","ai"],["y","ang"]],"removed":false},{"word":"八边形","synonyms":["八角形"],"drawingId":"octagon","pinyin":[["b","a"],["b","ian"],["x","ing"]],"removed":false},{"word":"章鱼","synonyms":[],"drawingId":"octopus","pinyin":[["zh","ang"],["y","u"]],"removed":false},{"word":"洋葱","synonyms":[],"drawingId":"onion","pinyin":[["y","ang"],["c","ong"]],"removed":false},{"word":"烤箱","synonyms":["烤炉"],"drawingId":"oven","pinyin":[["k","ao"],["x","iang"]],"removed":false},{"word":"猫头鹰","synonyms":["枭"],"drawingId":"owl","pinyin":[["m","ao"],["t","ou"],["y","ing"]],"removed":false},{"word":"画笔","synonyms":["画刷"],"drawingId":"paintbrush","pinyin":[["h","ua"],["b","i"]],"removed":false},{"word":"油漆桶","synonyms":["颜料桶"],"drawingId":"paint can","pinyin":[["y","ou"],["q","i"],["t","ong"]],"removed":false},{"word":"棕榈树","synonyms":["椰子树"],"drawingId":"palm tree","pinyin":[["z","ong"],["l","ü"],["sh","u"]],"removed":false},{"word":"熊猫","synonyms":[],"drawingId":"panda","pinyin":[["x","iong"],["m","ao"]],"removed":false},{"word":"裤子","synonyms":["长裤"],"drawingId":"pants","pinyin":[["k","u"],["z","i"]],"removed":false},{"word":"回形针","synonyms":["曲别针"],"drawingId":"paper clip","pinyin":[["h","ui"],["x","ing"],["zh","en"]],"removed":false},{"word":"降落伞","synonyms":[],"drawingId":"parachute","pinyin":[["j","iang"],["l","uo"],["s","an"]],"removed":false},{"word":"鹦鹉","synonyms":[],"drawingId":"parrot","pinyin":[["y","ing"],["w","u"]],"removed":false},{"word":"护照","synonyms":[],"drawingId":"passport","pinyin":[["h","u"],["zh","ao"]],"removed":false},{"word":"花生","synonyms":[],"drawingId":"peanut","pinyin":[["h","ua"],["sh","eng"]],"removed":false},{"word":"梨","synonyms":[],"drawingId":"pear","pinyin":[["l","i"]],"removed":false},{"word":"豌豆","synonyms":[],"drawingId":"peas","pinyin":[["w","an"],["d","ou"]],"removed":false},{"word":"铅笔","synonyms":[],"drawingId":"pencil","pinyin":[["q","ian"],["b","i"]],"removed":false},{"word":"企鹅","synonyms":[],"drawingId":"penguin","pinyin":[["q","i"],[null,"e"]],"removed":false},{"word":"钢琴","synonyms":[],"drawingId":"piano","pinyin":[["g","ang"],["q","in"]],"removed":false},{"word":"皮卡车","synonyms":["小货车"],"drawingId":"pickup truck","pinyin":[["p","i"],["k","a"],["ch","e"]],"removed":true},{"word":"相框","synonyms":["画框"],"drawingId":"picture frame","pinyin":[["x","iang"],["k","uang"]],"removed":false},{"word":"猪","synonyms":[],"drawingId":"pig","pinyin":[["zh","u"]],"removed":false},{"word":"枕头","synonyms":[],"drawingId":"pillow","pinyin":[["zh","en"],["t","ou"]],"removed":false},{"word":"菠萝","synonyms":["凤梨"],"drawingId":"pineapple","pinyin":[["b","o"],["l","uo"]],"removed":false},{"word":"披萨","synonyms":["比萨饼"],"drawingId":"pizza","pinyin":[["p","i"],["s","a"]],"removed":false},{"word":"钳子","synonyms":["老虎钳"],"drawingId":"pliers","pinyin":[["q","ian"],["z","i"]],"removed":false},{"word":"警车","synonyms":[],"drawingId":"police car","pinyin":[["j","ing"],["ch","e"]],"removed":false},{"word":"池塘","synonyms":["池子"],"drawingId":"pond","pinyin":[["ch","i"],["t","ang"]],"removed":false},{"word":"游泳池","synonyms":["泳池"],"drawingId":"pool","pinyin":[["y","ou"],["y","ong"],["ch","i"]],"removed":false},{"word":"冰棒","synonyms":["冰棍"],"drawingId":"popsicle","pinyin":[["b","ing"],["b","ang"]],"removed":false},{"word":"明信片","synonyms":[],"drawingId":"postcard","pinyin":[["m","ing"],["x","in"],["p","ian"]],"removed":false},{"word":"土豆","synonyms":["马铃薯"],"drawingId":"potato","pinyin":[["t","u"],["d","ou"]],"removed":false},{"word":"电源插座","synonyms":["插座"],"drawingId":"power outlet","pinyin":[["d","ian"],["y","uan"],["ch","a"],["z","uo"]],"removed":false},{"word":"钱包","synonyms":["手提包"],"drawingId":"purse","pinyin":[["q","ian"],["b","ao"]],"removed":false},{"word":"兔子","synonyms":[],"drawingId":"rabbit","pinyin":[["t","u"],["z","i"]],"removed":false},{"word":"浣熊","synonyms":[],"drawingId":"raccoon","pinyin":[["h","uan"],["x","iong"]],"removed":false},{"word":"收音机","synonyms":["无线电"],"drawingId":"radio","pinyin":[["sh","ou"],["y","in"],["j","i"]],"removed":false},{"word":"雨","synonyms":[],"drawingId":"rain","pinyin":[["y","u"]],"removed":false},{"word":"彩虹","synonyms":[],"drawingId":"rainbow","pinyin":[["c","ai"],["h","ong"]],"removed":false},{"word":"耙子","synonyms":[],"drawingId":"rake","pinyin":[["p","a"],["z","i"]],"removed":false},{"word":"遥控器","synonyms":[],"drawingId":"remote control","pinyin":[["y","ao"],["k","ong"],["q","i"]],"removed":false},{"word":"犀牛","synonyms":[],"drawingId":"rhinoceros","pinyin":[["x","i"],["n","iu"]],"removed":false},{"word":"步枪","synonyms":["来复枪"],"drawingId":"rifle","pinyin":[["b","u"],["q","iang"]],"removed":false},{"word":"河","synonyms":["河流"],"drawingId":"river","pinyin":[["h","e"]],"removed":false},{"word":"过山车","synonyms":["云霄飞车"],"drawingId":"roller coaster","pinyin":[["g","uo"],["sh","an"],["ch","e"]],"removed":false},{"word":"轮滑鞋","synonyms":["旱冰鞋"],"drawingId":"rollerskates","pinyin":[["l","un"],["h","ua"],["x","ie"]],"removed":false},{"word":"帆船","synonyms":[],"drawingId":"sailboat","pinyin":[["f","an"],["ch","uan"]],"removed":false},{"word":"三明治","synonyms":["三文治"],"drawingId":"sandwich","pinyin":[["s","an"],["m","ing"],["zh","i"]],"removed":false},{"word":"锯子","synonyms":["锯"],"drawingId":"saw","pinyin":[["j","u"],["z","i"]],"removed":false},{"word":"萨克斯管","synonyms":["萨克斯"],"drawingId":"saxophone","pinyin":[["s","a"],["k","e"],["s","i"],["g","uan"]],"removed":false},{"word":"校车","synonyms":[],"drawingId":"school bus","pinyin":[["x","iao"],["ch","e"]],"removed":true},{"word":"剪刀","synonyms":[],"drawingId":"scissors","pinyin":[["j","ian"],["d","ao"]],"removed":false},{"word":"蝎子","synonyms":[],"drawingId":"scorpion","pinyin":[["x","ie"],["z","i"]],"removed":false},{"word":"螺丝刀","synonyms":["改锥"],"drawingId":"screwdriver","pinyin":[["l","uo"],["s","i"],["d","ao"]],"removed":false},{"word":"海龟","synonyms":[],"drawingId":"sea turtle","pinyin":[["h","ai"],["g","ui"]],"removed":false},{"word":"跷跷板","synonyms":[],"drawingId":"see saw","pinyin":[["q","iao"],["q","iao"],["b","an"]],"removed":false},{"word":"鲨鱼","synonyms":[],"drawingId":"shark","pinyin":[["sh","a"],["y","u"]],"removed":false},{"word":"羊","synonyms":["绵羊"],"drawingId":"sheep","pinyin":[["y","ang"]],"removed":false},{"word":"鞋","synonyms":["鞋子"],"drawingId":"shoe","pinyin":[["x","ie"]],"removed":false},{"word":"短裤","synonyms":[],"drawingId":"shorts","pinyin":[["d","uan"],["k","u"]],"removed":false},{"word":"铲子","synonyms":["铁锹"],"drawingId":"shovel","pinyin":[["ch","an"],["z","i"]],"removed":false},{"word":"水槽","synonyms":["洗手池"],"drawingId":"sink","pinyin":[["sh","ui"],["c","ao"]],"removed":false},{"word":"滑板","synonyms":[],"drawingId":"skateboard","pinyin":[["h","ua"],["b","an"]],"removed":false},{"word":"头骨","synonyms":["骷髅"],"drawingId":"skull","pinyin":[["t","ou"],["g","u"]],"removed":false},{"word":"摩天大楼","synonyms":["高楼"],"drawingId":"skyscraper","pinyin":[["m","o"],["t","ian"],["d","a"],["l","ou"]],"removed":false},{"word":"睡袋","synonyms":[],"drawingId":"sleeping bag","pinyin":[["sh","ui"],["d","ai"]],"removed":true},{"word":"笑脸","synonyms":["笑脸"],"drawingId":"smiley face","pinyin":[["x","iao"],["l","ian"]],"removed":false},{"word":"蜗牛","synonyms":[],"drawingId":"snail","pinyin":[["w","o"],["n","iu"]],"removed":false},{"word":"蛇","synonyms":[],"drawingId":"snake","pinyin":[["sh","e"]],"removed":false},{"word":"呼吸管","synonyms":["通气管"],"drawingId":"snorkel","pinyin":[["h","u"],["x","i"],["g","uan"]],"removed":true},{"word":"雪花","synonyms":[],"drawingId":"snowflake","pinyin":[["x","ue"],["h","ua"]],"removed":false},{"word":"雪人","synonyms":[],"drawingId":"snowman","pinyin":[["x","ue"],["r","en"]],"removed":false},{"word":"足球","synonyms":[],"drawingId":"soccer ball","pinyin":[["z","u"],["q","iu"]],"removed":false},{"word":"袜子","synonyms":[],"drawingId":"sock","pinyin":[["w","a"],["z","i"]],"removed":false},{"word":"快艇","synonyms":["快船"],"drawingId":"speedboat","pinyin":[["k","uai"],["t","ing"]],"removed":true},{"word":"蜘蛛","synonyms":[],"drawingId":"spider","pinyin":[["zh","i"],["zh","u"]],"removed":false},{"word":"勺子","synonyms":["汤匙"],"drawingId":"spoon","pinyin":[["sh","ao"],["z","i"]],"removed":false},{"word":"电子表格","synonyms":["表格"],"drawingId":"spreadsheet","pinyin":[["d","ian"],["z","i"],["b","iao"],["g","e"]],"removed":false},{"word":"正方形","synonyms":["方形"],"drawingId":"square","pinyin":[["zh","eng"],["f","ang"],["x","ing"]],"removed":false},{"word":"波浪线","synonyms":["曲线"],"drawingId":"squiggle","pinyin":[["b","o"],["l","ang"],["x","ian"]],"removed":false},{"word":"松鼠","synonyms":[],"drawingId":"squirrel","pinyin":[["s","ong"],["sh","u"]],"removed":false},{"word":"楼梯","synonyms":["阶梯"],"drawingId":"stairs","pinyin":[["l","ou"],["t","i"]],"removed":false},{"word":"星星","synonyms":["星"],"drawingId":"star","pinyin":[["x","ing"],["x","ing"]],"removed":false},{"word":"牛排","synonyms":[],"drawingId":"steak","pinyin":[["n","iu"],["p","ai"]],"removed":false},{"word":"立体声音响","synonyms":["音响"],"drawingId":"stereo","pinyin":[["l","i"],["t","i"],["sh","eng"],["y","in"],["x","iang"]],"removed":false},{"word":"听诊器","synonyms":[],"drawingId":"stethoscope","pinyin":[["t","ing"],["zh","en"],["q","i"]],"removed":false},{"word":"缝线","synonyms":["针脚"],"drawingId":"stitches","pinyin":[["f","eng"],["x","ian"]],"removed":false},{"word":"停止标志","synonyms":["停车标志"],"drawingId":"stop sign","pinyin":[["t","ing"],["zh","i"],["b","iao"],["zh","i"]],"removed":false},{"word":"炉子","synonyms":["火炉"],"drawingId":"stove","pinyin":[["l","u"],["z","i"]],"removed":false},{"word":"草莓","synonyms":[],"drawingId":"strawberry","pinyin":[["c","ao"],["m","ei"]],"removed":false},{"word":"路灯","synonyms":["街灯"],"drawingId":"streetlight","pinyin":[["l","u"],["d","eng"]],"removed":false},{"word":"豆角","synonyms":["四季豆"],"drawingId":"string bean","pinyin":[["d","ou"],["j","iao"]],"removed":true},{"word":"潜艇","synonyms":["潜水艇"],"drawingId":"submarine","pinyin":[["q","ian"],["t","ing"]],"removed":false},{"word":"行李箱","synonyms":["手提箱"],"drawingId":"suitcase","pinyin":[["x","ing"],["l","i"],["x","iang"]],"removed":false},{"word":"太阳","synonyms":["日"],"drawingId":"sun","pinyin":[["t","ai"],["y","ang"]],"removed":false},{"word":"天鹅","synonyms":[],"drawingId":"swan","pinyin":[["t","ian"],[null,"e"]],"removed":false},{"word":"毛衣","synonyms":["针织衫"],"drawingId":"sweater","pinyin":[["m","ao"],["y","i"]],"removed":false},{"word":"秋千","synonyms":["荡秋千"],"drawingId":"swing set","pinyin":[["q","iu"],["q","ian"]],"removed":false},{"word":"剑","synonyms":[],"drawingId":"sword","pinyin":[["j","ian"]],"removed":false},{"word":"注射器","synonyms":["针管","针筒"],"drawingId":"syringe","pinyin":[["zh","u"],["sh","e"],["q","i"]],"removed":false},{"word":"桌子","synonyms":["台子"],"drawingId":"table","pinyin":[["zh","uo"],["z","i"]],"removed":false},{"word":"茶壶","synonyms":[],"drawingId":"teapot","pinyin":[["ch","a"],["h","u"]],"removed":false},{"word":"泰迪熊","synonyms":["玩具熊","小熊","熊"],"drawingId":"teddy-bear","pinyin":[["t","ai"],["d","i"],["x","iong"]],"removed":false},{"word":"电话","synonyms":[],"drawingId":"telephone","pinyin":[["d","ian"],["h","ua"]],"removed":false},{"word":"电视","synonyms":["电视机"],"drawingId":"television","pinyin":[["d","ian"],["sh","i"]],"removed":false},{"word":"网球拍","synonyms":["球拍"],"drawingId":"tennis racquet","pinyin":[["w","ang"],["q","iu"],["p","ai"]],"removed":false},{"word":"帐篷","synonyms":[],"drawingId":"tent","pinyin":[["zh","ang"],["p","eng"]],"removed":false},{"word":"埃菲尔铁塔","synonyms":[],"drawingId":"The Eiffel Tower","pinyin":[[null,"ai"],["f","ei"],[null,"er"],["t","ie"],["t","a"]],"removed":false},{"word":"长城","synonyms":["万里长城"],"drawingId":"The Great Wall of China","pinyin":[["ch","ang"],["ch","eng"]],"removed":false},{"word":"蒙娜丽莎","synonyms":[],"drawingId":"The Mona Lisa","pinyin":[["m","eng"],["n","a"],["l","i"],["sh","a"]],"removed":false},{"word":"老虎","synonyms":["虎"],"drawingId":"tiger","pinyin":[["l","ao"],["h","u"]],"removed":false},{"word":"烤面包机","synonyms":["吐司机"],"drawingId":"toaster","pinyin":[["k","ao"],["m","ian"],["b","ao"],["j","i"]],"removed":false},{"word":"脚趾","synonyms":["趾"],"drawingId":"toe","pinyin":[["j","iao"],["zh","i"]],"removed":false},{"word":"马桶","synonyms":["厕所"],"drawingId":"toilet","pinyin":[["m","a"],["t","ong"]],"removed":false},{"word":"牙齿","synonyms":["牙"],"drawingId":"tooth","pinyin":[["y","a"],["ch","i"]],"removed":false},{"word":"牙刷","synonyms":[],"drawingId":"toothbrush","pinyin":[["y","a"],["sh","ua"]],"removed":false},{"word":"牙膏","synonyms":[],"drawingId":"toothpaste","pinyin":[["y","a"],["g","ao"]],"removed":false},{"word":"龙卷风","synonyms":["旋风"],"drawingId":"tornado","pinyin":[["l","ong"],["j","uan"],["f","eng"]],"removed":false},{"word":"拖拉机","synonyms":[],"drawingId":"tractor","pinyin":[["t","uo"],["l","a"],["j","i"]],"removed":false},{"word":"红绿灯","synonyms":["交通灯"],"drawingId":"traffic light","pinyin":[["h","ong"],["l","ü"],["d","eng"]],"removed":false},{"word":"火车","synonyms":[],"drawingId":"train","pinyin":[["h","uo"],["ch","e"]],"removed":false},{"word":"树","synonyms":[],"drawingId":"tree","pinyin":[["sh","u"]],"removed":false},{"word":"三角形","synonyms":[],"drawingId":"triangle","pinyin":[["s","an"],["j","iao"],["x","ing"]],"removed":false},{"word":"长号","synonyms":[],"drawingId":"trombone","pinyin":[["ch","ang"],["h","ao"]],"removed":false},{"word":"卡车","synonyms":["货车"],"drawingId":"truck","pinyin":[["k","a"],["ch","e"]],"removed":false},{"word":"小号","synonyms":["喇叭"],"drawingId":"trumpet","pinyin":[["x","iao"],["h","ao"]],"removed":false},{"word":"T恤","synonyms":["短袖衫"],"drawingId":"t-shirt","pinyin":[["t","i"],["x","u"]],"removed":false},{"word":"雨伞","synonyms":["伞"],"drawingId":"umbrella","pinyin":[["y","u"],["s","an"]],"removed":false},{"word":"内衣","synonyms":["内裤"],"drawingId":"underwear","pinyin":[["n","ei"],["y","i"]],"removed":false},{"word":"面包车","synonyms":["厢式货车"],"drawingId":"van","pinyin":[["m","ian"],["b","ao"],["ch","e"]],"removed":false},{"word":"花瓶","synonyms":[],"drawingId":"vase","pinyin":[["h","ua"],["p","ing"]],"removed":false},{"word":"小提琴","synonyms":[],"drawingId":"violin","pinyin":[["x","iao"],["t","i"],["q","in"]],"removed":false},{"word":"洗衣机","synonyms":[],"drawingId":"washing machine","pinyin":[["x","i"],["y","i"],["j","i"]],"removed":false},{"word":"西瓜","synonyms":[],"drawingId":"watermelon","pinyin":[["x","i"],["g","ua"]],"removed":false},{"word":"水滑梯","synonyms":[],"drawingId":"waterslide","pinyin":[["sh","ui"],["h","ua"],["t","i"]],"removed":false},{"word":"鲸鱼","synonyms":[],"drawingId":"whale","pinyin":[["j","ing"],["y","u"]],"removed":false},{"word":"轮子","synonyms":["车轮"],"drawingId":"wheel","pinyin":[["l","un"],["z","i"]],"removed":false},{"word":"风车","synonyms":[],"drawingId":"windmill","pinyin":[["f","eng"],["ch","e"]],"removed":false},{"word":"酒瓶","synonyms":[],"drawingId":"wine bottle","pinyin":[["j","iu"],["p","ing"]],"removed":false},{"word":"酒杯","synonyms":["高脚杯"],"drawingId":"wine glass","pinyin":[["j","iu"],["b","ei"]],"removed":false},{"word":"手表","synonyms":[],"drawingId":"wristwatch","pinyin":[["sh","ou"],["b","iao"]],"removed":false},{"word":"瑜伽","synonyms":[],"drawingId":"yoga","pinyin":[["y","u"],["j","ia"]],"removed":false},{"word":"斑马","synonyms":[],"drawingId":"zebra","pinyin":[["b","an"],["m","a"]],"removed":false},{"word":"锯齿形","synonyms":["之字形"],"drawingId":"zigzag","pinyin":[["j","u"],["ch","i"],["x","ing"]],"removed":true}]',
  ),
  Po = vn({ from: "tw", to: "cn" }),
  on = { en: Lo, "zh-CN": Do };
function Te(n) {
  return (on[n] ?? on.en).filter((r) => !r.removed);
}
const In = { sessionDurationMs: 18e4, inferenceMode: "fast", locale: "en" },
  Bo = { drawer: "player", guesser: "agent" },
  me = zn({
    session_started: () => ({ type: "session_started" }),
    round_started: (n, e, r) => ({ type: "round_started", roundId: n, roles: e, drawingId: r }),
    guess_submitted: (n, e, r, s) => ({
    ...
    round_skipped: (n, e) => ({ type: "round_skipped", roundId: n, by: e }),
    nori_redraw: (n, e) => ({ type: "nori_redraw", roundId: n, epoch: e }),
    session_finished: () => ({ type: "session_finished" }),
  }),
  Fo = ln(["fast", "harder"]),
  Oo = re({
    sessionDurationMs: $().int().positive(),
    roundTimeLimitMs: $().int().positive().optional(),
    inferenceMode: Fo,
    locale: he(),
  }),
  qo = re({ x: $().min(0).max(1), y: $().min(0).max(1) }),
  Go = re({ points: cn(qo).min(2).max(128), color: he().optional(), width: $().optional() }),
  Wo = cn(Go).min(1).max(32),
  Yo = { player: {}, agent: {} },
  Ho = { ui: { actors: ["player", "agent"] } },
  ye = En({
    startSession: {
      actors: ["player"],
      schema: re({ atMs: $(), settings: Oo.partial().optional() }),
      input: (n, e) => ({ atMs: n, settings: e }),
      result: (n, e) => ({ success: n, roundId: e }),
    },
    startNextRound: {
      actors: ["player", "agent"],
      schema: re({ atMs: $() }),
    ...
    submitGuess: {
      actors: ["player", "agent"],
      schema: re({ atMs: $(), text: he().transform((n) => An(n, 50)) }),
      input: (n, e) => ({ atMs: n, text: e }),
      result: (n, e) => ({ success: n, correct: e }),
    },
    skipRound: {
      actors: ["player", "agent"],
      schema: re({ atMs: $() }),
    ...
    submitStrokeBatch: {
      actors: ["player"],
      schema: re({ atMs: $(), batch: Wo }),
      input: (n, e) => ({ atMs: n, batch: e }),
      result: (n) => ({ success: n }),
    },
    forceEndSession: {
      actors: ["player", "agent"],
...
function Be(n, e) {
  const r = He(n, e);
  return r ? r.toLowerCase().replace(/^(?:the|a|an)\s+/, "") : "";
}
function xn(n, e, r) {
  if (!n) return !1;
  const s = He(n, r);
  if (!s) return !1;
  if (r === "zh-CN") return s.includes(e.word) ? !0 : e.synonyms.some((a) => s.includes(a));
  {
    const a = Be(s, r),
      i = Be(e.word, r);
    if (!a || !i) return !1;
    ...
    for (const u of e.synonyms) {
      const y = ` ${Be(u, r)} `;
      if (t.includes(y)) return !0;
    }
    const c = a.replaceAll(/\s+/g, ""),
      w = i.replaceAll(/\s+/g, "");
    return !!(c && w && c.includes(w));
  }
}
function $o(n) {
  return (
    Te(n.locale).find((r) => r.drawingId === n.drawingId) ?? {
      word: n.word,
      synonyms: [],
...
function sn(n, e) {
  const r = Te(e),
    s = r[0] ?? { word: "apple", synonyms: [], drawingId: "apple", removed: !1 },
    a = new Set(n.map((l) => l.toLowerCase())),
    i = r.filter((l) => !a.has(l.drawingId.toLowerCase())),
    t = i.length ? i : r;
  return t[Math.floor(Math.random() * t.length)] ?? s;
}
function Uo(n) {
  return n.drawer === "player"
    ? { drawer: "agent", guesser: "player" }
    : { drawer: "player", guesser: "agent" };
}
function an(n) {
  return `round_${n}_${Math.random().toString(36).slice(2, 8)}`;
}
function Vo(n) {
  return n.reduce((e, r) => e + r.elapsedMs, 0);
}
function tn(n, e, r) {
  const s = e.sessionDurationMs;
  return n.phase !== G.PLAYING
    ? { phase: n.phase, events: [] }
    : !Number.isFinite(s) || s <= 0
      ? { phase: n.phase, events: [] }
      : Vo(r) < s
        ? { phase: n.phase, events: [] }
        : { phase: G.RESULTS, events: [me.session_finished(), yn("played")] };
}
const Xo = {
  startSession: ({ cmd: n, state: e }) => {
    if (e.gameState?.phase === G.PLAYING) throw new U("Session already in progress");
    const r = { ...In, ...e.settings, ...n.settings },
      s = r.locale,
      a = an(n.atMs),
      i = sn([], s),
      t = {
    ...
    return {
      nextState: {
        gameState: { phase: G.PLAYING, score: { solved: 0, skipped: 0 }, round: t, history: [] },
        settings: r,
      },
      events: [me.session_started(), me.round_started(a, t.roles, t.drawingId)],
      result: ye.startSession.result(!0, a),
    };
  },
  startNextRound: ({ cmd: n, state: e }) => {
    if (!e.gameState || e.gameState.phase !== G.PLAYING) throw new U("Session is not active");
    if (e.gameState.round.status === "active") throw new U("Round is still active");
    const r = e.settings.locale,
      s = Uo(e.gameState.round.roles),
      a = [
        e.gameState.round.drawingId,
        ...e.gameState.history.map((c) => Te(r).find((m) => m.word === c.word)?.drawingId ?? ""),
      ].filter(Boolean),
      i = sn(a, r),
      t = an(n.atMs);
    return {
      nextState: {
        ...
        gameState: {
          ...
          score: e.gameState.score,
        },
      },
      events: [me.round_started(t, s, i.drawingId)],
      result: ye.startNextRound.result(!0, t),
    };
  },
  submitGuess: ({ actor: n, cmd: e, state: r }) => {
    if (!r.gameState || r.gameState.phase !== G.PLAYING) throw new U("Session is not active");
    if (r.gameState.round.status !== "active") throw new U("Round is not active");
    if (r.gameState.round.roles.guesser !== n) throw new U("Not the current guesser");
    const s = r.settings.locale,
      a = e.text.trim(),
      i = He(e.text, s);
    if (!i) throw new U("Empty guess");
    const l = Te(s).find((D) => D.drawingId === r.gameState.round.drawingId) ?? {
        word: r.gameState.round.word,
        synonyms: [],
        drawingId: r.gameState.round.drawingId,
      },
      c = xn(i, l, s),
      w = { by: n, text: a, atMs: e.atMs, correct: c },
      u = { ...r.gameState.round, lastGuess: w },
      m = r.gameState.round.roundId,
      y = [me.guess_submitted(m, n, a, c)];
    if (!c)
      return {
        nextState: { ...r, gameState: { ...r.gameState, round: u } },
        events: y,
        result: ye.submitGuess.result(!0, !1),
      };
    const x = Math.max(0, e.atMs - r.gameState.round.startedAtMs),
      S = {
        word: r.gameState.round.word,
        roles: r.gameState.round.roles,
        elapsedMs: x,
        outcome: "solved",
      },
      I = [...r.gameState.history, S],
      { phase: C, events: O } = tn(r.gameState, r.settings, I);
    return (
      y.push(me.round_solved(m, n, r.gameState.round.word, x), ...O),
      {
        nextState: {
          ...r,
          gameState: {
            ...r.gameState,
            phase: C,
            score: { ...r.gameState.score, solved: r.gameState.score.solved + 1 },
            round: { ...u, status: "solved", solvedAtMs: e.atMs },
            history: I,
          },
        },
        events: y,
        result: ye.submitGuess.result(!0, !0),
      }
    );
  },
  skipRound: ({ actor: n, cmd: e, state: r }) => {
    if (!r.gameState || r.gameState.phase !== G.PLAYING) throw new U("Session is not active");
    if (r.gameState.round.status !== "active") throw new U("Round is not active");
    if (r.gameState.round.roles.drawer !== n && r.gameState.round.roles.guesser !== n)
      throw new U("Not allowed to skip this round");
    const s = Math.max(0, e.atMs - r.gameState.round.startedAtMs),
      a = {
        word: r.gameState.round.word,
        roles: r.gameState.round.roles,
        elapsedMs: s,
      ...
      i = [...r.gameState.history, a],
      { phase: t, events: l } = tn(r.gameState, r.settings, i),
      c = r.gameState.round.roundId,
      w = [me.round_skipped(c, n), ...l];
    return {
      nextState: {
        ...r,
        gameState: {
          ...r.gameState,
          phase: t,
          score: { ...r.gameState.score, skipped: r.gameState.score.skipped + 1 },
          round: { ...r.gameState.round, status: "skipped" },
          history: i,
        },
      },
      events: w,
      result: ye.skipRound.result(!0),
    };
  },
  noriRedraw: ({ actor: n, state: e }) => {
    if (n !== "agent") throw new U("Only Nori can redraw");
    if (!e.gameState || e.gameState.phase !== G.PLAYING) throw new U("Session is not active");
    if (e.gameState.round.status !== "active") throw new U("Round is not active");
    if (e.gameState.round.roles.drawer !== "agent") throw new U("Nori is not the drawer");
    const r = e.gameState.round.noriRedrawEpoch + 1,
      s = {
        ...e,
        gameState: { ...e.gameState, round: { ...e.gameState.round, noriRedrawEpoch: r } },
      },
      a = e.gameState.round.roundId;
    return { nextState: s, events: [me.nori_redraw(a, r)], result: ye.noriRedraw.result(r) };
  },
  submitStrokeBatch: ({ actor: n, state: e }) => {
    if (n !== "player") throw new U("Only player can submit strokes");
    if (!e.gameState || e.gameState.phase !== G.PLAYING) throw new U("Session is not active");
    if (e.gameState.round.status !== "active") throw new U("Round is not active");
    if (e.gameState.round.roles.drawer !== "player") throw new U("Player is not the drawer");
    return { nextState: e, events: [], result: ye.submitStrokeBatch.result(!0) };
  },
  forceEndSession: ({ cmd: n, state: e }) => {
    if (!e.gameState || e.gameState.phase !== G.PLAYING)
      return { nextState: e, events: [], result: ye.forceEndSession.result(!1) };
    const r = Math.max(0, n.atMs - e.gameState.round.startedAtMs),
      s = {
        word: e.gameState.round.word,
        roles: e.gameState.round.roles,
        elapsedMs: r,
        outcome: "unfinished",
      };
    return {
      nextState: {
        ...
        gameState: {
          ...e.gameState,
          phase: G.RESULTS,
          round: { ...e.gameState.round, status: "unfinished" },
          history: [...e.gameState.history, s],
        },
      },
      events: [me.session_finished(), yn("played", "forced")],
      result: ye.forceEndSession.result(!0),
    };
  },
};
Tn({
  id: "pictionary",
  mutexGroup: _n,
  initialState: { gameState: null, settings: In },
  actors: Yo,
  visibilityFences: Ho,
  ev: me,
  cmd: ye,
...
function Ko(n) {
  const {
    ...
    word: a,
    drawingId: i,
    submitCorrectGuess: t,
  } = n;
  return n.onPlayerChatSent((l) => {
    if (!e || r?.drawer !== "agent" || r.guesser !== "player" || !a) return;
    const c = $o({ locale: s, drawingId: i, word: a });
    xn(l, c, s) && t(c.word);
  });
}
const dn = 250;
function Qo(n, e) {
  const r = n.history.reduce((s, a) => s + a.elapsedMs, 0);
  return n.phase !== G.PLAYING || n.round.status !== "active"
    ? r
    : r + Math.max(0, e - n.round.startedAtMs);
}
function Jo(n) {
  const e = n.history.map((y) => ({
      word: y.word,
      elapsedMs: y.elapsedMs,
      roles: y.roles,
      outcome: y.outcome,
    })),
    r = n.history.map((y) => y.word),
    s = e.filter((y) => y.outcome === "solved").length,
    a = e.filter((y) => y.outcome === "skipped").length,
    i = e.filter((y) => y.outcome === "unfinished").length,
    t = s + a,
    l = t > 0 ? Math.round((s / t) * 100) : 0,
    c = e.filter((y) => y.outcome === "solved"),
    w = c.length ? Math.min(...c.map((y) => y.elapsedMs)) : null,
    u = c.length ? c.reduce((y, x) => y + x.elapsedMs, 0) / c.length : null,
    m = e.reduce((y, x) => y + x.elapsedMs, 0);
  return {
    solved: s,
    attempted: t,
    skipped: a,
    ...
    history: e,
    usedWords: r,
    lastCaption: n.round.lastGuess?.text ?? "",
    durationMs: m,
  };
}
function Zo({ count: n }) {
    ...
    children: [
      o.jsx("svg", {
        ...
        children: o.jsx("ellipse", {
          ...
          strokeWidth: "2",
          strokeLinecap: "round",
          style: { strokeDasharray: "2 4", transform: "rotate(-3deg)", transformOrigin: "center" },
        }),
      }),
      o.jsx("span", {
        style: {
...
function es({ isLow: n }) {
  return o.jsxs(_.svg, {
    viewBox: "0 0 20 24",
    className: "w-4 h-5",
    animate: n ? { rotate: [0, 15, -15, 0] } : {},
    transition: { duration: 0.8, repeat: n ? 1 / 0 : 0 },
    children: [
      o.jsx("path", {
        d: "M4 2 L16 2 L16 4 Q16 8 10 12 Q4 8 4 4 Z",
        fill: "none",
        stroke: n ? b.inkRed : b.graphite,
        strokeWidth: "1.5",
        strokeLinecap: "round",
        strokeLinejoin: "round",
      }),
      o.jsx("path", {
        d: "M4 22 L16 22 L16 20 Q16 16 10 12 Q4 16 4 20 Z",
        fill: "none",
        stroke: n ? b.inkRed : b.graphite,
        strokeWidth: "1.5",
        strokeLinecap: "round",
      ...
      o.jsx("path", { d: "M6 20 Q10 17 14 20", fill: n ? b.inkRed : b.graphite, opacity: "0.4" }),
      n &&
        o.jsx(_.circle, {
          cx: "10",
          cy: "14",
          r: "1",
          fill: b.inkRed,
          animate: { cy: [12, 18], opacity: [1, 0] },
          transition: { duration: 0.6, repeat: 1 / 0 },
        }),
    ],
  });
}
const ns = d.memo(function ({ timeLeft: e, score: r, isDrawing: s, word: a, onHelp: i }) {
    const { t } = Se(),
      l = e < 3e4,
      c = $r(e);
    return o.jsxs("div", {
      className:
        "relative shrink-0 flex flex-wrap items-center justify-between gap-x-2 px-5 py-2.5 rounded max-xl:px-3 max-xl:py-2",
      style: { background: b.washiYellow, boxShadow: "0 2px 8px rgba(0,0,0,0.2)" },
      children: [
        o.jsx("div", {
          ...
          children: [
            ...
            o.jsxs("div", {
              ...
              children: [
                o.jsx("span", {
                  style: {
                    color: b.graphiteLight,
                    fontFamily: le.handwriting,
                    fontSize: "12px",
                    lineHeight: 1,
                  },
                  children: t("pictionary.game.timeRemaining"),
                }),
                o.jsx(_.span, {
                  animate: l ? { scale: [1, 1.05, 1] } : {},
                  transition: { duration: 0.5, repeat: l ? 1 / 0 : 0 },
                  className: "tabular-nums",
                  style: {
                    color: l ? b.inkRed : b.graphite,
                    fontFamily: le.handwriting,
                    fontSize: "22px",
                    fontWeight: 700,
                    lineHeight: 1,
        ...
        o.jsx(rs, { isDrawing: s, word: a }),
        o.jsxs("div", {
          className: "relative flex items-center gap-2",
          children: [
            o.jsx("span", {
              style: { color: b.graphiteLight, fontFamily: le.handwriting, fontSize: "12px" },
              children: t("pictionary.game.correct"),
            }),
            o.jsx(Zo, { count: r }),
            o.jsx("button", {
              onClick: i,
              "aria-label": t("pictionary.help.button"),
              className:
                "ml-1 flex h-6 w-6 items-center justify-center rounded-full transition-transform hover:scale-110",
              style: {
                border: `1.5px solid ${b.graphiteLight}`,
                color: b.graphiteLight,
                fontFamily: le.handwriting,
  ...
  rs = d.memo(function ({ isDrawing: e, word: r }) {
    const { t: s } = Se(),
      a = s(e ? "pictionary.game.yourTurnToDraw" : "pictionary.game.yourTurnToGuess"),
      i = r.length > 18 ? "17px" : r.length > 12 ? "20px" : "24px";
    return o.jsxs("div", {
      className: "flex flex-col items-center min-w-0 max-xl:order-first max-xl:w-full",
      children: [
        o.jsx("span", {
          style: { color: b.graphiteLight, fontFamily: le.handwriting, fontSize: "12px" },
          children: a,
        ...
        o.jsxs(
          _.div,
          {
            ...
            children: [
              ...
              o.jsx(jn, { width: Math.min(r.length * 14, 160), className: "mt-0.5" }),
            ],
          },
          r,
        ),
  ...
  os = {
    default: { ink: "#2E3E54", edge: "#1B2634", paper: "#EDE3CB" },
    danger: { ink: "#8E2F22", edge: "#5E1E14", paper: "#F4DAD1" },
  };
function Fe({ onClick: n, disabled: e, label: r, icon: s, variant: a = "default" }) {
  const { ink: i, edge: t, paper: l } = os[a],
    c = a === "danger" ? -1.2 : 1;
  return o.jsxs(_.button, {
    type: "button",
    onClick: n,
    disabled: e,
    className:
      "relative w-full flex items-center justify-center gap-1.5 rounded-[3px] px-2 py-2.5 max-xl:gap-1 max-xl:px-1 max-xl:py-2",
    style: {
      background: l,
      border: `2px solid ${i}`,
      boxShadow: e ? "none" : `0 3px 0 ${t}, 0 7px 16px rgba(0,0,0,0.4)`,
      opacity: e ? 0.35 : 1,
      cursor: e ? "not-allowed" : "pointer",
    },
    initial: !1,
    animate: { rotate: c, y: 0 },
    whileHover: e ? {} : { rotate: 0, y: -2 },
    whileTap: e ? {} : { rotate: 0, y: 3 },
    transition: { type: "spring", stiffness: 500, damping: 30 },
    children: [
      o.jsx("div", {
        className: "absolute inset-[3px] rounded-[1px] pointer-events-none",
        style: { border: `1px dashed ${i}`, opacity: 0.35 },
      }),
      o.jsx("div", {
        className: "absolute inset-0 rounded-[3px] pointer-events-none",
        style: {
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='s'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='3'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23s)' opacity='0.18'/%3E%3C/svg%3E")`,
          mixBlendMode: "multiply",
        },
      }),
      o.jsx("span", { className: "relative shrink-0", style: { color: i }, children: s }),
      o.jsx("span", {
        className: "relative whitespace-nowrap text-[15px] max-xl:text-[13px]",
        style: {
          color: i,
          fontFamily: le.handwriting,
          fontWeight: 700,
...
function ss({ children: n }) {
  return o.jsxs("div", {
    className: "h-full flex flex-col relative rounded-md overflow-hidden",
    style: {
      background: "linear-gradient(175deg, #5C4033 0%, #4A3428 40%, #3D2A1F 100%)",
      boxShadow: `
    ...
    children: [
      o.jsx("div", {
        ...
        style: {
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='leather'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.7' numOctaves='4' stitchTiles='stitch'/%3E%3CfeColorMatrix type='saturate' values='0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23leather)'/%3E%3C/svg%3E")`,
          opacity: 0.12,
          mixBlendMode: "overlay",
        },
      }),
      o.jsx("div", {
        className: "relative shrink-0 flex justify-center pt-1.5 pb-0.5 z-10",
        children: o.jsxs("div", {
          className: "relative",
          ...
          children: [
            ...
            o.jsx("div", {
              className: "absolute top-0 left-1/2 -translate-x-1/2 rounded-t",
              style: {
                width: "30px",
                height: "6px",
                background: "linear-gradient(180deg, #9B9B9B 0%, #7B7B7B 100%)",
                boxShadow: "inset 0 1px 0 rgba(255,255,255,0.4)",
              },
            }),
            o.jsx("div", {
              className: "absolute top-1/2 left-1.5 -translate-y-1/2 w-1.5 h-1.5 rounded-full",
              style: {
                background: "radial-gradient(circle at 30% 30%, #9B9B9B 0%, #5B5B5B 100%)",
      ...
      o.jsx("div", {
        className: "flex-1 min-h-0 m-2 mt-0 relative rounded-sm overflow-hidden",
        style: {
          boxShadow: `
      ...
      o.jsx("div", {
        className: "absolute inset-2 pointer-events-none rounded-md",
        style: { border: "1px dashed rgba(255,255,255,0.06)" },
      }),
    ],
  });
}
function as({ active: n }) {
  const { t: e } = Se();
  return o.jsxs("div", {
      ...
      o.jsxs("div", {
        ...
        children: [
          o.jsxs(_.svg, {
            viewBox: "0 0 20 20",
            className: "w-4 h-4",
            animate: n ? { scale: [1, 1.1, 1] } : {},
            transition: { duration: 2, repeat: 1 / 0 },
            children: [
              o.jsx("path", {
                d: "M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2H8l-4 3v-3H3a1 1 0 01-1-1V5z",
                fill: "none",
                stroke: n ? "#34C759" : "rgba(255,255,255,0.4)",
                strokeWidth: "1.5",
                strokeLinecap: "round",
                strokeLinejoin: "round",
              }),
                ...
                o.jsxs(o.Fragment, {
                  children: [
                    o.jsx(_.circle, {
                      ...
                      transition: { duration: 1.2, repeat: 1 / 0, delay: 0 },
                    }),
                    o.jsx(_.circle, {
                      cx: "10",
                      cy: "9",
                      ...
                      fill: "#34C759",
                      animate: { opacity: [0.3, 1, 0.3] },
                      transition: { duration: 1.2, repeat: 1 / 0, delay: 0.2 },
                    }),
                    o.jsx(_.circle, {
                      cx: "13",
                      cy: "9",
                      ...
                      fill: "#34C759",
                      animate: { opacity: [0.3, 1, 0.3] },
                      transition: { duration: 1.2, repeat: 1 / 0, delay: 0.4 },
                    }),
                  ],
                }),
            ],
          ...
          o.jsx("span", {
            ...
            children: e("pictionary.game.guesses"),
          }),
        ],
      }),
      o.jsx(je, {
        children:
          ...
          o.jsxs(_.div, {
            ...
            children: [
              ...
              o.jsx("span", {
                style: { color: "#34C759", fontSize: "10px", fontWeight: 600 },
                children: "LIVE",
              }),
            ],
          }),
...
function is({ messages: n, viewportRef: e, isPlayerGuesser: r, active: s, onSubmitGuess: a }) {
  const { t: i } = Se();
  return o.jsxs(_.div, {
    ...
    children: [
      ...
      o.jsx("div", {
        ...
        children: o.jsx($n, {
          ...
          active: s,
          onSubmitGuess: a,
          placeholder: i("pictionary.game.guessPlaceholder"),
          disabledPlaceholder: i("pictionary.game.watchingPlaceholder"),
          emptyMessage: i("pictionary.game.waitingMessage"),
        }),
      }),
    ],
  });
...
const ts = 5,
  ds = d.memo(function ({ secondsLeft: e }) {
    const s = 2 * Math.PI * 115,
      a = e / ts,
      i = s * (1 - a);
    return o.jsxs(_.div, {
      ...
      children: [
        o.jsx(_.div, {
          className: "absolute inset-0",
          style: {
            background: `radial-gradient(ellipse 100% 100% at 50% 50%, ${b.paper}ee 0%, ${b.paperShadow}f5 100%)`,
        ...
        o.jsxs(_.div, {
          className: "relative flex items-center justify-center max-xl:scale-75",
          ...
          children: [
            ...
            o.jsxs("div", {
              ...
              style: {
                width: 260,
                height: 260,
                background: `radial-gradient(circle at 35% 35%, #FFFEF9 0%, ${b.paper} 50%, ${b.paperShadow} 100%)`,
                boxShadow: `
              ...
              children: [
                ...
                o.jsx("div", {
                  ...
                  style: {
                    ...
                    width: 80,
                    height: 80,
                    background: `radial-gradient(circle, ${b.coffeeRing} 0%, transparent 70%)`,
                  },
                }),
              ],
            }),
            o.jsxs("svg", {
              ...
              children: [
                ...
                o.jsx(_.circle, {
                  ...
                  strokeLinecap: "round",
                  strokeDasharray: s,
                  animate: { strokeDashoffset: i },
                  transition: { duration: 0.95, ease: "linear" },
                  style: { filter: "drop-shadow(0 3px 8px rgba(194, 59, 34, 0.35))" },
                }),
                o.jsx(_.circle, {
                  cx: "140",
                  cy: "140",
                  r: 115,
                  fill: "none",
                  stroke: b.elasticHighlight,
                  strokeWidth: "3",
                  strokeLinecap: "round",
                  strokeDasharray: `10 ${s - 10}`,
                  animate: { strokeDashoffset: i },
                  transition: { duration: 0.95, ease: "linear" },
            ...
            o.jsx(_.div, {
              className: "absolute rounded-full",
              style: { width: 260, height: 260, border: `2px solid ${b.elastic}` },
  ...
  xs = d.memo(function ({ navigate: e }) {
    const { t: r } = Se(),
      ...
      [l, c] = d.useState(0),
      [w, u] = d.useState(!1),
      { messages: m, push: y, clear: x, viewportRef: S } = Hr(),
      { bubbles: I, spawnBubble: C, clearBubbles: O } = Cr(),
      g = a?.gameState;
    d.useEffect(() => {
      g
        ? console.info("[GameScreen] gameState available:", {
            phase: g.phase,
            roundId: g.round?.roundId,
            roundStatus: g.round?.status,
          })
        : console.info("[GameScreen] gameState is null/undefined");
    }, [g]);
    const D = g?.phase === G.PLAYING;
    d.useEffect(() => {
      if (D) return (Fn(), () => On());
    }, [D]);
    const R = d.useRef(!1),
      ...
      z = d.useRef(null),
      [N, Y] = d.useState(null),
      [V, ie] = d.useState({ tool: "pen", strokeColor: ke[0].color }),
      Z = g?.round,
      ee = Z?.roundId ?? "",
      P = Z?.word ?? "",
      f = Z?.roles,
      j = Z?.status ?? "active",
      v = Z?.noriRedrawEpoch ?? 0,
      E = f?.guesser === "player",
      A = g?.phase ?? G.PLAYING,
      k = A === G.PLAYING && j === "active",
      p = d.useMemo(() => {
        if (!g || g.phase !== G.PLAYING) return null;
        const h = bn(g);
        return h === null ? null : h + kn;
      }, [g]);
    d.useEffect(() => {
      console.info("[GameScreen] Round state changed:", {
        phase: A,
        roundStatus: j,
        isRoundActive: k,
        roundId: ee,
    ...
    const { setHint: F, displayText: X } = Wr({
      active: A === G.PLAYING,
      isPlayerGuesser: !!E,
      word: P || null,
      sessionDurationMs: a?.settings.sessionDurationMs ?? 0,
      locale: a?.settings.locale ?? "en",
      pinyin: Z?.pinyin,
    });
    d.useEffect(() => (s({ titleBarBackground: "#0C0C0C" }), () => s(null)), [s]);
    const te = d.useCallback(async () => {
        if (!t || J.current) return;
        const h = M.current.shift();
        if (h) {
          J.current = !0;
          try {
            await Ce("pictionary", { type: "submitStrokeBatch", atMs: Date.now(), batch: h });
          } catch (q) {
            console.warn("[Pictionary] Failed to submit stroke batch:", q);
          } finally {
            ((J.current = !1), M.current.length && te());
          }
        }
      }, [t]),
      Re = d.useCallback(
        (h) => {
          t && (M.current.push(h), M.current.length > 12 && M.current.shift(), te());
        },
        [te, t],
      ),
      K = d.useCallback(
        (h) => {
          i &&
            _o(i, h).catch((q) => {
              console.warn("[Pictionary] Revision send failed:", q);
            });
        },
        [i],
      );
    d.useEffect(() => {
      if (i)
        return zo({
          ...
          roundId: ee,
          roundRoles: f ?? null,
          captureSnapshot: async () => (await z.current?.captureSnapshot()) ?? null,
        });
    }, [k, ee, f?.drawer, f?.guesser, i]);
    const T = Z?.drawingId ?? "",
      B = a?.settings.locale ?? "en";
    d.useEffect(() => {
      if (t)
        return Ko({
          onPlayerChatSent: Gn,
          ...
          word: P,
          drawingId: T,
          submitCorrectGuess: (h) => {
            Ce("pictionary", { type: "submitGuess", atMs: Date.now(), text: h }).catch((q) => {
              console.warn("[Pictionary] Failed to submit norichat guess:", q);
            });
          },
        });
    }, [t, k, ee, f?.drawer, f?.guesser, P, T, B]);
    const oe = d.useCallback(
        (h) => {
          if (
            ...
            !g ||
            g.phase !== G.PLAYING ||
            g.round.status !== "active" ||
            g.round.roles.guesser !== "player"
          )
            return;
          const q = a?.settings.locale ?? "en",
            Q = Ro(h, q);
          Q &&
            Ce("pictionary", { type: "submitGuess", atMs: Date.now(), text: Q }).catch((ne) => {
              console.warn("[Pictionary] Failed to submit guess:", ne);
            });
        },
        [t, g, a?.settings.locale],
      ),
      se = d.useCallback(() => {
        !t ||
          !g ||
          (g.phase === G.PLAYING &&
            g.round.status === "active" &&
            Ce("pictionary", { type: "skipRound", atMs: Date.now() }).catch((h) => {
              console.warn("[Pictionary] Failed to skip round:", h);
            }));
      }, [t, g]);
    (d.useEffect(() => {
      g && g.phase === G.PLAYING && (R.current = !1);
    }, [g, g?.phase]),
      d.useEffect(() => {
        if (!a) return;
        const h = a.gameState,
          q = i?.getHeadSnapshot()?.state,
          Q = Sn(h, q ? q.gameState : void 0);
        if (Q === "start") {
          e("start");
          return;
        }
        Q !== "results" || !h || R.current || ((R.current = !0), e("results", { summary: Jo(h) }));
      }, [e, a, i]),
      d.useEffect(() => {
        if (!a || !g || g.phase !== G.PLAYING) {
          c(a?.settings.sessionDurationMs ?? 0);
          return;
        }
        const h = () => {
            const Q = Qo(g, Date.now()),
              ne = Math.max(0, a.settings.sessionDurationMs - Q);
            c(ne);
          },
          q = window.setInterval(h, dn);
        return (h(), () => window.clearInterval(q));
      }, [a, g, g?.phase, g?.round.roundId, g?.history.length]),
      d.useEffect(() => {
        if (!p) {
          Y(null);
          return;
        ...
        const h = () => {
            ...
            const ne = Math.ceil(Q / 1e3);
            Y(ne);
          },
          q = window.setInterval(h, dn);
        return (h(), () => window.clearInterval(q));
      }, [p]));
    const ce = d.useRef(null);
    d.useEffect(() => {
      const h = ce.current;
      ((ce.current = N),
        !(N == null || h == null) && N < h && ge("partygames-pictionary-next-round-countdown"));
    }, [N]);
    const de = k && l > 0 && l < 3e4;
    (d.useEffect(() => {
      if (!de) return;
      const h = window.setInterval(() => {
        ge("partygames-pictionary-timer-low");
      }, 1e3);
      return () => window.clearInterval(h);
    }, [de]),
      d.useEffect(() => {
        if (!i) return;
        const h = i.onTransition(({ transition: q, next: Q }) => {
          const ne = Q.state.gameState;
          if (ne)
            for (const L of q.events) {
              if (L.type === "session_started") {
                (x(), O(), (W.current = null), F(null));
                continue;
              }
              if (L.type === "round_started") {
                (O(),
                  (W.current = { roundId: ne.round.roundId, by: "", text: "" }),
                  y({
                    id: `${L.type}-${Date.now()}`,
                    sender: "system",
                    content: r("pictionary.game.newRound"),
                    tone: "neutral",
                  }),
                  F(null));
                continue;
              }
              if (L.type === "guess_submitted") {
                const ve = W.current,
                  Ue = L.text.trim().toLowerCase();
                if (ve && ve.roundId === ne.round.roundId && ve.by === L.by && ve.text === Ue)
                  continue;
                ((W.current = { roundId: ne.round.roundId, by: L.by, text: Ue }),
                  y({
                    id: `${L.type}-${L.by}-${Date.now()}`,
                    sender: L.by === "player" ? "player" : "ai",
                    content: L.text,
                  }),
                  C({
                    text: L.text,
                    by: L.by === "player" ? "player" : "agent",
                    correct: L.correct,
                  }),
                  L.correct ||
                    (ge("partygames-pictionary-wrong-guess"),
                    Me(L.by === "player" ? pe.playerWrong.spec : pe.noriWrong.spec)));
                continue;
              }
              if (L.type === "round_solved") {
                const ve =
                  L.by === "agent"
                    ? r("pictionary.game.noriGot", { word: L.word })
                    : r("pictionary.game.youGot", { word: L.word });
                (y({
                  id: `${L.type}-${Date.now()}`,
                  sender: L.by === "agent" ? "ai" : "player",
                  content: ve,
                  tone: "success",
                }),
                  Vn(),
                  F(null),
                  L.by === "player"
                    ? Me(pe.playerCorrect.spec)
                    : Me(L.elapsedMs < qn ? pe.noriCorrectFast.spec : pe.noriCorrectSlow.spec));
                continue;
              }
              if (L.type === "round_skipped") {
                (ge("partygames-pictionary-skip-round"),
                  y({
                    id: `${L.type}-${Date.now()}`,
                    sender: "system",
                    content: r("pictionary.game.skipped"),
                    tone: "warning",
                  }),
                  F(null),
                  Me(
                    ne.round.roles.drawer === "agent"
                      ? pe.skipNoriDrawing.spec
                      : pe.skipPlayerDrawing.spec,
                  ));
                continue;
              }
            }
    ...
    return !g || !f
      ? o.jsx("div", {
          ...
          children: o.jsx("span", {
            ...
            children: r("pictionary.game.loading"),
          }),
        })
      : o.jsxs("div", {
          className: "relative h-full w-full",
          style: { background: "linear-gradient(165deg, #1A3D32 0%, #0F2921 50%, #0A1F18 100%)" },
          children: [
            o.jsx("div", {
              className: "absolute inset-0 pointer-events-none",
              style: {
                backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='felt'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='4' stitchTiles='stitch' result='noise'/%3E%3CfeColorMatrix type='saturate' values='0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23felt)'/%3E%3C/svg%3E")`,
                opacity: 0.08,
                mixBlendMode: "soft-light",
              },
            }),
            ...
            o.jsxs(_.div, {
              className: "relative z-10 h-full flex gap-3 p-3 max-xl:gap-2 max-xl:p-2",
              initial: { opacity: 0 },
              animate: { opacity: 1 },
              transition: { duration: 0.3 },
              children: [
                o.jsxs("div", {
                  className: "flex-1 min-w-0 h-full flex gap-3 max-xl:gap-2",
                  children: [
                    o.jsx("div", {
                      className:
                        "shrink-0 w-32 max-xl:w-20 h-full flex flex-col gap-1.5 overflow-visible z-10",
                      children:
                        f?.drawer === "player"
                          ? o.jsxs(o.Fragment, {
                              children: [
                                      ...
                                      ke.map((h) =>
                                        o.jsx(
                                          Ke,
                                          {
                                            pencilColor: h.color,
                                            woodColor: h.wood,
                                            label: r(`pictionary.canvas.colors.${h.id}`),
                                            active: V.strokeColor === h.color && V.tool === "pen",
                                            disabled: !k,
                                            onClick: () => {
                                              (ge("partygames-pictionary-tools"),
                                                z.current?.setStrokeColor(h.color),
                                                ie({ tool: "pen", strokeColor: h.color }));
                                            },
                                          },
                                          h.id,
                                        ),
                                      ),
                                      o.jsx("div", { className: "h-px w-full my-0.5 bg-white/10" }),
                                      o.jsx(Qe, {
                                        label: r("pictionary.canvas.eraser"),
                                        active: V.tool === "eraser",
                                        disabled: !k,
                                        onClick: () => {
                                          (ge("partygames-pictionary-tools"),
                                            z.current?.setTool("eraser"),
                                            ie((h) => ({ ...h, tool: "eraser" })));
                                        },
                                      }),
                                    ],
                                ...
                                o.jsx("div", { className: "flex-1 min-h-0" }),
                                o.jsxs("div", {
                                  ...
                                  children: [
                                    o.jsx(Fe, {
                                      onClick: () => {
                                        (ge("partygames-pictionary-tools"),
                                          z.current?.clearCanvas());
                                      },
                                      disabled: !k,
                                      label: r("pictionary.canvas.clear"),
                                      icon: o.jsx(fr, {
                                        className: "w-4 h-4 max-xl:w-3.5 max-xl:h-3.5",
                                      }),
                                      variant: "danger",
                                    }),
                                    o.jsx(Fe, {
                                      onClick: se,
                                      disabled: !k,
                                      label: r("pictionary.canvas.skip"),
                                      icon: o.jsx(Je, {
                                        className: "w-4 h-4 max-xl:w-3.5 max-xl:h-3.5",
                                      }),
                                    }),
                                  ...
                                  children: o.jsx(Ze, {
                                    children: o.jsxs("div", {
                                      ...
                                      children: [
                                        ...
                                        o.jsx("div", {
                                          className: "h-px w-full my-0.5 bg-white/10",
                                        }),
                                        o.jsx(Qe, {
                                          label: r("pictionary.canvas.eraser"),
                                          active: !1,
                    ...
                    o.jsxs("div", {
                      className: "flex-1 min-w-0 h-full flex flex-col gap-2",
                      children: [
                        o.jsx(ns, {
                          timeLeft: l,
                          score: g.score.solved,
                          isDrawing: !E,
                          word: $e,
                          onHelp: () => u(!0),
                        }),
                        o.jsx("div", {
                          ...
                          children: o.jsx("div", {
                            className: "w-full h-full max-w-[900px] max-h-[720px]",
                            children: o.jsx(ss, {
                              children: o.jsxs("div", {
                                ...
                                children: [
                                  o.jsx(hr, {
                                    ...
                                    drawer: f?.drawer ?? "agent",
                                    guesser: f?.guesser ?? "player",
                                    roundId: ee,
                                    noriRedrawEpoch: v,
                                    onStrokeBatch: Re,
                                    onRevision: K,
                                  ...
                                  o.jsx(kr, { bubbles: I }),
                                  o.jsx(je, {
                                    children: N != null && o.jsx(ds, { secondsLeft: N }),
                                  }),
                                ],
                              }),
                            }),
                ...
                o.jsx("div", {
                  className: "shrink-0 h-full w-64 max-xl:w-48",
                  children: o.jsx(is, {
                    messages: m,
                    viewportRef: S,
                    isPlayerGuesser: !!E,
            ...
            o.jsx(Un, { open: w, onClose: () => u(!1) }),
          ],
        });
  });
export { xs as GameScreen };
